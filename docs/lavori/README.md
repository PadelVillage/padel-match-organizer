...
⏳ **Cosa manca per chiuderla**: i **suoi numeri**. Ha già scelto la forma — **prezzo per
GIOCATORE**, non il campo da dividere — e il vincolo del database tiene `null` («non ancora
deciso») separato da zero («gratis») apposta.
