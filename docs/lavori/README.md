...
### **103** — 🩹 L'esito nominava la parola DICHIARATA, e il messaggio si contraddiceva

🆕 **NATA IL 28/08/2026 DA UNA PROVA FISICA, e la voce la vuole la SESSIONE** — dichiarato come
impone la delega. 🗣️ Il difetto l'ha visto **lui** sullo schermo (*«non coincide con le nostre
regole la risposta»*), durante il tentativo di provare la D2 col telefono di Marco.
⚖️ **Cosa scavalca**: niente. Entra sotto alle altre nove.

📏 **Il difetto, misurato alle 10:58.** Marco ha dichiarato **Intermedio** (3,5) e dimostrato
**Avanzato** (4). Il messaggio del maestro gli ha detto:
*«Il test da solo arriva fino a **Intermedio**, e te lo sto scrivendo adesso.»* e due righe sotto
*«Le tue risposte sono da **Intermedio**, ma un livello così alto non lo decide il test.»*
⇒ **Due affermazioni opposte sulla stessa parola**, e quella sbagliata era falsa due volte: le sue
risposte **non** erano da Intermedio (erano da Avanzato), ed è proprio Intermedio ciò che il test
**decide** — è il tetto.

⚖️ **La LOGICA era giusta, e va detto**: dimostrato 4 sta sopra il tetto 3,5 ⇒ il maestro ci va
davvero, e il tetto è stato scritto (`applied_level` 3,5, Marco da 3 a 3,5). La regola C1 ha
funzionato. **Sbagliata era solo la parola.**

🔎 **La causa: è la E4 del 27/08 sopravvissuta in un altro ramo.**
`promemoria.ts:352` calcola `parolaDelTest = livelloDimostrato || fascia`; la riga **356** la passa
alla **DOMANDA** (curata il 27/08), la riga **365** passava all'**ESITO** la `fascia`, cioè la
**dichiarata**. La parola giusta il bot ce l'aveva in mano: a quella funzione non gliela dava
nessuno. E `avvisi-testi.ts` lo dichiarava pure, nel commento — *«la parola resta quella
DICHIARATA»*.
📌 *Curare l'istanza invece della classe non è una cura* — la stessa frase della trappola ② del
27/08. Allora l'istanza era una `select`, stavolta è un **ramo**.

🔨✅ **CURATA E IN SERVIZIO** — PR #106 del repo del bot, fusa e deployata sui **soci** alle
**11:08:04** (deploy #119, `fb2cfec`, verificato sul bersaglio: «✍️ prenotazioni REALI»).
⭐ L'esito riceve `livelloDimostrato`, ed è **la stessa parola che riceve la domanda**: due sorgenti
per la stessa parola sarebbero il modo in cui le due frasi tornano a divergere. La usano le **tre**
frasi del ramo `pass` che parlano della prova.
⛔ **Lo `skip` NON si tocca, ed è il rovescio della cura**: quella frase dice *«per il livello che
hai DICHIARATO»*, e lì la dichiarata è la parola giusta. Senza quel limite la correzione avrebbe
**rotto una frase sana** — ed è uno dei sabotaggi.
🔒 Senza il campo si torna alla dichiarata, cioè al comportamento di prima.

🩹🚨⭐⭐ **E UN BUCO TROVATO SABOTANDO, NON RILEGGENDO — è il pezzo che vale più della cura.** Il
quarto sabotaggio (**staccare il collegamento** in `promemoria.ts`) all'inizio **non veniva colto**:
le prove chiamano `testoEsitoTest` in diretta, quindi il banco restava **verde** mentre il socio
tornava a leggere la parola sbagliata.
⚖️ È la **stessa identica forma** del difetto che la cura ripara — *la regola giusta con in pasto
una riga monca* — e sarebbe stato beffardo lasciarla scoperta proprio qui. Aggiunta una guardia sul
**cablaggio**, tollerante alla forma (non congela la formattazione), verificata **risabotando**.

✅ **Provato**: banco **1640/1640**, `tsc` pulito, **quattro sabotaggi visti rossi**. Fra le prove
nuove ce n'è una che **non nomina Marco e coglie la classe**: *la parola che il test scrive e quella
che il test non può decidere devono essere diverse, o il messaggio si contraddice* — vera per ogni
coppia di livelli, non solo Intermedio/Avanzato.

⏳ **COSA MANCA PER CHIUDERLA**: un tocco vero. Marco rifà **esattamente** il giro di stamattina
(dichiara Intermedio, risponde alto) e deve leggere *«Le tue risposte sono da **Avanzato**»*. ⚠️ In
scheda non cambia niente: è già a 3,5 e il tetto è già scritto.
...
## 📦 CHIUSE — dal 13 al 28/08/2026 — 79 voci
