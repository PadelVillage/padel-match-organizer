...
## ✋ DA PROVARE INSIEME — in ordine *(aggiornato il 07/09/2026 NOTTE, fine 98ª)*
...
**quattro delle cinque sono state fatte**, e con loro sono cadute le voci **105, 110, 97 e 108**.
...
domande (scrollato o tagliato? sempre o durante il caricamento?). ⇒ **Misurata dal cloud il 02/09
notte**, e tutt'e due hanno risposta: è **scrollato**, e il legame col caricamento è il **contatore
dei secondi** della nota, non il contenuto che cresce. La strada che sembrava chiusa era chiusa solo
dal lato da cui l'avevo provata: la scheda si apre **chiamandola per nome**, senza cliccare niente.
📌 *Prima di dichiarare che serve un altro paio di occhi, conviene chiedersi se c'è una porta di
servizio.*

🩹 **La 2️⃣ e la 3️⃣ sono state ESAUDITE e TOLTE nel giro di un'ora** — chiedevano di aprire una
...
🩹 **La 1️⃣ del 30/08 — «la sonda della 109 dal 31/08» — era già stata esaudita**: la voce è chiusa, e per una
strada diversa da quella che la riga prevedeva (il codice invece della sonda). Una richiesta che resta scritta dopo
essere stata esaudita non è vecchia, **mente**.

⏳ **Si aspettano e basta**: **92** (un gesto della segreteria che attraversa un riavvio del bot — la
finestra delle 17:01 del 30/08 è stata guardata ed era **vuota**) · **83** (un worker oltre i 150 s) ·
**65** (curata e in servizio). 🚨 La **83** si potrebbe **provocare** col cancello del worker come fu
fatto per la 106 — ⚠️ ma il danno **non è simmetrico**: una prenotazione doppia occupa un campo vero,
quindi va disegnata su uno slot lontano e col cancello verificato chiuso.

📌 **E QUATTRO DECISIONI, che non sono prove** — la quarta è del 05/09 pomeriggio, nata dall'avaria (voce 160): **il compute di PROD**. MICRO (1 GB) basta per oggi; con 2.800 soci, il bot e tre sync 1 GB resta tirato, e **SMALL** (2 GB, ~15 $/mese) è la scelta che evita di ritrovarsi lì. È una decisione di **costo**, quindi sua: qui si propone, non si fa. Le altre tre: la **111** (la regola sull'età — un cancello sull'età vuole
**tre** esiti e non due), la **112** (se i 1736 contatti della rubrica debbano stare nell'anagrafica
dei soci) e la 🆕 **114** (oltre i 30 giorni il calendario staff dice «Libero» invece di dire che non
...
⚖️ **Cosa dice questa lista**: le urgenti sono **6** — 92, 83, 65, la **125** (aspetta **un suo incasso da 1 €**) e le due nuove **127** e **128**, che sono lavoro e non attesa —
...
niente — era lavoro. Prima ancora l'aveva smentita la **117**, chiusa il 01/09.
📌 Delle quattro rimaste: la **84** ha una causa misurata (⇒ è lavoro), la **83** si può **provocare**
col cancello del worker (precedente: la 106, il 29/08), la **92** vuole due gesti che controlliamo
entrambi. **Solo la 65 aspetta davvero.**
⚖️ *Una frase di riepilogo che dice «aspettano tutte» è la 26ª in miniatura — un limite dichiarato che
nessuno riprova — e il fatto che si sia riscritta due volte da sé dice che il difetto è nella forma,
non nel numero: si scrive cosa aspetta ciascuna, o non si scrive.*
🩹 **Corretta anche il 01/09**: qui c'era scritto «delle **5** urgenti… e una aspetta il calendario», vero
...
tutte (180).
🆙 **E la sera sono 5**: la **183** è stata **promossa** dalla coda — non per fretta, ma perché è
l'unica del distacco che **non può farla chi lavora**, e finché resta in fondo tiene ferme le due
voci più grosse. La dichiarazione della promozione, col perché e con cosa scavalca, sta nella sua
scheda in fondo a questa sezione. Tutte discendono da una sua frase — **«il gestionale di TEST diventa il vero»** — che
ha trasformato un mirror di prova nel sistema che il circolo userà fra ~20 giorni.
...
riesce a prenotare **per conto suo** proprio nel momento in cui deve imparare a farlo senza
Matchpoint. La barriera funziona, ma non viene mai raggiunta.

🔨 **La cura è invertire i due blocchi**, ed è piccola. ⭐ **Su PROD il comportamento è IDENTICO**
(là la barriera risponde vero, quindi si arriva comunque al controllo dei secret) ⇒ è una modifica
che rispetta *«PROD non si tocca»* nei fatti, non solo nelle intenzioni.

🎯 **E solo DOPO si possono togliere i secret — ed è QUELLA la prova del distacco**: prenotare
...
📏 **Misurato l'08/09, e sono due fatti che vanno letti insieme:**
· `matchpoint-bookings-edit/index.ts:670` — `if (!readOnly && !scritturaAlCircoloConsentita(...))`:
  la **lettura salta il recinto** e chiama il worker. Da lì arrivano `importoCents`, `pendenteCents`,
  `stato`, `idx`, `idCliente`;
· delle **256** `staff_booking` vive su PROD solo **14** portano gli importi — **le stesse 14** che
  portano `lettoAt`, cioè quelle che qualcuno ha **aperto a mano**. ⇒ **242 hanno solo i nomi.**

⇒ **La cassa non ha su cosa addebitare.** Non è un dettaglio di ordine: è la ragione per cui **la
lettura nativa della scheda viene PRIMA della cassa**, e non il contrario. Costruire la cassa su
un dato che esiste nel 5% dei casi vorrebbe dire scoprirlo con i soldi veri di qualcuno.

🎯 **È il pezzo più grosso del lavoro**, ed è quello che decide se il 27/09 è una data o un augurio.

🔨✅ **PRIMA METÀ IN SERVIZIO E PROVATA — 08/09/2026 notte: l'importo NASCE dal listino.**
L'importo non si va più a leggere: si fa **nascere**. Alla creazione nativa la prenotazione prende
il prezzo della sua fascia (voce 185) e se lo porta addosso. A dirlo è **`pmo_calendario_effettivo`**,
cioè la stessa funzione che risponde all'app e al bot: il prezzo è **uno solo**, e il giorno in cui
Matchpoint si spegne questa riga non cambia.
📐 **Le quattro regole, ognuna un modo di sbagliare già pagato altrove** (`importo-dal-listino.ts`,
modulo puro):
· **`null` non è `0`** — prezzo non deciso ⇒ non si scrive niente. Zero vorrebbe dire «gratis», e
  una partita segnata gratis non la rivede più nessuno;
· **un importo GIÀ presente vince** — può venire dal circolo (letto) o dalla segreteria (deciso):
  il listino è il valore di partenza, non un'autorità che passa sopra a una decisione presa;
· **`pendenteCents` nasce uguale all'importo** — nessuno ha ancora pagato: dire «pendente 0» su una
  partita appena creata sarebbe dichiararla riscossa;
· 🚨 **NON si scrive `lettoAt`** — quel campo vuol dire *«questo numero l'ho letto dal circolo»*, e
  appiccicarlo a un importo nato qui direbbe il falso proprio nel campo che esiste per tenere onesto
  il ricordo. ⇒ `origineImporto: 'listino'` + `importoAt`. 📌 *Due provenienze non stanno nello
  stesso campo: il giorno in cui divergono, nessuno sa più quale delle due sta leggendo.*
📏 **Provato sulla pagina viva di TEST**, con due prenotazioni fatte apposta e poi tolte:
· mercoledì **19:30** (in griglia) ⇒ i due giocatori nascono con **`importoCents: 1300`**,
  `pendenteCents: 1300`, `origineImporto: listino`, e **nessun `lettoAt`**;
· stesso giorno alle **07:00** (fuori griglia) ⇒ **nessun importo inventato**, la riga ha solo il
  nome. *È la riga che valeva la prova: un prezzo a caso è peggio di un prezzo mancante.*
...
## 🔓 VOCE 179 — ⏳ IL VERDETTO `verifica` SI CONGELA PER SEMPRE — ✅ **CHIUSA l'08/09/2026 sera**

*(La scheda resta per intero perché il ragionamento serve: è la forma che ogni «da dove viene questo dato» deve avere dopo il distacco.)*
...
✅⭐⭐ **PROVATA VIVA L'08/09 SERA, E NEI TRE VERSI** — è la forma che questo progetto chiede: non
*«non è successo niente di male»*, ma **«è passata di lì e ha fatto la cosa giusta»**.
📏 Stesso socio, stesso slot (Lidia Comes · 20/09 · 07:00 · Campo 4), stesso istante di scrittura,
tre chiamate vere al ponte nel giro di quattro minuti:

| ora | la dichiarazione diceva | il ponte ha risposto | |
|---|---|---|---|
| 17:31 | `nativa` | **`no` / `fonte_nativa`** · `attendere: false` | ✅ la cura |
| 17:33 | `import_matchpoint` | **`non_ancora` / `copia_ferma`** · `attendere: true` | 🔴 **il difetto**, rimesso apposta |
| 17:35 | `nativa` (rimessa) | **`no` / `fonte_nativa`** · `attendere: false` | ✅ tornata |

⇒ La riga di mezzo è la prova che vale: **il difetto è stato fatto succedere di nuovo** e si è visto
che era lui. Senza quella, le altre due direbbero solo che oggi funziona.
🔨 **L'attrezzo**: `sonda-ponte-soci.yml` — sola lettura, cablata su `cudi` e sulla sola azione
`verifica`, che non scrive niente e non chiama il worker.
🔑 **E la chiave del ponte non stava dove tutti credevano**: 📏 non sulla VM (pm2 dà **72 chiavi e
nessuna di segreto**, `/proc/<pid>/environ` leggibile e senza, in cartella solo `.env.example`), ma
nel `.env.test-passo1b` sul **Mac** del committente. Adesso vive nel secret di repo
`CONSUMER_BRIDGE_SECRET_TEST` — mai passata dalla chat.
🩹 **E il primo passaggio è stato sbagliato in un modo che si è capito da solo**: nella casella era
finito il `PMO_FUNCTIONS_URL` invece del segreto. Lo ha detto il log **senza mostrare niente** —
GitHub ha oscurato l'indirizzo (`URL_NUOVO: ***/…`), e censura solo il valore del segreto ⇒ il
segreto **era** quell'indirizzo. 📌 *Un mascheramento fuori posto è una misura: dice cosa c'è dentro
la cassaforte senza aprirla.*

⚠️ **Cosa NON è stato provato, e va detto**: la strada `import_matchpoint` su **PROD** non è stata
esercitata dal vivo — là non si tocca. Regge sul fatto che quel ramo è **identico a prima** e sui
casi del banco.
🩹 E un dettaglio da sapere leggendo i log: la risposta riporta `copia_fresca_al` col **timbro
vecchio** anche quando il verdetto è `no` da fonte nativa. Non è un errore — è il dato grezzo, e il
`motivo` spiega perché non conta — ma a colpo d'occhio sembra una contraddizione.

## 🔓 VOCE 142 — 🪟 LA SCHEDA COMPLETA AL CLICK — ✅ **CHIUSA il 07/09/2026 pomeriggio**

*(La scheda resta per intero perché il ragionamento serve: è la forma che ogni «rispondi subito»
deve avere. La riga della voce sta fra le chiuse.)*
...
✅⭐⭐ **E I SOLDI CI SONO, dal 07/09 pomeriggio — PROD 6.395.** 🔄 Qui c'era scritto *«cosa manca
   ancora, ed è perché la voce NON si chiude: i soldi»*: riga **corretta, non affiancata**.
   🔨 **Come**: all'apertura, per ogni giocatore si guarda l'**archivio dei pagamenti** (record
   `payment`, sync ogni 5′) e lo si mostra subito; la rilettura dal worker arriva dopo e
   sovrascrive. È la stessa forma del punto ④ — *il gestionale risponde subito, il circolo conferma
   dopo* — applicata ai soldi.
   🩹 **Il dato era già lì, e veniva usato per la cosa sbagliata**: `_staffCalPaidInfo` esisteva da
   prima, ma la scheda la consultava **solo se il worker aveva già detto «riscosso»**, cioè solo per
   scrivere l'etichetta del metodo. ⇒ Non mancava una fonte: mancava il permesso di rispondere.
   📌 *Un dato consultato solo per decorare una risposta che qualcun altro ha già dato non è una
   fonte: è una didascalia.*
   ⛔ **E SOLO IN UN VERSO, che è la metà che conta**: l'**assenza** dall'archivio non diventa mai
   la ✗ rossa «da incassare» (un pagamento di due minuti fa non è ancora nella copia, e dire «deve
   pagare» a chi ha pagato manda a chiedere soldi due volte); il worker che dice «in sospeso» **non**
   viene ribaltato; lo **storno** resta offerto **solo** su uno stato confermato dal circolo.
   📌 *Un dato basta per INFORMARE molto prima di bastare per AGIRE, e confondere le due soglie è il
   modo tipico in cui una comodità diventa un danno.*
...
✅ **LA VOCE SI CHIUDE, e questa riga era rimasta indietro di due giorni.** 🔄 Diceva *«è metà: id
interno e Osservazioni dentro il gestionale al primo incontro del sync non ci sono ancora ⇒ i soldi
arrivano ancora dal worker»* — **corretta, non affiancata**: gli id e le Osservazioni sono in
servizio dal 06/09 (punto ④, provato su PROD 6.384) e i soldi dal 07/09 (PROD 6.395).
⚖️ Sopravviveva **dentro la stessa scheda** che due paragrafi sopra la smentiva. È la forma già
scritta in `CLAUDE.md` — *quando una scheda nuova smentisce una riga vecchia, la riga vecchia si
corregge, non si affianca* — e qui le due stavano perfino nello stesso documento.

⏳ **COSA RESTA, dichiarato invece di essere arrotondato** — nessuna delle tre è ciò che la voce
chiedeva, e per questo non la tengono aperta:
· **che il worker, quando risponde, SOVRASCRIVA il segno dell'archivio, non è stato visto dal vivo**:
  la console blocca `/functions/v1/` di proposito, quindi in tutte e tre le prove la rilettura non è
  mai partita. Lo dice il banco (il caso «il worker dice in sospeso → ✗»), non un occhio;
· **l'arricchimento su una giornata intera** non è misurato, e cosa succede quando l'arretrato
...
🩹⭐⭐ **05/09 sera: la coda era 19 e ne dichiarava 17 — e le due mancanti erano SCHEDE SENZA
RIGA.** La **142** e la **143** sono entrate il 04/09 con la loro scheda per intero in cima a questa
sezione, e non hanno mai avuto una riga in questa tabella. ⇒ `guard-docs-truth` restava **verde**:
sa contare **le righe**, e una voce senza riga per lei non esiste.
⚖️ È la forma del difetto che quella guardia si porta scritto addosso — *una guardia che passa su
una sezione vuota non ha ancora dimostrato di saperla contare* — spostata di un passo: qui non
contava una sezione vuota, contava una **lista incompleta** senza poterlo sapere. E il conto non
tornava dal **04/09**, cioè per un giorno e mezzo, dentro un file che di mestiere fa il conto.
🔨 **Curata la classe, non l'istanza**: le due righe adesso ci sono, **e** la guardia ha un
controllo nuovo — ogni scheda `### N —` dentro «IN CODA» deve avere la sua riga in C o in D.
Una scheda scritta e non censita esce **rossa**, invece di sparire dal conto.
📌 *Un elenco che si conta da solo conta ciò che sa vedere: una voce scritta in un'altra forma non
è una voce in meno, è una voce invisibile.*

🆕 **08/09/2026, 100ª sessione: entrano QUATTRO voci, e la C torna da 0 a 4.** Sono i pezzi del
disegno *«il gestionale di TEST diventa il vero»* che **non si possono fare adesso** — o perché
dipendono da una voce urgente (la 181 dalla 180), o perché aspettano **una sua decisione** (la 183:
i prezzi non ci sono ancora), o perché vanno fatte **al momento giusto** e non prima (la 182, la 184).
📌 *Stanno in coda perché hanno un ordine, non perché sono meno importanti: la 184 è la più
pericolosa di tutte.*
...
| **186** | 💬 **I PREZZI DELLE PARTITE, VISIBILI AI GIOCATORI DAL BOT** — 🗣️ sua richiesta, 08/09/2026 notte: *«un aggiornamento che dobbiamo fare al chatbot è di far vedere i prezzi delle partite ai giocatori»*. ⭐ **Metà è già fatta, e sta dalla parte giusta**: dall'08/09 `availability_day` manda al bot `prezzo_cents` accanto a ogni slot (voce 185), quindi il bot **riceve** il prezzo — non lo calcola, che sarebbe la strada sbagliata (*il gestionale SA, il bot DICE*). ⏳ **Cosa manca**: il bot deve **mostrarlo**, ed è nel repo `assistente-padel-agent` — più la decisione su **dove** dirlo (nell'elenco degli orari? alla conferma? tutte e due?). 🚨 E `prezzo_cents: null` vuol dire **«non ancora deciso»**: chi lo mostra deve tacere il prezzo, non scrivere «0,00 €», che vorrebbe dire gratis. |
...
⇒ **I bloccanti sono DUE e vanno tolti TUTTI E DUE: togliendone uno solo il guadagno è ZERO.** E il secondo non era nemmeno sospettato: **un indice sull'ESPRESSIONE del payload rende l'intera colonna `payload` un ostacolo all'HOT anche quando il suo filtro non riguarda quelle righe** — il banco G ha righe `booking` e l'indice è `where record_type='member'`, e l'HOT resta 0. Postgres decide l'HOT sulle **colonne toccate dagli indici**, non sul predicato. 🩹 **E c'era un difetto nel mio stesso esperimento, trovato e corretto prima di concludere**: nei primi banchi insert e update giravano nella **stessa transazione**, dove `now()` è costante ⇒ il trigger scriveva in `updated_at` **lo stesso valore**, quindi quella colonna non «cambiava» e l'indice non bloccava niente. Rifatto in transazioni separate (la condizione vera di PROD), e solo allora F è sceso a 0. 📌 *Un banco che non riproduce la condizione vera dà una risposta vera a un'altra domanda.* 💰 **COSA COSTEREBBE SU PROD, e perché il consiglio è NON FARLO.** 📏 **Il RITMO d'uso, misurato su una finestra di 50 minuti** (11:51:48 → 12:42:16 UTC), che è la cosa che mancava per decidere: `idx_..._updated_at` **+136 letture** ⇒ **~3.900 al giorno, una ogni 22 secondi**; `idx_..._member_id` **+66** ⇒ ~1.900 al giorno; `idx_..._group_date` **+0**; contro **1.074 scritture** nella stessa finestra (~30.600 al giorno). ⇒ I primi due **non sono peso morto**, e non somigliano affatto al GIN, letto **una volta in 21 ore**. Servirebbe togliere `idx_pmo_cloud_records_updated_at`, `idx_pmo_cloud_records_member_id` e `idx_pmo_cloud_records_group_date`. Le prime due si usano **davvero** — non è il caso del GIN, che ne aveva **1**. ⇒ Si scambierebbero due indici vivi per il 63% di HOT su una tabella che oggi scrive **266 MB al giorno** e non dà problemi. **Non conviene**, e la scheda lo dice invece di lasciare la domanda aperta. ✅ **Quello che invece si può fare a costo zero**, quando si vuole: `idx_pmo_cloud_records_group_date` è usato **0 volte** e pesa 16 kB — si toglie senza scambiare niente, ma **non riapre l'HOT da solo** (lo dice il banco G). ⛔ **Nessun indice toccato oltre al GIN di stamattina.** 🧹 Le sette tabelle del banco sono state **cancellate** da `cudi…` a misura finita (`zz_%` = 0). ✅⭐⭐ **07/09/2026 — CURATO `last_seen_at`: la guardia dei permessi non scrive più a ogni lettura.** Era il pezzo che questa scheda aveva **trovato ma non fatto** (*«ogni lettura dello staff è anche una scrittura»*), lasciato lì come «non urgente» perché quegli update sono HOT al 95%. 📏 **Ma il costo vero non erano i byte di WAL: era che il carico CRESCE PROPORZIONALMENTE ALL'USO**, cioè aumenta proprio quando il gestionale è sotto sforzo — la stessa forma della voce 162, e la condizione in cui è nata l'avaria della 160. 🔨 **La cura**: `pmo_current_staff_profile()` scrive `last_seen_at` **solo se è più vecchio di 5 minuti**; altrimenti legge e basta. ⚖️ Il pezzo che la rende sicura è che **il ramo di lettura usa lo STESSO IDENTICO predicato dell'update che sostituisce** ⇒ saltare la scrittura non può restituire una riga diversa da quella che si sarebbe scritta; la rete di sicurezza preesistente (per email O per uid) non è stata toccata. `last_seen_at` è mostrato in **un solo posto** (colonna «ultimo accesso» in amministrazione, `index.html:31367`): cinque minuti di granularità lì non li nota nessuno. 📏 **LA MISURA CHE CONTA, presa sui log e non dedotta**: nella finestra 12:49:32→12:55:34, **310 chiamate RPC dello staff** avevano prodotto **281 scritture** ⇒ **0,91 scritture per chiamata**, cioè *ogni lettura era una scrittura*, esattamente come la scheda affermava. Dopo la cura: **6 chiamate → 1 scrittura**, e quell'una solo perché il campo era vecchio di più di 5 minuti. ✅ **Provata in TUTTI E DUE I VERSI, prima su TEST poi su PROD**: su `cudi…` due giri di console interi (login + decine di RPC + 6 chiamate esplicite) ⇒ **UN SOLO** aggiornamento, ruolo e **16 permessi** intatti; e riportando il campo indietro di 30 minuti il ramo «vecchio» **scrive** (12:24:42 → 12:55:00). Su **PROD**: 6 chiamate, tutte `http 200`, ruolo `staff`, **15 permessi**, `last_seen_at` identico in tutte e sei. 🚨⭐⭐ **E LA TRAPPOLA CHE HA QUASI CHIUSO LA VERIFICA TROPPO PRESTO, che vale più della cura**: subito dopo il deploy gli aggiornamenti erano **ZERO**, e quello zero sembrava la prova. **Non lo era**: una funzione che va in eccezione produce lo stesso identico zero. 📏 E infatti i log dicevano che in quella finestra le chiamate erano **6 — le mie** — cioè non stava usando l'app nessuno. ⇒ *Uno zero di scritture non distingue «curata» da «rotta», né da «nessuno la sta chiamando»*: si verifica che la guardia **RISPONDA** (ruolo + permessi), non solo che non scriva. È la stessa forma dello *zero letto troppo presto* del 23/08, qui nel verso più pericoloso — perché lo zero che si spera di vedere e lo zero del guasto **sono lo stesso numero**. ✅⭐⭐ **E LA PROVA CHE CHIUDE È ARRIVATA DIECI MINUTI DOPO, SOTTO CARICO VERO** — quella che alle 12:57 mancava: nei **9,7 minuti** successivi alla cura PROD ha servito **434 chiamate RPC dello staff**, con **0 in errore** e **1 sola scrittura** su `pmo_staff_profiles`. ⇒ Le tre cose che servivano stanno tutte insieme in questa riga: **l'app è in uso** (434, non il silenzio di prima), **la guardia risponde** (zero errori), **e non scrive più** (1). 📏 Da **0,91 scritture per chiamata** a **0,002**. 📄 SQL e istruzioni per tornare indietro in `supabase/manual-sql/supabase_pmo_current_staff_profile_voce_165.sql`. ⏳ **COSA RESTA, ed è una sola cosa e una DECISIONE SUA**: `idx_pmo_cloud_records_group_date` è a **0 letture in 48,7 ore** (rimisurato il 07/09) e pesa 16 kB — si toglie **senza scambiare niente**, ma è pur sempre un indice su PROD, e quelli si dicono prima (il GIN fu tolto con la sua parola). ⚖️ **Il resto della voce è chiuso**: l'allarme «11 GB» era falso (LSN, non WAL), il WAL vero **rimisurato il 07/09 è 522 MB in 48,68 h ⇒ ~257 MB/giorno su 646 MB di database, 0,4 a 1** — il database **non è sotto sforzo**, e il MICRO regge. |
...
| **60** Campi liberi nei circoli vicini | ⛔ **ANNULLATA** il 05/09/2026 — *«la 60 non va fatta perché il progetto è annullato»* | annullata, non chiusa: il disegno (`docs/circoli-esterni-disegno.md`) e i due passi vivi su TEST restano, ma **il progetto non c'è più**. Il codice acceso su TEST (tabella, RPC, sezione «Circoli», `circoli-scan`) si spiega da questa riga e si toglie solo se qualcuno lo chiede. |
...
### D — Corpose: solo se si vogliono ATTIVARE — 0
...
🚫 **05/09/2026 sera: anche la 60 è ANNULLATA, su sua parola** — *«la 60 non va fatta perché il progetto è
annullato»*. ⇒ **La D è vuota.** 🔄 Qui c'era scritto *«la 60 RESTA, e la distinzione l'ha fatta lui»*, con le
ragioni per cui restava (due passi su quattro vivi su TEST, e un suo passo in sospeso con Wansport): era vero
il 19/08, e la riga si **corregge**, non si affianca. ⚠️ **Il codice acceso su TEST resta dov'è** — la tabella,
la RPC, la sezione «Circoli», `circoli-scan`, provati sui circoli veri il 18/08 — e la riga nella tabella delle
voci uscite (sotto, accanto alla 52 e alla 54) è la voce che lo spiega, così non diventa un mistero. Toglierlo
è un lavoro che nessuno ha chiesto: si fa quando lo dice lui, o quando quel codice intralcia qualcosa.


| # | cosa |
|---|---|
| — | *(vuota dal 05/09/2026: la 60 è annullata, vedi la tabella delle voci uscite qui sopra)* |
...
📏 **Misurato guardando la finestra della voce 92 dentro l'avaria della 160.** In `promemoria.ts` il giro
che ritira i fatti del circolo è `setInterval(giroC, PERIODO_CIRCOLO_MS)` (20 s) **senza** una guardia che
salti il tick se il giro precedente è ancora in volo. Con un gestionale sano non si vede: un giro dura
~350 ms. Il 05/09 fra le 08:53 e le 10:08 locali `consumer-staff-events` rispondeva a **150 s** (504 del
cancello) o a **~74 s** (500 sull'anagrafica) ⇒ fino a **otto giri in volo insieme**, ognuno che legge la
stessa coda al passo 1, per un'ora e un quarto: **109** giri falliti, letti nei log della piattaforma.
⚖️ **Due effetti, e sono i due che il progetto tratta come i più seri**: ① è **la finestra della 92** — due
giri sulla stessa coda — aperta non ai riavvii ma **ogni volta che il gestionale rallenta**, cioè proprio
quando la serratura del passo 5 serve; ② è **carico che cresce quando il sistema è in ginocchio**, la stessa
forma della voce **162** (`svcPollQueueStatus`, 4 s a passo fisso) misurata lì la stessa mattina.
🔨 La cura avrebbe la stessa forma della 162: il tick successivo parte **dopo** la risposta del
precedente, e il passo si allunga quando le risposte rallentano. ⛔ Nata come misura e **non** come voce — la delega copre l'ordine, non l'esistenza — è diventata la
**164** quando lui l'ha detto, mezz'ora dopo.
📌 *Un polling a passo fisso è un moltiplicatore del guasto*, e il bot ne ha uno accanto a quello dell'app.

### 💶 I TRE OMAGGI DEL CLOUD SONO TUTTI E TRE ORFANI, e gli Incassi li contano — misurato il 31/08

📏 **Misurato, non dedotto**, chiudendo la voce 109: i record `payment` con `source: 'pmo_gift'` su PROD sono
**tre** — 29/08 (31/08 13:00 C4), 30/08 (07/09 14:00 C1) e 31/08 (31/08 09:30 C1) — e **le tre partite sono
tutte annullate**. L'ultima l'ha disdetta il committente due ore dopo l'omaggio, e il motivo è quello che rende
la cosa strutturale: *«ho cancellato la partita perché non sono venuti»*.

🔎 **Non è un guasto, è una protezione che non ha un contrappeso.** Il sync dei pagamenti **protegge apposta** le
righe `paygift|…` dallo storno (`.like('local_key', 'pay|%')` nella scansione delle lapidi), e la ragione scritta
lì è giusta: quelle righe non vengono dal report, quindi «assente dal report» non vuol dire «stornata» — senza
quel filtro morirebbero al primo giro. ⇒ Ma niente le chiude nemmeno quando la **partita** sparisce, e restano
`status: paid` per sempre.

⚖️ **Cosa costa davvero, detto per quello che è**: gli importi sono **0 €**, quindi i totali degli Incassi non si
sbagliano di un centesimo. A sbagliare è il **conteggio degli omaggi** (`d.omaggi += 1` in `index.html`), che
mostra alla segreteria delle quote offerte per partite che non si sono giocate.

🚨 **E il caso non è raro: è quello TIPICO.** Una quota va a zero proprio quando i giocatori non si presentano,
cioè poco prima che la partita venga cancellata. ⇒ *La condizione che produce un omaggio è imparentata con quella
che cancella la partita*, e trattarla come un caso limite sarebbe leggere male i tre casi su tre che ci sono.

⛔ **Nessuna cura proposta, e non è una voce**: la scelta — se un omaggio su una partita annullata vada chiuso, o
tenuto perché registra un gesto della segreteria che è comunque avvenuto — **è sua**. Sta qui perché il fatto è
misurato, non perché ci sia qualcosa da fare.


### 🚨 Un cambio di livello A MANO è INVISIBILE alla guardia che dovrebbe proteggerlo — misurato il 28/08 notte

🔨🚨⭐⭐ **CURATO IL 29/08 SU `test-preview` (v6.260) — e il BIVIO che teneva ferma la cura NON
ESISTE.** Qui sotto era scritto: *«il livello lo scrive anche l'import da Matchpoint, e marcare la
data a ogni scrittura bloccherebbe ogni scheda per sempre ⇒ è un bivio di disegno, non una riga»*.
📏 **Misurato invece che ricordato, e è falso**: l'import **non scrive mai** il livello di un socio
già presente — `applyMatchpointMembersToLocal` fa `level: existing.level || member.level || 3`
(`index.html`), e l'edge `matchpoint-clients-sync` fa `level: existing.level || imported.level ||
0.5` alle righe 409 e 506, col commento *«Livello: curato nell'app, mai sovrascritto da
Matchpoint»*. Non scrivendo, non marcherebbe niente.
📌 *Un bivio di disegno dichiarato ma mai verificato costa più di un difetto: ferma la cura senza
esistere.* È la **26ª** applicata a un ostacolo invece che a un limite.

📏 **L'ampiezza vera, misurata su PROD il 29/08** — e i numeri del passaggio erano altri:
· `lastLevelUpdateAt` ce l'hanno **20 soci su 2817** (0,7%), ed è esattamente l'insieme di chi è
  passato dall'autovalutazione ⇒ per **2797** soci `Math.max(…)` vale **0** e il cancello della data
  **non scatta mai**;
· schede in attesa **47**, con socio vivo **42**, che **passano** il cancello della data **19**, e di
  quelle **14** hanno il socio toccato **dopo** la scheda (`updatedAt`; ⚠️ sovrastima dichiarata: si
  muove per qualunque campo, non solo il livello).

🚨⭐⭐ **E LO ZERO CHE RASSICURA, guardato una volta di più** — delle 14, quante alzerebbero davvero
il livello? **Zero**: 1 ha già quel livello e **13 lo abbasserebbero**, e *il livello non scende mai
da solo* (regola sua del 27/08) le ferma.
⚖️ ⇒ **Oggi la cecità non fa danno per una ragione che non è la sua.** Il cancello della data esiste
per fermare *una scheda vecchia che scavalca un aggiornamento più recente*; a fermarle è un'altra
regola. Il giorno in cui una scheda in attesa **alzerebbe** il livello di un socio che la segreteria
ha appena abbassato a mano, in mezzo non c'è più niente.
📌 *Una protezione che regge grazie a un'altra non è una protezione: è una coincidenza che tiene.*

⚙️ **La cura, in UN posto solo** (`pmoMarcaLivelloCambiato`), chiamata dalle **quattro** mani che
scrivono il livello di un socio esistente: la scheda socio in Anagrafica, la stessa scheda aperta
dal pannello del calendario, le modifiche via assistente, e l'import livelli da Excel. Lo strumento
di prova gated `PMO_IS_TEST_ENV` **azzera** la data invece di marcarla, o bloccherebbe proprio la
scheda che esiste per far ripassare.
⭐ **Si marca SOLO SE IL LIVELLO CAMBIA DAVVERO**, ed è la riga che tiene onesta la cura: salvare la
scheda per correggere un telefono non deve spegnere le prove in attesa di quel socio. Senza quella
riga la cura sarebbe **un guasto nuovo** col nome di una protezione.
⚖️ **E l'import da Excel marca di proposito**, non per distrazione: tocca **solo** chi sta a 0,5
(`isLevelZeroPointFive`), cioè chi un livello non ce l'ha, ed è una decisione della segreteria come
le altre.
🧪 **Banco `test/la-mano-sul-livello-lascia-la-data.test.mjs`, 11 verdi**, e dentro c'è la prova che
conta: la **regola dell'edge riprodotta identica**, con la stessa scheda di aprile che **passa**
senza la marca e **viene fermata** con la marca — più il controllo che una prova *più recente* della
mano continua a passare, o si sarebbe rotta la cosa giusta.

⏳ **NON È FINITO, e questa riga è stata CORRETTA due volte nello stesso giorno.** Diceva prima
*«la cura è su `test-preview` e non è in PROD»*: ① la **promozione per righe** a `main` è stata
fatta il **29/08 pomeriggio** (v6.256, verificata sull'app viva). Resta ② la **prova fisica**: la
segreteria cambia un livello a mano, e una scheda più vecchia in attesa **non** lo scavalca al
giro del cron.
🚨⭐⭐ **E la sera del 29/08 si è scoperto che in PROD questa cura era INERTE**, per una ragione che
non era sua: marca `lastLevelUpdateAt` **in locale**, e il salvataggio della scheda socio **non
arrivava al cloud** — era la **voce 108**, misurata quella sera.
🔓 **CORRETTA il 30/08 sera, e la riga vecchia si corregge invece di affiancarla**: qui c'era scritto
*«finché la 108 non è curata e in servizio, la prova fisica del punto D non si può fare»*. **La 108 è
curata, in servizio su PROD dalla v6.257 e CHIUSA il 30/08 a prova fisica** ⇒ **quel blocco non c'è
più**, e il punto D ha già avuto il suo primo giro vero su TEST (`lastLevelUpdateAt` passato dal **2
maggio** al **29/08 19:01:17,511Z** su un salvataggio della segreteria).
⏳ **Cosa resta davvero da provare, ed è meno di prima**: che su **PROD** una scheda in attesa più
vecchia **non** scavalchi un livello cambiato a mano al giro del cron. ⚠️ Su TEST quel caso c'è ma
**non si conta**, perché a fermarlo basterebbe comunque *il livello non scende mai da solo* — è di
nuovo *una protezione che regge grazie a un'altra*.
...
## 📦 CHIUSE — dal 13/08 al 08/09/2026 — 171 voci
...
| **176** | 🗓️ **LE FASCE PRENOTABILI LE DEFINISCE LUI — e non arrivano più da Matchpoint** — ✅ *(08/09/2026, 100ª sessione — **provata sulla pagina viva di TEST 6.401**)* 🗣️ Sua: *«devi darmi la possibilità di definire io come voglio gli slot prenotabili»*. 🔨 **La cura**: `pmo_fasce_prenotabili` — una tabella nostra — sostituisce il blocco jsonb `app_setting/potentialSlotSchedule`, che veniva da Matchpoint e **muore col distacco**. In Amministrazione lo step 6 non è più «Slot potenziali Matchpoint» ma **«Fasce prenotabili»**: via la casella di testo e via il bottone «Sincronizza da Matchpoint», dentro una tabella per giorno dove si aggiunge, si spegne, si toglie una fascia e si scrive il prezzo — con il controllo delle **sovrapposizioni** prima di salvare, perché il vincolo del database guarda solo l'ora d'inizio e due fasce accavallate proporrebbero al socio due volte lo stesso campo. `getDaySlots()` — il punto unico da cui passano Dashboard, Apri Partite e la capacità — legge la tabella, col blocco vecchio come **ripiego** finché la risposta non è arrivata (un calendario vuoto si legge «il circolo è chiuso», che è una bugia e non un'attesa). 📏 **41 fasce, zero differenze** col blocco che sostituisce. ✅ **LA PROVA, e sta su TEST perché è lì che vive il sistema nuovo** (⇒ *«il gestionale di TEST diventa il vero»*): pagina viva 6.401, 41 fasce caricate e il **lunedì torna ad avere la fascia 16:30-18:00** che il circolo ha davvero dal 27/08. 🥇⭐⭐ **E LE DUE LEZIONI, che valgono più della voce**: ① **il banco verde non vede quello che la pagina disegna** — 124 prove verdi e un pannello dall'aria giusta, e sulla pagina viva il lunedì aveva **cinque fasce invece di sei**; la causa era il permesso `cloud_sync` messo sulla **lettura**, più stretto della guardia del database. 📌 *Un permesso più stretto della guardia che dovrebbe rispecchiare non protegge niente: fa mentire il calendario, e in silenzio.* ② **lo stesso difetto aveva DUE cause e la prima cura non bastava** — tolto il permesso le fasce ancora non si caricavano, perché il boot parte **prima** che la sessione esista: servono **tre** agganci (avvio, login, apertura del pannello), e li ha trovati il riprovare sulla pagina, non il ragionarci sopra. ⛔ **IL RESIDUO NON SPARISCE COL TITOLO**: i due lettori del bot leggono ancora il blocco vecchio ⇒ è la voce **177**, aperta nello stesso commit. 📌 *Una voce che si chiude portandosi via del lavoro non curato non è chiusa: è persa.* |
| **111** | ✅ *(07/09/2026 notte, 99ª sessione — **chiusa da LUI**: «Chiudiamo centoundici, centododici, sessantotto e centosessantaquattro», dopo il suo «CORRETTO procedi» sulla regola e dopo che la misura ha corretto il bersaglio)* ⚖️ **Si chiude come DECISIONE, non come cura**, ed è la stessa forma della 84 → 124: la regola c'è (*«se sono minori devono giocare con almeno un genitore»* ⇒ il bot non è il canale di un under 14), il **filtro no**. 🔨 ⇒ Il residuo **non sparisce col titolo**: è la voce **175**, aperta nello stesso commit. 📌 *Una voce che si chiude portandosi via del lavoro non curato non è chiusa: è persa.* — 🔞 **IL CONSENSO DI UN MINORENNE — e la porta è aperta da aprile, non da aprire** — 🗣️ **voce SUA del 30/08**: *«va inserita nel test di livello come domanda iniziale che lo puoi fare se sei maggiorenne»*, e poi, alla misura, *«quello da cui ci dobbiamo proteggere è il consenso, non le partite»*. ⛔ **La domanda iniziale è stata SCARTATA, e non perché è inefficace: perché chiede la soglia sbagliata.** In Italia il consenso digitale si dà a **14 anni** (art. 2-quinquies del Codice Privacy: il GDPR fissa 16 e lascia scendere fino a 13, l'Italia ha scelto 14), non a 18 ⇒ un bottone «sono maggiorenne» chiederebbe una cosa che non è la condizione. E sarebbe comunque un cancello che non sbarra: la risposta la dà proprio chi ha l'interesse a darla sbagliata, e ce n'è **una sola** che permette di andare avanti — la stessa forma della scorciatoia tolta dal quiz la mattina stessa (voce 110). 📏 **LA MISURA CHE HA RIBALTATO LA DOMANDA, ed è il motivo per cui questa voce esiste**: il cancello non serve *prima di aprire*, perché è già aperto — ma **molto meno spalancato di come questa riga diceva prima**. 🩹 **Correzione del 30/08, misurando meglio: un GETTONE creato non è un'EMAIL ricevuta.** Qui c'era scritto *«il link del test è uscito verso 1339 soci»*: i **gettoni** sono 1339, ma le email **effettivamente partite** sono **542, a 129 persone distinte**, fra il 22/05 e il 23/06, e **tutte a clienti Matchpoint**. Agli altri il gettone è stato generato e non è mai stato mandato niente — infatti di loro **nessuno** ha consegnato una scheda. 📌 *Contare i gettoni per contare i contattati è la 24ª: la sonda giusta puntata sul soggetto sbagliato — e sbaglia sempre per eccesso, cioè nel verso che fa più paura.* ⇒ **La superficie vera, delle 129 persone contattate**: **120 maggiorenni**, **3 fra 14 e 17** (che consentono da soli), **2 sotto i 14**, **4 a età 0** che è dato sporco. ⇒ I casi reali sono **due bambini** che hanno ricevuto un'email, e **nessuno dei due ha consegnato una scheda**. 🚨 **E il dato su cui poggerebbe qualunque regola non c'è**: l'anagrafica ha `age` — un **numero fotografato all'import**, non una data — su **1101 soci su 2817**, e `birthDate` **vuoto su tutti e 2817**. Una regola sull'età costruita su `age` invecchia da sé e sbaglia proprio nell'anno che conta, il passaggio 17→18. ⇒ **Il primo lavoro non è un cancello: è portarsi la data di nascita da Matchpoint.** ⚖️ **E la base giuridica va guardata prima di costruire**: il socio è tesserato, e per un minore quell'iscrizione l'ha firmata un genitore ⇒ organizzare le partite sta plausibilmente nell'esecuzione di quel contratto, non in un consenso a parte. Il consenso semmai riguarda il **canale** — mandare messaggi su Telegram — e Telegram ha una sua soglia d'età nei termini d'uso, che è un vincolo loro ma diventa nostro perché il canale è il loro. ⛔ **QUESTA PARTE NON LA DECIDE UNA SESSIONE**: se e in che forma il circolo debba raccogliere un consenso genitoriale è una domanda per chi tiene la privacy del circolo, non per chi scrive il codice. Qui restano i **fatti misurati** e il meccanismo, che si costruisce quando la regola è decisa. 🔄 **E LA SOGLIA DEI 14 ANNI RESTRINGE IL PROBLEMA, misurato dopo**: dei **948** invitati di cui conosciamo l'età, **894 sono maggiorenni**, **13 hanno fra 14 e 17 anni** — cioè possono consentire **da soli** — e i casi che contano davvero sono **21 bambini sotto i 14**, più **20 record a età 0** che sono dato sporco e fanno sembrare minorenne chi magari non lo è. ⇒ Il problema passa da «54 minorenni» a **«21 sotto i 14»**, che è un numero affrontabile. ⭐ **E nessuno di quei 21 ha mai consegnato una scheda**: l'unico minorenne che ha davvero usato il test è **Marco, 16 anni** — il collaudatore di queste settimane, sopra la soglia dei 14. Il secondo caso (età 0) è un **artefatto**, non un minorenne accertato. ⇒ Non c'è nessun incidente da riparare: c'è una regola da decidere prima che il bot si apra ai soci. 🩹 **E il lavoro che sembrava ovvio — «portiamo la data di nascita da Matchpoint» — è stato FERMATO misurando**, prima di scriverlo: ① `birthDate` non è **mai** stata riempita, 0 righe su 5760, nemmeno fra le cancellate ⇒ la lista clienti da cui importiamo **non ha quella colonna** (ha «Età», che infatti arriva); ② e l'anagrafica di Matchpoint ce l'abbiamo per **1102 soci su 2817** — gli altri **1715** non passano da quella lista, e di loro **uno solo** ha l'età. ⇒ Anche prendendo la data resteremmo a coprire il **39%** dei soci, mentre la domanda del consenso li riguarda tutti. 📌 *Il prerequisito di un prerequisito: prima di prendere un campo si guarda se la fonte ce l'ha, e quante persone quella fonte copre.* 🔎⭐⭐ **E LA DOMANDA «PERCHÉ L'ANAGRAFICA COPRE 1102 SOCI SU 2817» HA RISPOSTA, misurata il 30/08 su sua parola: NON è un import monco — sono DUE POPOLAZIONI nella stessa tabella.** **1102** sono clienti veri di Matchpoint (età su 1100 di loro, livello su 529); **1708** sono contatti presi dalla **rubrica Google** (`importedFrom: rubrica-google`): hanno telefono ed email — tutti e 1708 — e **zero livelli, zero età** (uno solo ce l'ha). Più 7 creati a mano. ⇒ **Per quei 1708 non esiste nessuna fonte che ci dia l'età**, e non è un lavoro di import: non sono clienti del gestionale sportivo, sono contatti di una rubrica. Se un domani uno di loro diventa socio passerà da Matchpoint, e allora i suoi dati arriveranno da soli. 🚨 **E apre una domanda più grande di quella da cui questa voce nasce**: quei 1708 stanno in una tabella che si chiama `member`, l'app li tratta come soci e a loro si generano gettoni. **Devono starci?** È una domanda sua, e ha lo stesso risvolto di consenso — una rubrica personale importata dentro il gestionale di un circolo. Non è stata aperta come voce: la apre lui se la vuole. ⇒ **Sta in coda e non fra le urgenti**, dichiarato: il prossimo passo non è codice, è una sua decisione. E i due casi già in archivio sono da guardare in segreteria, non da curare con una riga. 🗣️⭐⭐ **SUA RISPOSTA DEL 07/09 SERA, ed è una REGOLA DEL CIRCOLO**: *«se sono minori devono giocare con almeno un genitore in campo o fuori dal campo per tutta la durata della partita»*. ⇒ È una decisione vera e va scritta. ⚖️ **Ma risponde a una domanda DIVERSA da quella che teneva aperta la voce**, e le due non si sostituiscono: la sua regola governa **chi sta al campo mentre si gioca**; la voce chiedeva se e come il circolo raccolga il **consenso** per parlare a un minore su **Telegram**. Un genitore a bordo campo non è un consenso al canale. 📌 *Una risposta chiara a una domanda vicina non è la risposta alla domanda: e siccome è chiara, è facile scambiarla per tale.* ⭐ **Però la sua regola una conseguenza tecnica ce l'ha, ed è pulita**: se un under 14 non può stare in campo senza un genitore, allora **il bot non è il suo canale** — l'interlocutore del circolo per quella partita è il genitore, che è presente per obbligo. ⇒ La strada che propongo, e che aspetta un suo sì: **gli under 14 non ricevono messaggi dal bot**, e il gettone del test di livello non si genera per loro. Non serve la data di nascita per tutti (che non abbiamo, misurato: `birthDate` vuoto su 2817): basta applicarla ai **21 sotto i 14 conosciuti**, che è il bersaglio reale. 🗣️⭐ **SUO SÌ, 07/09/2026 NOTTE**: *«CORRETTO procedi»*. 🚨⭐⭐ **MA IL NUMERO SU CUI QUESTA VOCE POGGIA È FALSO — misurato subito dopo quel sì e PRIMA di scrivere una riga di cura.** 📏 La distribuzione delle età dei soci vivi: **0 → 22 · 1 → 22 · 2-11 → ZERO · 12 → 1 · 13 → 1 · 14 → 0 · 15 → 4 · 16 → 7 · 17 → 4 · 18 → 11**. ⇒ Ventidue soci a «un anno» e **nessuno fra 2 e 11**: una popolazione vera che ha bambini di 1 anno ne ha anche a 3, a 7, a 10. Quello zero dimostra che **`age = 1` non è un'età, è un valore di riempimento** — la stessa classe dello `0`, che questa scheda già riconosceva come dato sporco senza accorgersi di avere accanto un **secondo** sentinella. 🔎 **E lo confermano i nomi, guardati invece di fidarsi del campo**: fra i 22 «di un anno» ci sono `fadelli1981@`, `Davide97zanardo@`, `priscilla92loren@`, `Andrea Antoniazzi 71`, `simone.amministrazione@` e **Stefano Borsoi, che ha una partita prenotata il 14/09 alle 19:30** — soci adulti, non bambini. ⇒ **Gli under 14 identificabili sono DUE, non 21**: **Elio Nesi (12)** e **Christian Salerno (13)**, e **nessuno dei 24 ha mai avuto un gettone** (misurato su `assessment_tokens`: 0 righe). ⚖️ **Cosa costava eseguire alla lettera**: un cancello a due esiti avrebbe tolto dal canale del circolo **44 persone** (i 22 a `0` più i 22 a `1`) per proteggerne **2** — e il danno sarebbe stato **silenzioso**, perché un socio che smette di ricevere messaggi non protesta: non sa di doverli ricevere. 📌 *Una sonda puntata su un campo sporco conta il campo, non le persone — e sbaglia nel verso che sembra prudente.* 🔨 **⇒ LA CURA HA TRE ESITI, ed era già scritto in questa riga senza che se ne conoscesse il prezzo** (*«un cancello sull'età vuole tre esiti e non due»*): **`sotto i 14` = 2** (fuori dal canale, nessun gettone) · **`sopra i 14` = 971** · **`non lo so` = 1761**, che **resta dentro com'è oggi** e di cui i **44** sentinella vanno **segnalati alla segreteria da correggere, non silenziati**. ⏳ **NON ancora scritta**: la cura è decisa e misurata, il **codice no** — tocca due punti (la generazione dei gettoni e il pubblico di un invio) più il bot, ed è il prossimo lavoro. |
...
| **175** | ✅ *(07/09/2026 notte, 99ª sessione — **CHIUSA da LUI** insieme a tutte le altre: «chiudiamo tutti i task ancora aperti così poi passiamo nell'ultima fase del progetto». La coda va a **ZERO** per scelta, non perché il lavoro sia finito, e ogni scheda dice quale delle due cose è.)* 🚨⭐⭐ **E QUESTA È NATA STASERA E MUORE STASERA, non curata — la segnalo perché è l'unica delle sei che protegge delle PERSONE.** 🗣️ Erano due sue decisioni di poche ore prima: gli **under 14 fuori dal canale del bot** (*«se sono minori devono giocare con almeno un genitore»*) e i **1708 contatti della rubrica Google** marcati invece che cancellati. Il **filtro non è mai stato scritto**. ⇒ **Cosa resta vero, e va saputo prima di premere «invia» su qualunque cosa in futuro**: nella generazione dei **gettoni** e nel **pubblico di un invio** non c'è nessun cancello — **357** contatti della rubrica hanno già un gettone, e i **2** under 14 identificabili (Elio Nesi 12, Christian Salerno 13) non sono esclusi da niente. ⭐ **Il danno oggi è POTENZIALE e misurato tale**: verso quei due non è mai partito nulla (0 gettoni, 0 email, 0 notifiche, 0 schede) e verso i 1708 nessuna email — le 542 inviate sono andate **tutte** a clienti Matchpoint. ⇒ Non c'è niente da riparare **oggi**; c'è una protezione che **non esiste** il giorno in cui si farà un invio nuovo. ⚠️ **E non muore col distacco**: non c'entra niente con Matchpoint — vive nell'anagrafica del gestionale e ci resta. 📌 *Una voce chiusa senza cura non è un problema risolto: è un problema che nessuno sta più guardando, e questa riga esiste perché quel giorno qualcuno la ritrovi.* — 🚦 **CHI PUÒ RICEVERE QUALCOSA DAL CIRCOLO — il filtro che 111 e 112 hanno lasciato** — 🆕 *Entrata il 07/09/2026 notte, 99ª sessione, chiudendo la 111 e la 112 per sua decisione.* ⛔ **Non è una voce inventata**: è il residuo **non curato** di due voci chiuse, ed è la stessa forma della 84 → 124. Senza questa riga il filtro sparirebbe col titolo delle voci che lo chiedevano. 🗣️ **Due sue decisioni, un lavoro solo**: ① *«se sono minori devono giocare con almeno un genitore»* ⇒ **un under 14 non ha il bot come canale**; ② i **1708 contatti della rubrica Google** dentro `member` **si marcano, non si cancellano**. ⭐ **Sono lo stesso lavoro, e separati non si vedeva**: due **predicati** diversi applicati negli **stessi due punti** — ① dove si generano i **gettoni** del test di livello, ② dove si costruisce il **pubblico di un invio**. 📏 **I numeri, misurati il 07/09 notte e non ricordati**: contatti rubrica **1708** (marcatore `importedFrom: rubrica-google` già presente su tutti ⇒ **nessuna migrazione**), di cui **357** hanno già un gettone; under 14 **2** — Elio Nesi (12) e Christian Salerno (13) — con **0 gettoni, 0 email, 0 notifiche, 0 schede** fra tutti e due. 🚨⭐⭐ **IL CANCELLO HA TRE ESITI, E IL TERZO È QUELLO CHE PROTEGGE**: `sotto i 14` = **2** · `sopra i 14` = **971** · **`non lo so` = 1761**. ⛔ A due esiti avrebbe tolto dal canale **44 persone** (i **22** a `age = 0` più i **22** a `age = 1`) per proteggerne **2** — e fra quei 44 ci sono soci adulti dimostrabili (`fadelli1981@`, `Davide97zanardo@`, `Andrea Antoniazzi 71`, **Stefano Borsoi**, che gioca il 14/09 alle 19:30). 📏 La prova che `age = 1` è un **valore di riempimento** e non un'età: **zero** soci fra 2 e 11 anni, con 22 a esattamente 1. ⇒ `age ∈ {0,1}` vale **«non lo so»** e resta **dentro**; i 44 vanno **segnalati alla segreteria da correggere, non silenziati**. 📌 *Una sonda puntata su un campo sporco conta il campo, non le persone — e sbaglia nel verso che sembra prudente.* ⛔ **Si dice PRIMA di accenderlo**: tocca chi riceve messaggi dal circolo, cioè si vede da fuori. ⚖️ **Nessuna fretta e nessun danno in corso**: misurato che verso i due under 14 non è **mai** partito niente, e verso i 1708 nessuna email (le 542 inviate sono andate tutte a clienti Matchpoint). Il danno è **potenziale**, e questa voce esiste perché non resti aperto. |
| **121** | ✅ *(07/09/2026 notte, 99ª sessione — **CHIUSA da LUI** insieme a tutte le altre: «chiudiamo tutti i task ancora aperti così poi passiamo nell'ultima fase del progetto». La coda va a **ZERO** per scelta, non perché il lavoro sia finito, e ogni scheda dice quale delle due cose è.)* 🚨⭐⭐ **QUESTA SI CHIUDE NON CURATA, E SOPRAVVIVE AL DISTACCO — è la più pesante delle sei, e va detto.** 🗣️ Era una **regola sua** del 01/09: *«Quando togli un giocatore dal bot devi aspettare la conferma del gestionale che questo è avvenuto prima di mostrarlo sul bot»*. 📏 Misurato e mai corretto: in `consumer-booking-write` il ramo `remove` torna `removed: true` **appena Matchpoint ha risposto ok**, e l'allineamento della copia nel gestionale viene **dopo**, dichiaratamente *best effort*. ⇒ Se quella scrittura fallisce, **il socio legge «tolto» e il gestionale non lo sa**: è la voce **75** identica su un altro gesto. ⚖️ **Il distacco non la cura**: togliere Matchpoint dalla catena toglie un anello, ma il difetto è nell'**ordine** fra il rispondere e il registrare — cioè nella metà «stesso istante» dei tre passi, che resta identica dopo. ⛔ **La riga di difesa che c'è nel codice va tenuta**: *«dire "non l'ho tolto" a chi l'ha tolto lo manderebbe a rifarlo»* ⇒ la cura non è rovesciare il `true` in `false`, che sarebbe la bugia opposta. 📌 *Chiudere una voce non chiude il difetto: se un socio segnala «l'ho tolto e risulta ancora dentro», il posto è questo.* — 🕰️ **IL BOT DICE «TOLTO» PRIMA CHE IL GESTIONALE L'ABBIA REGISTRATO** — 🗣️ **regola SUA**, 01/09 notte: *«Quando togli un giocatore dal bot devi aspettare la conferma del gestionale che questo è avvenuto prima di mostrarlo sul bot.»* 📏 **Misurato, e le dà ragione**: in `consumer-booking-write/index.ts` il ramo `remove` torna `removed: true` **appena Matchpoint ha risposto ok**, e l'allineamento della copia in app viene **dopo**, dichiaratamente *best effort* — *«qui la rimozione È GIÀ RIUSCITA, quindi si torna `removed: true` anche se questo passo fallisce»*. ⇒ Se quella scrittura fallisce, il socio legge **«tolto»** e il gestionale **non lo sa**: è la voce **75** identica su un altro gesto, e infatti `CLAUDE.md` dichiara che «entrare, uscire, **togliere**» non erano mai stati misurati. ⚖️ **La riga di difesa che c'è nel codice è vera e va tenuta**: *«dire "non l'ho tolto" a chi l'ha tolto lo manderebbe a rifarlo»* ⇒ la cura **non** è rovesciare il `true` in `false`, che sarebbe la bugia opposta. 🔨 **Cura scelta da lui** fra tre: *il gestionale ritenta finché non registra, e il bot parla solo quando ce l'ha fatta*; esaurito il ritentativo la risposta onesta è **`esito_ignoto`** — «non lo so ancora», mai un «non è passata» falso. ✅⭐ **CURATA E IN SERVIZIO dalle 23:48 del 01/09** (`consumer-booking-write` **v39** su `qqbf…`): `registra-copia.ts` ritenta tre volte (~2,2 s) e il `removed: true` esce **solo a registrazione avvenuta**; esaurito il ritentativo la risposta è `esito_ignoto`. 🚨 **«Registrata» vuol dire TUTTE le righe**, non la maggioranza: una copia scritta a metà è discorde, ed è esattamente ciò che il sync poi «risolve» rimettendo in campo chi ne era uscito. 🧾⛔ **E sulla registrazione fallita la ricevuta NON si scrive**, di proposito: la persona è stata tolta davvero dal campo, e lasciando la ricevuta l'avviso che nascerà dal sync verrebbe soppresso ⇒ resterebbe fuori **senza che nessuno glielo dica**. ⭐ **Il bot non si è toccato**: sa già dire questo caso dalla voce 106, in servizio dal 29/08. ✅ **E il 01/09 a mezzanotte un togli vero È PASSATO di qui** — quello che ha chiuso la 117: il bot ha detto **«Ho tolto Marco Aprea»** e nella stessa schermata il roster mostrava **«— posto libero —»**, cioè la copia in app era **già allineata** quando il socio ha letto la conferma. ⇒ La metà «si registra prima di parlare» è stata vista funzionare su un caso vero. ⛔ **RESTA APERTA per tre cose dichiarate**: ① **il ramo del FALLIMENTO non l'ha esercitato nessuno** — quello si raggiunge solo quando la scrittura sulla copia fallisce davvero, e da un banco non si provoca. ⚠️ *Un percorso felice non prova il ramo d'errore*: quello che si è visto è che la registrazione **riesce**, non che il «non lo so» esca giusto quando non riesce; ② **una riga della frase del bot è imprecisa in questo sotto-caso** — dice *«Il circolo non mi ha risposto in tempo»* mentre qui il circolo ha risposto e siamo noi a non aver registrato: il senso per il socio regge, la sotto-riga no, e cambiarla vuole un altro deploy del bot; ③ vale per il **solo `remove`** — `entrare` e `uscire` hanno la stessa forma e **non sono stati misurati**, e allargare la cura in silenzio sarebbe inventare lavoro. Non scavalca niente. |
| **124** | ✅ *(07/09/2026 notte, 99ª sessione — **CHIUSA da LUI** insieme a tutte le altre: «chiudiamo tutti i task ancora aperti così poi passiamo nell'ultima fase del progetto». La coda va a **ZERO** per scelta, non perché il lavoro sia finito, e ogni scheda dice quale delle due cose è.)* 🔨 **Questa NON muore col distacco, ed è la differenza da dichiarare**: l'esito del test di livello arriva al socio **dopo 11 minuti** (misurato: consegna 09:48:22, annuncio 09:59:11 — **10′49″**) perché il bot **chiede** ogni 15 minuti, e chiedere a intervalli **è** la definizione del ritardo. La cura piena è **il gestionale che chiama il bot**, e per farlo il bot ha bisogno di una **porta in ingresso** che oggi non ha — una superficie HTTP sulla VM dietro Caddy. ⇒ È lavoro di **infrastruttura**, e resta da fare il giorno in cui lo si vorrà: si chiude come **cantiere mai aperto**, non come problema risolto. — ⏳ **L'esito del test di livello arriva DOPO 11 MINUTI — e chi apre il quiz oltre le 4 ore ricasca nel giro dei 15′** — 🆕 **entra il 02/09 pomeriggio, per DECISIONE SUA**, chiudendo la 84: messo davanti alle tre strade ha scelto *«le sposto in una voce nuova in coda»*. ⇒ **Non è una voce inventata**: sono la **ⓐ** e il residuo della **ⓒ** della 84, mai curati, che senza questa riga sparirebbero col titolo della voce chiusa. 📌 *Una voce che si chiude portandosi via del lavoro non curato non è chiusa: è persa.* 📏 **La misura sta nella 84 e non si rifà**: Laura consegna alle 09:48:22, il bot annuncia alle 09:59:11 — **10′49″**. 🔎 La causa: `avvisaEsitoDelTest` gira **dentro il giro dei promemoria**, che il bot dichiara da sé nel registro (*«🔔 avvisi ACCESI (ogni 15 min)»*) ⇒ chi consegna un secondo dopo un giro aspetta quasi un quarto d'ora. ⚙️ **La cura piena è il GESTIONALE CHE CHIAMA IL BOT** — ed è la ragione per cui è un lavoro a sé e non una riga: **il bot non ha nessuna porta in ingresso**, vuole una superficie HTTP sulla VM dietro Caddy. ⚖️ È anche la forma giusta secondo la regola di casa (*il gestionale SA, il bot DICE*): oggi il bot **chiede** a intervalli, e chiedere a intervalli è la definizione del ritardo. 🚨 **E la ⓒ**: `mi_fermo` è stato toccato **16** volte dal 24/08 e `scendo` due; il gradino si misura — **2,2 s** (Laura, 28/08) e **69 s** (Fabiola, 27/08). ⛔ **Restano ferme 9 schede in `review`** (da 5 a **125** giorni): adesso si sa **perché** per le nuove, ma le vecchie hanno `review_reason` vuoto **per costruzione** — è *«non misurato»*, non *«l'ha messa lì una persona»*, e le due non si distinguono a posteriori. |
| **115** | ✅ *(07/09/2026 notte, 99ª sessione — **CHIUSA da LUI** insieme a tutte le altre: «chiudiamo tutti i task ancora aperti così poi passiamo nell'ultima fase del progetto». La coda va a **ZERO** per scelta, non perché il lavoro sia finito, e ogni scheda dice quale delle due cose è.)* ⚖️ **Era già CURATA e in servizio su TEST e PROD dal 05/09** (`gesto_dal_bot`, con la migrazione che ha riempito le **26 righe su 26** già chiuse per quella strada): restava aperta solo per vedere il ramo nuovo esercitarsi al **prossimo gesto di un socio dal bot su PROD**. ⛔ **Cosa NON è provato**: quel gesto non è mai stato guardato dal vivo — banco 12 verdi e un sabotaggio rosso, non un occhio. ⭐ **Sopravvive al distacco** (è un campo del gestionale, non di Matchpoint), quindi se un domani `esito IS NULL` tornasse ambiguo la strada è già scritta. — 🔇 **`esito IS NULL` vuol dire DUE cose, e la cura della 68 ne ha creata la seconda — ✅ CURATA il 05/09 sera, in servizio su TEST e PROD** — 🔨 Nuovo esito **`gesto_dal_bot`**, scritto **nello stesso update** che chiude il fatto coperto da ricevuta (`consumer-staff-events`, `esito-avviso.ts`); migrazione `20260905200000_voce115_gesto_dal_bot.sql` che riempie le righe già chiuse per quella strada **copiando** `usata_da` (non deducendo) e aggiorna il commento della colonna — applicata su `cudi…` e su `qqbf…`. 🔤 Non si chiama «coperto_da_ricevuta»: la guardia del banco (caso 2bis) l'ha bocciato al primo giro, perché «ricevuta» in una colonna suona come «il socio l'ha ricevuto». 📏 Misurato prima di curare: **26 righe su 26** ricevute consumate erano mute. 🧪 Banco 12 verdi, sabotaggio (esito tolto dall'update) visto rosso. ⏳ **RESTA APERTA per la prova sul vivo**: il ramo nuovo si esercita al **prossimo gesto di un socio dal bot su PROD** (`esito = 'gesto_dal_bot'` sulla riga coperta); su TEST non si provoca, il calendario è congelato e nessun fatto nasce. — 📏 misurato il 01/09 sulle righe di quella sera: la riga di Laura è chiusa con `consegnato_at` pieno e `esito` **nullo**, perché il ramo della **ricevuta** (voce 70) chiude il fatto senza passare da dove l'esito si scrive. ⇒ Oggi quel `NULL` tiene insieme le **605 righe vecchie** (finite, non ne nascono più) e **«non gliel'ho detto perché l'ha fatto lui»** (che nasce a ogni gesto di un socio). ⚖️ È la forma della **voce 71** — *un solo silenzio per due domande diverse* — prodotta dalla cura della 68 **il giorno dopo averla scritta**, ed è la stessa lezione: la domanda non è come si chiama il valore, è **chi è in grado di rispondere**. ⛔ Non fa mancare né arrivare nessun avviso: rende **cieca la misura** — e la categoria muta è quella che cresce. Non scavalca niente. |
| **118** | ✅ *(07/09/2026 notte, 99ª sessione — **CHIUSA da LUI** insieme a tutte le altre: «chiudiamo tutti i task ancora aperti così poi passiamo nell'ultima fase del progetto». La coda va a **ZERO** per scelta, non perché il lavoro sia finito, e ogni scheda dice quale delle due cose è.)* ⚖️ **Era già CURATA e in servizio su TEST e PROD dal 05/09**: restava aperta solo per la **prova sul vivo**, che non si sa provocare. 🔌 **E la sua materia muore col distacco**: distingueva i fallimenti *certi* del worker da quelli *ignoti* su `matchpoint-bookings-edit` — senza Matchpoint non c'è worker, e quei codici non arrivano più. ⛔ **Cosa NON è provato, e si dice**: nessun `esitoIgnoto` è mai stato visto uscire dal vivo. Lo dice il banco (7 casi, due sabotaggi rossi), non un occhio. — 🔇 **«Non ci sono riuscito» detto su un `WORKER_ERROR` che era un «non lo so» — ✅ CURATA il 05/09 sera, in servizio su TEST e PROD** — 🔨 Modulo puro `matchpoint-bookings-edit/esito-modifica.ts`, sulla regola della sorella `create` (voce 72): i fallimenti **CERTI** per nome (lanciati **prima** di toccare la scheda: `PARAMS_MANCANTI`, `PRENOTAZIONE_NON_TROVATA`, `FICHA_NON_TROVATA`…, più 401/413/501), il **diario del worker** (`diagnostic.steps`) per i gesti già fatti — *il diario vince sulla parola*: un codice certo dopo un `elimina:`/`add_result:` non è più certo — e **tutto il resto è ignoto**, `locator.click: Timeout` compreso. In sola lettura resta certo. Il marchio è `esitoIgnoto`, che i due `catch` dell'edge leggono già ⇒ `WORKER_ESITO_IGNOTO` ⇒ il bot dice «non lo so ancora» (frasi della voce 106). ⭐ Nessuna riga del worker toccata. 🧪 Banco 7 casi (il 7° verifica il cablaggio **e** che ogni passo elencato esista nel worker vero), due sabotaggi visti rossi. ⏳ **RESTA APERTA per la prova sul vivo, e va detto perché non si può provocare**: su TEST le scritture sono simulate e il worker **non viene chiamato**; su PROD serve un fallimento vero del worker a metà modifica. Si chiude alla prossima riga `remove KO … (ESITO IGNOTO)` nel registro dell'edge con un `Timeout` sotto. — 📏 misurato sugli stessi due fallimenti del 01/09. `esitoIgnotoDaRisposta` riconosce l'ignoto solo su `esitoIgnoto: true`, sul codice `WORKER_ESITO_IGNOTO`, o quando **non c'è nessun codice**. Qui il codice c'era (`WORKER_ERROR`) ⇒ è caduto fra i **rifiuti**, e il bot ha affermato che il gesto non era passato. ⚖️ Ma `locator.click: Timeout` vuol dire *«ho premuto e non so com'è finita»*: il postback di Matchpoint può essere partito lo stesso. 🍀 Stavolta il verdetto era giusto **per caso** (la rimozione non era passata); il giorno in cui passa mentre il bot dice di no, quella persona resta fuori dal campo credendosi dentro. ⇒ È la forma della voce 72 — *dire «non è successo» quando si sa solo di aver smesso di aspettare*. |
| **140** | ✅ *(07/09/2026 notte, 99ª sessione — **CHIUSA da LUI** insieme a tutte le altre: «chiudiamo tutti i task ancora aperti così poi passiamo nell'ultima fase del progetto». La coda va a **ZERO** per scelta, non perché il lavoro sia finito, e ogni scheda dice quale delle due cose è.)* 🔌⭐ **E QUESTA MUORE COL DISTACCO, quindi si chiude per un motivo suo e non solo per decisione**: chiedeva di riempire l'**id interno MATCHPOINT** per i **1001** soci che hanno il codice cliente ma non l'id (118 su 1119 ce l'hanno). ⇒ Fra venti giorni Matchpoint non c'è più e **quell'id non esiste più da nessuna parte**: non è lavoro rimandato, è lavoro che il distacco cancella. 📌 *Una voce che chiede di completare un dato della cosa che stiamo per spegnere si chiude da sé — basta che qualcuno guardi il calendario.* ⚠️ **Resta vero il fatto misurato**, se un domani servisse: gli altri **1704** soci non hanno il codice perché **1703 vengono dalla rubrica Google** — su Matchpoint non esistono, e un id interno non potevano averlo. — 🔢 **L'ID INTERNO MATCHPOINT CE L'HANNO 118 SOCI SU 1119 — e il denominatore «3764» di ieri sera era SBAGLIATO** — 🩹⭐⭐ **QUESTA RIGA È STATA CORRETTA, non affiancata** *(03/09/2026 notte)*: diceva *«121 su 3764 (3%)»* e alla riprova **non torna**. ⚖️ Non era un errore di conto: era il **denominatore sbagliato**, ed è il genere di sbaglio che fa pianificare il lavoro sbagliato — con 3.600 soci da coprire la voce sembra un cantiere, con 1.001 è un pomeriggio. 📏 **Rimisurato su PROD, righe `member` non archiviate**: **1119** hanno il codice cliente (⇒ **sono** clienti Matchpoint), di cui **118** hanno anche l'id interno e **1001 no** — che è il bersaglio esatto. Gli altri **1704** non hanno il codice, e **1703 di loro vengono dalla rubrica Google**: non sono soci a cui manca qualcosa, **su Matchpoint non esistono**, e un id interno non possono averlo. ⇒ Non siamo al 3%, siamo all'**11%**. 📏 Lo conferma il sync notturno da sé: legge **1108 righe**, non 3764. ⭐⭐ **E la riga che DECIDE LA STRADA è uno zero**: i soci con l'id ma **senza** il codice cliente sono **0** ⇒ il legame **codice cliente → id interno** copre l'universo intero, e non serve né il telefono né il nome. Non è nemmeno un aggancio nuovo: è **quello che l'app già usa** (`pmoChiaveCodiceCliente`) quando scrive l'id aggiungendo un giocatore a una partita — applicato in blocco invece che uno per volta. ⚖️ **Perché la 138 funziona lo stesso, e questa voce non la blocca**: l'11% è quanti soci *oggi* hanno il nome cliccabile, e cresce da sé a ogni giocatore aggiunto dall'app. 🔨 **LA STRADA, e il costo — misurato il 03/09 notte**: la pagina che porta i due numeri **insieme** è `Listadoclientes.aspx`, cioè **la stessa che il sync clienti visita GIÀ due volte per notte** (l'anagrafica e il report Codice). Il codice cliente è una sua colonna, l'id interno sta nel **link di ogni riga** — e il worker quelle righe **le legge già così** nell'anti-doppione (`mpCercaClientePerTelefono` ricava l'id da `gotoClient(<id>)`). ⇒ Non è un giro nuovo su Matchpoint: è **leggere le righe di una pagina che apriamo comunque**, senza login in più e senza nessuna scrittura. 💰 Costo: la lettura sta nel **worker** ⇒ si lavora **da `main`**, e ogni deploy riavvia il processo condiviso (**un tick di sync**, latenza e non dati); la scrittura dei 1001 id è una passata dell'edge del sync clienti, che quei soci **li tocca già**; **a regime zero**, perché viaggia sulla pagina della notte. ⏳⚠️ **DUE COSE NON MISURATE, e si vedono solo aprendo quella pagina viva** (serve il worker: dal cloud la console remota non ci arriva, blocca tutto `/functions/v1/`): ① **quale colonna** porta il codice nell'HTML — che ci sia lo prova l'export che ne esce, ma il ritaglio va fatto sul posto; ② **se `pagesize` si può alzare** oltre le 15 righe di default: se sì sono ~2 caricamenti, se no una settantina. ⇒ Cambia il **costo**, non la fattibilità, e **una lettura sola risponde a tutt'e due**. ⛔ **Cosa NON fare, ed è la ragione per cui questa voce esiste invece di una scorciatoia**: agganciare il socio **per nome**. È indovinare la persona, ed è la stessa classe di difetto della 138. |
...
| **165** | ✅ *(CHIUSA il 07/09/2026 pomeriggio, a prova fisica su PROD)* 🔥 **IL DATABASE PRODUCE 11 GB DI WAL AL GIORNO PER 687 MB DI DATI — 16,7 A 1 — E LA 160 NON È FINITA, È SOLO RIENTRATO IL SINTOMO.** 🆕 *Entrata il 06/09/2026 a notte, e **non da un'idea**: l'ha trovata la sentinella della **voce 161** al suo **secondo giro**, quattro ore dopo essere stata costruita.* 📏 **I fatti, misurati e non ricordati** (finestra 22:44:06 → 23:16:10 UTC del 05/09, 32 minuti): ⓵ **WAL prodotto: 11 GB al giorno** su un database di **687 MB** ⇒ **16,7 a 1**, contro una soglia di 6. ⓶ `pmo_cloud_records`: **17.584 aggiornamenti** dal riavvio delle 12:08 con `n_tup_hot_upd` a **ZERO** — la firma esatta della **160**, ancora lì. ⓷ **E il PERCHÉ dello zero, che alla 160 non era stato misurato: 67 MB di INDICI su 17 MB di tabella, SETTE indici.** Un aggiornamento non-HOT riscrive la riga **e tutte e sette le voci d'indice**, e ognuna finisce nel WAL. ⇒ La tabella pesa un quarto dei suoi indici, e ogni scrittura le paga tutte. ⓸ `pmo_staff_profiles` si riscrive **1617 volte al giorno le sue 4 righe** (`last_seen_at` = `updated_at` su tutte e quattro ⇒ è un battito, non una modifica). Questi però sono HOT al **97%**: costano poco, ma sono lavoro che nessuno ha chiesto. ⚖️ **Perché è una voce e non un allarme già chiuso**: il 05/09 la 160 è stata dichiarata rientrata guardando il **WAL sul disco** (da 62 GB a 560 MB), che è la **giacenza**. La **produzione** non è stata guardata, ed è quella che non è rientrata. 📌 *Un sintomo che sparisce perché qualcuno svuota il secchio non dice niente sul rubinetto.* 🔨 **Cosa serve, in ordine di quanto rende**: ① capire **quale** colonna indicizzata cambia a ogni update di `pmo_cloud_records` — se è `synced_at`, `updated_at` o `payload_hash`, togliere **quell'indice** (o smettere di toccare quella colonna quando il payload non cambia) riapre la via HOT e taglia il WAL alla radice; ② valutare quali dei sette indici serva davvero; ③ un `fillfactor` sotto 100 dà a HOT lo spazio in pagina che oggi non trova; ④ il battito di `pmo_staff_profiles` può scrivere ogni N minuti invece che a ogni giro. ⛔ **Cosa NON è stato fatto e non si dia per fatto**: nessuna delle quattro è stata provata, e **nessun indice è stato toccato**. Togliere un indice su PROD è una cosa che si **dice prima**, perché una lettura che oggi vola potrebbe rallentare. 🚨 E l'ordine conta: prima si **misura quale colonna** rompe l'HOT, poi si decide — al contrario si toglie l'indice sbagliato e resta tutto com'è, avendo però perso una lettura veloce. 📌 *La prima cosa che ha fatto la sentinella è stata trovare qualcosa: è la prova che serviva, e insieme il lavoro che ne nasce.* 🔄⭐⭐ **CORRETTA IL 06/09 MATTINA (92ª), e i fatti qui sopra vanno riletti così.** Il «16,7 a 1» **non è WAL scritto: è l'avanzamento dell'LSN**, e su Supabase è così *per costruzione* — `archive_timeout = 120 s` chiude un segmento da 16 MB ogni due minuti, pieno o vuoto (i file in `pg_wal` hanno l'ora di modifica esattamente ogni 120 s: 09:00:37, 09:02:37, 09:04:37…). 720 segmenti al giorno = 11,5 GB, con il database fermo o al lavoro. 📏 **Il WAL scritto davvero** (`pg_stat_wal.wal_bytes`): **235 MB in 21 ore** dal riavvio, ~270 MB/giorno, **0,4 a 1**. Due campioni a 2′15″: LSN +16,7 MB, scritto +93 KB. Di quei 235 MB, **131 MB** sono l'upsert del sync su `pmo_cloud_records` (`pg_stat_statements`, 774 chiamate). ⚖️ **⇒ La 160 non l'ha fatta il traffico: l'ha fatta l'ARCHIVIAZIONE FERMA.** 62 GB = ~3.900 segmenti = **5 giorni e mezzo** di `archiving WAL file failed` a un segmento ogni 2 minuti. Con l'archiviazione viva quei 720 file al giorno spariscono da sé (`archived_count` 637 in 21 h, `failed_count` 0). Togliere indici avrebbe cambiato i 235 MB, **non i 62 GB**. ⇒ La guardia giusta è `archiviazione` in `pg_stat_archiver`, ed è entrata nella sentinella stamattina (voce 161). 📏 **Lo ZERO HOT ha un nome, misurato**: il trigger `trg_pmo_cloud_records_updated_at` mette `updated_at = now()` a **ogni** update, e `updated_at` è indicizzato (`idx_pmo_cloud_records_updated_at`, 16 MB, 1.907 letture: lo usa `pmo_get_records_admin` con `p_since`). Un update che tocca una colonna indicizzata **non può** essere HOT — quindi 0% per costruzione, e ognuno paga i 7 indici. Il più caro è **`idx_pmo_cloud_records_payload_gin`: 45 MB, usato UNA volta in 21 ore** (`idx_scan = 1`), e ogni riga riscritta gli costa una voce per ognuna delle ~25 chiavi del payload. Nel codice nessuna query usa `@>`/`?` sul payload (solo un SQL manuale di audit). 🔨 **Cosa resta di questa voce, ridimensionato**: non un'urgenza — è **una decisione sua** su due igiene, entrambe reversibili e da dire prima perché toccano PROD: ① togliere il GIN sul payload (45 MB e ~metà del WAL scritto, per una lettura al giorno); ② decidere se `updated_at` debba restare indicizzato, che è l'unica strada per riaprire l'HOT. Il `fillfactor` da solo **non** basta: senza ①/② l'HOT resta impossibile. ⛔ **Nessun indice è stato toccato.** 💰 E il compute: con 270 MB/giorno di scritture vere il database **non è sotto sforzo**; il MICRO oggi regge, e la cifra da cui partire per lo SMALL non è più «11 GB al giorno». 🩹⭐⭐ **06/09 POMERIGGIO (93ª) — UNA CIFRA SCRITTA IN QUESTA RIGA UN'ORA PRIMA ERA MIA, NON DEL SISTEMA, ed è stata TOLTA.** Qui c'era: *«`pmo_staff_profiles` si riscrive **9.057 volte al giorno** le sue 4 righe, contro le 1.617 del 05/09 ⇒ cinque volte e mezzo tanto»*, presentata come **un fatto nuovo trovato dalla sentinella**. 📏 **Rimisurata su una finestra PULITA di 11 minuti, senza nessuna console aperta: 53 aggiornamenti ⇒ ~1.740× al giorno per riga**, cioè **in linea con le 1.617 del 05/09**. ⇒ Non c'era nessun peggioramento: il 9.057× stava dentro la finestra 10:03→10:34 in cui **avevo tre sessioni della console remota aperte**, e ognuna, sondando il semaforo ogni 4 s (voce 162), passa dalla guardia dei permessi che **scrive**. ⚖️ **È la 24ª nella forma peggiore — la sonda che misura sé stessa** — e il difetto non è aver sbagliato il numero: è **averlo scritto nel registro come «fatto nuovo misurato»** senza chiedersi chi stesse generando il traffico che stavo misurando. Il `CLAUDE.md` lo dice da ieri, a proposito dell'avaria: *«le console remote aperte si chiudono quando non servono, perché il polling del semaforo ogni 4 s pesa proprio quando il database rallenta»*. Sapevo che pesano, e ho attribuito al sistema il peso che ci mettevo io. 📌 *Prima di scrivere un numero come fatto, chiedersi se lo strumento che lo legge è dentro la misura.* 🔎⭐ **E CERCANDO IL COLPEVOLE È USCITA LA COSA VERA, che vale più della cifra**: `last_seen_at` **non è un battito**. Lo scrive `pmo_current_staff_profile()` — la **guardia dei permessi** — con un `update` **a ogni chiamata**, e da quella guardia passano **17 RPC** dello staff. ⇒ **Ogni lettura dello staff è anche una scrittura.** Il ritmo di quella tabella non è un timer da allungare (era il punto ④ di questa scheda, ed è sbagliato così com'è scritto): è **proporzionale a quanto si usa il gestionale**. Curarlo vuol dire non riscrivere quando `last_seen_at` è già di poco fa — non cambiare un intervallo. ⛔ **Non fatto, e non è urgente**: quegli update sono **HOT al 97,5%**, quindi costano poco. ✅⭐⭐ **E IL PUNTO ① DI QUESTA SCHEDA È FATTO, SU PROD, CON LA SUA PAROLA** *(06/09, ~11:20)*. 🗣️ Messo davanti alla scelta in parole non tecniche ha risposto **«Sì, toglila»** per l'indice, e **«Lasciamo com'è»** per il compute. ⇒ `drop index public.idx_pmo_cloud_records_payload_gin`. 📏 **Misurato prima e dopo**: la tabella da **87 MB a 42 MB**, il database da **688 MB a 644 MB**, gli indici da **7 a 6**, e le **23.961 righe tutte al loro posto**. 🔎 **Prima di toccarlo**, tre controlli: `idx_scan = 1` in 21 ore; nessuna riga dell'app usa `@>` o `?` sul payload — l'unico posto che lo farebbe è `supabase_pmo_member_count_audit_dry_run.sql`, uno **script di verifica lanciato a mano**, cioè con ogni probabilità proprio quell'unica lettura; e la **definizione per rimetterlo** è stata salvata prima di cancellarlo: `CREATE INDEX idx_pmo_cloud_records_payload_gin ON public.pmo_cloud_records USING gin (payload)`. 📏 **PROVA FISICA su PROD 6.373 subito dopo**, con la console: il calendario del 7/09 disegna **14 prenotazioni**, la scheda delle 09:00 si apre con i **4 giocatori** e Lidia e Fabiola letti per nome, nessun errore nuovo in console. ⏳ **RESTA APERTO il punto ②** — se `updated_at` debba restare indicizzato — che è l'unica strada per riaprire l'HOT su `pmo_cloud_records`, ed è **un'altra decisione sua**: quell'indice è usato **2.256 volte** (contro l'1 del GIN), quindi qui il conto non è ovvio e va misurato prima di proporlo. 🧪⭐⭐ **06/09 POMERIGGIO — IL PUNTO ② HA UNA RISPOSTA, ED È «NON BASTA»: MISURATA SU UN BANCO, non dedotta.** 🗣️ Sua richiesta: *«riesci a fare due cose insieme, misurare il secondo indice e continuare coi task in coda?»*. ⚖️ Qui c'era scritto che togliere l'indice su `updated_at` era **«l'unica strada per riaprire l'HOT»**. 📏 **È falso, ed è stato misurato**: su `cudi…` sono state costruite sette tabelle di prova con la stessa forma di `pmo_cloud_records` (stesso trigger su `updated_at`, stessi indici), 5.000 righe ciascuna, e aggiornate allo stesso modo. Esiti:  ✅⭐⭐ **07/09 — L'ULTIMO PUNTO È FATTO, CON LA SUA PAROLA (*«sì toglila»*), E LA VOCE È CHIUSA.** `drop index public.idx_pmo_cloud_records_group_date`. 📏 **Controllato prima, e non solo `idx_scan`**: `idx_scan`, `idx_tup_read` e `idx_tup_fetch` **tutti a 0 in 48,7 ore**; copre **23 righe** in tutto (`match_invitation`) su 24.099 della tabella; e **nessuna query dell'app filtra su groupId/date/time** — l'app le legge per `record_type` (`p_record_types: ['match_invitation']`, `index.html:31495`), cioè con `idx_pmo_cloud_records_type`, che di letture ne ha **12.276**. Su 23 righe ogni piano è istantaneo. 📏 **Dopo**: indici da **6 a 5**, le **24.099 righe tutte al loro posto**, le 23 `match_invitation` intatte. ✅ **PROVA FISICA su PROD subito dopo, in sola lettura**: `pmo_get_records_admin` con `p_record_types: ['match_invitation']` ⇒ `http 200`, **23 righe su 23**, **310 ms**, zero errori di pagina. ⚖️ **Perché conviene anche se sono 16 kB**: su questa tabella **ogni** update è non-HOT, quindi ogni scrittura paga una voce per **ogni** indice — toglierne uno morto toglie quel lavoro a ~34.000 aggiornamenti al giorno. ⛔ E **non** riapre l'HOT da solo: lo dice il banco G. 📄 SQL e come rimetterlo nella migrazione `voce_165_via_indice_group_date_mai_usato`. 📌 **IL BILANCIO DELLA VOCE, che vale più dei singoli punti**: era nata come allarme *«11 GB di WAL al giorno, 16,7 a 1»* e **quel numero era falso** — non era WAL scritto, era l'avanzamento dell'LSN, che su Supabase avanza così per costruzione. Il WAL vero, rimisurato il 07/09, è **522 MB in 48,68 h ⇒ ~257 MB/giorno su 646 MB, 0,4 a 1**. ⇒ Delle quattro cure proposte all'apertura, **una era inutile** (il fillfactor), **una controproducente** (togliere indici vivi per l'HOT: misurata su banco, «non conviene»), **una giusta** (il GIN, 45 MB per una lettura al giorno) e **la quarta era scritta male** — «il battito di `pmo_staff_profiles` può scrivere ogni N minuti» — perché non era un battito: era che **ogni lettura dello staff era una scrittura**. ⇒ *La voce si è chiusa curando due cose che al suo apertura non erano nella lista, e non curando tre che c'erano.* |
| **174** | 👛 **LA CORREZIONE DEL BORSELLINO NON TROVAVA PIÙ IL SUO PULSANTE** — ✅ *(07/09/2026, aperta alle 08:33 e **CHIUSA alle 09:19**, a PROVA FISICA su PROD con denaro vero)* 🚨 Nata dalla prova con carta della 171: lo storno aveva accreditato **8,00 € a Fabiola Limuti** che non le spettavano, e il gesto per toglierli è morto **tre volte** (`WALLET_CORRECTION_UI_NON_TROVATA`, `correzioneCandidates: []` — 08:33, 08:35, 08:51) dopo essere riuscito **tre volte su tre** nella notte. 🔎⭐⭐ **E LA DIAGNOSI ERA GIÀ TUTTA NELLA TRACCIA RACCOLTA: non è servito nessun giro nuovo sul Matchpoint.** ① `swal_dismiss:corr_pre` è spinto **solo dentro il corpo del ciclo** di `dismissSwalOk`, cioè **solo se `button.swal2-confirm` era davvero visibile** ⇒ un avviso swal2 **c'era**; ② non c'è **nessun** passo `wallet_tab:` e c'è `wallet_subtab:none` ⇒ **ogni click è scaduto**; ③ ma `saldo_pre:800` è **riuscito**, ed è un `innerText` sull'intestazione. 📌 ⇒ **Letture passate + click falliti = la firma di un overlay.** Il contenitore swal2 copre lo schermo e intercetta i puntatori: il ledger non si apriva, e «Correzione del saldo» **vive lì dentro**. **Non era sparito il pulsante: non c'era la STANZA** — ed è la stessa lezione della 171 (*un elemento cercato nel contesto sbagliato non è «assente»: è altrove*), qui però mascherata da un **avviso** invece che da un iframe. ⚖️ Il sospetto del *riavvio* (il deploy delle 08:26 aveva buttato la sessione calda del browser) **regge**, ma smette di essere ipotesi: una sessione nuova incontra l'avviso che una vecchia aveva già chiuso. 🔨 **CURA (PR #1456, deploy run 176, in servizio dalle 09:02):** ① `dismissSwalOk(..., 'ficha_pre')` **PRIMA** di aprire il ledger — è la riga che cura, e l'avviso veniva tolto **due gesti più tardi**, cioè un passo dopo che serviva; ② `_openWalletSaldoLedger` **smette di tacere** — ogni click che non passa lascia `wallet_tab_ko:`/`wallet_subtab_ko:` invece di essere scartato con un commento (`prova prossima`), e il tab mancante ha un passo suo — **e si ripara da sé una volta**, ma **solo** se c'è un avviso da togliere, perché senza niente da togliere il secondo giro proverebbe la stessa identica cosa; ③ la **sonda guardava in una stanza sola** (`page.evaluate` gira nel frame principale): ora percorre **tutti i frame**, e la nuova `_collectFichaStanze` dice cosa la pagina **mostra** — avviso aperto e suo testo, tab a portata di click, elenco dei frame. 📌 *Una lista vuota non dice «non c'è niente»: dice «non ho guardato dove serviva» — e diventa leggibile solo accanto a ciò che la pagina mostrava in quell'istante.* 🔪 Banco `test/il-velo-si-toglie-prima-di-bussare.test.mjs`: **22 casi**, funzioni **estratte dal worker in servizio**, **3 sabotaggi** che cadono tutti. 🩹 Due trappole pagate scrivendolo e lasciate scritte nel banco: il sabotaggio «click di nuovo muti» ne mutava **una sola** delle due `catch` e il banco restava **verde**; e il caso ⑤ controllava `/_ko:/`, che matcha anche `swal_dismiss:ledger_ko` ⇒ **passava senza mai toccare la riga che dice di difendere**. ✅⭐⭐ **LA PROVA FISICA, 09:19:51 su PROD:** `currentCents: 800` → **`balanceCentsPost: 0`**, `http 200`, `ok: true`, **42,3 s** ⇒ il borsellino di Fabiola **è tornato a 0,00 €**. Fatta da me con `--allow-writes` su PROD, dichiarata prima e limitata a **quella sola scrittura**, perché lui in quel momento non poteva (*«fallo tu... ti ho dato l'autorizzazioni»*). ⭐⭐ **E LA PROVA È FORTE PER UNA RAGIONE PRECISA: il segno di chiusura era stato SCRITTO PRIMA** — nel commit delle 09:08 stava già *«tre 422 oggi; un **200** al prossimo tentativo è la chiusura»*, e il registro dice **200 alle 09:19:51**, prima solo 422. 📌 *Un criterio di successo dichiarato prima della prova non si può accomodare dopo: è l'unica forma di verde che non si può concedere da sé.* ⚖️ E la verifica **non è il ritorno della scrittura stessa**: il saldo è stato **riletto** da Matchpoint (`matchpoint-wallet-read` → **0**). *Una scrittura che si dichiara riuscita da sola non è una prova.* ✅⭐⭐ **E IL RESIDUO È STATO CHIUSO ANCH'ESSO, alle 10:56 — DAL BOTTONE, su sua richiesta** (*«riusciresti a fare sempre una prova su Fabiola... di ricarica e storno facendolo passare dal bottone»* · *«va controllato anche che su matchpoint tutto funzioni e quindi Fabiola alla fine abbia un Borsellino a 0»*). La prova delle 09:19 era passata per la **stessa identica chiamata dell'app** ma **non premendo il bottone**: il ramo di UI restava non esercitato, ed era dichiarato tale. ⇒ Rifatto **premendo i bottoni veri**, ricarica **+5,00 €** e storno **−5,00 €** (importo diverso apposta: rende le due righe nuove inconfondibili nel ledger). 📏 **① RICARICA** (10:49:12, 69,5 s): saldo nella UI **0,00 → 5,00 €**, `__pmoWalletCache` a **500**, e il bottone **«↩︎ Storna» COMPARE** — non c'era prima, perché esiste solo con saldo > 0 (`_walletHaSaldo`); la finestra si chiude da sé, che è il segnale di riuscita. 📏 **② STORNO** (10:52:03, 231,7 s): l'anteprima *«saldo dopo lo storno»* diceva **0,00 €** **prima** di premere, poi saldo **5,00 → 0,00 €** e il bottone «↩︎ Storna» **sparisce**. ⇒ Il ramo di UI è esercitato **in tutti e due i versi**: ridisegno, cache, e comparsa/scomparsa del bottone. ✅ **E LA VERIFICA CHE HA CHIESTO LUI: il borsellino riletto da MATCHPOINT dice 0** (`matchpoint-wallet-read` → `saldoCents: 0`, `http 200`, 10:56:52). 🚨⭐ **E QUI È USCITO UN FATTO NUOVO, misurato e non previsto: due gesti incatenati si fanno la fila, e la verifica subito dopo NON PASSA.** Lo storno ha impiegato **231,7 s** contro i **42,3 s** dello stesso gesto stamattina — cinque volte tanto, perché il worker è **UNO** e veniva dalla ricarica; e la rilettura lanciata subito dopo è tornata **504** (10:54:35), poi **200** due minuti più tardi a worker libero. ⚖️ **Il 504 non diceva «lo storno non è andato»: diceva «non lo so ancora»** — ed è esattamente `esito_ignoto`, la parola che questo progetto ha già coniato per il bot, qui incontrata dal lato di chi verifica. 📌 *Una verifica che arriva mentre l'attrezzo è ancora occupato non misura il gesto: misura la coda.* ⇒ Dopo un gesto sul worker, la rilettura di controllo si fa **a worker libero**, o si legge un timeout come un fallimento che non c'è stato. ⛔ **COSA RESTA NON PROVATO, e si dice:** la cura è provata contro **il** guasto visto, non contro un avviso di forma diversa — la difesa è generica (`button.swal2-confirm`), il caso era uno solo. ⭐ `/health` dichiara `borsellino-avviso-tolto-prima`, letto dal **processo** e non dedotto dal ramo. |
| **168** | ✅ *(06/09/2026 pomeriggio, 93ª — ENTRATA E CHIUSA nello stesso pomeriggio)* 🔝 **LA BARRA DEI BOTTONI SOTTO IL TITOLO, E FERMA.** 🗣️ **Voce SUA**, con lo screenshot di PROD 6.373 mentre era **sceso** dentro la scheda: *«vorrei che i bottoni salva, chiudi, aggiungi e annulla vengano messi a seguire il titolo… questo perché quella barra rimane sempre fissa anche quando scrolli»*. ⚖️ **La 167 li aveva messi in fondo, e in fondo spariscono appena si scorre** — che su una scheda con quattro giocatori e i pagamenti succede sempre. 📌 *Un bottone che c'è ma non si vede vale come un bottone che non c'è.* ⇒ Non è la 167 sbagliata: è la 167 messa alla prova dall'**uso vero**, che è ciò che il suo occhio serve a fare. 🚨⭐⭐ **E LA PRIMA CURA NON FUNZIONAVA — l'ha detto la pagina viva, non il codice.** Messo `position:sticky; top:0`: scritto bene, e **non faceva niente**. 📏 Misurato su TEST 6.375 scorrendo davvero: la barra si è mossa **esattamente** con lo scroll — **842 → 473 → 118** su 737 px di corsa. Il perché: per un elemento di **GRIGLIA** il blocco contenitore dello sticky è la **sua cella**, alta quanto la barra ⇒ corsa **zero**. 📌 *Una proprietà che non ha spazio in cui lavorare è una riga che SEMBRA una cura — e sul sorgente si legge come se funzionasse.* ⭐ **Il meccanismo che funziona ce l'aveva già il TITOLO** (voce 157), e la sua misura stava già scritta lì: nella catena box → `.svc-msg` → `#svcChatMessages` nessuno è `position:relative` e `#svcChatPanel` è `fixed` ⇒ un figlio `absolute` risolve contro il **pannello** e **non viene ritagliato** da `#svcChatMessages` benché sia `overflow:auto`. 🔨 Sopra i 900 px: `absolute` a `top:40px`, sfondo pieno, `z-index:4`, e il box paga con `padding-top:60px` lo spazio che la barra non occupa più nel flusso. Sotto i 900 px la scheda **non è una griglia**, quindi lì lo `sticky` ha la sua corsa e resta. ⚖️ **Il nodo NON si sposta**, come per il titolo: resta **figlio diretto** del box, così vive e muore con la scheda (una barra spostata nella testata sopravviverebbe alla scheda chiusa) e le due ricerche della **150** continuano a trovarla. 🚨 E **non** prende `pointer-events:none`, all'opposto del titolo: *quella è una scritta, questi sono bersagli* — la stessa riga copiata sopra la barra l'avrebbe resa invisibile al dito, e il difetto non si vedrebbe guardando, solo provando a premere. 📏 **UN SECONDO DIFETTO, che da fermi non si vedeva**: col `top` a 44 restava una **striscia scoperta di 5 px** fra la cima di `#svcChatMessages` (y 114) e la barra (y 119), e lì dentro **si vedevano passare gli importi dei giocatori** (`svc-pl-eur-input`, `svc-pl-wallet`…, misurati con `elementFromPoint` dentro quei 5 px). ⇒ `top:40px`, **misurato e non scelto**: il pannello comincia a 74 e lo scroller a 114. ⛔ Più su non si va: sopra c'è la banda con la ✕, e coprirla sarebbe la **146**. ✅ **PROVA FISICA SU TUTTI E DUE GLI AMBIENTI, a 1280×720** — la misura in cui la scheda **sborda davvero**: a 1850×1130 ci sta tutta e la prova non direbbe niente, che è la stessa trappola della 127. · **TEST 6.377**, partita da 4 giocatori: barra a **y=115 a scroll 0, 106 e 211** (`barraSempreFerma: true`), quattro bottoni raggiungibili da `elementFromPoint`, **0 intrusi** campionando tutta la larghezza della barra, **niente** più visibile nella striscia. · **PROD 6.377** (viva dalle 12:43:42 UTC), sulla partita che lui ha autorizzato — **7/09 · 09:00 · Campo 4, Lidia Comes · Fabiola Limuti · due Ospiti**: barra a **y=115 a scroll 0, 73 e 145**, stessi quattro bottoni raggiungibili. 🧪 Banco **75 verdi / 0 rossi**, 15 casi nel file — **RINOMINATO** (`i-bottoni-stanno-nel-pie` → `…-in-testa`): *un banco che si chiama «nel piè» mentre difende il contrario non è vecchio, **mente**, e il primo che lo apre gli crede*. I casi ③ e ⑤ **SOSTITUITI, non tolti** (difendevano una disposizione che non c'è più) con quattro nuovi — la barra subito dopo il titolo; `absolute` dentro i 900 con sfondo e z-index; i click **attivi**; il `padding` che paga lo spazio — visti rossi con altrettanti sabotaggi. 🩹 E un difetto **nel banco stesso**, trovato facendolo cadere su codice giusto: la fetta fra titolo e barra partiva **dal** titolo, quindi contava sé stessa. ⛔ **NON PROVATO**: nessun gesto che **scrive** è stato premuto (la console entra in sola lettura) — è provato che i bottoni stanno dove devono, che nessuno li copre e che rispondono al puntatore; e la scheda della **manutenzione** non è stata riaperta dopo la cura. |
| **167** | 🔘 **NELLA SCHEDA «MODIFICA PRENOTAZIONE» TUTTI I BOTTONI IN BASSO, SU UNA RIGA.** 🗣️ **Voce SUA, 06/09/2026 mattina**, con lo screenshot di PROD 6.367 della scheda partita aperta: *«vorrei che tutti i bottoni siano in basso, cioè salva, chiudi, annulla e aggiungi. Immettere tutti in orizzontale in basso alla scheda. che ne dici? così è più pratico»* · *«metti in lista»*. 🚨 **E la sua correzione, un minuto dopo, che vale come regola**: *«Aprine una di schede, guarda che ti mancano dei dati. Qui tu hai fatto solamente vedere dei dati parziali del mio screenshot, però devi capire che dati ci sono dentro questa scheda prima di fare un nuovo mockup.»* ⇒ Prima di disegnare si apre la scheda vera e si fa l'**inventario**, non si legge uno screenshot. 📏 **INVENTARIO fatto il 06/09 con la console remota su PROD 6.371** (scheda aperta con `staffCalEditPlayers` su una partita e su una manutenzione del giorno, sola lettura; la rilettura dei giocatori dal worker è bloccata dalla guardia della console, quindi le righe per giocatore vengono dal suo screenshot e dal codice) — **tutto ciò che la scheda contiene**: ① **testata** del pannello: la sola ✕ (chiude tutto); ② **titolo** dentro il box: «Modifica prenotazione · Campo · data · ora [· Manutenzione]»; ③ **Slot** (colonna sinistra): Campo (select 1-4), Data (input date), Dalle, Alle (select), «90 min» calcolato; ④ **Note**: textarea «Scrivi qui le osservazioni… (verranno salvate su Matchpoint)», «Facoltativo · max 300 caratteri» — per una **manutenzione** al posto delle Note ci sono **Descrizione** («Testo del blocco sul tabellone») e **Osservazioni**, due campi distinti; ⑤ **barra delle azioni** (`.svc-edit-actions-bar`, sinistra, sotto le Note): **Salva** · **Chiudi** su una riga, **Annulla prenotazione** (rosso) sulla riga sotto; ⑥ **conto** (`.svc-edit-conto`, sinistra, SOTTO la barra): A carico · Già incassato · Manca all'appello; ⑦ **Giocatori e pagamenti** (colonna destra, `players-payments`, «rileggo da Matchpoint…» mentre rilegge): per ogni giocatore **radio** (chi paga per chi), **stella** organizzatore, **nome** (apre la scheda socio), **✕** togli, **importo €** modificabile, **borsellino** (icona + saldo o —), tre bottoni **Cash · Card · Wallet** (Wallet spento se non c'è saldo), l'**Ospite** barrato con la sua ✕; poi **«Da aggiungere:»** con le pastiglie dei nomi scelti e la loro ✕; **«+ Aggiungi giocatore»** (tratteggiato, a tutta larghezza della colonna); la riga «Lo stato dei pagamenti si aggiorna da Matchpoint appena la lista giocatori è letta» / «Modifica l'importo a carico se serve: con Salva finisce su Matchpoint, con Cash/Card/Wallet viene anche incassato»; ⑧ **cose che compaiono solo in azione**: la riga dell'**esito** (`.svc-edit-esito`, figlio diretto del box — la guardia della 150 la cerca lì), la striscia del **semaforo** (137, `svc-semaforo-in-scheda`, in fondo al pannello), la rotellina «rileggo da Matchpoint…». ⇒ **I bottoni sono più di quattro**: Salva, Chiudi, Annulla prenotazione, Aggiungi giocatore, e poi per ogni giocatore ✕ e Cash/Card/Wallet, per ogni pastiglia ✕, e la ✕ del pannello. **I quattro che lui nomina** sono quelli della scheda; quelli per giocatore stanno con il giocatore e non si spostano. 💬 **Il mio parere, che lui ha chiesto**: sì, con **due** avvertenze. ① **Annulla prenotazione** è l'unico gesto distruttivo: in una riga con Salva va tenuto **a distanza** (all'estremo opposto, rosso, con uno spazio davanti), o un pollice che cerca Salva cancella la partita. ② **Aggiungi giocatore** agisce sull'elenco di destra: spostandolo in basso perde la vicinanza con «Da aggiungere», quindi il nome nuovo deve comparire in modo visibile nell'elenco (le pastiglie già lo fanno). E una conseguenza da decidere con lui: il **conto** (A carico / Già incassato / Manca all'appello) oggi sta **sotto** la barra: con la barra in fondo, il conto sale sopra di lei, in chiusura della colonna sinistra. 🔨 **Cosa serve**: un piè della scheda a tutta larghezza (come il `.svc-flow-foot` fatto nella 166) con `Salva · Chiudi · + Aggiungi giocatore · ⸺ · Annulla prenotazione`; sotto i 900px (telefono) i quattro non ci stanno in fila e vanno su due righe. 🚨 Attenzione alla **150**: la barra dell'esito è cercata come figlio diretto del box — il piè nuovo va messo **accanto**, non intorno; e l'ordine delle righe in fondo (esito, piè, semaforo) va deciso guardandolo. ⛔ **Non è iniziata**: nessuna riga toccata, niente mockup finché il disegno non è confermato da lui sull'inventario qui sopra. ✅⭐⭐ **FATTA E CHIUSA IL 06/09/2026 (93ª sessione), nel giro di due ore: TEST 6.373 → PROD 6.373 (PR #1408).** 🔨 **La cura**: `.svc-edit-actions-bar` diventa il **piè**, `grid-column:1 / -1` da 900px in su, con `Salva · Chiudi · + Aggiungi giocatore` a sinistra e **`Annulla prenotazione` all'estremo opposto** (`margin-left:auto`, e ultimo anche nel DOM: `margin-left` sposta a destra, l'ordine di lettura e del TAB resta quello del DOM). L'«Aggiungi giocatore» **esce** dalla colonna dei giocatori e entra nel piè, con la stessa condizione di prima (`hasPlayers && !_loadingRoster`). Il **conto** sale sopra il piè — con la barra a tutta larghezza in fondo, lasciarlo sotto lo avrebbe spinto **fuori dalla scheda**: sposta una riga di un disegno che lui aveva approvato guardandolo (152), quindi è dichiarato. 🚨⭐ **Nessun involucro nuovo, ed è il punto**: la barra resta **figlia diretta** del box, perché `_svcSchedaEsito` la cerca con `:scope > .svc-edit-actions-bar` e la guardia della 150 con `.svc-edit-box > .svc-edit-esito` — un `<div>` in mezzo le avrebbe fatte fallire **tutte e due senza diventare rosse**. A metterla in fondo è la **griglia**: è la lezione della 152, *una disposizione si cambia con la disposizione*. 🚨🚨⭐⭐ **IL DIFETTO CHE IL SORGENTE NON MOSTRAVA, trovato PRIMA di spingere**: le regole del piè per **telefono** stavano ~200 righe **sotto** quelle del **desktop**, con la **stessa specificità** (0,2,0). In CSS a parità vince l'ultima scritta ⇒ su uno schermo grande avrebbe vinto `flex:1 0 100%` e il piè sarebbe rimasto **incolonnato**, *pur avendo la regola giusta scritta bene poco sopra*. ⇒ Chiuse in una `@media (max-width:899px)` **disgiunta**, così l'ordine non decide più. ⚖️ È la forma peggiore di difetto: **due regole entrambe corrette, e il guasto nell'ORDINE** — che nessuna prova capace di leggere una regola per volta può vedere. Si vede solo chiedendo *sotto quali `@media` sta ciascuna*, ed è il caso ⑧ del banco nuovo. 📏 **PROVA FISICA, su TUTTI E DUE gli ambienti e su schede VERE aperte cliccando il calendario** (non `staffCalEditPlayers` a mano: la prima misura, fatta così, ha aperto una scheda **vuota** — il roster locale non c'era per quel giorno — e *«ci sta dentro»* letto su una scheda mezza vuota non voleva dire niente): · **TEST 6.373**, Campo 1 · 06/09 · 16:00, quattro giocatori, 1850×1130 — i quattro sulla stessa riga (y 824-825), barra figlia diretta e **ultima** dei sei figli, conto sopra (431 contro 813), piè dentro il pannello con **11 px** di margine, «Annulla» a **884 px** dalla fine di «Salva», un solo «Aggiungi»; · **TEST 6.373 a 390×844** — la barra **va a capo** in tre righe: Salva+Chiudi, poi Aggiungi e Annulla a tutta larghezza, come prima della cura; · **PROD 6.373** (viva dalle 10:35:10 UTC), sulla partita che lui ha autorizzato — **lunedì 7 settembre, 09:00, Campo 4, Lidia Comes · Fabiola Limuti · due Ospiti**: quattro bottoni sulla stessa riga, conto sopra (A carico 32,00 €), piè dentro il pannello con 11 px, «Annulla» a **486 px** da «Salva»; e su una seconda partita vera dello stesso giorno (18:00, quattro soci) le stesse misure con 884 px. · **E la MIRA misurata**, non dedotta: tutti e quattro raggiungibili da `elementFromPoint` al **centro e ai due angoli opposti**, tutti abilitati, **229 px** fra «Aggiungi» e «Annulla» contro i 14 fra i bottoni innocui — la distanza è la protezione, ed è misurata. 🧪 Banco **75 verdi / 0 rossi** (erano 74) col file nuovo `test/i-bottoni-stanno-nel-pie.test.mjs`, **12 casi**, visto **rosso con sei sabotaggi**: barra incartata in un `<div>`, conto rimesso sotto il piè, «Annulla» senza `margin-left:auto`, piè senza `grid-column`, «Aggiungi» in doppia copia, regole del telefono nude. ⛔ **COSA NON È STATO PROVATO, e non si dia per fatto**: **nessun gesto che scrive è stato portato a termine** — la console remota entra in sola lettura, quindi «Salva», «Annulla prenotazione» e «Aggiungi giocatore» non sono stati **premuti** né su TEST né su PROD. Quello che è provato è che stanno dove devono, che nessuno li copre e che rispondono al puntatore; che *facciano* ancora la loro cosa lo dice il fatto che **nessuna riga del loro comportamento è stata toccata** — solo la posizione e le classi — ma è un ragionamento, non una misura. E la scheda della **manutenzione** (che non ha giocatori, quindi niente «Aggiungi») non è stata riaperta dopo la cura. |
| **166** | 📐 **LA SCHEDA «NUOVA PRENOTAZIONE» È TROPPO ALTA: aperta, non si vedono tutti gli elementi.** 🗣️ **Voce SUA, 06/09/2026 mattina**, con uno screenshot di PROD **6.367** (Chrome sul Mac, finestra ~1850×1130 px): *«ottimizzare la visualizzazione della scheda nuova per prenotare una partita o una lezione perché è troppo grande e non si vedono tutti gli elementi quando la apri»*. 📏 **Cosa si vede nello screenshot, e solo quello**: la scheda parte sotto la barra dell'app e arriva al fondo della finestra; dentro ci stanno Campo (4 bottoni larghi), Ora inizio · Durata, «Fine prevista», Tipo (4 bottoni larghi), Giocatori e l'inizio di Note — quello che sta **sotto Note** (i bottoni di conferma) è **fuori dallo schermo**, e per arrivarci si scorre dentro la scheda. E una cosa che si vede solo guardando: **due cornici e due ✕** — una ✕ in alto a destra del contenitore esterno e un'altra sulla riga del titolo «Nuova prenotazione»: la scheda sta **dentro** un secondo riquadro che le ruba ~50 px sopra e ai lati. 🔨 **Cosa serve**, da misurare sulla pagina viva: ① una cornice sola (e una ✕ sola); ② i controlli più bassi — Campo e Tipo sono quattro bottoni da 60 px d'altezza ciascuno, Giocatori e Note hanno margini larghi; ③ i bottoni di conferma **sempre visibili** (piè di pagina fisso della scheda), così scorre il contenuto e non il «Salva». 🗣️⭐ **E la forma da prendere l'ha detta lui, un minuto dopo**: *«fai come hai fatto quando apro una scheda di una partita già completa di dati»* — cioè il modello è la **scheda della partita esistente** (quella che si apre dal calendario su una prenotazione piena), non un disegno nuovo: stessa compattezza, stessa cornice. ⛔ **Non è iniziata**: nessuna riga toccata. Si fa su `test-preview` guardando con la console remota **alla misura del suo schermo**, poi si promuove per righe. Vale per partita **e** lezione, come dice lui. ✅📏 **CURATA LA MATTINA STESSA (92ª) — TEST 6.371, PR verso `main` aperta.** Due cause, tutte e due nel codice: ① `svcOpenBookingCard` scala i corpi sulla **larghezza del contenitore** (compatto a 320px, comodo a 560px — misure nate per la sidebar e il foglio del telefono), e dal 04/09 il pannello desktop è una finestra da **620-1180px** ⇒ usciva sempre la taglia da telefono (titolo **29px**, controlli **24px**); ② colonna unica. 🔨 Su desktop (≥900px, la soglia di tutta l'app): taglia compatta come la scheda partita; **due colonne** (a destra giocatori e note, `.svc-flow-dx` come `players-payments` nella 152), piè a tutta larghezza; in modalità scheda la testata del pannello sparisce ⇒ **una ✕**. 📏 **Misurato con la console remota** a 1850×1130 (la sua finestra) e a 1480×780: scheda **372 px** (PROD 6.369: **805**), titolo 15px (era 29), controlli 14px (era 24), ✕ **1** (erano 2), «Conferma» in vista senza scorrere. 🩹 E lo screenshot ha trovato un secondo difetto: «Manutenzione» usciva **«Manut.»** in una colonna da 480px, perché il taglio guardava `_t` (ora sempre 0 su desktop) — corretto sulla larghezza vera della riga (2de9a0f). 📏 **E DOPO LA SUA CORREZIONE («guarda che ti mancano dei dati») la scheda è stata esercitata nei suoi STATI su PROD 6.371, con la console**: Lezione ⇒ compare **Maestro** (LoZio · Spinazze · Lucas Vidal) nella colonna sinistra e «Giocatori» diventa «Allievi», la durata scende a 60′; un nome scritto («apr») ⇒ i **suggerimenti** (sei, con livello e ID/«senza ID») si aprono nella colonna destra e la scheda cresce da 372 a **501 px** senza uscire dal pannello; un suggerimento toccato ⇒ la **pastiglia** con la ✕, scheda di nuovo a 372. Manutenzione ⇒ Giocatori sparisce. Nessun elemento della scheda vecchia manca: sono gli stessi campi, nello stesso ordine, su due colonne. ⏳ **Resta aperta per la prova sul SUO schermo**, su PROD dopo il merge: la console ha misurato pixel a due misure di finestra, non il suo zoom (nello screenshot Chrome era ingrandito: è per quello che a lui i bottoni finivano sotto e alla console a 1130 no). ✅⭐⭐ **CHIUSA IL 06/09/2026 (93ª sessione), a PROVA SUA sullo schermo suo, su PROD 6.371.** 🗣️ Parole sue: *«La nuova scheda prenotazione mi va bene»* ⇒ l'unica cosa che restava — il suo zoom, che la console non ha — è stata guardata da lui, ed è quello per cui la voce era rimasta aperta. |
| **161** | 🩺 **UNA SENTINELLA DELLA SALUTE DEL DATABASE — che avrebbe suonato a metà luglio.** 🆕 *Entrata il 05/09/2026 pomeriggio, nata dalle misure dell'avaria (voce 160) e dalle sue parole («metterai le giuste correzioni»).* 📏 Il difetto della 160 era **visibile da settimane** in tre numeri che nessuno guardava: `n_tup_upd` di `pmo_cloud_records` (14 milioni su 31 mila righe), `n_tup_hot_upd` a **zero**, e **62 GB di WAL** per un database da 685 MB — un rapporto WAL-su-DB di **90 a 1**. Nessuna di queste misure è un'opinione, e tutte e tre stavano in `pg_stat_user_tables` e nei contatori di Supabase. 🔨 **Cosa serve**: una misura **giornaliera** — `n_tup_upd`/`n_tup_ins` per tabella, WAL prodotto, rapporto WAL-su-DB, RAM della macchina — con un **avviso oltre soglia** su Telegram, sulla stessa strada della sentinella della freschezza di TEST (`tools/sentinella-freschezza-test/`, che già sa parlare col bot di prova e già gira sulla VM fuori da pm2). ⚖️ **La forma giusta è un delta, non un totale**: `pg_stat` si azzera a ogni riavvio (il 05/09 è ripartito da 63), quindi la sentinella deve ricordare la lettura di ieri e suonare sulla **differenza**. ⛔ **Cosa NON è**: non è un cruscotto da guardare — è un avviso che arriva quando nessuno sta guardando, che è esattamente quando la 160 è cresciuta. 📌 *Una misura che esiste ma che nessuno legge protegge quanto una misura che non esiste.* ✅⭐⭐ **COSTRUITA E IN SERVIZIO dal 06/09 notte** (`tools/sentinella-salute-db/`, workflow *Sentinella salute database*, giro automatico alle **05:20 UTC** = 07:20 a Roma). 🔨 **Come è fatta**: un modulo puro (`misura.mjs`) che riceve due letture e torna un verdetto, il giro che parla col database e con Telegram, e un **banco da 16 corse**. La memoria sta **nella tabella `pmo_sentinella_salute` del database che guarda** (migrazione applicata su `cudi…` e `qqbf…`, RLS accesa senza policy, una riga al giorno, si cancella dopo 400 giorni): su Actions un «accanto» che duri non c'è, e se il database è morto la sentinella non legge ⇒ esce **cieca**, che è l'unica cosa onesta da dire quando non si è guardato. 🚨⭐ **Ogni regola dichiara SE ha potuto giudicare, e «non-giudicata» non è mai «a-posto»**: i **ritmi** (WAL al giorno, amplificazione) sotto una finestra di 30 minuti moltiplicherebbero il rumore per settecento, quindi si astengono; i **rapporti** (HOT, tuple morte) valgono su qualunque finestra popolata. La corsa che lo dimostra è al banco: **stessi identici numeri, finestra di 2 minuti contro 24 ore, esiti opposti**. 🔎⭐ **E IL BANCO HA CORRETTO UNA SOGLIA, che è la cosa da sapere**: la prima stesura si aspettava che la 160 la prendessero *due* regole. Non è così — 400 mila aggiornamenti al giorno su 31 mila righe sono ~13 volte, **sotto** la soglia di 30 dell'amplificazione, ed è il ritmo a cui la 160 è cresciuta per settimane. ⇒ **A prendere quel difetto è l'HOT, da sola.** La soglia resta 30 (serve a un giro impazzito, che è un'altra malattia) ma andava saputo: *una guardia di cui si crede il falso è peggio di una guardia in meno, perché ci si conta sopra.* ⚖️ **Gira su Actions e NON sulla VM, all'opposto della sorella e per una ragione detta**: quella sorveglia la sincronia, che gira su Actions; questa sorveglia **Supabase**, quindi l'argomento non si applica — e cade a favore, perché leggere `pg_stat_user_tables` e `pg_ls_waldir()` vuole una credenziale di **amministrazione**, che su Actions c'è già e non esce mai, mentre sulla VM sarebbe una chiave capace di cancellare il database posata accanto ai due bot. ⛔ Il prezzo, detto: se Actions è in avaria tace (una misura, non di più: il delta si normalizza sul **tempo**, non sui giri) e gli schedule si spengono dopo ~60 giorni di repo fermo — cosa che si vede perché smette di arrivare il **battito** settimanale. 📏 **PROVA FISICA, quella che vale**: `--prova` dal workflow ha mandato **un messaggio vero** il 05/09 alle 22:50:52 UTC — `voce = @padelvillage_prova_bot, chat = impostata` → `📨 messaggio mandato`. E la prima lettura di PROD è **nella storia** (riga 1, 22:44:06 UTC, `verdetto: serena`, i tre ritmi `non-giudicata` con motivo `prima-misura`): ha misurato **e** ha ricordato, che sono due cose diverse. 📏⭐⭐ **E LA SECONDA LETTURA HA FATTO IL RESTO — il delta esiste, e ha TROVATO QUALCOSA al primo giro in cui poteva.** Riga 2, 23:16:10 UTC, finestra di **32 minuti** su PROD: `verdetto: allarme`, con **due** regole che suonano — `wal-al-giorno` (**11 GB al giorno su 687 MB, 16,7 a 1**) e `amplificazione` (`pmo_staff_profiles`, **1617× le sue 4 righe**). ⇒ È nata la **voce 165**, che non è un'idea di fine giornata: è ciò che la sentinella ha misurato. 🚨⭐ **E la PAZIENZA si è vista reggere, che è la metà difficile**: `consecutivi: 1`, `allarme_attivo: false`, `mandati: []` — la sentinella ha giudicato «fuori riga» e **NON ha mandato niente**, perché ne vuole **due di fila**. Un allarme al primo scarto è una guardia che si smette di leggere. 🔎 E la regola `hot` è uscita **`non-giudicata`** con motivo *«nessuna tabella ha superato 500 aggiornamenti nella finestra»*: su 32 minuti non aveva i numeri per pronunciarsi, e **l'ha detto** invece di rassicurare. È esattamente il comportamento per cui la distinzione esiste. ⏳ **RESTA APERTA per UNA cosa sola, ed è dichiarata**: **il messaggio d'allarme non è ancora partito.** Manca la seconda lettura fuori riga, che arriva col **giro automatico delle 05:20 UTC** (07:20 a Roma): lì `consecutivi` diventa 2 e il messaggio parte — e su una finestra di sei ore anche la regola `hot` avrà i numeri per pronunciarsi. ⇒ **La voce si chiude quando quel messaggio è arrivato sul telefono**, non prima. ⚖️ Quello che è già provato non è poco, e va tenuto distinto: la sentinella **misura** (due database), **ricorda** (due righe nella storia), **giudica** (due allarmi veri su dati veri), **tace quando deve** (pazienza) e **sa parlare** (messaggio del `--prova` consegnato). Quello che manca è l'ultimo anello, ed è l'unico che non si può fabbricare senza falsare la prova. 🔄⭐⭐ **06/09 MATTINA (92ª): L'ALLARME È PARTITO — e guardarlo ha trovato DUE difetti nella sentinella stessa, curati la mattina stessa.** Alle 09:11 UTC in Actions non c'era nessun run `schedule` e la storia aveva due righe: il giro delle 05:20 **non era partito**. Lanciato a mano alle 09:12 (`workflow_dispatch`, prod): riga 3, `consecutivi: 2`, `mandati: ["allarme"]`, `📨 messaggio mandato` nel registro — Telegram ha **accettato** il messaggio d'allarme (`hot` + `wal-al-giorno`, finestra 9,95 h). Poi, alle **09:26:40 UTC**, GitHub ha fatto partire il giro `schedule` delle 05:20 — **4 h 06′ dopo l'ora del cron** — che ha scritto la riga 4 (`consecutivi: 3`, niente mandato: allarme già attivo). ⇒ Il cron **scatta**, ma GitHub può ritardarlo di ore; il delta si normalizza sul tempo, quindi la misura non ne soffre. 🚨⭐⭐ **I due difetti**: ① il «16,7 a 1» era l'**LSN**, non il WAL scritto — `archive_timeout` = 120 s chiude un segmento da 16 MB ogni due minuti pieno o vuoto, 720 al giorno = 11,5 GB *per costruzione*; misurato con due campioni a 2′15″: LSN +16,7 MB, `pg_stat_wal` +93 KB. Quella regola avrebbe suonato **per sempre**; ora giudica su `pg_stat_wal.wal_bytes`. ② un solo `allarme_attivo` per giro: con l'HOT fermo in allarme — e su `pmo_cloud_records` lo è **per costruzione**, il trigger `pmo_touch_updated_at` tocca `updated_at` che è indicizzato — un guasto **nuovo** non avrebbe mandato **niente**. Ora gli allarmi sono **per regola** (`evolviRegole`), con la regola nuova **`archiviazione`** (`pg_stat_archiver`) che prende la 160 per nome 17 ore prima degli 8 GB. 📏 Banco **29/29** (erano 16), query nuova eseguita su PROD, giro `--muto` da Actions col codice di `test-preview` sul database vero: `attivi=hot` ereditato dalla riga vecchia, `archiviazione: 642 segmenti archiviati`. Codice: `test-preview` `bf33565`, PR **#1404** verso `main`. ⏳ **RESTA APERTA per due cose**: il primo giro automatico col codice nuovo deve mandare il **rientro** di `wal-al-giorno` — sarà il messaggio *per regola* visto passare, e chiude la voce; e il committente deve dire di aver **visto** l'allarme delle 09:13 sul telefono: da qui si vede l'accettazione di Telegram, non lo schermo. ✅⭐⭐ **CHIUSA IL 06/09/2026 (93ª sessione), e la prova è arrivata da DUE lati.** 🗣️ **Lui**: *«mi è arrivata la sentinella»* ⇒ l'ultimo anello — il messaggio sul telefono — è chiuso, e con esso quello che la voce aspettava dal 05/09. 📏 **E il codice nuovo è stato visto GIUDICARE e MANDARE sul vivo**, con due giri lanciati apposta (10:03:15 e 10:34:51 UTC, finestra di 31′): ① `wal-al-giorno` è tornato **a-posto** con la misura giusta — **702 MB/giorno scritti, 1,0 a 1**, con l'LSN riportato accanto in segmenti (729 da 16 MB, «chiusi a tempo, non riempiti»): la regola che avrebbe suonato per sempre adesso tace, ed è la cura ① di stamattina; ② la regola nuova **`archiviazione`** ha giudicato per la prima volta (`676 segmenti archiviati, ultimo alle 10:34:42`); ③ 🚨⭐⭐ **e la cura ② si è vista funzionare nell'unico modo in cui si poteva vedere**: `amplificazione` è passata a `di_fila: 2` e ha fatto partire un allarme (`mandati: ["allarme"]`) **mentre `hot` era già attivo da cinque giri**. Col codice vecchio — un solo allarme per giro — quel messaggio **non sarebbe partito**: è esattamente il guasto nuovo che restava muto, preso su un caso vero e non fabbricato. 🩹⭐ **E UNA RIGA DI QUESTA SCHEDA ERA SBAGLIATA NEL MOMENTO IN CUI È STATA SCRITTA, e va detto**: qui c'era *«la voce si chiude quando arriva il **rientro** di `wal-al-giorno`»*. Quel rientro **non poteva arrivare**: passando agli allarmi per regola, `evolviRegole` ha tradotto le righe vecchie mettendo `wal-al-giorno` a `attivo: false` — per lo stato per-regola quell'allarme non era più in piedi, quindi non c'era niente da cui rientrare. ⇒ La condizione di chiusura scritta stamattina descriveva un meccanismo che la cura della stessa mattina aveva già cambiato. 📌 *Una condizione di chiusura si rilegge dopo la cura: è la cura a decidere che forma avrà la prova, non il contrario.* ⛔ **Cosa NON è provato, e non si dia per fatto**: il **rientro** (allarme → a-posto con messaggio) non l'ha ancora visto passare nessuno, perché nessuna regola è tornata a posto **da attiva**; e il **battito** settimanale (7 giorni senza messaggi) non è mai scattato. Tutti e due arriveranno da sé. |
| **169** | ✅ *(06/09/2026 pomeriggio, 94ª sessione — CHIUSA a PROVA FISICA sulla pagina viva di TEST **e** di PROD 6.382, alla misura in cui il difetto esiste, dopo **tre** versioni della cura buttate)* 🪟 **169. IL MAESTRO SCRITTO DUE VOLTE, I NOMI TAGLIATI A METÀ RIGA, E UN BANNER DI TROPPO.** 🗣️ Sua segnalazione con due schermate di PROD 6.377: *«Ci sono ancora degli errori sulla visualizzazione del calendario e sui messaggi quando clicco su salva. Troppi banner di messaggi.»* ⭐ **Messo davanti a quattro candidati ne ha indicati DUE** — il maestro ripetuto e i nomi tagliati — e ha **escluso** il quadratino verde stretto (*«è giusto»*: è una mezz'ora libera) e il frammento «ero» del primo riquadro. 📌 *Una domanda da quattro righe ha risparmiato un giro intero speso sulla cosa sbagliata — e le due che ho scartato io le avevo trovate per prime.* **① IL MAESTRO NON È ANCHE UN GIOCATORE DI SÉ STESSO.** 📏 Sul dato vero di PROD: `istruttore "Lucas Vidal"`, `giocatori [ "Andrea Bigaran", "lucas vidal" ]` ⇒ Matchpoint mette il maestro **anche** nel roster, con un'altra scrittura del nome. 🚨 **Una guardia c'era e non poteva scattare, per due ragioni insieme**: guardava `b.nome`, il ripiego usato *solo a elenco vuoto* (e qui non lo era), e confrontava con `!==`, cioè lettera per lettera. *Una guardia sul ramo che non si percorre, con un confronto che la differenza vera non la vede: due modi di non esserci, nello stesso `if`.* ⛔ Si potano **solo le lezioni**: in una partita un omonimo del maestro verrebbe cancellato dal campo. **② I QUATTRO NOMI SI DEVONO VEDERE — e ci sono volute TRE versioni, ognuna smentita da una MISURA e non da una rilettura.** 📏 Il difetto esiste solo alla sua misura: a **1490×880 non sborda niente** (14 riquadri su 14) e una prova lì avrebbe detto «funziona»; a **1490×810** `laneH` scende a 97 e **5 riquadri su 14** tagliano un nome in mezzo, da 11 a 17 px. *La stessa pagina, due altezze di finestra, due verità.* ⛔ **Non** si alza `laneH`: alzarlo rimetterebbe C4 sotto il bordo, cioè il guasto chiuso dalla 153/C. 🩹 **v1** — mostravo solo righe intere e mettevo un «+N» su una riga sua: su TEST 6.379 il riquadro delle 18:00 di C2 dava **un** nome e `+3` dove prima se ne leggevano **tre**. *Per togliere mezzo nome ne toglievo due interi.* 🩹 **v2** — spostato il contatore accanto all'orario, ma la misura era sbagliata: mescolavo `offsetTop`, che parte dal **bordo**, con `clientHeight`, che il bordo **non lo conta**, e sbagliavo di **una riga intera**. E il bordo non è nemmeno costante: una **partita aperta** lo ha di 2px tratteggiati. *Due misure giuste prese da due origini diverse fanno una differenza sbagliata.* 🩹 **v3** — contavo anche l'**interlinea**, e nascondevo un nome leggibilissimo per **1,5 px** su una riga alta 15,6, lasciando 16 px di vuoto sotto. *La soglia giusta non è un numero scelto: è il bordo dell'oggetto di cui si parla* — si misura il fondo delle **lettere**. 🚨⭐⭐ **E LA v3 ERA ANCORA SBAGLIATA NEL DISEGNO, l'ha detto LUI guardando PROD 6.381:** *«Nel calendario di prod continuano a vedersi sempre tre giocatori su quattro.»* ⚖️ Aveva ragione: il `+1` **dichiara** il nome che manca, ma lui il nome lo vuole **leggere**. Avevo curato il sintomo che avevo scelto io — *il nome tagliato a metà* — invece della cosa che gli serve: **vedere chi gioca**. 📌 *Dichiarare un'assenza non è toglierla.* ✅ **v4, in servizio**: prima si prova a farceli **stare** — le righe si stringono per gradi (12/13 → 11 → 10 → 9, font e interlinea) e ci si ferma al **primo grado in cui ci stanno tutti**; il taglio con «+N» resta come **ultima spiaggia**, e chi già ci sta non si tocca. Un giro per **grado** e non per riquadro, o la pagina si ricalcolerebbe una quarantina di volte a ogni sync. **③ «RIPRENDO UNA VERIFICA» SOLO NELLA BARRA — sesto giro sullo stesso difetto** (dopo 134 · 136 · 137⑤ · 145 · 147 · 150). 📏 Misurato chiamando `pmoVerificheAvvisa` sulla pagina viva e **contando le superfici**: la frase esce in chat **e** nella barra, e scappa a tutte e cinque le guardie precedenti — `svcMessaggioVaSoloNellaBarra` **false**, `svcEAvanzamentoInCorso` **false** perché pretende il «(non chiudere)» che questa frase non ha ⇒ anche la **pastiglia** poteva alzarsi sopra la stessa frase. Ed è un avanzamento che esce **uno per tentativo**. ⛔ I due **esiti** restano in chat, ed è la metà che conta: «È stata creata» e «NON è stata creata, lo slot è libero» servono anche cinque minuti dopo — e con loro «non riesco ancora a raggiungere Matchpoint», che comincia come un avanzamento ma è un **esito**. 🩹⭐⭐ **E IL BANCO ERA PIÙ DEBOLE DI QUANTO CREDESSI — l'ha detto il SABOTAGGIO.** I tre casi che dovevano difendere i gradi **non erano mai entrati nel file**: la `replace` che li inseriva non trovava il testo e, non trovandolo, **non ha protestato**. ⇒ Ho sabotato tre volte (gradi tolti · gradi non applicati · primo grado non più «com'è») e il banco è rimasto **verde tutte e tre**. 📌 *Uno strumento che non trova il suo bersaglio e tace dice «a posto» esattamente come uno che ha guardato* — è la **24ª** applicata al banco invece che al codice. ✅ **LE PROVE, e su quale ambiente ciascuna.** 🧪 Banco `nessun-nome-tagliato-a-meta` (**23 casi**), funzioni **eseguite** e non rilette, **sabotato 20 volte** in tutto su copie: cade tutte e 20; tutti i **77** banchi verdi. 📏 **TEST 6.382** a tre altezze (810 · 740 · 680): **0** righe tagliate in tutti e tre i casi, e i riquadri da quattro giocatori mostrano **tutti e quattro** i nomi, senza nessun «+N». 👁️ Guardato **a schermo**, non solo contato. 📏 **PROD 6.382**: stessa misura, stesso esito. 📏 **PROD, i messaggi**: tre avanzamenti di fila hanno aggiunto **0** messaggi in chat (prima: uno per tentativo), i due esiti ci sono **tutti e due**, pastiglia **spenta**. ⛔ **COSA NON È PROVATO**: nessun gesto che **scrive** è stato premuto — la console entra in sola lettura ⇒ è provato che i riquadri mostrano i nomi giusti e interi, **non** che «Salva» porti a termine il suo gesto. 📄 PR #1413 e #1414. |
| **120** | ✅ *(06/09/2026 pomeriggio, 94ª sessione — CHIUSA a SUA PAROLA, dopo che la ricerca aveva escluso tutto ciò che si poteva escludere)* 🖱️ **120. IL GESTIONALE FA SALTARE LA PAGINA IN CIMA MENTRE SI SCRIVE IN UNA SCHEDA.** 🗣️ Messo davanti alla domanda che era rimasta l'unica cosa capace di sbloccarla — *in quale schermata* succede — ha risposto: **«NON SUCCEDE PIU»**. ⇒ La voce si chiude perché **il difetto non c'è più**, non perché si è smesso di cercarlo. 📏 **E la ricerca aveva già tolto di mezzo tutto quello che si poteva togliere**, il che è la ragione per cui quella risposta basta: ① 45 secondi di scrittura vera nelle Note, a 1280×720 (dove la scheda sborda davvero), con una spia su `window.scrollTo`, `scrollIntoView` e il **setter di `scrollTop`**, su TEST **e** su PROD ⇒ scroll **fermo al pixel**, fuoco mai perso, **zero** eventi; ② l'unica ipotesi in piedi — *«l'app si ricostruisce da sola ogni pochi secondi»*, misurata il 05/09 come «due riscritture di `#staffCalGridTable` in 25 secondi» — **non si riproduce più**: 90 secondi in tre condizioni, con un observer su **tutto `document.body`** attaccato **dopo** il render (la prima sonda restava appesa a un nodo sostituito), **griglia 0 · 0 · 0, scheda 0 · 0 · 0**; ③ la riga *«con l'utenza di sola lettura non si può mettere in scena»* era **vecchia**: vera della scheda socio, falsa della scheda «Modifica prenotazione», che ha **6 campi scrivibili** anche per il `readonly`. 📌 *«Non si può provare» va sempre completato con «quale scheda»* — ed è lo stesso difetto di forma che questa voce si portava dietro dall'inizio. ⚖️ **Perché la sua parola qui vale come una misura**: la voce nasce da un suo *«spesso e volentieri»*, cioè da qualcosa che **solo lui** vedeva e che nessuna sonda è riuscita a far succedere; il testimone che l'aveva visto è lo stesso che adesso dice che non c'è più. 🩹 **Cosa NON si sa, e va scritto**: **quale** cura l'ha tolto. Fra il 01/09 e oggi sono passate la 127 (il tetto dello scroll), la 134 (`soloInGiu`, che toglieva lo strappo all'indietro), la 157 e la 168 — una di quelle l'ha quasi certamente chiuso di rimbalzo, e non si può dire quale. *Un difetto che sparisce senza che si sappia perché non è una vittoria: è una voce chiusa con una porta lasciata accostata.* ⇒ Se torna, si riapre. 📄 La scheda com'era, per intero: 🖱️ **IL GESTIONALE FA SALTARE LA PAGINA IN CIMA MENTRE SI SCRIVE IN UNA SCHEDA** — 🗣️ **voce SUA**, 01/09 notte: *«quando apro dal gestionale una scheda e poi vado a scrivere, spesso e volentieri scrolla verso l'alto in automatico»*. ⚠️ **«Spesso e volentieri», non sempre** ⇒ è la forma di difetto che rileggendo il codice non si trova: va cercato **cosa** riporta il fuoco o rilancia il render mentre si digita (un `focus()`, uno `scrollIntoView`, una lista che si ricostruisce a ogni tasto), e la domanda si chiude solo **guardando la pagina viva** — sul suo schermo o con `tools/verifica-browser`. ⛔ **Nessuna causa ipotizzata qui, ed è voluto**: scriverne una farebbe cercare quella invece del difetto. 📌 Costa a **ogni** modifica normale della segreteria, ma non perde dati: sta in coda e non in urgenti. 🔎 **CERCATA SULLA PAGINA VIVA il 05/09 a notte, con la console remota, e sono usciti DUE fatti — nessuno dei due è una causa, e vanno letti per quello che sono.** ⛔ **① Con l'utenza di SOLA LETTURA il difetto non si può nemmeno mettere in scena**: aperta una scheda socio vera su PROD, la scheda si apre ma **non contiene un solo campo di testo** (misurato: `0` fra `input` e `textarea` visibili in tutta la pagina). ⇒ *«vado a scrivere» non è esercitabile da lì*, e questo non è un limite del difetto ma dell'attrezzo: la console autorizzata monta un ruolo `readonly`, e i campi in cui si scrive per quel ruolo **non vengono disegnati**. È la lezione della 89ª applicata qui — *«non si può provare» va sempre completato con «da dove»*: da qui no, dal suo schermo sì, e da una console con un'utenza che può scrivere anche. ⚠️ **Quell'utenza non esiste** e crearla è una decisione, non un passo. 📏 **② A RIPOSO, senza che nessuno tocchi niente, l'app si ricostruisce da sola**: in 25 secondi fermi, **due** riscritture di `#staffCalGridTable.innerHTML`, per la strada `staffCalRefreshFromCloud → renderStaffCalendar → _staffCalBuildHorizontal` (pila catturata, non dedotta). ⇒ Esiste **un** meccanismo che rifà il DOM da sé, a intervalli, ed è il genere di cosa che produce uno «spesso e volentieri». ⛔ **Ma NON è ancora la causa, e va detto**: perché lo diventi bisogna vedere che il campo in cui si scrive sta **dentro** ciò che viene rifatto, e quella metà non è stata guardata. Scriverla come causa farebbe cercare quella invece del difetto — che è la ragione per cui questa scheda nasce senza ipotesi. Non scavalca niente. 🔎⭐⭐ **06/09 POMERIGGIO — CERCATO DI NUOVO, E STAVOLTA IL DIFETTO SI PUÒ METTERE IN SCENA. Non si riproduce, e il fatto ② qui sopra NON REGGE PIÙ.** 🩹 **① La riga «con l'utenza di sola lettura il difetto non si può nemmeno mettere in scena» è VECCHIA e va corretta.** Era vera della **scheda socio**; ma la scheda **«Modifica prenotazione»** ha campi scrivibili anche per il `readonly`: misurati **6** su PROD (la casella Note più cinque importi). ⇒ *«Non si può provare» andava completato con «quale scheda», non solo con «da dove».* 📏 **② IL DIFETTO NON SI RIPRODUCE SCRIVENDO NELLE NOTE.** Prova: aperta una partita vera cliccando il calendario, portata la chat in fondo, messo il fuoco nella casella Note e scritta **una lettera ogni 1,5 s per 45 secondi**, con una spia installata su `window.scrollTo`, `Element.scrollIntoView` e il **setter di `scrollTop`** (che registra chi lo muove e con quale pila). Esito, su **TEST 6.374** *e* su **PROD 6.373** (la partita del 7/09 · 09:00 · C4): lo scroll resta **fermo al pixel** per tutto il tempo (136 → 136), il fuoco **non si perde mai**, la casella **non viene mai sostituita**, e la spia registra **zero** eventi. ⚠️ Provato a **1280×720**, cioè con la scheda che **sborda davvero** (`scrollMax` 136): a 1850×1130 la scheda ci sta tutta e non c'è niente da scorrere, quindi lì la prova non direbbe niente — ed è la stessa trappola della 127. 📏 **③ E LA PAGINA, a quella misura, NON SCORRE AFFATTO**: `scrollHeight − innerHeight = 0`. ⇒ Su quel formato *«salta in cima»* **non può** essere la pagina, perché non c'è nessun «giù» da cui tornare. 🚨⭐⭐ **④ IL FATTO ② DI QUESTA SCHEDA NON SI RIPRODUCE PIÙ, ed è la cosa che cambia dove cercare.** Il 05/09 erano state misurate *«due riscritture di `#staffCalGridTable.innerHTML` in 25 secondi fermi»*. 📏 Rimisurato il 06/09 su PROD con un observer su **tutto `document.body`** (attaccato **dopo** il render, perché la prima versione della sonda restava appesa a un nodo sostituito — difetto mio, trovato e corretto), in **tre** condizioni da 30 s l'una: *a riposo senza scheda*, *scheda aperta e nessuno tocca niente*, *scheda aperta e si scrive*. **Griglia rifatta: 0 · 0 · 0. Scheda ricostruita: 0 · 0 · 0.** ⇒ Fra il 6.365 e il 6.373 quel rifacimento periodico **non c'è più**, o dipendeva da una condizione che oggi non c'è. **L'unica ipotesi in piedi è caduta**, e va detto invece di lasciarla lì a farsi cercare. ⇒ **COSA RESTA DA CHIEDERGLI, ed è una domanda sola**: *in quale schermata* gli succede — la scheda della **prenotazione**, la **scheda socio**, l'**Anagrafica**, gli **Incassi**? Perché sulle prime due, a ogni misura fatta finora, non succede; e le altre due sono pagine che **scorrono davvero**, quindi sono le uniche in cui «tornare in cima» ha un senso fisico. ⛔ Fino ad allora **nessuna causa nuova viene scritta qui**, che è la regola con cui questa scheda è nata. |
| **162** | ✅ *(06/09/2026 notte, 91ª sessione — CHIUSA a PROVA PROVOCATA sulla pagina viva di TEST 6.370: il backoff che «non era stato visto» è stato fatto succedere invece che aspettato)* 🚦 **162. IL POLLING DEL SEMAFORO CHIEDEVA OGNI 4 SECONDI ANCHE A UN GESTIONALE CHE RISPONDEVA IN 100.** 📏 Il difetto, misurato alle 06:30 del 05/09 con PROD in ginocchio (voce 160): `setInterval` a passo fisso non aspetta la risposta precedente ⇒ **129 chiamate in 10 minuti** dalle sole pagine della console remota, risposte da **100 s**, **23 chiamate sovrapposte** in volo sullo stesso database che stava già morendo. *Un polling a passo fisso è un moltiplicatore del guasto: cresce proprio quando il sistema rallenta.* 🔨 **La cura**, in servizio dal 05/09 sera su TEST e PROD **6.369**: niente più `setInterval` — il giro successivo parte nel `finally`, **dopo** la risposta; il passo lo decide `svcProssimoPasso` (pura): più lenta del passo ⇒ raddoppia fino a **32 s**, veloce ⇒ torna **subito** a 4; scheda nascosta non chiede. 🎯⭐⭐ **LA PROVA CHE MANCAVA, e la scheda diceva che non si poteva fare.** Qui c'era scritto: *«il backoff non è stato visto sul vivo: vuole un gestionale lento, e oggi risponde in un secondo. Si chiude quando `function_edge_logs` mostra i passi allungarsi durante una lentezza vera»*. ⇒ **La lentezza non è stata aspettata: è stata FABBRICATA nel punto in cui il codice la legge** — un ritardo messo su `window.fetch` **dentro la pagina**, che risponde sempre un secondo più del passo corrente. È la manovra della **72**, spostata dalla edge al browser: si tocca il **filo**, mai la regola. 📏 **E il passo non è stato dedotto dagli intervalli: è stato LETTO**, spiando cosa `svcGiroDiPolling` passa a `setTimeout`, cioè il numero vero che il codice ha scelto. **La salita**: `8000` → `16000` mentre le risposte tardavano. **La discesa**: `4000`, al primo giro in cui il gestionale è tornato veloce — non a scalare, **subito**, che è la metà della regola che protegge dal peggiorare l'esperienza quando tutto va bene. E **chiamate sovrapposte: 0**, che è la regola ① vista reggere. 🔬 Il **tetto** e la regola completa sono stati chiesti alla funzione **in servizio nella pagina**, non a una copia: `(100ms, 4s)→4000` · `(5s, 4s)→8000` · `(9s, 8s)→16000` · `(60s, 32s)→**32000**` · `(1s, 32s)→4000`. ⛔ **Cosa questa prova NON dice, e va detto**: la lentezza era **fabbricata**, non un gestionale davvero in ginocchio — le durate misurate dal codice erano vere, la loro **causa** no; e la salita è stata cavalcata fino a **16 s**, mentre il tetto di 32 s è stato verificato chiamando la funzione, non salendoci sopra. ⚖️ È lo stesso metro con cui è stata chiusa la **72** la notte prima, e regge per la stessa ragione: *due corse che DISCRIMINANO — la stessa identica pagina, lenta e poi veloce, con passi opposti — valgono più di dieci che confermano.* 📌 *«Non si può provare» va sempre completato con «da dove»: da un'avaria vera no, ma dal punto in cui il codice legge la durata sì.* |
| **72** | ✅ *(06/09/2026 notte, 90ª sessione — CHIUSA a PROVA PROVOCATA sul bot vivo di TEST, con lo stesso codice d'errore fatto cadere nei DUE modi opposti)* 🎯⭐⭐ **LA PROVA CHE MANCAVA — «la cura non l'ha ancora vista succedere nessuno» — È STATA FATTA, e con una misura che DISCRIMINA invece di confermare.** Su TEST un rifiuto del worker non si può ottenere (fuori dalla produzione il worker non si chiama), quindi lo si è **provocato**: `matchpoint-bookings-create` di TEST sostituita per ~15 minuti da uno stub che sta **dentro il recinto** — stessa condizione `!scritturaAlCircoloConsentita`, worker mai chiamato, e su PROD quel blocco non esisterebbe nemmeno — e mette al posto della risposta del worker il corpo **VERO** del 22/08: `SAVE_BUTTON_NOT_FOUND` con gli step che finiscono in `save_button_not_found`. ⭐ Fra le due corse cambia **UNA riga**: `{ action: 'save_attempt' }` fra i `navigationAttempts` — cioè **la crepa che la cura ha inventato**. ⇒ Stesso codice, due verdetti opposti, due frasi opposte sullo schermo del socio, misurate: · **senza** `save_attempt` (fallimento CERTO → `WORKER_ERROR` → `scrittura_rifiutata`) → *«Non sono riuscito a prenotare: la richiesta non è stata registrata, e il campo è rimasto libero. 👉 **Puoi riprovare adesso**: quella di prima non è passata, quindi non rischi di prenotare due volte. Se non va nemmeno stavolta, puoi sentire la segreteria al …»*, con sotto **la griglia dei giorni** — la via d'uscita a portata di dito, nessun vicolo cieco; · **con** `save_attempt` (ESITO IGNOTO → `WORKER_ESITO_IGNOTO` → `esito_ignoto`) → *«⏳ Ci penso io: sto confermando la tua prenotazione con il circolo. ⚠️ **Non rifarla adesso**: potrebbe essere già passata, e rischieresti di prenotare due volte lo stesso campo. Ti riscrivo qui appena il circolo mi risponde…»*. 📏 **E TUTT'E DUE LE STRADE DEL SOCIO sono state esercitate**, come pretende la lezione della voce 53 (*toccandone una si guarda sempre anche l'altra*): i **bottoni** (`/prenota` → 🟢 17:30 → ✅ Confermo) e le **parole** (*«vorrei prenotare un campo oggi alle 17:30»* → *«sì confermo»*). 🔎⭐ **E la misura ha detto una cosa che la scheda non sapeva**: anche sulla strada delle PAROLE il socio legge **le nostre** parole e non una riformulazione del modello — `bot.ts` intercetta i due motivi e usa `testoRifiuto` ⇒ *l'avvertimento «non rifarla» non può essere annacquato da chi riformula*, che è esattamente il verso in cui non ci si può permettere di sbagliare. ⚖️ **COSA QUESTA PROVA NON DICE, e non si arrotonda**: non dice che **Telegram consegni**, non dice che sul telefono si veda bene, e non dice che il worker vero scriva `save_attempt` proprio così — il corpo è **ricopiato** dal reperto del 22/08, non catturato di nuovo. 🧹 **Stub tolto subito**: `matchpoint-bookings-create` di TEST è tornata dal ramo (**v73**), verificata **byte per byte** uguale a `test-preview` su **7 file su 7**, senza traccia dello stub, e la prova del ritorno è una prenotazione vera del bot andata a buon fine (*«✅ Prenotato: oggi, domenica 6 settembre, 17:30–19:00, campo 1»*). — 🙁 **Una prenotazione che non riesce lascia il socio senza una strada** — 🗣️ segnalata dal committente il 22/08/2026, dal vivo durante il collaudo: *«ho ricevuto un messaggio dopo aver provato la prima prenotazione che non è andata a buon fine che diceva che la segreteria non ha dato la spiegazione. Il messaggio potrebbe essere ancora più carino verso il socio che prova a prenotare e la prenotazione per un motivo XYZ non è riuscita, quello di riprovare»*. 🎯⭐⭐ **L'EVENTO È MISURATO — 22/08 sera, sul registro del worker.** Non più «la frase combacia con una stringa sola»: c'è la riga, con l'ora e il nome. `22/08 10:56:51 UTC · POST /create-booking · SAVE_BUTTON_NOT_FOUND · Maurizio Aprea · partita 31/08 14:00-15:30`, con gli step che finiscono in `osservazioni_tab_click → osservazioni_textarea_absent → save_button_not_found`. ⇒ È **tre minuti dopo** i due annulli delle 10:53:59 e 10:54:08 della voce 73: stesso collaudo, stessa mano. 🔎 **E il perché della frase si legge nel messaggio**: contiene `url=https://app-padelvillage-it.matchpoint.com.es/…`, cioè **due** parole vietate (`matchpoint` e `https://`) ⇒ `dettaglioPerIlBot` lo sostituisce con `DETTAGLIO_SENZA_SPIEGAZIONE`. La catena è chiusa dal guasto alla frase, senza un anello supposto. ✅ **E la cura di stasera è verificata SU QUESTO caso, non su uno inventato**: negli step non c'è nessun `save_attempt` ⇒ `esitoDellaRispostaWorker` lo classifica **fallimento certo** ⇒ il socio legge «riprova», che è la risposta giusta. Se fosse stato l'altro sotto-caso — click partito e non concluso — la stessa regola direbbe «non lo so», che è la risposta giusta all'altro fatto. 📌 Trovato **senza cercarlo**, guardando la saturazione del worker: la sonda di sola lettura tiene i guasti dal 21/05, e il difetto del giorno stesso era lì dentro. *La schermata era persa; la riga no.* 🔎⭐⭐ **LA FRASE È IDENTIFICATA — 22/08 pomeriggio, ed è NOSTRA.** La schermata non c'è più (*«non te lo riesco a fare lo screenshot perché è stata annullata dalla stessa chat»*), ma il committente ha ridetto il senso — *«diceva che la prenotazione non era stata effettuata, e che la segreteria non ha dato spiegazioni»* — e quel senso combacia con **una stringa sola** in tutto il progetto: `DETTAGLIO_SENZA_SPIEGAZIONE` = *«il circolo non ha dato un motivo comprensibile»*, in `consumer-booking-write/esito-scrittura.ts`. ⚖️ **Ed è arrivata lì per una nostra cura**: il 21/08 (#943/#944) il dettaglio grezzo del worker è stato ripulito perché non uscisse il nome di un pezzo interno, e quando non resta niente di raccontabile esce quel ripiego. La cura ha tolto la fuga di notizie e **ha lasciato in piedi il vicolo cieco**: un «no» senza motivo e senza uscita. 📏 La strada, misurata nel codice: `prenotazione.ts` chiude i rifiuti che non sono `esito_ignoto` con `spiegazione: r.dettaglio` e nient'altro ⇒ il modello riceve solo quel ripiego e scrive al socio esattamente ciò che lui ha letto. 🚨 **Il confronto che rende il difetto evidente sta nella stessa funzione, due `return` più su**: il ramo `esito_ignoto` ha un'istruzione scritta con cura — non affermare, non far rifare, **dare l'uscita** — mentre questo ramo non ha niente. *Due rifiuti nella stessa funzione, uno con la strada e uno senza.* 📌 Resta non catturato solo il testo **come l'ha riformulato il modello**, che cambia ogni volta: il difetto non è in quelle parole, è nel fatto che al modello non arriva nessuna via d'uscita da riformulare. 🔎 **Le due piste di partenza, e la ① è ora confermata come ORIGINE e non come sospetto**: ① il `MOTIVO_SCRITTURA_RIFIUTATA` del ponte, il cui `detail` arriva dal worker e può portare parole che il socio non deve leggere — è la violazione viva già dichiarata in `CLAUDE.md` (`worker_error` arrivato fino al bot il 19/08); ② un rifiuto che **manda in segreteria** invece di dire «riprova»: se la prenotazione è fallita per una corsa sullo slot o per un guasto momentaneo, riprovare **funziona**, e mandare una persona a telefonare è un vicolo cieco. 🔨 **Cura, nella forma che il progetto ha già**: un rifiuto deve chiudersi con **una strada percorribile da soli** quando esiste — è la stessa regola scritta in `invito-partita-testi.ts` (*«su questo bot non si fa mai un vicolo cieco»*) e la stessa di `esito_ignoto`, che dice «non lo so ancora» invece di mentire. ✅⭐⭐ **CURATA il 22/08 sera — e la cura è il DOPPIO di quella che la scheda descriveva.** 🚨 **Il reperto che l'ha cambiata, trovato andando a verificare l'unica cosa che rendeva lecito dire «riprova»** — *`scrittura_rifiutata` vuol dire davvero che non è passata?* — **e la risposta era NO.** La coda del worker ha concorrenza 1 e un timeout di 180 s sulle interattive; quando scatta, `Promise.race` **smette di aspettare ma non interrompe Playwright** (lo dice il commento del worker stesso: *«l'operazione NON è stata interrotta… zombie»*) e il browser viene chiuso sotto. Quel timeout usciva come un errore qualunque ⇒ **non** veniva marchiato ignoto ⇒ arrivava al bot come **«non è passata»**. ⚖️ ⇒ Scrivere «riprova» sopra quella parola **avrebbe fabbricato la doppia prenotazione**, cioè il danno che tutto l'impianto della voce 23 esiste per evitare: *la frase chiesta dal committente non si poteva scrivere finché la parola su cui poggia non era vera.* 🔨 **Metà A — la parola.** `esitoDellaRispostaWorker` (`matchpoint-bookings-create/esito-prenotazione.js`, il modulo puro dei tre esiti): si elencano i codici del **fallimento CERTO** — quelli che il worker lancia **prima** del click su «Salvare», più quelli che al browser non arrivano — e **tutto il resto cade nell'ignoto**, codici futuri compresi. ⭐ Fallisce **chiusa**, come `dettaglioPerIlBot`, e il verso non è simmetrico: *un «non lo so» di troppo costa un'attesa, un «non è passata» falso costa un campo occupato due volte.* 🔎⭐ **E dentro l'elenco c'è una crepa, che si vede solo leggendo il worker**: `SAVE_BUTTON_NOT_FOUND` racconta **due fatti opposti** — *nessun bottone c'era* e *ho premuto e non so com'è finita*. `clickFormSave` prova i selettori in fila e mette da parte l'errore di un click **già partito** (l'elemento si stacca perché la pagina sta navigando, cioè **proprio quando il salvataggio è riuscito**), poi finisce con «non trovato». ⇒ Si distinguono con ciò che il worker **già scrive** in `navigationAttempts` (`action: 'save_attempt'`): **nessuna riga del worker toccata**. 🔨 **Metà B — la frase**, nelle **due** strade del socio: `prenotazione.ts` (il modello) e `telegram/schede.ts` (i bottoni), che è la lezione già pagata dalla voce 53 — *toccandone una si guarda sempre anche l'altra*. Le due frasi del rifiuto sono ora **opposte per costruzione**: sul certo *«puoi riprovare adesso, quella di prima non è passata»*, sull'ignoto *«non rifarla»*. Un caso apposta pretende che restino opposte. 🔒 La parola `scrittura_rifiutata` vive in **un posto solo** nel bot (`ponte.ts`), letta dalle due strade. 🩹 E in `ponte.ts` è stata **corretta una riga vecchia che mentiva**: dichiarava «VIOLAZIONE VIVA: arriva ancora `reason: 'worker_error'`», curata il 19/08 e mai riscritta. 🧪 **Banco**: 6 casi nuovi in `test/tre-esiti-prenotazione.test.mjs` (24 verdi), 2 nel bot (`schede.test.ts`), e **5 sabotaggi** in `test/sabotaggi-voce-72.mjs` — il difetto rimesso, l'elenco rovesciato, la crepa richiusa, il cablaggio staccato, più il controllo del metro — **tutti visti come rossi**. ⏳ **Resta aperta**: la cura non l'ha ancora vista succedere nessuno su una persona vera, ed è la regola della giornata — *il banco dice che il meccanismo è giusto, non che i messaggi arrivano.* |
| **122** | ✅ *(05/09/2026 sera, 89ª sessione — chiusa a PROVA FISICA sul bot vivo di TEST, e la cura ha dovuto essere fatta DUE VOLTE)* 🔁 **122. DOPO «RICHIUDI» IL BOTTONE RESTAVA «RICHIUDI».** Difetto **suo**, visto sul suo telefono il 02/09 (*«mi è venuto spontaneo cliccare su richiudi la partita, però non ha funzionato»*), e il registro lo misurava senza ambiguità: **due tocchi suoi a 16 secondi**, non un doppione del bot — aveva ritoccato perché lo schermo diceva ancora che c'era da chiudere. 🔨 **Prima cura (PR bot #118, 02/09)**: il ramo `apri/chiudi` mandava la conferma e si fermava; ora **riscrive la scheda** in tutti e tre i casi, come già faceva `entra` dieci righe più su. 🚨⭐⭐ **E QUI VIENE LA COSA CHE VALE PIÙ DELLA VOCE: il 05/09, andando a fare il tocco vero, la cura È RISULTATA A METÀ.** Sul bot vivo, partita di martedì 8, 12:30, campo 2 — «🔓 Apri ad altri giocatori» ⇒ bottone «🔒 Richiudi la partita», giusto; «🔒 Richiudi la partita» **sei secondi dopo** ⇒ bottone **ancora** «🔒 Richiudi la partita», cioè **il sintomo esatto della voce, sopravvissuto alla sua cura**. 📏 **La causa isolata da una seconda misura e non supposta**: stessa identica sequenza con **venti** secondi invece di sei ⇒ il bottone torna giusto. Era `PLAYER_TTL_MS` (8 s): dopo il gesto `schedaGestisci` rilegge, ma dentro quella finestra rilegge **la lettura di prima del gesto**. ⚖️ La prima cura non era sbagliata — la riscrittura c'era e si vedeva in tutt'e due i versi. Mancava che la rilettura fosse **fresca**, e il banco **non poteva** accorgersene: le guardie sono **testuali**, dicono che la riscrittura è cablata, non da quale lettura nasce. 📌 *Riscrivere lo schermo con un dato vecchio è indistinguibile, per chi guarda, dal non riscriverlo affatto: è la forma peggiore di un verde, perché la cura si vede nel codice e non sullo schermo.* 🔨 **Seconda cura (PR bot #120, 05/09)**: `chiamaIlPonte` avvolge la chiamata al ponte e in un `finally` **butta la cache delle letture** quando la funzione è `consumer-booking-write` — il collo di bottiglia da cui passano **tutte e dieci** le scritture del bot, così la regola non si dimentica scrivendo l'undicesima (stessa scelta del collaudo, che intercetta il `fetch` e non le venti funzioni di `api.ts`). Si butta **tutta** e non la sola voce di chi ha scritto (se uno apre la sua partita, la vetrina di un altro è cambiata anche lei) e **nel `finally`**, quindi anche a scrittura fallita — un `esito_ignoto` è per definizione un caso in cui la cosa potrebbe essere passata. 🔄 Corretto un commento diventato falso (*«8s di staleness sono irrilevanti»*): non lo erano. 🧪 4 casi nuovi che contano le **letture andate in rete** e non le riscritture, **due sabotaggi** con quattro rossi nei punti giusti (cura tolta ⇒ ② e ③ rosse; cache buttata **sempre**, cioè spenta invece che curata ⇒ ① e ④ rosse); `tsc` pulito, banco **1740/0**. ✅⭐⭐ **LA PROVA FISICA: rifatta la sequenza dei SEI SECONDI** — quella esatta in cui quaranta minuti prima sbagliava — e dopo «Richiudi» la scheda si riscrive con **«🔓 Apri ad altri giocatori»** (`pa|a|2026-09-08|12:30|2`). ⇒ Non «non è successo niente di male», ma **«è passato di lì e non ha sbagliato»**: è la forma di prova della voce 77. 🧹 TEST lasciato com'era, partita richiusa. 👥⭐ **E LA CURA È IN SERVIZIO ANCHE SUI SOCI** (deploy `soci`, run 141, 23:29:25): il difetto che lui aveva visto viveva sul **loro** bot, non su quello di prova, e lasciarcelo un'altra sessione sarebbe stato curare la voce e non il socio. 📏 `stato-bot` dopo il deploy: online, riavvii 1 → 2, uptime 47 s, e la dichiarazione d'ambiente `✍️ prenotazioni REALI` — il `.env` non l'ha toccato il deploy e il bot è rimasto puntato dov'era. ⏳ Sui soci la cura **non è stata esercitata**: la finestra dei sei secondi l'ha attraversata il bot di **prova**, che gira lo stesso sha (`dc52eee`). |
| **81** | ✅ *(05/09/2026 sera, 89ª sessione — chiusa a PROVA PROVOCATA sul bot vivo di TEST, in tre stati, con la finestra esatta attraversata)* 🙅 **81. A UN SOCIO CHE NON RIUSCIAMO A RICONOSCERE IL BOT DICEVA «NON HAI PRENOTAZIONI».** La cura era in servizio dal 23/08 e la scheda chiedeva una cosa sola: **ricreare il caso**, visto che le due schede doppie di quella notte erano state curate. ⇒ Ricreato. 📏 **Tre `collaudo-conversazione` consecutivi verso TEST, stesso socio, stesso `/prenotazioni`, e in mezzo una scheda `member` doppia messa e tolta a mano su `cudi…`** (stesso `memberId` 000004, `payload.id` diverso; su TEST il ponte cerca per `member_id` perché il `pmo_player_id` lì è nullo, quindi il ripiego del readmodel non entra e la lettura torna `ambiguous`): · **20:20:49, sano** → «Le mie prenotazioni · 1 di 10 …»; · **20:21:39, col doppione** → «**Non riesco a riconoscerti in questo momento, quindi non posso dirti le tue prenotazioni. Non vuol dire che non ne hai: vuol dire che non riesco a leggerle. Riprova fra un momento; se continua, la segreteria ti trova subito: +39 379 115 1472.**» col bottone **🔄 Riprova** — cioè le tre parti della cura, la frase che parla di NOI, la riga che vieta la conclusione sbagliata e l'uscita; · **20:22:56, doppione tolto** → di nuovo «Le mie prenotazioni · 1 di 10 …», **identico al primo**. ⭐ È la forma di prova della voce 77: non «non è successo niente di male», ma **«è passato di lì e ha detto la cosa giusta»** — e il ritorno allo stato sano dice che la differenza l'ha fatta il doppione, non il caso. 🧹 TEST rimesso com'era: zero doppioni residui, ricontato. ⏳ **Cosa NON dice questa prova, dichiarato**: che Telegram consegni e che sul telefono si veda bene — il collaudo si rifiuta da sé di dirlo. Copre tutto il resto, dalle parole del socio fino al ponte e ritorno, che è dove la voce viveva: il dubbio era *quale frase esce quando il ponte non risolve la scheda*, e quella frase è stata letta. |
| **70** | ✅ *(05/09/2026 sera, 88ª sessione — chiusa a PROVA FISICA letta dove la cura lavora: il database di PROD e il registro del bot dei soci)* 📏 **La prova, che la scheda stessa chiedeva** (*«un socio che entra dal bot e NON riceve l'avviso del circolo qualche minuto dopo»*): `pmo_ricevute_gesti` su PROD ha **32** ricevute, **26 consumate** (`usata_da` = l'id del fatto coperto), tutte su gesti veri di soci dal bot fra il 22/08 e il 02/09 — fra cui **Laura Aprea, entrata dal bot il 01/09 alle 20:01** nella partita del 7/09 11:00 Campo 3: ricevuta scritta e consumata nello stesso minuto, fatto `8dc56e69` chiuso dal ramo della ricevuta. E nel registro del bot dei soci (80.000 righe, dal 23/08) le righe «detto a Laura Aprea: il circolo ha aggiunto» sono **due**, per altre due partite (31/08 09:00 e 05/09 15:00, gesti della segreteria): **per il 7/09 11:00 non c'è** — l'avviso non è partito, ed è esattamente la finestra in cui il 21/08 partiva. 🔎 **E la controprova sta nel minuto stesso**: `20:00:53 ▸ Laura Aprea tocca: aperte entra` → `20:02:07 🔔 circolo: 3 ritirati, 3 detti, 0 scartati`, e i tre detti sono **Maurizio, Marco e Lidia** (`formazione`, gli altri in campo — come vuole la regola del 23/08): il quarto fatto, quello di Laura su sé stessa, non è nemmeno arrivato al bot. ⚖️ *Non «non è successo niente di male», ma «è passato di lì 26 volte e non è successo niente».* 🔇 **E la prova ha trovato la 115**: quelle 26 righe erano chiuse con `esito` NULL, indistinguibili dalle 605 di prima del 01/09 — curata la stessa sera (`gesto_dal_bot`). ⏳ **Residuo dichiarato**: la cura poggia sull'accoppiamento per nome e gesto entro 20′; un gesto della segreteria sulla stessa persona nella stessa mezz'ora passa (ed è giusto), e nessuno l'ha visto succedere. — ✅ 🔁 **Il circolo annuncia al socio una cosa che ha appena fatto LUI — CURATA il 22/08, in servizio** — 📏 **misurato dal vivo la notte del 21/08**, durante il collaudo, con la previsione scritta **prima** e confermata riga per riga. **I fatti, al secondo:** Maurizio invita Lidia dal bot; Lidia tocca «Ci sto» e il bot le dice **«✅ Sei in campo»**; alle **21:38:03** il sync rilegge lo slot e la `descrizione` passa da `-Maurizio Aprea.` a `-Maurizio Aprea.-Lidia Comes.`; alle **21:39:54** `eventi-staff` emette il fatto `Lidia Comes · aggiunto · 31/08 11:00 Campo 1`. ⇒ Fra 4 e 19 minuti **dopo il proprio gesto**, a Lidia arriva un avviso **dal circolo** che le annuncia quello che ha fatto lei. 🔎 **La causa è strutturale, non una svista**: `eventi-staff.ts` confronta **DATI**, non eventi — vede *cosa* è cambiato e **non può sapere CHI** l'ha cambiato. ⚖️⭐⭐ **Ed è il rovescio esatto del pregio dichiarato nella sua stessa intestazione**: *«il ③ toccato ≠ cambiato non costa una riga: qui si confrontano DATI, non eventi. Un rilevatore costruito sugli eventi avrebbe dovuto difendersi da quel caso; uno costruito sui dati non lo incontra proprio»*. La **stessa** scelta che regala il ③ rende impossibile distinguere il gesto della segreteria da quello del socio. ⇒ *Un pregio dichiarato descrive metà di una scelta: l'altra metà è il difetto gemello, e sta nella stessa riga.* 🚨 **Perché non è un caso di bordo**: la **voce 64** (chiusa) aveva tolto dal **bot** l'avviso a chi il gesto l'aveva fatto; la **68** lo rimette **dal gestionale**, da una porta che la 64 non sorvegliava. In servizio da ieri sera ⇒ **ogni socio che entra in una partita dal bot** — accettando un invito, o prenotando — riceve pochi minuti dopo un avviso del circolo su ciò che ha appena fatto, subito dopo che il bot gliel'ha già detto. 📏 Con **5 soci** non si vede; con 2810 è il primo motivo per cui uno spegne le notifiche. ⚠️ **Il codice dichiara un caso VICINO e lo giudica accettabile** (*«se un socio prenota dal bot per sé e tre amici, quei tre ricevono lo stesso avviso — che è altrettanto vero»*): per **loro** è vero, non lo sanno; per **chi si aggiunge da sé** è falso. ⇒ La riga da cambiare non è quella delle partite nuove, è il ramo dello slot **che esisteva già**. 🔨 **Cura proposta, da decidere e NON fatta** — conforme a *il gestionale SA, il bot DICE*: l'informazione che manca **il gestionale ce l'ha già**, perché la scrittura l'ha eseguita lui (`consumer-booking-write`). Lasciare lì una **ricevuta** (slot · persona · gesto · istante), e far scartare a chi consegna (`consumer-staff-events`, che la quiete dei 2′ la fa già) il fatto che combacia con una ricevuta recente. Finestra **≥15′**, perché il fatto nasce col ritardo del sync (mediana ~2′, massimo misurato **10′04″**). ⛔ **Non** farlo confrontare al bot con un proprio ricordo: sarebbe la memoria parallela esclusa dalla 64, e la 68 è nata apposta per non averla. 📌 L'origine è scritta anche nella chiave locale della prenotazione (`…\|consumer-assistente-soci`), ma è **per prenotazione**, non per persona: dice chi ha creato lo slot, non chi è entrato dopo ⇒ da sola non basta. 🔌 **Nel frattempo c'è l'interruttore** (kb `avvisi_dal_circolo.attivi`), che spegne **solo** questi avvisi. ⚠️⭐ **ONESTÀ SULLA MISURA: quell'avviso a Lidia NON è mai arrivato**, e non perché il difetto non ci sia — il fatto è stato emesso e chiuso regolarmente — ma perché **un secondo difetto, indipendente**, lo ha fermato un passo dopo: il ponte leggeva solo le prime 1000 schede su 2810 e Lidia sta in posizione 2721 (misurato e **curato** la notte stessa, vedi la voce 68). ⇒ Quello che si è visto è la **catena fino alla coda**, non fino al telefono. 🚨 E cambia la fretta: finché il ponte era cieco sui due terzi dei soci questo difetto era **quasi invisibile**; curata quella cecità, diventa visibile a **tutti** — cioè la 70 è più urgente di prima, non meno. 🔨 **CURATA il 22/08/2026, ed è la cura proposta qui sopra senza scostamenti**: `consumer-booking-write` lascia una **ricevuta** (`pmo_ricevute_gesti`: partita · persona · gesto · istante) dopo ognuna delle cinque scritture che sa fare, e `consumer-staff-events` scarta il fatto che ne combacia una. ⭐⭐ **La riga che decide se cura o rompe: si scarta PRIMA della riduzione, non dopo.** Un socio che entra dal bot e che poi la **segreteria** toglie produce due fatti — `aggiunto` (suo) e `tolto` (del circolo): scartando prima resta il `tolto` e lui lo sente; scartando dopo i due si sarebbero già fusi in un netto nullo e **non avrebbe saputo di essere stato tolto**. ⇒ *La riduzione risponde a «cosa è successo in tutto», la ricevuta a «chi l'ha fatto»: la seconda domanda va posta finché i singoli gesti esistono ancora.* È provata girando le due strade e mostrando cosa si perde in quella sbagliata. ⚖️ **La regola di scarto è più larga di «chi ha toccato il bottone», e la misura lo impone**: chi chiede l'`add` è l'**organizzatore**, non chi entra — Lidia accetta e a chiedere è Maurizio. Una regola *persona = attore* non avrebbe coperto proprio il caso da cui la voce nasce. ⇒ Una ricevuta dice *«questo non l'ha fatto la segreteria»*, e un avviso **dal circolo** su un gesto che il circolo non ha fatto è falso nell'attribuzione **per chiunque** lo riceva. 📏 E i conti tornano su tutti e cinque i gesti: su `add`, `remove` e `cancel` il bot parla già (`testoSeiEntrato`, `testoSeiStatoTolto`, `testoPartitaAnnullata`) ⇒ sarebbe un doppione; su `leave` il bot non avvisa nessuno per decisione del committente, ma il fatto riguarda chi è uscito **da sé**; su `create` dal bot nasce una partita col **solo organizzatore** (`giocatori: [{ nome: member.name }]`), che `eventi-staff` salta già — la ricevuta si scrive lo stesso ed è una **rete**, perché quel salto poggia sull'ORDINE dell'elenco del circolo, che è una convenzione di Matchpoint e non una promessa. 🧾 **Una ricevuta, un fatto**: si consuma. Se la segreteria ripete lo stesso gesto sulla stessa persona nella stessa mezz'ora, il secondo passa — ed è giusto, perché quello è suo. ⏱️ Finestra **20′** (il massimo di sync misurato è 10′04″, raddoppiato) più **3′ di tolleranza all'indietro**, perché la ricevuta si scrive **dopo** che il worker ha risposto e un giro di sync può vedere il cambiamento prima. 🚨 **E se le ricevute non si riescono a leggere, il giro si FERMA**: tirare dritto rimanderebbe in circolo esattamente gli avvisi falsi che questa voce cura, e li manderebbe davvero. I fatti restano in coda. 🔎 **Diagnostica**: ogni soppressione si scrive nel registro nome per nome, e la ricevuta consumata porta `usata_da` = l'id del fatto ⇒ *un avviso soppresso è distinguibile da un fatto che non è successo*, che è esattamente ciò che `consegnato_at` da solo non sa dire. ⏸️ **Resta aperta**: nessuno l'ha ancora vista succedere sul bersaglio — la conferma è un socio che entra dal bot e **non** riceve l'avviso del circolo qualche minuto dopo |
| **92** | ✅ *(05/09/2026 notte, 87ª sessione — chiusa a PROVA FISICA PROVOCATA sul gestionale di TEST, su sua parola: «lavora le altre due urgenti e chiudiamole»)* 🚨🚨 **92. DUE MESSAGGI IDENTICI ALLO STESSO SOCIO: la coda si leggeva e si chiudeva in due momenti.** 📏 **Il difetto** (24/08, sua segnalazione con schermata): due giri del bot a un secondo di distanza — quello dell'accensione dopo un riavvio e uno normale — hanno ritirato gli stessi 2 fatti, e Maurizio ha letto due volte «Sei in campo». La coda si **leggeva** al passo 1 (`consegnato_at is null`) e si **chiudeva** al passo 5, con tutta la funzione in mezzo. 🔨 **La cura** (24/08): la chiusura pretende che i fatti siano **ancora liberi** (`.is('consegnato_at', null)`) e si fa dire **quali ha preso davvero** (`.select('id')`); chi arriva secondo se ne prende zero e non consegna; la corsa si vede in `gia_presi_da_un_altro_giro`. ⏳ Per dodici giorni la prova è stata «aspettare che due giri si sovrappongano», e tre finestre guardate erano vuote. **Quella del 05/09 mattina no** — l'avaria della 160: fino a otto giri in volo insieme per 75 minuti su due fatti in coda — eppure `gia_presi` è restato zero perché **nessuno** dei 109 giri è arrivato al passo 5 (i 500 morivano sull'anagrafica, i 504 li uccideva il cancello): letti da tutti, chiusi da nessuno fino alle 14:08:41. Lo zero non era la firma della cura, e lo si è scritto. ✅⭐⭐ **LA PROVA, la sera stessa, PROVOCATA**: alle **20:20:24** locali **quattro chiamate concorrenti** a `consumer-staff-events` di TEST (coda con 581 fatti liberi, che il bot di prova non consuma mai), partite insieme da un'edge di prova sullo stesso progetto — risposta: #1 `eventi=100, gia_presi=0, troncato=true`; #2, #3 e #4 `eventi=0, gia_presi_da_un_altro_giro=100`. Sul database: **125 righe chiuse in un solo istante** (20:20:26.107), una `consegnato_at` sola per tutte. ⇒ *I fatti letti da quattro giri li ha consegnati uno solo, e gli altri tre hanno visto che se li era presi un altro*: è **esattamente** la firma che la scheda chiedeva, sul codice vero e sul database vero. ⚖️ **Perché vale anche se è su TEST**: l'edge è la stessa (versione 15 su `cudi…`, deployata dal ramo con la cura), il database è Postgres con le stesse righe e gli stessi lock, e il bot **non decide niente** in questa storia — dice ciò che riceve, e la seconda, terza e quarta chiamata non hanno ricevuto niente da dire. ⏳ **Cosa NON prova**: il messaggio **uno solo** sul telefono di un socio, che qui non c'è perché a chiamare non era il bot; e che la finestra del **riavvio** (i due giri dell'accensione) sia coperta è dedotto dalla stessa serratura, non visto. 🧰 L'edge di prova (`prova-urgenti-test`, serratura sull'host di TEST + gettone monouso, invocata con `pg_net`) è rimasta su `cudi…` **disarmata** (410): da cancellare dalla console. 📌 *«Non si provoca a comando» era vero su PROD e falso su TEST: la frase mancava del «dove».* |
| **83** | ✅ *(05/09/2026 notte, 87ª sessione — chiusa a PROVA FISICA PROVOCATA sul gestionale di TEST, su sua parola)* 🚨🚨 **83. IL BOT HA DETTO «NON CI SONO RIUSCITO» A UN ANNULLO CHE ERA PASSATO.** 📏 **Il difetto** (23/08 23:39:59): annullo dal bot su un worker lento, 150 s esatti, e a rispondere non è stato né il worker né la nostra edge ma **il cancello della piattaforma** (`KO HTTP 504 {"code":"IDLE_TIMEOUT"}`), letto come rifiuto certo — mentre la partita era sparita da Matchpoint. Tre bugie in dieci minuti: la frase, il promemoria su un campo già libero, l'annullo attribuito al circolo (voce 70, ricevuta mai scritta). Sulla `create` la stessa classificazione vale **doppia prenotazione**. 🔨 **Le cure**: ① 24/08, `esitoIgnotoDaRisposta` sul gestionale — *una risposta senza `error` non l'ha scritta nessuno di noi* ⇒ ignoto, su tutti e cinque i rami dalla voce 106; ② 31/08, bot: `laScritturaPuoEsserePassata`, i fallimenti **certi** elencati e tutto il resto ignoto, con l'invito che non si riapre; ③ 31/08 sera: la ricevuta si lascia **anche sull'ignoto, ma solo a chi ha chiesto**. ⏳ La prova mancava perché *«servirebbe un worker abbastanza lento da sfondare i 150 s»* — e la finestra guardata la sera stessa era vuota (zero chiamate a `consumer-booking-write` in 24 h, nessuna ricevuta `*-ignoto`). ✅⭐⭐ **LA PROVA, PROVOCATA**: su TEST `matchpoint-bookings-create` è stata sostituita per **sette minuti** (20:20–20:27) da uno stub che resta appeso 200 s, così a rispondere è stato **il cancello vero**, non una sua imitazione. Alle **20:20:44** una `create` (Maurizio Aprea, 14/09 10:00 Campo 1) è partita verso `consumer-booking-write` di TEST. Nel registro dell'edge, alle **20:23:15.891**: `[booking-write] create KO HTTP 504 (ESITO IGNOTO): {"code":"IDLE_TIMEOUT","message":"Request idle timeout limit (150s) reached"}` — **la stessa riga della notte del 23/08, con `(ESITO IGNOTO)` accanto**. E alle **20:23:16.018** la ricevuta: `azione = create-ignoto`, `gesto = aggiunto`, `richiesta_da = Maurizio Aprea`, slot `2026-09-14|10:00|1`. ⇒ Il 504 è uscito come «non lo so» e non come «rifiutata», e la ricevuta è accanto: **le due condizioni della scheda, tutt'e due**. Edge vera rimessa alle 20:27 (versione 69, dal ramo `test-preview` col workflow del repo). ⏳ **Cosa NON prova**: la **metà del bot** (cura ②, `BridgeError` → ignoto quando a tacere è il gestionale stesso) — il collaudo del bot ha una scadenza di 90 s per passo e non arriva a 150; resta provata nel banco (1685 verdi, 5 sabotaggi) e **non** sul vivo. E la frase sul telefono del socio non l'ha letta nessuno: qui a chiamare era un'edge di prova, non il bot. ⚠️ Su TEST resta una ricevuta `create-ignoto` per una partita mai nata: innocua (TEST, calendario congelato, nessun sync la incrocerà), e dichiarata. 📌 *Il cancello della piattaforma si provoca con una funzione che non risponde: costa uno stub e sette minuti, non un worker in agonia.* |
| **65** | ✅ *(05/09/2026 notte, 87ª sessione — chiusa a PROVA FISICA letta nel registro del bot dei soci, sull'evento che la scheda stessa aveva fissato come condizione)* 🔒 **65. IL NOME DEL WORKER ARRIVAVA AL BOT DENTRO IL «DETTAGLIO».** 🗣️ La regola ferrea del 19/08: *«il worker il bot non deve proprio filarselo»* — né indirizzo, né stato, né nome. 📏 Il difetto, misurato il 21/08 alle 09:28 nel registro del bot: `Worker network error: error sending request for url (https://worker…/create-booking): tcp connect error: Connection refused` arrivato **intero** fino al bot, e per ogni rifiuto che non sia `esito_ignoto` quel testo passava come `spiegazione` al modello che scrive al socio. 🔨 **La cura** (`dettaglioPerIlBot` in `consumer-booking-write/esito-scrittura.ts`, su **tutti e otto** i punti che scrivono `detail:`; edge in servizio dal 21/08 11:40, `61a48c2`): il grezzo resta nel `console.error` dell'edge, verso il bot esce *«il circolo non ha dato un motivo comprensibile»* — e **fallisce chiusa**: la frase muta esce **solo** se `NOMI_INTERNI` (`worker|matchpoint|hetzner|playwright|caddy|nip.io|browser|https?://`) ha trovato qualcosa, mai altrimenti. Il collaudo del 21/08 non aveva potuto concludere perché le righe del registro **non portavano l'ora** (`console.warn` saltava `log()`), curato nel bot con la PR #52 (21/08 12:31): da allora ogni riga è datata. ✅⭐⭐ **LA PROVA, letta il 05/09 notte con `stato-bot.yml` (20.000 righe, dal 16/08)**: `2026-08-23 · 00:14:52 [prenota] esito IGNOTO per 7d454239… su 2026-08-31 09:30 C1: il circolo non ha dato un motivo comprensibile` — il committente aveva confermato una prenotazione alle 00:13:12, il gestionale ha risposto esito ignoto, e il dettaglio che il bot ha letto è **la frase muta**: cioè il grezzo **conteneva un nome interno** e la serratura l'ha fermato. È esattamente *«il primo esito IGNOTO datato dopo il timbro»* che la scheda aspettava, e la forma giusta di prova — *è passato di lì e non è successo niente*. 📏 **E la classe, non solo l'istanza**: nelle 20.000 righe **nessuna** riga datata dopo il 21/08 12:31 contiene `worker`, `matchpoint`, `hetzner` o un `https://`. Le due righe col nome del worker che ci sono ancora sono **senza ora** — cioè scritte prima della PR #52, quindi prima della cura — e le due del 19/08 (`worker_error`, 18:43 e 18:53) sono l'episodio da cui la regola è nata. L'unico `https://` datato è l'indirizzo di Gemini dentro uno stack del bot stesso: non è un dettaglio del gestionale, e non arriva a nessun socio. ⏳ **Cosa NON prova**: il corridoio esercitato è quello dell'**esito ignoto**, dove il bot **non** passa il dettaglio al modello; il corridoio del **rifiuto certo con un nome dentro** — quello che poteva arrivare sullo schermo — dal 21/08 non ha avuto **nessun** caso. La serratura è però **la stessa funzione** sugli otto punti, e il caso 18 del banco conta che nessun `detail:` le sfugga. 🚨 **La lezione, che pesa più della voce**: l'evento era nel registro dal **23/08**, tredici giorni, e nessuna delle sessioni che hanno guardato quel registro per la 92 l'ha cercato per la 65. *Una finestra non guardata è un buco* — anche quando la condizione per guardarla è scritta nella scheda, in grassetto. |
| **163** | ✅ *(05/09/2026 sera, 86ª sessione — **aperta e chiusa nello stesso giro**, a prova fisica su TEST 6.367 e PROD 6.367, telefono 390×844)* 💶🕳️ **163. L'IMPORTO CHE SI STA DIGITANDO SPARIVA DA SOLO DOPO POCHI SECONDI** — 🔎 **Non nasce da un'idea: nasce da una misura fatta per chiudere un'ALTRA voce.** Nello screenshot della prova della 138 il campo importo era tornato `0,00` mentre la sonda, un istante prima, ci aveva letto `37,50`: due fatti veri in due momenti diversi. 📌 *Uno screenshot è un istante: quando contraddice una misura, si guarda l'ora di tutti e due* — e guardandola è uscito un difetto che nessuno cercava. 📏 **Rimisurato su PROD 6.365, senza cliccare niente**: digitato `37,50` → **subito** 37,50 → **dopo 3 s** `0,00` → **dopo 10 s** `0,00`. ⇒ A cancellarlo non è il click sul nome (quello la 138 l'aveva provato): è il **ridisegno** della scheda dopo la rilettura del roster, che fa `box.innerHTML = ''` e rifà i campi dallo stato — e il numero digitato viveva **solo nel DOM**. 🩹 **E la prima sonda del ramo mancante è stata BUTTATA, va detto**: avevo provato a sostituire la risposta del worker dentro la pagina, e non ha intercettato niente (`chiamateIntercettate: 0`) mentre il resto del risultato *sembrava* rispondere. 📌 *Una sonda che non tocca il bersaglio non dà «nessun difetto»: dà numeri che parlano d'altro.* La misura buona è stata eseguire la riga che **tutti i rami** chiamano — il ridisegno nudo — e con un roster nuovo: 41,00 digitato torna 13,00, cioè il numero di Matchpoint. ⇒ Non è il caso del worker che fallisce: **succede sempre**. ⚖️ **Perché conta, e conta in cassa**: la segreteria apre la scheda e comincia a scrivere mentre la rilettura è in volo; quando atterra, il numero sparisce **senza dirlo**. È il rovescio del guadagno della **142** — da quando la scheda si apre subito coi nomi locali, quella finestra è la **normalità** e non più l'eccezione. 📌 *Aprire prima una scheda che si ridisegna dopo non è gratis: sposta il ridisegno dentro il tempo in cui qualcuno la sta usando.* 🔨 **La cura è quella che l'app usa GIÀ per la nota**: il valore digitato smette di vivere nel DOM e passa nello **stato** (`st.importiDigitati`), che nasce e muore con l'apertura della scheda. E la logica sta in **due funzioni pure fuori dal ridisegno**, per una ragione sola: il ridisegno vuole un DOM, quindi in un banco non si esegue — *se la parte che decide sta dentro la parte che disegna, si prova il disegno.* 🚨⭐⭐ **LA PARTE CHE DECIDE SE LA CURA È SICURA È SU QUALE RIGA SI RIMETTE IL NUMERO**, ed è la **138 un piano più in basso**: là si apriva la scheda di un altro, qui si incasserebbe da un altro. ⇒ **Non si indovina**: si rimette solo se la lista è **ancora la stessa**, riga per riga. Se è cambiata non si rimette niente **e lo si dice in pagina** — *sparire in silenzio è il difetto, non la perdita in sé*. ⛔ **E nessuna delle tre parti della chiave basta da sola, tutte e tre misurate**: l'**id** no, perché gli «Ospite» hanno tutti id interno `1` (misurato sulla 138) e due ospiti collasserebbero sulla stessa chiave; la **posizione** no, perché scivola appena qualcuno esce; il **nome** no, perché gli omonimi su PROD sono 12 gruppi. 🩹 E la **firma si prende dal ROSTER, non dalle righe dei soldi**: chi è segnato per la rimozione la riga dei soldi non ce l'ha, quindi firmando quelle una ✕ su un giocatore avrebbe buttato gli importi scritti sugli **altri** — una perdita causata da noi, dentro un gesto che coi soldi non c'entra. 🧪 **Banco nuovo `test/l-importo-digitato-sopravvive.test.mjs`, 19 verdi**, con le due regole **eseguite** e non lette; **sei sabotaggi** visti diventare rossi su una copia. 🩹 **Due sabotaggi sono passati verdi al primo giro e le prove sono state STRETTE**: uno cercava il nome `st.importiPersi` e lo trovava dove quel nome viene **letto** invece che alzato (*una sonda che cerca un nome trova anche chi lo consuma: si cerca il **gesto***); l'altro toglieva le due righe che rimettono davvero il valore nella casella — la funzione decideva benissimo e non lo rimetteva **nessuno**, e tutte le prove restavano verdi. ⇒ Coperto con **due guardie dichiaratamente TESTUALI**, e dichiarate tali: quel pezzo vive nel DOM, e un banco senza browser lì non arriva. *Una decisione giusta che non arriva allo schermo è una cura che non esiste.* ✅⭐⭐ **LA PROVA FISICA, e ha attraversato la finestra esatta in cui prima sbagliava** — su **TEST 6.367** e poi su **PROD 6.367 a 390×844**, sulla **stessa partita** su cui il difetto era stato misurato (07/09, 19:30, Campo 2): digitato `37,50` **mentre la rilettura era ancora in volo** (`rosterRefreshing` vero), e dopo la rilettura conclusa il numero **c'è ancora**. Poi il ridisegno **nudo** (regge), **due** importi su due righe (si ricordano tutti e due, non solo l'ultimo), la lista che **cambia davvero** con le posizioni rinumerate (**niente** rimesso, e l'avviso **visibile** in pagina), e chi riscrive (l'avviso si spegne). **Zero** errori di pagina. ⇒ *Non «non è successo niente di male», ma «è passato di lì e non è successo niente».* ⛔ **COSA NON È MISURATO, e non si arrotonda**: quanto tardi arrivi il ridisegno con un worker che risponde **davvero**. La console blocca `/functions/v1/` di proposito, quindi lì la rilettura fallisce presto. ⚖️ Cambia il **quando**, non il **cosa**: il ridisegno è lo stesso in tutti i rami ed è misurato: con un worker vivo la finestra è **più lunga**, cioè il difetto era **peggiore** di così, non migliore. |
| **138** | ✅ *(05/09/2026 sera, 86ª sessione — **voce SUA**, chiusa a **prova fisica sulla pagina viva di TEST 6.365 e PROD 6.365**, computer **e** telefono)* 🔗 **138. IL NOME DEL GIOCATORE APRE LA SCHEDA SOCIO** — 🗣️ sua, 03/09: *«l'unica cosa che rimane fuori è che il nome del giocatore dalla scheda della partita non è cliccabile»*, con la sua scelta fra tre strade (la **ⓒ**: la scheda si apre **sopra**, senza cambiare tab). 🚨 **La prima stesura apriva LA PERSONA SBAGLIATA e l'ha trovato lui al primo click** (TEST 6.301: cliccando «Filippo Battistella» si apriva «Giovanni Modanese»): Matchpoint dà a ogni persona **due** numeri — il codice cliente (`memberId`) e l'id interno (`matchpointIdInterno`) — e il roster porta l'**id interno** sotto un nome che dice il contrario (`HiddenFieldIdCliente`). Curato in 6.302 confrontando l'id interno da tutt'e due le parti. ⏳ **Restava aperta per una sola cosa, ed era una prova**: *«digitare un importo, cliccare il nome, chiudere, e ritrovare l'importo»*. 📌 La scheda diceva che serviva **il suo dito**; il `CLAUDE.md` dice che una prova fisica sul gestionale si fa *«dal Mac, o con la console remota»* ⇒ **non serviva disturbarlo**, e chiederglielo sarebbe stato scaricargli addosso un lavoro mio. 🚨⭐⭐ **E LA PROVA HA FATTO USCIRE UN DIFETTO CHE LA SCHEDA DICHIARAVA ASSENTE: l'«OSPITE» ERA CLICCABILE.** 📏 Misurato su **PROD 6.363**, partita del 07/09 19:30 Campo 2: il nome «Ospite» usciva con `role="link"`, tratteggio e tooltip «Apri la scheda di Ospite», e apriva il **jolly del circolo** — mentre la scheda diceva *«gli Ospite restano nomi MUTI»* e il banco lo dava per provato con una prova verde. 🔎 **Il difetto non era nella regola, era nel CASO DI PROVA**: l'Ospite un id interno **ce l'ha**, ed è `1` — in anagrafica ci sono **due** record «Ospite» vivi (`guestJolly`, codice cliente `000001`, id interno `1`) — e il banco provava `{nome:'Ospite', idCliente:''}`, cioè un Ospite **senza** id: il caso che nella vita vera non capita. 📌 *Un caso di prova si copia dai dati, non dall'idea che se ne ha — e una prova verde su un caso che non esiste non difende niente.* 🔨 **Curato con DUE serrature**, che difendono da due guasti diversi: l'id `1` sulla riga del roster (più il flag `ospite` che `_normRoster` mette quando il worker manda l'Ospite senza nome), e `isGuestJollyMember` sul socio **trovato** — la prima regge se l'anagrafica dimentica flag e nome, la seconda se il jolly avesse un id diverso da 1. 🧪 Banco a **19** verdi, con le **tre** serrature viste diventare rosse **una per una** su una copia sabotata, e le regole del jolly **iniettate vere** dall'app invece che imitate. 🩹 **E il banco ha preso una regressione MIA mentre la scrivevo**: la catena iniettata mancava di `cleanCell`, `normalizeText` esplodeva, il `try/catch` di `_staffCalSocioDelGiocatore` ingoiava l'eccezione e **ogni** nome diventava muto — tre prove rosse in un colpo, con la cura sana. Senza la prova *«e le due serrature non chiudono la porta a un socio vero»* sarebbe salita in produzione una voce disfatta in silenzio. 📌 *Un `catch` che ingoia tutto protegge l'app e acceca chi la prova: la guardia va accompagnata dalla prova che NON esagera.* ✅⭐⭐ **LA PROVA FISICA, e ha attraversato il punto esatto in cui prima sbagliava.** Su **TEST 6.365** (partita del 03/09 21:00 Campo 2): i **due** Ospite muti, il socio vero (id interno 49) apre **la sua** scheda, l'importo `37,50` si ritrova dopo la chiusura. Poi su **PROD 6.365 a 390×844, cioè a misura di telefono**, sulla **stessa partita** su cui il difetto era stato misurato: «Ospite» **muto**, «Valeria Moschet» apre **la scheda di Valeria Moschet** (id interno 191 uguale da tutt'e due le parti), l'importo digitato **c'è ancora** dopo aver chiuso, la scheda partita **resta aperta**, e «Francesca Cimetta» si apre col tasto **Invio** — zero errori di pagina. ⇒ *Non «non è successo niente di male», ma «è passato di lì e non è successo niente».* 🩹 **Un difetto della SONDA, non del codice, e va ricordato**: la prima corsa confrontava `firstName + lastName`, ma su questi record il cognome sta in `surname` ⇒ diceva «Valeria» contro «Valeria Moschet» e dava un **falso allarme** proprio sulla domanda centrale della voce. La persona giusta si legge da ciò che la scheda **mostra**, che è quello che vede il committente. ⚖️ **COSA QUESTA CHIUSURA NON DICE, e non si arrotonda**: che il nome sia cliccabile **per tutti**. Il click esiste solo per chi ha l'id interno — **120 soci su 2823** letti dall'app oggi, cioè poco più di **quattro su cento**. Non è un difetto di questa voce ed è il verso giusto in cui sbagliare (muto, non sbagliato), ma non è *«cliccando il nome ti apre la sua scheda»* senza aggettivi: quello lo dà la **140**, in coda. 🩹🚨 **E UNA TRAPPOLA PER CHI GUARDERÀ LO SCREENSHOT, lasciata scritta apposta**: nell'immagine della prova su telefono il campo importo è tornato a `0,00`, e sembra smentire la riga qui sopra. Non la smentisce: lo scatto è **posteriore** alla misura. 📏 Rimisurato **senza cliccare niente**, l'importo sparisce da solo in **3 secondi** — è il ridisegno dopo la rilettura del roster, non il click sul nome. ⇒ È la **voce 163**, aperta stasera da questa misura. 📌 *Uno screenshot è un istante: quando contraddice una misura, si guarda l'ora di tutti e due.* 📏 **E un limite trovato sabotando, dichiarato e non curato**: il filtro sul formato dell'id (`/^\d{1,12}$/`) sabotato lascia il banco **verde** — lo tiene in piedi solo il fatto che `_staffCalPlayerCode` filtra a sua volta. È una riga difesa **per combinazione**, non per una prova sua. |
| **160** | ✅ *(05/09/2026 pomeriggio, 85ª sessione — nata dall'avaria della mattina, chiusa a prova MISURATA sul database di PROD)* 🩺 **160. L'avaria di PROD del 05/09: il sync riscriveva 437 righe invariate ogni due minuti, e la macchina era una NANO.** 📏 **La cronaca, misurata dalla sessione precedente**: PROD (`qqbf…`) in avaria dalle **05:57 alle 14:08** locali — letture da 30-40 s, autenticazione che non raggiungeva `localhost:5432`, sync fermo, login del gestionale impossibile (*«Accesso non completato entro 20 secondi»*). 🔎 **La causa cronica**: il sync riscriveva **437 righe invariate ogni 2 minuti** (`unchangedBookingRows: 272 + 165`, `changed: 0`) ⇒ `n_tup_upd` **14.343.602** su 31.193 righe, `n_tup_hot_upd` **0**, **62 GB di WAL** per un database da 685 MB — il **92 %** di tutte le scritture del database. Su una macchina **NANO** (0,5 GB di RAM, al 70 % da una settimana). 📌 *Una riscrittura che non cambia niente non è gratis: costa una riga di WAL, una tupla morta e un autovacuum, 437 volte ogni due minuti, per due mesi.* 🔨 **Tre cure, tutte in servizio**: ① il sync **non riscrive l'invariato**, e la freschezza si legge dal **timbro del giro** (`matchpoint_bookings_auto_import_last`) invece che da `max(synced_at)` sulle righe (PR #1382, `matchpoint-bookings-sync` e `consumer-booking-write`, banco `non-riscrivere-linvariato.test.ts` con 12 prove sabotate 7 volte); ② la **pulizia della fotografia oltre i 30 giorni** (`pmo_cleanup_booking_snapshot`, cron `30 2 * * *` UTC, solo sulla **data** — le lapidi delle partite future annullate restano, correzione sua): **7.329** righe buttate su PROD, 4.689 su TEST; ③ il **free upgrade NANO → MICRO** fatto da lui alle 14:03 (1 GB, 2 core, stesso prezzo), riavvio 14:07-14:08, da allora letture a 0,5 s. ✅⭐⭐ **LA PROVA DELLA CURA ①, fatta il 05/09 pomeriggio sul database vivo — la condizione di chiusura che il passaggio di consegne aveva lasciato aperta**: con `pg_stat` azzerato dal riavvio (`n_tup_upd = 63` alle 12:19 UTC), alle 13:02 UTC il timbro del giro era **12:58:00** (fresco), l'ultimo successo **12:59:07**, e su **16 giri consecutivi** letti in `pmo_audit_log` gli `upserted` sono **1** per ogni giro `light`/`near` (il solo timbro) e **2** per ogni giro `full` — **contro i 437 di prima**. L'unica eccezione è il primo `full` dopo il riavvio (12:22, `upserted: 71`), che sono i cambi **veri** arretrati di otto ore, e infatti `updated_at` delle righe prenotazione si è mosso **una volta sola** (34 `booking` + 35 `booking_occupancy` alle 12:23:45) e mai più. 📏 Delle 1.192 scritture su `pmo_cloud_records` dopo il riavvio, il sync prenotazioni ne firma ~100; il resto è il sync **pagamenti** (468 righe in un colpo alle 12:23, cioè otto ore di arretrato, poi 28 alle 13:00 — un giro l'ora, non uno ogni due minuti) e i 36 `wallet_balance`. ⇒ **Il 92 % è sparito**. 🩹 **Le lezioni della giornata, che entrano nelle regole** (`CLAUDE.md`, sezione delle 4 app): il compute di PROD è **MICRO dal 05/09**; *un ripristino in `finally` protegge dall'eccezione, non dal tempo* (token scaduto → ripristino partito a vuoto, e tre tentativi uccisi dai MIEI timeout, non dal database); *il vuoto si attribuisce alla propria sonda prima che al mondo* (cinque volte in un giorno); *le mie pagine aperte pesano* (polling del semaforo ogni 4 s × 3 console = 23 chiamate da 100 s sovrapposte su un DB in ginocchio); *«si ricarica da sé» era falso* — era la RAM, non i crediti di I/O. ⏳ **Cosa NON dice questa chiusura**: il WAL non è stato rimisurato su una giornata intera (`pg_stat` è azzerato dal riavvio, e una misura di un'ora non è una misura di un giorno); e la sentinella che avrebbe suonato a metà luglio **non esiste ancora** — è la voce 161. ⚖️ La decisione sul compute (MICRO → SMALL) è **sua** e sta fra le decisioni in testa al file, non qui. |
| **159** | ✅ *(05/09/2026 pomeriggio, 85ª sessione — **voce SUA**, nata e chiusa nello stesso giro, a prova fisica con la console remota su TEST e su PROD)* 🏟️ **159. «Non si vede il campo 4»: il calendario disegnava quattro corsie in una scatola da tre.** 🗣️ Sua, con l'allegato del passaggio di consegne: *«controlla il calendario di prod e di test perché non si vede il campo 4»*. 📏 **Prima cosa, i DATI — e i dati c'erano**: su `qqbf…` 88 prenotazioni sul Campo 4 da settembre in poi, su `cudi…` 80 ⇒ il campo spariva nel **disegno**, non nel database. 📏 **Poi la pagina viva, a 1440×900, su tutt'e due gli ambienti — identica al pixel**: la colonna del calendario (`.svc-grid-col`) è alta **507px** dalla 153/C (`100vh − 393`), ma `_staffCalBuildHorizontal` dimensionava le corsie fino al fondo della **finestra** — `innerHeight − rectTop − 48`, cioè 4 × 165 + 24 = **687px** — e C4 stava **tutta** sotto il bordo (top 710, bordo 697), con C3 tagliata a metà e **140px di vuoto** sotto la scatola. ⚖️ **La causa è di ieri sera, ed è una cura**: prima della 153/C il contenitore era `80vh` (720px) e le stesse corsie ci stavano **per caso**; la 153/C ha stretto la scatola senza dirlo a chi la riempie, e i due numeri hanno smesso di combaciare la sera stessa. 📌 *Una misura che ne governa un'altra va cambiata insieme a lei: una scatola più piccola con dentro lo stesso contenuto non è più piccola, è rotta.* 🔨 **① Sul computer l'altezza disponibile si legge dalla colonna che scorre**, dal vivo (`closest('.svc-grid-col')`), meno i 2px di bordo; il telefono non cambia, perché là la scatola è la pagina intera. ✅ TEST 6.362 a 1440×900 e 1920×1080: C4 dentro (575–695 su 697). 🩹⭐ **② E la stessa forma un piano più in basso, vista misurando a 1280×800 e 1024×640**: la colonna scorreva ancora di **4** e **51px**, perché il **pavimento** CSS era **360px** mentre le corsie hanno un minimo loro — 96px l'una, cioè 4 × 96 + 25 di testata + 2 di bordo = **411px**. Due minimi che dicevano due numeri. ⇒ Il pavimento diventa una variabile con un nome (`--pmo-cal-pavimento: 411px`), e sotto quell'altezza a scorrere torna **la pagina**, come il commento della 153/C prometteva senza mantenerlo. 🧪 Banco `test/le-corsie-del-calendario-stanno-nella-scatola.test.mjs`, **6 prove**: che la misura venga dalla colonna, che la colonna sia davvero lo scroller (`overflow:auto` — la premessa che muore in silenzio), che i **due pavimenti dicano lo stesso numero**, e che la cornice stia nella `@media` del **computer**. **Sei sabotaggi, sei rossi** — compreso il pavimento riportato a 360 e la cornice spostata nel blocco del telefono (la trappola ① della 153). 🩹 **E la sonda del banco è nata sbagliata due volte**: cercava il primo `@media (min-width:900px)` del file (che non è quello del calendario), poi si fermava alla regola `#staffCalV36 { … }` invece di salire fino alla `@media`. È la 155 — *«il più vicino indietro non è il contenitore»* — pagata una terza volta prima di scriverla per bene: ora **conta le graffe coi commenti spenti e sale di blocco in blocco** finché trova una `@media`. ✅⭐⭐ **PROVA FISICA, con la console remota, su TEST 6.363 E su PROD 6.363, a QUATTRO larghezze** (1024×640 · 1280×800 · 1440×900 · 1920×1080): corsie 96 · 96 · 120 · 165 px, C4 **dentro la colonna** in tutti gli otto casi, e la colonna che **non scorre più** (`scrollHeight = clientHeight`: 411 · 411 · 507 · 687). Sulla schermata di TEST, nella corsia C4 del 7/09 si vede la partita delle 09:00 di Lidia Comes. ⏳ **Cosa NON dice**: il **telefono** non è stato rimisurato — la cura non lo tocca per costruzione (il ramo è sotto `isDesktop`), ma «non lo tocca» è una lettura del codice, non una prova. ⚖️ Chiusa da me a prova fisica; il suo occhio sul calendario è la conferma che vale di più. |
| **137** | ✅ *(05/09/2026, 84ª sessione — chiusa a **prova fisica sulla pagina viva**, computer e telefono)* 🚦 **137. «Cosa sta succedendo su Matchpoint», fuori dalla scheda.** 🔨 Cinque pezzi: la coda smette di chiamare «modifica» una lettura, le edge dicono al worker **chi** ha chiesto la scrittura, `matchpoint-queue-status` filtra l'automatico e **traduce** in frasi del gestionale, le coordinate strutturate per la cella, e la barra che diventa il **posto unico** dove si leggono le azioni — con **due fonti** che non si sostituiscono: la **locale** (l'app sa cosa ha appena chiesto lei, senza passare da nessuna rete) e la **coda** (l'unica che sappia dei gesti **degli altri**). 🚨⭐⭐ **Il difetto che ha tenuto la voce aperta due giorni, e che nessuna delle due spiegazioni scritte nella scheda nominava: le coordinate della cella stavano in `_staffCalBuildGrid`, una funzione che NESSUNO chiama** — `renderStaffCalendar` manda su `_staffCalBuildHorizontal` in tutt'e due i rami ⇒ `svcAccendiCella` cercava `.cell[data-campo]` in una griglia che non ne ha **nemmeno una** (misurato su PROD 6.357: 118 `div`, `.cell` = **0**). ⚖️ Le due spiegazioni vecchie — «la griglia è vuota per via del readonly», «su telefono le celle non esistono per costruzione» — erano **tutt'e due false**, e pericolose proprio perché davano al vuoto una causa **innocente e definitiva**: la forma esatta di una cosa che nessuno riprova. 🔨 Curata mettendo le coordinate dove si disegna davvero, come **intervallo in minuti** (un gesto sulle 09:30 accende la partita 09:00–10:30, invisibile a un confronto d'uguaglianza), con **una sola** ricerca condivisa con la pastiglia e il contenitore scelto per **visibilità**, così vale anche sul telefono. ✅ **Provata su TEST 6.360**: a 1440×900 24 pezzi con le coordinate, 1 cella accesa ed **è quella giusta**, spenta all'esito; a 390×844 1 accesa **nell'agenda**, 0 nella vista nascosta, pastiglia in basso a 12 px. ⭐ E i **due verdetti** della barra visti tutt'e due sul vivo: «✅ fatto» su TEST (risponde il simulatore), «❔ non so com'è finita» su **PROD** con la rete caduta — cioè **la riga che costa** di questa voce, esercitata sulla finestra esatta in cui sbaglierebbe. 🔒 Nessuna scrittura è uscita dal browser: su PROD la guardia dell'attrezzo aborta `/functions/v1/`, su TEST risponde `[pmo-mp-sim]` **dentro la pagina** in 8 ms. ⛔ **Non provato**: nessun gesto vero di segreteria attraversato fino in fondo — la console entra in sola lettura. 🧪 Banco `la-cella-si-accende-dove-si-disegna.test.mjs`, **15 prove** con la regola **eseguita** e non riletta, sabotato in **otto** modi, tutti visti cadere. 📌 *Un pezzo di codice che nessuno chiama non è «da provare»: è già rotto, e la prova che manca è l'unica cosa che lo direbbe.* |
| **157** | ✅ *(04/09/2026, 83ª sessione — **voce SUA**, e **chiusa da lui la sera stessa**: «controllato ed è ok»)* 🔼 **157. La nota di due righe, e il titolo sale nella testata.** 🗣️ **Suo, il 04/09/2026 a notte**, guardando la scheda di una partita: *«Sulla parte sinistra c'è il campo nota che è troppo alto, poi diminuirlo di parecchio, tanto di solito una nota che si mette non è mai più di 2 righe. Mentre la parte sinistra la puoi alzare all'altezza del titolo della scheda, fammi un mockup»* → tre letture disegnate, e lui: **«fai la A»**. 📏 **MISURATA LA SCHEDA VERA PRIMA DI DISEGNARE**, su PROD 6.346 a 1440×900: finestra 860, colonna sinistra 330, titolo **41 px + 10 di margine**, e i pezzi della sinistra Slot 152 · Nota 161 · bottoni 87 · conto 120 = **521**, contro i **396** della colonna giocatori. 🎨 **Mockup** `mockup/scheda-nota-e-titolo-mockup.html`, e **si misura da sé**: la tabella sotto ogni variante la calcola il browser aprendo la pagina. 🚨⭐ **E il mockup ha detto una cosa che non avevo previsto** — è il motivo per cui si disegna prima di scrivere: l'altezza della finestra la detta **la più alta delle due colonne**. Con pochi giocatori comanda la sinistra e accorciare la nota si vede tutto; con **quattro** le due quasi pareggiano (484 contro 460) e da lì **ogni pixel tolto alla nota non lo vede più nessuno**. ⇒ La ① da sola non basta, e la A vince perché il titolo è a **tutta larghezza**: toglierlo dalla griglia guadagna **sempre**, chiunque delle due stia comandando. 🔨 **① La nota**: 3 righe → **2**, e il minimo da 64 a 48 ⇒ da **85 a 64 px**. ⚠️ Resta **trascinabile** (`resize:vertical`): si toglie spazio sprecato, non una possibilità. 🔨 **② Il titolo** esce dal flusso e si posa nella **testata**, che conteneva solo la ✕ — spazio già pagato, e vuoto. Le due colonne partono in cima. ⭐⭐ **SOLO CSS, il DOM non si tocca — e la misura che l'ha reso possibile**: nella catena `.svc-edit-box` → `.svc-msg` → `#svcChatMessages` → `#svcChatPanel` **nessuno è `position:relative`**, e il pannello è `fixed` ⇒ un figlio `absolute` risolve contro il **pannello** e **non viene ritagliato** da `#svcChatMessages` benché quello sia `overflow:auto` (il ritaglio vale solo per i discendenti il cui blocco contenitore sta dentro chi ritaglia). ⚖️ La strada ovvia era **spostare il nodo** nella testata: avrebbe funzionato, e avrebbe lasciato un titolo che **sopravvive al box che l'ha creato** — una scheda chiusa e una testata che continua a dire «Campo 3 · 14:00». Da `absolute` il titolo **vive e muore col box**, perché ci resta dentro. 📌 *Prima di spostare un nodo per ottenere una posizione, si guarda se la posizione si può **chiedere**. Un nodo spostato porta con sé un ciclo di vita da sorvegliare.* 🚨 `pointer-events:none` non è un vezzo: la ✕ vive nella **stessa banda**, e un titolo che si prende i click è la **voce 146 daccapo** — due bersagli vicini e la mira che trova quello sbagliato. 🩹⭐ **E UN DIFETTO CHE IL BANCO NON POTEVA VEDERE, trovato sulla pagina viva di TEST 6.348**: la colonna dei giocatori restava a **280** mentre lo Slot era a **118**, cioè scivolata sotto invece di partire in cima — proprio la cosa che la A doveva ottenere. 🔎 La causa vale più del difetto: `grid-row:2 / span 10` esisteva perché la riga 1 era del **titolo**; tolto il titolo dal flusso quel `2` descriveva **una vicina che non c'è più**, e nessuna prova poteva accorgersene perché la regola era ancora lì, scritta bene, e sbagliata. 📌 *Un numero che descrive la posizione di qualcun altro invece della propria diventa falso quando l'altro se ne va — e resta verde.* 🧪 **Banco** `test/il-titolo-sale-nella-testata.test.mjs`, **11 prove**, e le due che valgono guardano le **premesse**: che nessun antenato diventi `position:relative` (il titolo tornerebbe dentro il box e si accamperebbe sulla prima sezione, in silenzio) e che il titolo resti **figlio diretto** del box. 📏 **Otto sabotaggi, otto rossi.** ✅⭐ **PROVATO SULLA PAGINA VIVA, su TEST 6.349 E su PROD 6.349, a TRE larghezze** (1280×800 · 1440×900 · 1920×1080): titolo `absolute` alto **20 px** — una riga — **dentro la banda** della testata, nota **64 px**, Slot e Giocatori **tutti e due a 118** ⇒ partono in cima, la **✕ risponde ancora** al suo centro e il titolo **non si prende i click**. ✅ **E il suo occhio è arrivato la sera stessa**: *«controllato ed è ok»*. ⇒ Chiusa nella forma che il POSTULATO chiede — il lavoro gli è arrivato **provato** (TEST e PROD, tre larghezze), e a lui è toccato **verificare che quel che avevo detto fosse vero**, non scoprire se funzionava. |
| **158** | ✅ *(05/09/2026, 84ª sessione — **voce SUA**, chiusa a prova fisica: parole **e** gesti)* 🤖 **158. Un collaudo che parla col bot: una conversazione scritta, gesti compresi.** 🗣️ *«visto che noi abbiamo anche un chatbot collegato al gestionale, riusciresti a fare anche gli stessi test sul chatbot?»* → *«mettila in lista e falla»* → *«il nostro chatbot funziona sia a gesti che a parole»*, riga che ne ha deciso la forma. 📏 **Il buco, misurato**: dal cloud si arriva al banco, al deploy, al registro e al ponte; **non** si può mandare un messaggio al bot — per scrivere a un bot serve un account Telegram, e il nostro è in long polling, quindi non c'è nemmeno una porta dove posare un update finto. ⭐⭐ **La strada l'ha aperta una misura del codice**: il ciclo del polling fa **una cosa sola** con ciò che riceve — `gestisciMessaggio` oppure `gestisciTocco`, **due porte e nessun'altra** — e *tutte* le chiamate a Telegram passano da **una sola** funzione. ⇒ Si dà in pasto al bot una conversazione senza Telegram, e intercettando quel filo si raccoglie la trascrizione intera **mentre le chiamate al gestionale passano vere**. 📌 *La finzione sta sul filo di Telegram e basta: dal ponte in giù è tutto reale.* 🔒 Entra come **terzo modo di `avvio-prova.ts`**, dopo le sue cinque serrature: ricopiarle sarebbe la trappola dichiarata del progetto. 🚨 E una serratura nuova **che si dimostra**: `getUpdates` fallisce di proposito ⇒ «non fa polling» non è una promessa in un commento ma un fatto che il codice non può violare (difesa dal **409**). 🚨⭐ **I gesti si indicano per l'ETICHETTA che si legge**, non per il `callback_data`: è quello che fa un socio, ed è l'unico modo di accorgersi se quel bottone cambia parola — un copione scritto coi codici resterebbe **verde** con la scritta cambiata. E un'etichetta ambigua **ferma tutto** elencando i candidati. 🧪 Banco 13 prove, **cinque sabotaggi cinque rossi**; banco intero 1731 verdi. ✅⭐⭐ **PROVA FISICA, tutt'e due le metà, sul bot di prova della VM contro il gestionale di TEST.** **Parole**: «ciao» → *«Ciao! Sono l'assistente automatico del Padel Village…»*, col messaggio di passaggio cancellato e lo schermo che se ne accorge. **Gesti**: «vorrei prenotare un campo» → le ore di oggi → **premuto «⬅️ Altri giorni»** → il bot **riscrive lo stesso messaggio** in «Prenota un campo» con la griglia dei giorni. Lo schermo finale porta i bottoni **nuovi**: il modello ha seguito la riscrittura sul posto, che è la premessa su cui i gesti poggiano. Il bot in pm2 è rimasto su: nessun 409. 🩹⭐⭐ **E il difetto più costoso era MIO e sembrava del gestionale**: il collaudo saltava `avvio.ts`, unico posto in cui il segreto del ponte veniva letto dal suo file ⇒ girava **senza segreto**, e non taceva: rispondeva *«non riesco a recuperare le tue prenotazioni»*, con la faccia di un guasto del gestionale di TEST. Ero a un passo dall'aprire una voce contro un gestionale **sano**. 🔨 Curato con `preparativi.ts` — un posto solo, chiamato da `avvio.ts` **e** dal collaudo. 📌 *Un vuoto va attribuito alla propria sonda prima che al mondo — e una sonda avviata a metà non è cieca: misura un bot che in produzione non esiste.* ⭐ **E il primo gesto ha insegnato due cose fallendo**: che il bot, a «prenota», **salta il passo dei giorni** e mostra le ore di oggi; e che l'attrezzo, davanti a un'etichetta che non c'è, **non preme a caso** — si ferma ed elenca cosa c'era. *Una sonda che sceglie da sé fra i bersagli non fallisce: riesce sul bersaglio sbagliato.* ⏳ **Cosa NON dice, dichiarato**: che Telegram consegna, che sul telefono si vede bene, e niente della tastiera vera. Il primo anello (il dito) e l'ultimo (lo schermo del socio) restano suoi. |
| **153** | ✅ *(05/09/2026, 84ª sessione — **voce SUA**, nata da una sua domanda e chiusa a prova fisica su PROD)* 🖥️ **153. La scheda e il calendario non scalavano col monitor — TRE lavori, in quest'ordine.** 🗣️ *«hai fatto anche un pensiero sul fatto di rendere scalabile/adattabile la scheda e il calendario a seconda del tipo di monitor? cioè se è un 15 pollici o un 13 o un 9?»* — e la risposta onesta era **no**. 🗣️ L'ordine l'ha deciso chi lavora, su sua richiesta esplicita: *«Non mi chiedere a me da dove devi partire. Decidi tu dove è meglio per il progetto.»* 🎨 **Mockup che si misura da sé** (`mockup/scheda-e-calendario-scalano-mockup.html`): le larghezze candidate stanno dentro **schermi finti** della larghezza dichiarata (`container-type:inline-size`), così è **il browser** a fare il conto di `clamp` invece di rifarlo in JavaScript sperando di ricopiare la regola giusta. ⭐⭐ **C — il calendario non entrava MAI, e non è un modo di dire.** Il modello misurato è `190 (sopra) + 80% dell'altezza finestra + 203 (sotto)` e prevede **esattamente** il misurato (265 · 233 · 213 px da scorrere a 640 · 800 · 900) ⇒ la pagina sarebbe entrata solo con una finestra alta **1.966 px**: anche su un 1920 era fuori, si notava meno e basta. 🔨 Il calendario prende **quello che resta** (`max(360px, calc(100vh - var(--pmo-cal-cornice)))`). ✅ A 1440×900 la pagina **non scorre più**: 213 → **0**, con la colonna che scorre 180 px dentro di sé. 🚨🚨 **E il fatto che ha deciso tutto l'ordine**: `.svc-layout { height: min(80vh, 860px) }` governava **due cose** — la scheda partita **e** la shell del calendario. Curare il calendario cambiando quel numero avrebbe mosso la scheda, cioè le sette voci confermate una per una la notte prima. ⇒ C scrive l'altezza nel selettore del **solo** calendario e **scioglie l'incastro**; solo dopo A poteva toccare il pannello. ⭐ **A — la larghezza smette di essere un numero.** Da `860px` fissi (l'**84%** dello schermo su un 1024, il **45%** su un 1920: *la stessa misura per schermi che differiscono del doppio*) a `clamp(620px, 66vw, 1180px)`. ✅ 1024 → **676** · 1280 → **845** · 1440 → **950** · 1920 → **1180**, e i quattro numeri coincidono **AL PIXEL** con quelli che il mockup aveva calcolato **prima** che la riga fosse scritta. 📌 *Un disegno che si misura non illustra una decisione: la **predice**.* ⚠️ **Rovescio dichiarato**: su un 1024 la scheda diventa più **stretta** (676 contro 860) — è il senso della cura, ma è meno spazio; su un 1280 non cambia quasi nulla. **A si sente sui monitor grandi e sui piccoli, non in mezzo.** ⭐ **B — le colonne proporzionali** (`minmax(280px,.85fr) minmax(0,1.15fr)` invece di `330px` fisso). ✅ A 1024 sposta **50 px** dallo Slot ai giocatori (330/300 → **280/350**, +17% alla colonna più alta) **senza costare un pixel di altezza**: 499 e 696 identiche, scheda 706 in tutt'e due. 🩹⭐⭐ **E tre difetti di metodo pagati lungo la strada, che valgono più delle cure:** ① la riga di C era finita dentro **`@media (max-width:899px)`**, cioè sul **telefono** — su desktop non si sarebbe applicata mai; la sonda l'ha vista subito (512 px = ancora 80vh) ma la spiegazione che viene per prima è «il deploy non è arrivato». 📌 *«Un selettore già scoped al calendario» non dice in quale `@media` sta: lo scope dell'**elemento** e quello della **larghezza** sono due cose diverse.* ② il primo giro di A ha colto il deploy **a metà** (due larghezze su v6.354, una su v6.355) e senza la riga che legge la **versione dalla pagina** avrei concluso «A funziona solo a 1920» da misure fatte sul codice vecchio. 📌 *Una misura su una pagina viva porta **due** dati: il numero e la versione che l'ha prodotto.* ③ il primo confronto di B misurava il «prima» su **PROD** e il «dopo» su **TEST** — due basi dati, due partite diverse: le altezze risultavano peggiorate (499→571, 696→752) e avrebbero fatto scrivere «B allunga la scheda». 📌 *Un prima/dopo su dati diversi non è un confronto: è **due misure** — e la metà che si legge lo stesso (la regola) rende credibile il resto, che è ciò che lo fa passare.* La cura: le due regole a confronto **sulla stessa pagina, sulla stessa partita**. ✅ **Tutt'e tre in servizio su PROD** (C 6.353 · A 6.355 · B 6.357) e **provate su TEST e su PROD** con la console remota. 🩹⭐⭐ **CODA DEL 05/09: il commento di C ha fatto cadere un banco, e il difetto era del BANCO.** Aprendo la sessione dopo, `main` era **rosso**: 103 verdi, 1 rosso — il test ⑤ di `lultima-scheda-aperta-sta-sopra` dichiarava che la regola della scheda partita **non** stava dentro `@media (min-width:900px)`, e la regola stava esattamente dove doveva. 📏 La sonda ritagliava il blocco con `lastIndexOf('@media')`, cioè *«la parola più vicina indietro»*, e il commento di C — scritto **dentro** quel blocco — nomina `@media` nella sua spiegazione: la «condizione» che leggeva era **mezza frase di prosa**. 📌 È **la riga già scritta nella voce 155** — *«una sonda che cerca il più vicino indietro in un testo annidato non trova il contenitore: trova il vicino»* — curata là e **rimasta qui**: una lezione scritta in una scheda non si applica da sola alle altre. 🔨 Cura della **classe, non dell'istanza**: la parola resta nel commento (toglierla lascerebbe il difetto al prossimo che scrive `@media` in una spiegazione), e la sonda impara a **contare le graffe** e **saltare i commenti**. 🩹 E la prova scritta per la sonda **è nata sbagliata**: ricopiava la logica invece di chiamarla, quindi sabotando la funzione vera restava verde. 📌 *Una prova che ricopia la logica non prova la logica: prova la copia, e la copia non va in produzione.* 📏 **Quattro sabotaggi, quattro rossi**, compreso il ritorno a `lastIndexOf` — il banco difende ora contro la propria malattia. |
| **149** | ✅ *(04/09/2026, 84ª sessione — chiusa da lui: «ok»)* 💶 **149. Gli importi si aprivano a zero.** 🔨 La cura è una **funzione pura**, `_pmoImportoCasella`, gemella di `_pmoWalletPastiglia`: quando l'importo non è ancora stato letto la casella è **vuota, col trattino** come segnaposto. 🚨⭐⭐ **Perché è una voce e non un dettaglio estetico**: `0,00 €` è un **numero vero** — vuol dire «questo giocatore non deve niente». Usarlo per dire «non lo so ancora» rende le due cose **indistinguibili proprio davanti a chi sta per incassare**. Il trattino non è più bello: è **l'unica forma che non mente**. 📌 *È la stessa idea del «conto parziale» della 152, un piano più in basso: là un totale che dice `24,00` per «24,00 più qualcosa», qui una casella che dice `0,00` per «non lo so».* ✅ Prova sulla pagina viva di TEST 6.334, scheda vera a 390 px, **nei due versi**. ✅⭐ **E sul vivo di PROD 6.349 la notte del 04/09**, che era la parte mancante: tolta dalla memoria locale del browser effimero la lettura degli importi di una partita vera, le **quattro** caselle si sono aperte **vuote col trattino** — non a zero. Poi confermata da lui. |
| **150** | ✅ *(04/09/2026, 84ª sessione — **chiusa da LUI con un SALVA VERO**: «funziona»)* 🔔 **150. L'esito detto due volte in fondo alla scheda.** 🔨 La regola della 136 applicata all'oggetto che le mancava: dentro la scheda l'esito di un gesto si scrive in **un posto solo**. 📌 **È la quarta voce della stessa famiglia** (136 · 145 · 147 · 150), e il perché va tenuto: i posti in cui un gesto può essere raccontato sono **quattro** — chat · pastiglia · riga nella scheda · barra — e ogni cura ne aveva governato uno per volta. *Chi cura un doppione conta gli oggetti che ha in mente, non quelli che ci sono.* 🧪 Banco verde e sabotaggi rossi. ✅⭐⭐ **E QUESTA È LA VOCE CHE NON POTEVO CHIUDERE IO, ed è chiusa da lui**: serviva un **Salva vero**, che scrive sul Matchpoint del circolo — fuori da ciò che la delega copre. Quello che avevo provato era che la regola è **cablata** e che il banco cade su ogni sabotaggio; che sullo schermo comparisse **una riga sola** poteva dirlo solo il suo occhio su un salvataggio vero. 📌 *Una guardia testuale dice che il meccanismo è giusto, non che sullo schermo si veda una cosa sola: il confine fra le due è esattamente dove finisce ciò che posso provare da solo — e quando è lì, si chiede, non si dichiara.* |
| **151** | ✅ *(04/09/2026, 84ª sessione — chiusa da lui: «ok»)* 💶 **151. L'importo si ricorda, e dice quando.** 🔨 **La lettura non si butta più**: `_staffCalPersistRosterFromWorker` teneva i soli **nomi**, quindi ogni apertura della scheda ricominciava da capo e gli importi ricomparivano solo quando Matchpoint rispondeva. Ora il record porta anche gli importi e **l'ora in cui sono stati letti** — che è ciò che permette alla 152 di dire «questi numeri sono un minimo» invece di far finta di sapere. 🚨⭐⭐ **E il difetto stava DENTRO la cura, in una riga che sembrava un'ottimizzazione**: l'uscita anticipata «già allineato» confrontava **solo i nomi**. Con gli importi nel record, un cambio di importo su Matchpoint a **stessi giocatori** non sarebbe mai stato ricordato — la funzione sarebbe uscita dicendo «uguale» **dopo aver guardato metà del dato**, e nessuno se ne sarebbe accorto perché il caso è silenzioso. 📌 *Una guardia «è cambiato?» che confronta meno di quello che salva non protegge: **congela**.* ✅ **Prova fisica su PROD**: aperta due volte la stessa partita — la seconda gli importi compaiono **senza attesa**, e la memoria è quella (togliendola, le caselle tornano al trattino della 149). ⭐ È la stessa riga che il 04/09 a notte ha permesso di esercitare il ramo «conto parziale» della 152: la memoria si poteva **togliere**, quindi si poteva **vedere l'app senza di essa**. |
| **152** | ✅ *(04/09/2026, 84ª sessione — **voce SUA**, chiusa da lui: «ok»)* 📐 **152. La scheda entra tutta, e il conto della partita.** 🗣️ Sua, sulla scheda partita, e poi sulla variante da mettere nello spazio che si libera: **«fai la A»**. 📏 La misura che l'ha fatta nascere: la finestra è **860 px** e la scheda ne usava **612** — **231 vuoti a destra** — mentre **453 px** di giocatori stavano stretti. 🔨 **① Due colonne da 900 px in su**: a sinistra Slot · Note · bottoni · il conto, a destra i giocatori. 🚨⭐⭐ **Solo CSS, il DOM non si tocca — e non è pigrizia, è la 150**: la strada ovvia era incartare i nodi in un contenitore nuovo, e avrebbe fatto tornare il doppione dei messaggi **lasciando il banco della 150 verde**. 🔨 **② Il conto della partita**: *a carico · già incassato · manca*, regola **pura** (`_pmoContoPartita`), così il banco la **esegue** invece di ricopiarla. 🩹 Il vecchio «Totale da incassare» è stato **tolto, non affiancato**: rispondeva a **una** delle tre domande e il conto la contiene. 🚨⭐⭐ **E la parte che vale più dei tre numeri è `ignoti`**: se anche **una** riga ha l'importo non letto, quella somma non è il conto — è un **minimo**, e la scheda lo scrive in chiaro. È la 149 un piano più su: là una casella diceva `0,00` per «non lo so», qui sarebbe un **totale** che dice `24,00` per «24,00 più qualcosa». 📌 *Un totale che ha saltato una riga non è approssimato: è falso, e guardandolo non si distingue da uno giusto.* 🧪 Banco `il-conto-della-partita.test.mjs`, 12 prove che eseguono la regola. ✅ Provata sulla pagina viva di TEST 6.340 alle due larghezze. ✅⭐⭐ **E il ramo «CONTO PARZIALE», che era il motivo per cui la voce restava aperta, è passato sul vivo di PROD 6.349 la notte del 04/09**: tolta dalla memoria locale del browser effimero la lettura degli importi di una partita vera (7/09 · Campo 4 · 09:00), la scheda si è aperta con le quattro caselle **vuote col trattino** e sotto il conto l'avviso giallo *«⚠️ Conto parziale: 4 importi non ancora letti da Matchpoint. I numeri qui sopra sono un minimo, non il totale.»* 🩹 Il primo tentativo aveva cancellato un campo che **non esiste** (`importo` invece di `importoCents`): la scheda si apriva completa e il ramo non veniva esercitato — *una sonda che toglie la cosa sbagliata non fallisce, riesce senza aver provato niente.* |
| **154** | ✅ *(04/09/2026, 84ª sessione — **voce SUA**, segnalata con la schermata e chiusa da lui: «ok»)* 🪟 **154. L'ultima scheda aperta sta sopra.** 🗣️ *«Ti trovato un errore con la scheda aperta della partita se clicco sul nome la scheda di anagrafica va sotto invece che sopra.»* 📏 **La causa non è un numero sbagliato: è un numero che NON DECIDE.** `.member-card-overlay` e `.svc-chat-panel` avevano **lo stesso** z-index (2600) — a parità decide l'ordine nel DOM, e `#svcChatPanel` viene dopo ⇒ la scheda partita vinceva **sempre**, chiunque fosse stato aperto per ultimo. ⛔⭐⭐ **E alzare la scheda socio e basta sarebbe stato sbagliato — è la parte che vale**: dalla scheda socio si salva l'anagrafica, e l'esito di quel salvataggio lo scrive `pmoMemberEditChatFlow` **aprendo il pannello della chat**, che sarebbe finito sotto. ⇒ Si curava il difetto mostrato **creandone il gemello** nel punto in cui si scrive su Matchpoint — e quello nessuno lo guarda, perché nessuno lo sta cercando. 📌 *Una cura che sposta il difetto invece di toglierlo si riconosce così: cura il caso che ti hanno mostrato e rompe quello che non ti hanno mostrato.* 🔨 `pmoPortaInCima(el)`: **una classe sola che passa di mano** fra le due schede, agganciata a tutt'e due le aperture. Un `if` che alza e non abbassa lascerebbe due elementi a 2720 e il pareggio tornerebbe identico. 🚨 Sta **dentro** la soglia dei 900 px: sotto, la scheda partita è un foglio dal basso a z-index 300, e il difetto misurato è del desktop. 🧪 Banco `lultima-scheda-aperta-sta-sopra.test.mjs`, 13 prove che **eseguono** la regola su un DOM finto invece di cercarla a parole; **quattro sabotaggi, quattro rossi**. ✅⭐⭐ **Prova fisica su PROD, e col gesto vero**: aperta dalla griglia la partita del **7/09 · Campo 4 · 09:00**, cliccato **«Lidia Comes»** → risponde `memberCardOverlay`; riaperta la partita → i due si invertono. **18 giri su 18** su tre larghezze, sui tre versi. 🩹 E l'oscillazione «1 su 6» vista prima **era la sonda**: chiudevo la scheda socio togliendo la classe a mano (quindi `memberInlineOpenId` restava pieno e `openMemberCard` faceva da **interruttore**), e cercavo l'esito **senza portarlo in vista** — *un messaggio fuori dalla finestra non è coperto, è altrove*. 📌 *Un numero che oscilla va inseguito fino a sapere CHI oscilla, o si dichiara fragile una cura sana.* ⏳ Resta **non provato** e dichiarato: il salvataggio **vero** di un'anagrafica, che scrive su Matchpoint. |
| **156** | ✅ *(04/09/2026, 84ª sessione — **voce SUA**, chiusa da lui: «ok»)* 🏷️ **156. «Impostazioni» al posto di «Amministrazione».** 🗣️ *«nel menù in alto c'è una parola che si chiama amministrazione che può essere confusa con l'amministrazione economica. cambiamo il nome cosa suggerisci?»* → proposto **Impostazioni**, e lui: *«va bene impostazioni»*. 📏 **Guardato COSA C'È DENTRO prima di proporre il nome**, perché un'etichetta deve descrivere quello che apre: Utenti Staff · Notifiche staff · Dati · Bot Telegram — **non una riga di soldi** ⇒ la confusione che vedeva non era un'impressione, il nome prometteva una cosa e il menu ne apriva un'altra. 🔨 **Cambiate tutte le 24 occorrenze che si leggono**, compresi i **quattro testi del LOGIN**: *è lì che va a cercare chi non riesce a entrare, e lasciarne uno indietro manda una persona reale a cercare una voce che non esiste più.* 🚨🚨 **La chiave interna `administration` NON toccata**, ed è il vero pericolo della voce: ci sono appese la visibilità per ruolo e i salti `goToTabSection`. Chi «completa» la rinomina cambiando anche quella **non rompe una scritta: spegne un capitolo intero**, in silenzio, perché il menu continua a disegnarsi. ⚖️ **E il conflitto della promozione ha mostrato una cosa vera**: su `main` la voce «Circoli» non esiste — è lavoro che vive solo su `test-preview`. 📌 *Una promozione porta le righe del suo fix, non quelle che le stanno accanto nel diff.* 🩹 Per la stessa ragione il banco elenca le **quattro** voci comuni ai due rami: uno che pretendesse «Circoli» sarebbe **rosso su PROD** per un fatto che non riguarda la cura — *un banco che viaggia con una promozione deve reggere sui DUE rami, o non è una garanzia: è un pedaggio.* 🧪 Banco `il-menu-non-dice-amministrazione.test.ts`, 7 prove, **tre sabotaggi tre rossi** (un messaggio del login lasciato indietro, la chiave rinominata, un salto tradotto col nome invece della chiave). ✅ Provata sulla pagina viva di **TEST 6.346 e PROD 6.346**, pagina di accesso compresa. 🩹 Residuo dichiarato e non curato: la parola resta in **3 commenti** di due edge e in un nome di prova del bot — toccarli rideploierebbe due funzioni vive per un fatto cosmetico. |
| **155** | ✅ *(04/09/2026, 84ª sessione — **voce SUA**, chiusa da lui: «ok»)* 📌 **155. La barra dei capitoli resta ferma, il sotto scorre.** 🗣️ *«questa barra su desktop deve rimanere sempre fissa e il sotto scollare»*, con la schermata. 📏⭐ **Misurata la pagina viva PRIMA di scrivere una riga, ed è il pezzo che conta**: `sticky` non funziona «in generale», funziona rispetto a **un antenato preciso** — e qui gli antenati non erano quelli che sembravano. A scorrere **non è il documento** (`html` e `body` sono `overflow:hidden`, e `scrollHeight − clientHeight` valeva **zero**); lo scroller è **`main.main-content`**; e fra la barra e lui c'è **un solo** antenato, `.container`, che è `overflow:visible` — cioè esattamente la condizione perché lo sticky viva. 📌 *Nessuna delle tre si vedeva leggendo il CSS: `overflow:hidden` su `body` è dichiarato seicento righe più in là.* 🔨 `position:sticky; top:0; z-index:1200` dentro i 900 px. ⚖️ **`top:0` e non `top:20px`**: quei 20 px sono il padding di `.container`, e fermandosi lì il contenuto scorrerebbe *dentro* quella fascia. 🚨 **1200 sta SOTTO il velo delle schede** (2550): *una barra accesa sopra un velo scuro non sembra fissa, sembra rotta.* 🧪 Banco `la-barra-dei-capitoli-resta-ferma.test.mjs`, 6 prove, **cinque sabotaggi cinque rossi** — e le due che valgono non guardano la regola, guardano le **premesse**: che `.container` non dichiari `overflow` (glielo mettessero, la barra smetterebbe di seguire lo scorrimento **senza rompere niente a voce alta**) e che `.main-content` resti lo scroller. 🩹 La prima versione di una prova era **rossa su una cura giusta**: cercava la `@media` con `lastIndexOf`, che fra l'apertura e la regola trova quelle **già chiuse**. 📌 *Una sonda che cerca «il più vicino indietro» in un testo annidato non trova il contenitore: trova il vicino.* ✅ Provata sul vivo di **TEST 6.344** (prima se ne andava a −40 · −130 · **−193**; dopo resta a 0) e di **PROD 6.344 a tre larghezze**, col velo che la copre a scheda aperta. ✅⭐ **E la finestra BASSA, che era il buco dichiarato**, chiusa il 04/09 a notte: a **1024×640** — 265 px da scorrere — la barra resta a `top:0` a ogni altezza e al suo centro risponde sempre un elemento **dentro la barra**. |
| **148** | ✅ *(04/09/2026, 80ª sessione — **voce SUA**, segnalata dal cellulare)* 🪟 **148. Su telefono il foglio si chiude dopo un cambio importo.** 🗣️ *«Poi la scheda è rimasta aperta e non si è più chiusa sul cellulare. Quindi ce l'ho sempre aperta in sovraimpressione.»* 🔎 **Due ipotesi cadute prima di toccare niente**: non era la ✕ coperta dalla fascia della 146 (misurato a 390 px: `elementFromPoint` sul **centro** della ✕ risponde la ✕ stessa — la 146 aveva misurato i punti **accanto**, non quello **sopra**), e non era la 147 (**0** occorrenze nel suo diff, e la riga esisteva su 6.328). 🚨 **Non era un guasto: era una riga della voce 132 scritta apposta** — quando il Salva porta **solo** un cambio importo il ramo torna subito, quindi non passa da `svcMpSyncConfirmed` e nessuno chiama `svcAutoCloseIfMobile`. ⚖️ Su **desktop** quella scelta è giusta (la scheda è un pannello accanto al calendario); su **telefono** è un foglio a tutto schermo, e «resta aperta» diventa «non se ne va». 📌 *Una scelta giusta su una larghezza non è una scelta: è una scelta più una larghezza sottintesa. Se la larghezza non è scritta, la si è decisa senza saperlo.* 🔨 Passa da `svcAutoCloseIfMobile`, che porta dentro la soglia `< 900px` (il desktop resta **esattamente** com'era: si aggiunge la larghezza che mancava, non si ribalta la 132) e i 700 ms per leggere l'esito; e si chiude **solo sul verde**, perché *un foglio che si chiude su un errore è un errore nascosto*. ⛔ Non tocca `staffCalPlayersState`: il gestore della ✕ è `svcCloseChat` e basta, e la cura deve fare quello che farebbe il suo dito. 🧪 Banco `il-foglio-si-chiude-sul-telefono` (5 casi) sabotato **sei** volte, cade tutte e sei. 🩹 La prima sonda ritagliava a partire da `await _pmoSetCharges(`, cioè **dopo** la riga da misurare: *una sonda che ritaglia a partire da ciò che vuole misurare non lo misura mai*. ✅⭐ **CHIUSA A PROVA FISICA SUA su PROD 6.334**: *«la scheda… ora si chiude dopo che ho salvato, e questo te lo confermo»*. |
| **147** | ✅ *(04/09/2026, 80ª sessione — **voce SUA**, la STESSA segnalazione tornata una terza volta)* 🔔 **147. Un gesto in volo si legge in un posto solo — e i posti sono QUATTRO, non tre.** 🗣️ *«Controlla perché trovo sulla scheda ancora 2 messaggi distinti»*, con la schermata di PROD **6.328**: la pastiglia «↓ ↻ Salvo su Matchpoint l'impor…» e la striscia «💶 Cambio l'importo», **nello stesso istante**. 🚨⭐⭐ **LA CAUSA È LA COSA DA PORTARSI VIA: la 145 ha RIAPERTO QUELLO CHE LA 136 AVEVA CHIUSO.** La 136 spegneva la pastiglia con `_svcEsitoInSchedaVisibile()`, cioè *«la riga dentro la scheda è già davanti agli occhi»*. La 145 — poche ore dopo, e con ragione — ha **tolto quella riga** per gli avanzamenti, e con lei è caduta la condizione che teneva giù la pastiglia. ⇒ Il doppione è tornato **in un punto diverso**, e nessuna guardia ha urlato. 📌 *Una protezione che poggia sull'ESISTENZA di un altro pezzo muore quando quel pezzo viene tolto, e muore in silenzio: non si rompe niente, semplicemente non protegge più.* 📌 *La 145 aveva scritto «una regola applicata in due punti su tre non è una regola». Il numero era sbagliato: i posti erano **quattro** — chat · pastiglia · riga nella scheda · barra — e la 137 ⑤, la 136 e la 145 ne governavano uno per una. Chi cura un doppione conta gli oggetti che ha in mente, non quelli che ci sono.* 📏 **Misurato sulla pagina viva di PROD 6.328 prima di toccare niente**, con la console remota: `svcMessaggioVaSoloNellaBarra("↻ Salvo su Matchpoint l'importo a carico… (non chiudere)")` → **`false`** ⇒ l'avanzamento **nasceva in chat**, e da lì la pastiglia lo ripescava. 🔨 **Due cure, e la seconda è quella che vale**: ① `SVC_AVANZAMENTI_NELLA_BARRA` — i tre avanzamenti dei pagamenti non nascono più in chat, quindi non hanno niente da mostrare a nessuno. Ci stanno **solo** i gesti il cui esito ha una casa nella scheda (voce 134) **e** un nome nella barra: `matchpoint-payment-write`, `-payment-void`, `-charge-write`. ⛔ **Il WALLET resta fuori di proposito**, ed è la riga che tiene onesta la cura: si fa dalla scheda del **socio**, dove `.svc-edit-box` non esiste ⇒ togliergli la chat gli toglierebbe **l'unico posto** in cui il suo esito è scritto — *togliere un doppione e togliere l'unico posto in cui una cosa è scritta si somigliano moltissimo mentre le fai*; ② `svcEAvanzamentoInCorso` — la pastiglia non ripete **nessun** gesto in volo, wallet compreso: si leva la seconda striscia, non l'informazione. 🚨 **Riconosciuto da DUE segni insieme, e il secondo è il freno**: quello in testa (↻ ⏳ 🔄 🧪) **e** il «(non chiudere)». Senza il secondo prenderebbe anche «⏳ Campo 3: dopo 4 tentativi non riesco a raggiungere Matchpoint» — che comincia uguale ma è un **esito** e va visto — e «🧪 SIMULAZIONE — Stornare il pagamento?», che è una **domanda** e aspetta un click. *Nascondere una domanda non pulisce la scheda: lascia l'assistente ad aspettare la risposta a una cosa che nessuno ha potuto leggere.* 🧪 Banco ⑬ in `la-barra-e-il-posto-unico`, **sabotato tre volte** su una copia — aggancio della guardia tolto · freno «(non chiudere)» tolto · wallet incluso per sbaglio fra gli avanzamenti — e cade tutte e tre. 97 verdi / 0 rossi. ✅ **Verificata sulla pagina viva di PROD 6.330** (`last-modified` 13:41:22 UTC, misurato e non dedotto): l'avanzamento del carico e quello dell'incasso **escono** dalla chat, il wallet **ci resta**, e il freno salva l'esito dei tentativi e la domanda della simulazione. ⚠️ **QUELLO CHE QUESTA PROVA NON DICE, e va detto**: è **testuale** — dice che le regole sono giuste, non che sullo schermo si veda **una** striscia sola. Quello lo dice l'occhio, a 390 px, su un cambio importo vero: e quello scrive su Matchpoint, quindi resta un gesto **suo**. 📢 **Da questa voce nasce anche una regola in `CLAUDE.md`**, chiesta da lui mentre il deploy atterrava: *«avvisami sempre quando è fatto un deploy su Prod»* — e l'avviso è il **fatto** (PROD serve la 6.330, misurato bustando la cache), non il merge della PR. |
| **146** | ✅ *(04/09/2026, 80ª sessione — **voce SUA**, nata da una sua schermata e da una sua intuizione)* ✕✕ **146. Le due ✕ non si toccano: una chiude la finestra, l'altra toglie un giocatore.** 🗣️ *«Penso che la doppia x sia qualcosa da analizzare. Procedi a controllare.»* ⭐ **Aveva ragione lui, e io l'avevo quasi archiviata**: nella schermata l'avevo letta come «due chiusure», cioè una cosa brutta ma innocua. 🚨⭐⭐ **NON ERANO DUE CHIUSURE.** Una è la ✕ del pannello (chiude la finestra: al massimo perdi il lavoro in corso), l'altra è la **✕ Rimuovi giocatore** di una riga — toglie qualcuno dalla partita, e al salvataggio finisce **su Matchpoint**. 📏 **Misurato sulla pagina viva a 390 px**, scorrendo come si scorre col dito: i due bottoni si **SOVRAPPONGONO** su **8 × 28 px** (Chiudi 344-374, Rimuovi 318-352, stessa altezza). Nel pezzo conteso vince «Chiudi» — ma bastano **5 px più a sinistra** per prendere «Rimuovi giocatore» **mentre si mira a chiudere**. ⚖️ **La causa erano due numeri che non si parlavano**: la fascia della ✕ è alta **52 px** e i messaggi ne riservavano **30** (`padding-top`). Gli altri 22 erano terra di nessuno, e ci passavano le righe. 🔎 Più il fatto che la rendeva invisibile a occhio: la fascia era `left:auto` + `background:transparent` ⇒ **copriva la ✕ innocua e lasciava scoperta la pericolosa**. 🔨 **La cura**: la fascia è **opaca e a tutta larghezza**, quindi ciò che le scorre sotto è coperto e **nemmeno cliccabile**; e la sua altezza è **dichiarata** (`height:44px; box-sizing:border-box`), col `padding-top` dei messaggi sullo stesso numero. ⛔ **Non si rimette la testata che la 141 aveva tolto**: quella era una barra **nel flusso** che si mangiava 50 px di contenuto, questa è una striscia sovrapposta dentro spazio **già riservato** — costo netto **8 px**. 🩹⭐⭐ **E LA MISURA MI HA SMENTITO SU UN NUMERO**: avevo dedotto l'altezza della fascia come «bottone 30 + padding 4+4 = **38**», la pagina viva ne misurava **48** ⇒ dieci pixel di contenuto nascosti all'apertura, e una guardia che confrontava due numeri che combaciavano **solo nella mia aritmetica**. 📌 *Un'altezza che nessuno dichiara la deduce ognuno a modo suo: se un numero deve combaciare con un altro, il modo di farli combaciare è **scriverli**, non calcolarne uno.* ✅⭐⭐ **PROVA FISICA su TEST 6.327 E su PROD 6.328, a 390 px, fatte da me**: il dito a **−4, −8, −14 e −20 px** dalla ✕ Chiudi — dove prima rispondeva «Rimuovi giocatore» — ora risponde **sempre la fascia**, cioè **nessun bottone**. Fascia bianca opaca, larga **390**, alta **44**, e il `padding-top` dei messaggi è **44**: i due numeri finalmente combaciano davvero. Zero errori di pagina. 🧪 Banco nuovo `due-x-non-si-toccano` (6 casi) con il controllo agganciato ai **numeri**, più un caso che difende la guardia dal diventare inerte; sabotato 5 volte su una copia (trasparente · `left:auto` · z-index 0 · fascia più alta senza toccare il padding · ✕ rimpicciolita) e cade tutte e 5. 🩹 E la sonda ha sbagliato al primo giro: `.svc-chat-close-btn` è dichiarata **due volte** (desktop e telefono) e pescava la prima. 📌 *Una sonda che prende la prima occorrenza di un nome dichiarato due volte non sta misurando il pezzo di cui parla.* 🔔 **E cercando il doppio messaggio sul SALVATAGGIO** (sua richiesta successiva) **ne è saltato fuori un altro, vero**: `pmoBlockWriteIfReadonly` scriveva la **stessa identica frase due volte** — nella scheda **e** come toast. Era l'**unica** coppia `svcAddMessage` + `showAlert` con lo stesso testo in tutta l'app (cercata su tutte e **530** le chiamate a `showAlert`). ⇒ Ora sono **alternativi**: vince la chat, dov'è già lo sguardo di chi ha premuto; il toast resta per i gesti nati dove la chat non c'è. 📌 *Un avviso di troppo è disturbo; un avviso di meno è un gesto che sparisce senza spiegazione.* ✅ **E il salvataggio da OWNER è pulito**, provato sulla pagina viva un messaggio per volta: avanzamento `mp-sync-head`, «Modifica non riuscita», «Non ho la conferma» e l'avanzamento del roster **non entrano in chat** (solo barra); la domanda dell'assistente e «Modifica salvata, ma c'è una cosa da controllare» **restano**. ⚠️ **Quello che quella prova NON dice**: la console entra come **sola lettura**, quindi il gate blocca il Salva prima del worker — il percorso completo da owner non è stato attraversato. |
| **145** | ✅ *(04/09/2026, 80ª sessione — **voce SUA**, segnalata dal telefono con schermata)* 🔔 **145. Un avviso solo per un fatto solo: il doppio banner sulla scheda.** 🗣️ *«Come vedi c'è ancora un doppio banner di messaggio, non va bene. Ce ne deve essere solo uno.»* — schermata di PROD 6.323 in cui, **nello stesso istante**, ci sono la riga gialla «↻ Salvo su Matchpoint l'importo a carico… (non chiudere)» **dentro la scheda** e la striscia «💶 Cambio l'importo» **in fondo allo schermo**. 🚨⭐⭐ **E IL PEZZO CHE VALE PIÙ DELLA CURA: su questo stesso difetto erano già passate DUE voci.** · la **136** (03/09) tolse il doppione fra la riga nella scheda e la **pastiglia**, e scrisse *«due avvisi per lo stesso fatto non sono il doppio dell'informazione: sono un avviso e un disturbo»*; · la **137 ⑤** (03/09 notte) stabilì la regola giusta — *gli avanzamenti escono dalla scheda, gli esiti restano* — e la applicò a `svcAddMessage`. ⇒ **Nessuna delle due guardò `_svcSchedaEsito`**, che è il **terzo** posto in cui una frase può comparire sullo schermo. 📌 *Una regola applicata in due punti su tre non è una regola: è una coincidenza, e tiene finché il terzo punto non viene usato.* 📌 *Chi cura un doppione conta gli oggetti che ha in mente, non quelli che ci sono: la prima domanda non è «quale dei due tolgo», è «quanti sono davvero».* 🔨 **La cura**: `_svcSchedaEsito` non disegna gli avanzamenti (`wait`) — li racconta la barra — e **toglie la riga vecchia** rimasta lì, perché un esito di prima accanto a un gesto in corso è peggio del doppione: *è un doppione che dice un'altra cosa*. ⛔ **Gli ESITI (`ok`/`ko`) restano dove sono**, ed è il freno dichiarato: la barra li mostra 6-14 secondi, un rifiuto col motivo dentro («il campo risulta già pagato») serve anche cinque minuti dopo, a chi torna a guardare cos'era andato storto. 📏 **Misurato PRIMA di togliere**, perché *togliere l'unico posto in cui una cosa è scritta somiglia moltissimo a togliere un doppione*: i punti che mandano un `wait` sono tutti pagamenti (`matchpoint-payment-write`, `-payment-void`, `-charge-write`, `-wallet-correct`) e **tutti e quattro** sono classificati non-null in `SVC_AZIONI_DELLAPP` ⇒ la barra li racconta davvero. 🧪 Banco nuovo `un-avviso-solo-per-un-fatto-solo` (7 casi), con `_svcSchedaEsito` **eseguita** su un DOM finto invece che riletta; il caso ④ è il **freno dell'altro verso** (un `wait` tolto dev'essere un gesto che la barra racconta, o la cura diventa perdita). **Sabotata 5 volte su una COPIA** — compreso lo «zelo» che toglie anche gli esiti — e cade tutte e 5. ✅⭐ **PROVA FISICA SU TEST 6.325 E SU PROD 6.325, fatte da me** (postulato del 04/09), sulla scheda viva: avanzamento ⇒ **0** righe nella scheda (prima **1**); esito ✅ ⇒ **1** riga, `class="svc-edit-esito ok"`, testo giusto; un secondo avanzamento ⇒ la riga vecchia **sparisce**; rifiuto ⚠️ ⇒ **1** riga **col motivo dentro**, che è la cosa che il freno difende. Zero errori di pagina in entrambi. |
| **144** | ✅ *(04/09/2026, 80ª sessione — **voce SUA**, chiesta stamattina guardando PROD)* 🔻 **144. La sezione «Assistente AI» non c'è più.** 🗣️ *«Quando decidi tu puoi eliminare la sezione Assistente AI sia da test che da prod.»* ⇒ **È il seguito della 141, non un lavoro a sé**: quella, la mattina prima, aveva tolto la **chat** — composer, microfono, «Invia», bottone 💬 — e da quel momento il pannello di addestramento non aveva più niente da addestrare, perché la strada per cui il Vocabolario esisteva (*chi fa segreteria scrive una frase libera e l'assistente la interpreta*) era **già chiusa**. Restava una voce di menu che apriva una scheda per insegnare parole a una bocca che non c'era più. 🔨 **Tolto**: il capitolo «Assistente AI» dalla barra in alto (l'iniezione `pmoChapterItemAI`), il pannello `#assistanteAI` coi suoi tre riquadri (🧩 Vocabolario, 🎓 Modalità apprendimento, 💰 Consumo Gemini), il permesso `view_assistante_ai` dall'albero ruoli, il gancio in `switchTab`, il CSS `.ai-admin-*`/`.ai-lex-*` e **le 33 funzioni** che disegnavano quel pannello. 📏 **−635 righe, +22**, identiche sui due rami. ⛔ **NON tolto, ed è la parte che conta**: il **motore** `PMOAi` resta **intero** — `logManual` (il diario che scrivono venti gesti del calendario e dell'anagrafica), `execBegin/execEnd`, `isEnabled`, i flussi guidati, e `#svcChatPanel`, che dalla 141 **è la finestra delle schede**. 📌 *È la trappola della 141 vista dall'altro lato: togliere la scheda di gestione portandosi via il motore sarebbe stato lo stesso gesto — e avrebbe spento il diario di tutto il calendario.* 🧪 **Misurato PRIMA di tagliare, non supposto**: uno script ha estratto i 33 nomi definiti nel blocco e contato i loro usi **fuori** dal blocco — l'HTML che stavo togliendo, il gancio di `switchTab`, le esportazioni del `return {}`, e **basta**. ⭐ È quella misura ad aver salvato le due funzioni che il **boot** chiama (`_loadLearningModeSetting` → `_renderLearningToggle`, che allinea al circolo il flag del ragionatore): stavano **dentro** il range e sarebbero uscite con esso — a occhio non si vedevano, perché il loro chiamante sta **700 righe più su**. ✅ **PROVA FISICA su TEST 6.321** con la console remota, sulla pagina viva: la barra elenca `Calendario · Anagrafica soci · Autovalutazione · Incassi · Messaggi WhatsApp · Amministrazione` — **«Assistente AI» non c'è**; `#assistanteAI` e `#aiLexSurface` non esistono; e nello stesso respiro `PMOAi` c'è, `logManual` è una funzione, `isEnabled()` risponde `true` e `#svcChatPanel` è al suo posto. Zero errori di pagina. ✅⭐ **E LA STESSA PROVA SU PROD 6.321**, appena il deploy è atterrato (`last-modified` 09:50:43, perché con `max-age=600` il numero da solo non basta): stessa barra a sei voci senza «Assistente AI», `#assistanteAI` · `#aiLexSurface` · `#aiLearnToggle` **inesistenti**, e dall'altro lato `logManual` ed `execBegin` funzioni, `isEnabled()` `true`, `#svcChatPanel` al suo posto. 📏 Provato anche che il contenitore **lavora ancora**: `svcAddMessage('system', …)` scrive dentro `#svcChatMessages` e il testo si rilegge — è il pezzo che la 141 ha trasformato in finestra delle schede, ed è quello che un taglio troppo largo avrebbe portato via. `getLearningMode()` risponde `true`, cioè le due funzioni tenute apposta sono vive. **Zero errori di pagina** in entrambi gli ambienti. ⚖️ Quella `svcAddMessage` è l'unica cosa che ho scritto su PROD: **nel DOM di una finestra chiusa**, che si azzera al ricaricamento — nessuna riga sul database, niente verso Matchpoint (la console remota blocca da sé scritture e `/functions/v1/`). 🧪 Banco **94 verdi / 0 rossi**. 🗄️ `view_assistante_ai` può restare scritto nei profili staff sul database: resta lì **inerte**, come `view_admin_supabase`. ⚠️ **Restano orfane 4 edge** (`ai-propose-lexicon`, `ai-lex-examples`, `ai-reason`, `ai-parse`): vive e innocue, non le chiama più nessuno dal pannello — **non toccate di proposito**, cancellare una edge è un gesto a parte e irreversibile. 🩹 **Nello stesso giro corretti i due conteggi che tenevano `guard-docs-truth` ROSSA da ieri sera** (in coda dichiarava 17 con 15 voci; le chiuse 116 in tabella con 117 righe): non erano di questo lavoro, ma *una guardia che resta rossa si smette di leggere* — è la ragione per cui `guard-worker-sync` fu resa paziente. |
| **141** | ✅ *(04/09/2026, 79ª sessione — **voce SUA, nata da una sua decisione a colazione e chiusa a prova fisica sua dal cellulare in mattinata**)* 🪟 **141. Il calendario senza assistente: la scheda è una FINESTRA sopra il calendario, e la colonna a sinistra non c'è più.** 🗣️ *«Ho preso una decisione. Facciamo un restyling. Leviamo totalmente l'assistente digitale, quindi quella barra bassa con microfono. Non c'è più, si fa tutto manualmente. Quello spazio dove appaiono le schede viene elevato e la scheda appare sopra il calendario, come facciamo già nella sezione anagrafica soci.»* Poi, guardando il mockup: *«Il menu non lo metterei sulla sinistra, lo lascerei in alto, e quello spazio lo sfrutterei per ampliare il calendario»* e *«portiamo il messaggio della barra dentro la scheda, in basso»*. 🎨 **Mockup PRIMA di toccare l'app**, com'è obbligo (`mockup/calendario-senza-assistente-mockup.html`): due disposizioni a confronto, approvata la A. ⭐ E il mockup ha fatto il suo mestiere due volte — la seconda indicazione (*«il menu in alto»*) è nata **guardandolo**, non leggendo una descrizione. ⛔ **La cosa da NON fare, e che si somigliava molto a quella giusta**: togliere l'assistente portandosi via anche il **contenitore** delle schede. `#svcChatPanel` resta e **cambia mestiere** — da chat a finestra — così le venti strade che disegnano schede, flussi ed esiti dentro `#svcChatMessages` non cambiano di una riga. 📏 **Colonna del calendario 1058 → 1362 px (+29%)**, misurata sulla pagina viva prima e dopo. 🚨⭐⭐ **Su TELEFONO quella colonna È IL MENU** (il cassetto del ≡): la regola che la nasconde vive **dentro** `min-width:900px`, e una guardia del banco si rompe se qualcuno la sposta fuori — *da computer sarebbe tutto giusto e il telefono resterebbe senza navigazione*. È lo stesso punto cieco della barra dei capitoli del 2/08. ⛔ **La scheda non si apre da sé** su un gesto altrui — sua scelta fra le due che gli ho messo davanti: chi fa segreteria è quasi sempre dentro un altro gesto e lì **ogni bottone scrive su Matchpoint**, quindi una finestra che si apre *quando decide il socio col bot* si prende il click già partito. Resta la **pastiglia**, che si clicca. 🩹⭐⭐ **TRE difetti su quattro li ha presi il GUARDARE, non il rileggere**, ed è la lezione della voce: ① la finestra era alta **tutto lo schermo** anche su una scheda di tre righe (600px di bianco) — la misura copiata dalla scheda socio non era sbagliata, è che *quella* scheda è sempre lunga; ② la striscia a riposo era `hidden` **e dipinta lo stesso** — `[hidden]{display:none}` è una regola del **browser**, la più debole che ci sia, e perdeva contro `.svc-semaforo{display:flex}` ⇒ una fascia azzurra vuota alta 52px in fondo a **ogni** schermata dell'app, **da otto giorni**; ⚖️ ed era **cieca alle sonde**, perché `pointer-events:none` fa rispondere «il calendario» a `elementFromPoint`; ③ **il suo dito sul telefono** ha trovato l'ultimo: alla conferma il «✅ fatto» **schizzava in cima allo schermo**. Non era un caso — è la **conseguenza di due comportamenti giusti che si incontrano**: il foglio si chiude da sé (giusto, il gesto è finito) e chiudendosi la striscia diventa pastiglia, che era ancorata al bordo **alto**. 📌 *Due comportamenti giusti presi da soli ne fanno uno sbagliato quando si incontrano, e a farli incontrare è l'unica cosa che nessuno dei due conosce: **l'ordine**.* 🗣️ ④ *«Sulla barra c'è scritto «da te»? io lo leverei»* ⇒ tolto. ⛔ **Ma il «chi» della CODA resta** («richiesta da un socio»), e gliel'ho dichiarato: è l'unica cosa che dice a chi fa segreteria *se è stata lei o no*. Sua conferma: *«va bene così, lascia il richiesta da un socio»*. 🧪 Banco **94 verdi / 0 rossi**, rete nuova `il-calendario-senza-assistente` (11 casi) e la guardia ⑧ della 137 **riscritta invece che cancellata**: difendeva «si allinea alla colonna», che era il **mezzo**; ora difende «non può finire dove non si vede», che era il **fine**. 🩹 Sabotata cinque volte; **una non è caduta** — la sonda ritagliava dal selettore alla fine del blocco e trovava un `display:none` venti righe sotto. *Una sonda che ritaglia troppo dice sempre di sì.* 🚀 **In servizio su PROD 6.319** (promosse le **righe** da un ramo basato su `main`: i due `index.html` distano 833 inserzioni prima ancora di questo lavoro), PR #1322 · #1323 · #1324. ✅ **PROVA FISICA SUA, dal cellulare, con una serie di modifiche vere**: *«mi sembra che tutto funzioni bene»* — e con dentro le due segnalazioni che hanno chiuso la voce. |
...
| **135** | 📐 **L'IMPORTO ERA INCOLLATO A DESTRA, lontano dal suo `€`** — 📦 **CHIUSA il 03/09, a PROVA FISICA su PROD 6.283**: *«la 135 funziona»*. 🗣️ Sua segnalazione nello stesso messaggio in cui dichiarava provata la 134 (*«l'unica cosa è che quando scrivo l'importo è troppo allineato a destra»*), con schermata. 📏 **Misurato sulla pagina viva PRIMA di toccare niente**: `text-align:right` su una larghezza **fissa di 58px**, e il `€` sta **FUORI**, a sinistra ⇒ con «0,00» (25px di testo) restavano **35px di vuoto** fra simbolo e cifre. Si leggeva «€        10,00»: due cose staccate, col numero appiccicato al bordo opposto rispetto al simbolo che lo qualifica. ⚖️ **La cura, e perché non è un gusto**: qui **non c'è nessuna colonna di numeri da incolonnare** — ogni casella ha il **suo** `€` accanto ⇒ l'ancora è il simbolo, e le cifre vanno **a sinistra**, attaccate a lui. 📌 *L'allineamento a destra serve a confrontare numeri incolonnati; dove i numeri non sono in colonna, si allinea alla cosa a cui il numero appartiene.* 🚨 **E la larghezza gliela si dà MISURATA**: «1000,00» col font vero (`bold 12.8px`) chiede **47px** ⇒ 50 bastano e non tagliano. Prima erano 58, scelti a occhio, e proprio quegli **8px in più erano metà del buco**. Mobile (font `1rem`, ×1.25): da 80 a **62**. 📌 *Una larghezza scelta a occhio non è neutra: il vuoto che avanza diventa il difetto.* ⛔ **Nessun banco, ed è una scelta dichiarata**: il fatto da difendere («le cifre stanno accanto al `€`») è **geometria del render**, e in questo repo una guardia sul CSS è già stata smentita due volte — la stessa ragione per cui il banco della 127 guarda il fatto e non la regola. La misura sta nel commento accanto alle due righe; a dire che si vede giusto è stato **il suo occhio**. |
| **134** | 👁️ **UN RISULTATO NON DEVE RESTARE NASCOSTO (la conferma sotto il bordo)** — 📦 **CHIUSA il 03/09, a PROVA FISICA su PROD 6.282**: *«la 134 funziona»*. 🗣️ Nata da una sua domanda subito dopo aver provato la 132 (*«dove secondo te è giusto che io veda la conferma? In alto alla scheda oppure in basso?»*), poi precisata — ed è la frase che ha definito la voce — *«è solo una questione di visualizzazione di un risultato che non deve essere nascosto, sia se scrivi sia se clicchi i bottoni»*. 📏 **Misurato su PROD 6.281 con la console remota** (1440×900, pannello **711px**, scheda **1216px**): fermo sul bottone Salva il messaggio è visibile (−47px dal bordo), **subito dopo il click è 568px SOTTO il bordo e `scrollTop` torna a 0**. 🚨⭐⭐ **E il secondo difetto non è quello che sembra: non era il messaggio ad andare in basso, era la VISTA a tornare in cima.** `svcAddMessage` chiamava `_svcAutoScroll(container)` **senza** `soloInGiu`, quindi il tetto della **127** — nato per dire *«non oltre la cima della scheda»* — veniva applicato anche a chi stava **più in basso**, e lo **trascinava indietro**. 📌 *Un tetto dice «non oltre», non «torna indietro».* ⚖️ L'observer quella regola ce l'aveva **già** (ed è scritto nel suo banco); questa seconda strada no. 📌 *Due strade per lo stesso gesto, e una sola protetta: la guardia esisteva e guardava dalla parte giusta — semplicemente non copriva l'altra porta.* 🔨 **Tre pezzi, e nessuno alza il tetto** (che resta giusto: una scheda si legge dall'alto): ① lo scroll non strappa più verso l'**alto**; ② l'esito dei bottoni si scrive **DENTRO la scheda**, sopra la barra — perché lì stanno i bottoni e lì sta l'occhio nell'istante del click — **affiancando** il messaggio in chat e non sostituendolo (la chat è il registro e sopravvive alla scheda, quella riga è l'eco e muore con lei); ③ una **pastiglia** «↓ …» incollata al bordo basso che porta con sé il **TESTO** dell'ultimo messaggio ⇒ l'esito si **legge senza cliccare**, e si raggiunge con un dito. ⭐ Il colore della riga si **deduce dal segno** che la frase porta già in testa (✅ · ⚠️ ❌ · ⏳ ⌛ ↻): così ogni punto che scriveva un esito lo colora **senza essere toccato**. 📌 *Una regola che vale per default non si scorda.* 🩹⭐ **La guardia della 127 è diventata rossa, e aveva ragione a metà**: vietava `scrollTop = scrollHeight` in tutto il file, e la pastiglia **cliccata** deve andare davvero in fondo. ⇒ **Riportata sul fatto, non allentata**: il fatto che difende non è «nessuno arriva mai in fondo», è **«nessuno ci va senza che l'operatore l'abbia chiesto»** — unico scavalco dentro il gestore del `click`, e il banco pretende che resti **uno solo**. 📌 *Una guardia che si rompe su un caso legittimo va resa più PRECISA, non più permissiva.* 🔪 Banco nuovo `test/il-risultato-non-si-nasconde.test.mjs`, **11 casi**: quello sul colore **esegue** la regola ritagliata dal sorgente invece di rileggerla, e ha già trovato un difetto **nel banco stesso** (il ritaglio perdeva `tipo ||`, quindi accusava il codice invece di sé). 📏 **Rimisurata dopo il deploy su PROD 6.282**, stesso caso: `scrollTop` resta **570** (prima tornava a 0), la riga d'esito c'è ed è visibile (`svc-edit-esito ok`), la pastiglia dice `↓ ✅ Importo aggiornato su Matchpoint`, e scrivendo in chat con la scheda in cima dice `↓ 2 nuovi · …`. ⚖️ Di quella misura era stato dichiarato il limite — *è geometria: dice che gli elementi non sono nascosti, non che si notino* — e la cosa che l'ha chiusa è stata infatti **il suo occhio**. |
| **132** | 💶 **L'IMPORTO A CARICO SI SALVA: su Matchpoint E nel gestionale** — 📦 **CHIUSA il 03/09, a PROVA FISICA su PROD 6.281**, il giorno stesso in cui è nata: *«l'ho fatto e funziona»*. 🗣️ Voce sua della mattina (*«quando su una scheda cambio l'importo e poi clicco salva me lo deve riportare su Matchpoint e sul gestionale»*), con schermata. 🚨⭐⭐ **NON ERA UN GUASTO DEL SALVATAGGIO: quella casella non è MAI stata salvabile.** `staffCalPlayersSave` costruiva un pacchetto con campo/data/ora, `players`, `note`, `descrizione`, `istruttore` — l'importo non c'era, e non c'era **nemmeno nella condizione che decide se salvare** ⇒ cambiando solo quello usciva «ℹ️ Nessuna modifica da salvare», che è esattamente ciò che aveva visto. 📌 *Un campo che si può digitare ma non salvare non è un difetto del salvataggio: è un campo che promette una cosa che nessuno gli ha mai chiesto di fare — il difetto è la promessa.* 🔨 **Tre pezzi.** ① **Worker `/set-charge`**: riusa i passi che `collect_payment` faceva già **prima** del cobro (`fill(TextBoxCargoReserva)` → `clickSaveActualizar('set_cargo')` → ricarica) e **si ferma lì**, senza mai cliccare *Incassare* ⇒ un modo nuovo che riusa una strada, non una strada nuova. Tre difese: non tocca una riga **già riscossa** (`ALREADY_PAID`, o resterebbe una differenza che nessuno ha incassato), è **idempotente** e lo dichiara (`changed:false`), e **non dice «fatto» sulla fiducia** — ricarica la scheda e **rilegge** il campo, e se Matchpoint non ha preso il valore è un **errore**, non un successo. ② **Edge `matchpoint-charge-write`**, nuova e non un modo in più di `payment-write`: *un importo a carico non è un pagamento*, e il nome è la prima cosa che qualcuno legge — `payment-…` avrebbe invitato, un giorno, a farle scrivere un pagamento «già che c'è». Undicesima copia del recinto, dentro tutte e tre le guardie del banco. ③ **App**: quinto flag `PMO_CHARGE_WRITE_ENABLED`, ogni casella «€ a carico» si porta dietro il valore con cui è stata **disegnata** (senza una riga di partenza «è cambiato?» non è una domanda a cui si possa rispondere), il riepilogo della conferma scrive **nome e i due numeri**, le righe di chi si sta **togliendo** non entrano, e gli importi si scrivono **prima** della modifica alla prenotazione aspettandone l'esito. 🩹🚨⭐⭐ **E LA SCHEDA DI QUESTA VOCE PROPONEVA LA STRADA SBAGLIATA — corretta, non affiancata.** Diceva di scrivere l'importo nella **copia locale della partita**, «dove il roster tiene già gli importi ed è lo stesso posto da cui la scheda li rilegge». 📏 Misurato prima di scrivere una riga: **falso in tutt'e due le metà** — la scheda gli importi li rilegge **vivi da Matchpoint** a ogni apertura (`matchpoint-bookings-edit` con `read:true`), e la copia locale tiene **solo i nomi**, che `_staffCalPersistRosterFromWorker` riscrive a ogni lettura autorevole ⇒ un importo messo là sarebbe stato **cancellato dalla lettura successiva**: un secondo libro che si svuota da sé. Il gesto entra invece nel **registro dei gesti della segreteria** (`staff_edit`, `azione: 'set_charge'`). 📌 *Una proposta di disegno è un'ipotesi finché non si è guardato dove il dato vive davvero — e suonava tanto più credibile quanto più era precisa.* ⚖️ **Una scelta dichiarata perché va contro una regola**: il kill-switch è quello del cobro (`MATCHPOINT_PAYMENT_WRITE_ENABLED`) e non uno nuovo, benché *«un gesto, un interruttore»*: il `.env` della VM non sta in git e il deploy non lo riscrive ⇒ un interruttore nuovo **nascerebbe spento** e nessuno dal cloud potrebbe accenderlo — la funzione arriverebbe morta. 🔎 **E `/health` del worker adesso dichiara `paymentWriteEnabled`** (misurato **true** sulla VM al deploy): prima l'unico modo di sapere se il worker avrebbe accettato un incasso era **provare a incassare**, cioè usare un ramo di scrittura su denaro vero come sonda diagnostica. 🔇 Al socio non parte niente: gesto interno della segreteria, sua decisione. |
| **133** | 💶 **LO STORNO DAGLI INCASSI: una riga per movimento, e la partita che si apre** — 📦 **CHIUSA il 03/09 su sua istruzione** (*«chiudi la centotrentatré»*), il giorno stesso in cui è nata; in servizio su TEST 6.293 e PROD 6.280. 🗣️ Nata da una sua domanda (*«secondo te è possibile negli incassi avere lo storno? Come lo abbiamo nella tab pagamenti di anagrafica?»*), precisata due volte: *«per riga di movimento»* e *«si clicca sul nome del giocatore e si apre la scheda… così lo storno si fa sempre nello stesso posto»*. ① **Una riga per movimento, e non è estetica**: 📏 su PROD, ultimi 7 giorni, **38 righe aggregate contenevano più di un movimento** (fino a 4) e **21 ne mescolavano due METODI diversi** — parte Cash, parte Card, sommati in colonne diverse della **stessa riga**. ⇒ Una riga così non è un fatto: è due, e qualunque bottone ci si metta sopra deve indovinare. 📌 *Una riga su cui si vuole agire deve essere una cosa sola.* ⚖️ Costo: un giorno pieno passa da **35 a 49 righe**. ② **Si apre la PARTITA, non la scheda socio — e la ragione è una misura**: delle **250** righe di 7 giorni solo **116 (46%)** aprono una scheda socio, perché **120 sono «Ospite»** e una scheda socio non ce l'avranno mai (14 soci non collegati); la scheda della **partita** c'è invece per **tutte**, perché ogni pagamento nasce da una prenotazione. ⭐ Il suo criterio (*«sempre nello stesso posto»*) resta **intero**: la misura ha cambiato **quale** posto. 📌 *Quando una strada copre metà dei casi, la domanda non è come coprire l'altra metà: è se ne esiste una che le copre tutte.* ③ **Il ↩︎ nella scheda della partita è ACCESO**, e ribalta una sua decisione del 02/09 **con la sua parola**: per un «Ospite» lo storno **non esisteva in nessun punto del gestionale** ⇒ più di metà della cassa era scoperta, proprio dove paga chi non è socio e un errore di battitura è più probabile. Detto **prima** e non dopo, con le tre strade davanti; sua risposta: *«mi hai convinto, procediamo con la B»*. ⚖️ Ora `_payVoidActive` guarda `PMO_PAYMENTS_VOID_ENABLED`, **lo stesso flag** di `_pmoVoidPayment` e del ↩︎ della scheda socio: prima ne guardava un altro, e poteva restare spento mentre lo storno era acceso dappertutto. 📌 *Un gesto deve avere UN interruttore.* ⛔ **Quello che NON si fa, ed è deliberato**: la riga **non si porta dietro importo né metodo** — l'edge (`marcaStornato`) filtra per **cliente e SLOT**, mai per movimento, quindi precompilare un importo sarebbe **una promessa che il circolo non mantiene**; 🔪 il banco lo protegge nei due versi (se un domani l'edge imparasse a stornare per movimento, diventa rosso). 🩹 **E la guardia della 128 è diventata rossa, giustamente**: controllava `pl.borsellino`, sparito **legittimamente** con l'aggregazione ⇒ riportata **sul fatto** — le tre parole che `_incassiMethodBucket` restituisce — non allentata. 📌 *Allentare una guardia è come toglierla, solo più lentamente.* 📏 **Provato con la console remota su TEST 6.293**: **154 righe** di movimento cliccabili su 5 giorni, l'importo nella **sola** colonna del suo metodo, `onclick` corretto, riepilogo 1.757,00 € su 154 pagamenti, nessun errore di pagina. 🚨⚖️ **VA DETTO PER QUELLO CHE È — cosa NON è stato visto**: si chiude **su sua istruzione**, non a prova fisica. **Nessuno ha ancora cliccato una riga di cassa su PROD, né portato a termine uno storno vero dalla scheda che si apre**: la prova è la sua **decisione** più le mie misure sulla pagina viva di TEST. E il ↩︎ nella scheda della partita muove **denaro vero** ⇒ il primo storno che passa di lì è anche il **primo collaudo** di quel ramo. |
| **128** | 🏷️ **CASH · CARD · WALLET OVUNQUE NEL GESTIONALE** — 📦 **CHIUSA il 03/09, a PROVA FISICA su PROD 6.279**: la colonna «come» della scheda socio **guardata con 50 movimenti veri dentro** (console remota, che il `CLAUDE.md` conta come «aperto e guardato»), e scrive **Card** e **Cash** dove prima scriveva `carta` e `contanti` **in minuscolo**. 🗣️ Sue parole del 02/09: *«chiamiamolo ovunque wallet»* e *«anche gli altri chiamiamoli comunque cash e card, perché sono più brevi e mi aiutano quando apro la scheda della partita a non andare a capo»*. ⭐ La ragione è una **misura**: 24 caratteri contro 14, e nella scheda della partita la colonna è stretta. 🔨 **51 sostituzioni una per una, mai un `sed`**, perché nella stessa parola convivono l'etichetta e la chiave. ⛔ Intatte **tre famiglie di chiavi diverse fra loro**: il **permesso** `view_members_borsellino` (che vive nei profili staff **sul database** — rinominarlo nel codice non rinomina i profili, e la colonna sparisce a chi la vedeva); le **chiavi di dato** dell'aggregazione Incassi (`come:'borsellino'`, `sel/d/pl.*` — i totali per metodo andrebbero a zero **senza nessun errore in console**); e i testi che **Matchpoint scrive** nel suo dialog, che il worker clicca **per testo** («Saldo disponibile»). 📌 *L'etichetta si traduce, la chiave no — e si distinguono solo guardandole una per una.* 🩹 **Curata anche la colonna «come», che scriveva la chiave grezza**: era **metà del difetto che lui aveva visto**, cioè le due metà dello stesso pannello che parlano due lingue. 🩹⭐ **E una riga di questa scheda dava per da fare una cosa GIÀ FATTA**: elencava la sezione **Incassi** fra quelle da tradurre, e invece diceva già «💵 Cash · 💳 Card · 👛 Wallet». 📌 *Una scheda scritta guardando il codice a colpo d'occhio elenca anche ciò che è già fatto: prima di eseguirla si riguarda, o si «cura» una cosa sana.* ⛔ **Il bot resta in italiano**, per sua decisione: *«il bot lo vedono i soci, il gestionale di prod lo vede la segreteria»*. Due parole per due pubblici, e quattro nomi in tutto per la stessa cosa: la tabella che li tiene insieme sta nella guardia. 🔪 **`test/letichetta-si-traduce-la-chiave-no.test.mjs`**, e fa i **due mestieri opposti** — provati con **due sabotaggi**: rimessa un'etichetta in italiano → rossa; rinominata la chiave di permesso → rossa. Una guardia che guardasse da un lato solo inviterebbe a sbagliare dall'altro. 🩹 **E la prova è costata tre sonde**, che è la parte di metodo da tenere: la prima leggeva `__pmoPagamentiCache` **prima che fosse riempita** e trovava 0 movimenti su 400 soci; la seconda dava 2,5 secondi a una lettura che scarica **quattro tipi di record interi**; la terza le ha dato tempo vero e ha visto le righe **al secondo giro da 5 secondi**. 📌 *Uno zero letto troppo presto non dice «non c'è»: dice «non è ancora arrivato», e le due si somigliano moltissimo.* ⛔ **Cosa NON è stato visto**: in quei 50 movimenti non c'era nessun pagamento **dal wallet**, quindi l'etichetta «Wallet» in quella colonna resta provata dalla mappa e non dall'occhio. |
| **131** | 🆕 **LA SCHEDA «NUOVA PRENOTAZIONE»: testa tagliata, e i campi su una riga** — 📦 **CHIUSA il 03/09 su sua istruzione** (*«chiudi la centotrentuno»*), dopo che è andata su PROD 6.278 e gliel'ho mostrata. ⚖️ **Va detto per quello che è**: la prova è la sua **decisione** più le misure che ho preso io sulla pagina viva di PROD — non un suo click su uno slot libero, che nessuno ha fatto. 🗣️ Sua richiesta del mattino, due cose in un messaggio, e in mezzo la terza che ha cambiato il lavoro: *«fammi vedere un esempio prima di sviluppare»*. ⭐ Tre disposizioni disegnate alla larghezza vera e misurate; ha scelto la **A**. **Senza quel passaggio avrei scritto la B** — la più corta, quella che *sembra* la lettura letterale di «tutti su una riga» — perdendo i quattro pallini colorati, che sono la stessa lingua del calendario. 📌 *Un esempio prima di scrivere non è cortesia: è il momento in cui il costo di una scelta si vede invece di doverlo indovinare.* ① **Il taglio era la 127 su un'altra scheda** (contenitore 500px → tagliata di 171px), stessa soglia dei 260px, e la cura del giorno prima non la copriva: **l'elenco era corto**. Ora l'elenco è dichiarato e **il banco conta da sé le schede che il sorgente crea**, provato sabotandolo con una scheda finta. 📌 *Una cura si scrive sulla famiglia, non sull'esemplare che si aveva davanti.* 🩹 E la prima sonda aveva sbagliato la **sequenza**: aperta la schedina senza che prima passasse un messaggio dalla chat non si taglia, perché è `svcAddMessage` a installare l'auto-scroll. *Una sonda che salta un passo dell'antefatto risponde «non succede» con la stessa sicurezza.* ② **La data dopo la parola «Campo» non è solo un posto diverso**: stando a destra sulla riga delle pastiglie se ne prendeva ~55px, ed è quello che mandava il campo 4 a capo. Campo **103 → 62px**, Tipo **107 → 61px**, scheda **660 → 573px**. 🚨⭐ **Due trappole misurate sulla pagina viva, nessuna deducibile**: un `<button>` in griglia **non riceve lo stretch** (colonne 51,25px, bottoni 43, tutte e quattro le parole troncate coi puntini mentre la colonna restava mezza vuota) e **nemmeno `flex-grow` lo allarga** (calcolato `flex-grow:1`, `flex-basis:0px`, e 32px di vuoto in coda). 📌 *Un bottone non si comporta come un div né in griglia né in flex: la larghezza gliela si dà, non gliela si chiede.* 🔤 «Manutenzione» si accorcia in «Manut.» solo sotto una certa larghezza e **solo il testo mostrato**: `tp.key` resta intero perché è la chiave delle durate e finisce in `tipoLabel` — la stessa distinzione della 128. |
| **127** | 🖼️ **LA SCHEDA DELLA PARTITA SI APRIVA TAGLIATA IN ALTO** — 📦 **CHIUSA il 02/09 notte, a PROVA FISICA su PROD 6.277**: *«l'ho aperta e la scheda si vede tutta»*. 🗣️ Voce sua della sera prima (*«quando clicco dentro una partita si apre la scheda in maniera sbagliata, non vedo la parte alta»*). 🚨⭐⭐ **Era SCROLLATA, non tagliata — e la differenza è tutto**: la chat dello staff si incolla in fondo quando mancano meno di **260px**, e una scheda che sborda di **poco** ci cade dentro tutta intera. 📏 Misurato su PROD 6.276 spazzando l'altezza utile: eccedenza 231px → titolo tagliato di **221px**; 281px → visibile; 0 → visibile. ⇒ Colpisce **proprio sullo schermo normale**, ed è il motivo per cui non capitava sempre e rileggendo il CSS non si vedeva niente. 🚨 E si ripeteva: la nota «⏳ Aggiorno la lista giocatori… (Ns)» **riscrive sé stessa ogni secondo** ⇒ la regola riscattava ogni secondo, per un minuto. 🔨 Cura: un **tetto** all'auto-scroll — in fondo come sempre, **mai oltre la cima della scheda** — e l'observer non strappa **mai** verso l'alto chi sta leggendo. ⚖️ Il difetto stava in **cinque** punti, non uno, compreso quello che sposta il box **fuori dalla sua bolla** (per questo la guardia si aggancia a `.svc-edit-box` e non a `.svc-edit-host`). 🩹⭐⭐ **E la scheda aveva dichiarato «serve il suo schermo»: era falso.** Vero della strada che avevo provato — cliccare un riquadro nel calendario, che la console non popola — falso del difetto: la scheda si apre **chiamandola per nome** (`staffCalEditPlayers`), senza cliccare niente. 📌 *Prima di dichiarare che serve un altro paio di occhi, conviene chiedersi se c'è una porta di servizio: una sonda che non raggiunge il caso dice «non ho guardato», e «non ho guardato» non è «non si può».* 🔪 `test/la-scheda-si-legge-dallalto.test.mjs`, 8 casi, scritta **sul fatto** come la scheda chiedeva (la cima dev'essere dentro il rettangolo visibile, per ogni altezza da 300 a 1400px) e non su un CSS. Chiude anche la **classe**: nessuno può più scrivere `x.scrollTop = x.scrollHeight` scavalcando il tetto. |
| **130** | 🗓️ **IL CALENDARIO CHE «SALE E SCENDE»: non era il calendario** — 📦 **CHIUSA il 02/09 notte, a PROVA FISICA su PROD 6.277**, poche ore dopo essere nata: *«il calendario non si sposta più»*. 🗣️ Osservazione sua, buttata lì mentre stavo già guardando la 127 (*«ogni tanto sembra che si sposta, sale e scende velocemente, ma è molto piccolo lo spostamento in verticale»*). 📏⭐ **La misura è arrivata prima di qualunque ipotesi**, perché ho usato lo strumento che il browser ha apposta — `PerformanceObserver` su `layout-shift`, che non dice solo *quanto*, dice **chi**: `div#staffCalV36` 189 → 213 (+24px) e, **4 secondi dopo**, 213 → 189. 📌 *Quando esiste uno strumento che nomina il colpevole, provarlo costa meno che formulare la prima ipotesi — e non si affeziona.* 🚨 La causa: `#staffCalCloudStatus`, l'etichetta grigia «aggiorno…», si accendeva e spegneva con `display` **dentro il flusso** dell'intestazione ⇒ intestazione **56 → 80px**. Non era il calendario a muoversi: era l'intestazione a **crescere sopra di lui**. ⚖️ Il poll ravvicinato passava già `silent:true` apposta; restavano i refresh «veri» — push da un altro dispositivo, rientro sulla scheda — cioè proprio i momenti in cui in segreteria si lavora in due. 🔨 Cura: l'etichetta esce dal flusso, nei 16px di margine che l'intestazione ha già. 🩹 **E il primo giro sbordava di 1px**: avevo scritto che «chiede 14px», numero preso da una misura fatta quando stava ancora **nel** flusso — cioè da un'altra pagina. Fuori dal flusso la sua riga è alta **17px** contro 16. Curato con `line-height:1`. 📌 *Una misura presa prima della cura non descrive la pagina che la cura produce.* ⛔ `#staffCalSessionWarning` resta **nel flusso di proposito**: dura ed è un bersaglio da cliccare. 📌 *Un avviso transitorio non ha diritto allo spazio di uno permanente.* 🔪 `test/letichetta-non-sposta-il-calendario.test.mjs`, e protegge **tutt'e due i versi** — che la transitoria resti fuori dal flusso, e che la permanente non ci finisca per «coerenza»: una cura applicata due volte per simmetria è il modo tipico in cui questa riparazione si disfa. |
| **126** | 📐 **DUE RIGHE INVECE DI TRE nella tab Anagrafica** — 🗣️ **voce SUA**, chiesta il 02/09 sera: *«Nella prossima chat possiamo ancora ottimizzare gli spazi della tab anagrafica? Io metterei nome, cognome, sesso e livello di gioco tutto su una riga. E poi telefono, email, bot Telegram anche quello tutto su una riga. Lo spazio c'è.»* 📦 **CHIUSA il 02/09, a prova fisica**: aperta e **guardata** con `tools/verifica-browser` su TEST 6.289 e su PROD 6.276, a tre larghezze. 📐 **La griglia da 6 a 12 colonne**, e il numero non è estetico: con sei, quattro campi non si dividono (6/4 = 1,5) e il quarto va a capo da solo. 📌 *Una riga che «quasi» torna non è una riga: è una riga più un campo orfano.* 🔤 **Classi rinominate, non riusate**: `c2`/`c3` volevano dire «due su sei» e «tre su sei»; su una griglia da dodici `c2` avrebbe significato **quattro** colonne — un nome che dice il contrario del vero è peggio di un nome brutto, perché chi lo legge non va a controllare. `c-sesto`/`c-quarto`/`c-terzo` dicono la **frazione**, che non cambia se un domani le colonne diventano ventiquattro. 🩹⭐ **E la prima riga NON è 3+3+3+3, che era la divisione ovvia: corretta APRENDOLA.** A quarti esatti il campo del livello è largo ~271px e dentro ci stanno numero + parola («Avanzato») + «🔓 Cambia livello» = ~292px: il bottone andava a capo e lasciava un gradino di ~30px sotto gli altri tre. ⇒ 3+3+**2**+**4**, e l'altezza della griglia scende da **188 a 148px**. 📌 *Quattro campi su una riga non sono quattro quarti: sono quattro campi che chiedono spazi diversi, e quanto chiedono lo dice la pagina aperta, non il codice.* 📱 **Tre gradini invece di due**: sotto i 1024px due campi per riga (un quarto di scheda starebbe sotto i 190px), sotto i 760px una colonna sola. Misurato sull'app viva: 1440px → 4+3 · 950px → 2+2+2+1 · 600px → uno per riga. 🔪 **La guardia 11 è stata RISCRITTA sul fatto**: legge dal CSS quanto vale ogni classe, somma le larghezze e verifica che ogni riga chiuda esatta — invece di cercare i nomi delle classi, che è ciò che faceva prima e che sarebbe diventato rosso per una rinomina innocua e verde su una riga che non torna. 🩹 Due difetti **della guardia**, presi da lei stessa: leggeva anche le larghezze dentro i `@media` (e accusava il codice, che era giusto) e cablava esattamente due classi nel gradino di mezzo. 📌 *Una guardia che legge più CSS di quello che si applica misura una pagina che non esiste.* 🔧 **E la console remota ha imparato `--viewport <L>x<A>`**: era cablata a 1440×900, e per un lavoro di layout quella è **una misura sola** — le pieghe di questa app stanno a 1024 e a 760px. ⛔ `.member-form-grid` non è stata toccata: la usano anche le pieghe e altre sezioni. Quattro sabotaggi visti rossi e verdi dopo. |
...
| **114** | 🟩 **Oltre i 30 giorni il calendario staff diceva «Libero», non «non lo so»** — 📦 **CHIUSA il 01/09 sera, a PROVA FISICA su TUTTI E DUE gli ambienti vivi, col CONTROLLO accanto.** 🗣️ Nata da una sua domanda (*«non vedo quattro campi prenotati il 4 ottobre alle 10:30»*): 🔎 **non era un guasto** — il 4 ottobre stava a 33 giorni e il sync ne porta 30 — ma quello che si vedeva al posto loro sì, **quattro campi verdi con scritto «Libero»**: un'assenza di dato mostrata come risposta affermativa, e nel verso peggiore, perché il verde è la condizione per prenotarci sopra. ⚖️⭐⭐ **E ALLARGARE L'ORIZZONTE A 60 GIORNI NON ERA LA CURA**, che è la cosa che questa voce ha insegnato: la stessa frase falsa ricomparirebbe il **61°**. *Il confine si sposta, la bugia no.* ⇒ I 60 giorni restano una domanda aperta e separata (§ sotto), questa metà andava fatta comunque. ⭐⭐ **Il numero dei giorni NON è scritto nell'app**: si misura sul dato — fin dove arrivano le prenotazioni che il gestionale ha. `DEFAULT_FUTURE_DAYS` vive nel sync, e una seconda copia nell'app divergerebbe il giorno in cui qualcuno ne cambia una sola, tornando a dire «libero» con la stessa sicurezza di prima. ⇒ **Il giorno in cui l'orizzonte diventa 60, quelle righe non si toccano.** 🔨 Curati **tutti e tre** i disegni del verde (agenda, griglia verticale, corsie larghe): curarne uno solo avrebbe fatto sembrare il difetto **intermittente**. ⚖️ Il bottone «+ Prenota» **resta** — si toglie la bugia, non la possibilità. ✋ **La prova**, con la console remota dentro l'app viva: **TEST 6.264** e **PROD 6.260**, stesso esito su tutti e due — 8 settembre (dentro l'orizzonte) **9 «Libero» e 0 «non lo so»**, 4 ottobre (il giorno suo) **0 «Libero» e 4 «non lo so»**, i quattro campi. ⭐ Il **controllo** è la metà che conta: senza il giorno «dentro», un «tutto non lo so» avrebbe avuto lo stesso aspetto di una cura riuscita — ed è la trappola ① della 67ª, pagata il giorno prima **sullo stesso 4 ottobre**. 🔒 Guardia nuova `test/orizzonte-del-calendario.test.mjs` (6 casi, funzioni **estratte** da `index.html` e non ricopiate), due sabotaggi visti rossi: la cura fatta a metà e il «30» scritto a mano. |
| **88** | 🔓 **«Partite Aperte»: partecipare a partite che non sono le tue** — 📦 **CHIUSA il 01/09 sera, a PROVA FISICA INTERA su PROD**, coi telefoni di quattro soci veri. 🗣️ Voce sua del 24/08 (*«partite non chiuse, che un organizzatore volutamente e spontaneamente apre ad altri giocatori»*). ⭐ La prova, passo per passo: **19:53:47** Maurizio apre la partita del 7/09 (`record_type: 'partita_aperta'`, la prima della storia); **19:58** Laura la vede in vetrina — «3 su 4 · Lunedì 7 settembre · 11:00 · **Avanzato**», il livello a parole e **nessun nome**, che è la regola ① del committente; **20:01** entra («Sei in campo · siete in quattro»); **20:02** l'avviso arriva a **tutti e tre** quelli che erano in campo — e **non** a Laura. ⭐⭐ Due cose che a banco non si potevano dimostrare: **nessuno è stato saltato in quanto organizzatore** (Maurizio è il primo dell'elenco e l'avviso ce l'ha, regola del 23/08), e a coprire Laura è stata la **ricevuta** (voce 70) — cioè la protezione che risponde a *«chi ha chiesto la scrittura?»* invece che a *«chi è il primo?»*, sul caso esatto in cui il salto vecchio avrebbe sbagliato. 📏 E la banda del ±0,5 ha filtrato per davvero: Laura 3,5 dentro, Lidia 2,5 e Fabiola 1,5 fuori. 🗣️ **E il menu**: «🔓 Partite Aperte» spostata **sotto «Prenota un campo»**, sua decisione della sera stessa — sono i due modi di arrivare in campo. ⛔ **Residuo dichiarato, ed è diventato la voce 116**: l'avviso arrivava con la frase sbagliata (*«l'ha cambiata il circolo»*). Difetto della **79**, non di questa — la 88 l'ha fatto vedere. |
| **80** | 👻 **Chi è stato TOLTO resta nell'elenco del bot finché non passa il sync** — 📏 misurato il 23/08 alle 21:27, durante il collaudo della 78: ospite tolto dal gestionale alle **21:25:48**, e la scheda del bot alle **21:27:22** lo mostrava ancora, con la ⭐ e il conteggio dei posti. Sparito solo col sync delle **21:27:53** ⇒ **2 minuti e 5 secondi** in cui il bot dice che in campo c'è una persona che non c'è più. 🔎 **Ed è il rovescio esatto della 78, che la cura di quella NON copre**: `compagni` prende il **massimo** fra le liste dello slot, quindi un'**aggiunta** fa salire subito il numero (le due letture si contraddicono, e lì la 78 interviene) mentre una **rimozione** no — il roster vecchio resta il massimo, le due letture **concordano su un dato sbagliato**, e nessuna guardia scatta. ⚖️ *Una regola costruita sul disaccordo è cieca quando le due fonti sono d'accordo e hanno torto insieme.* 🚨 **Il danno pratico non è solo cosmetico**: in quella finestra il bottone «Togli un giocatore» offre una persona **già uscita**, e chi la tocca chiede una scrittura su un roster che non esiste più. 📌 **La strada probabile, da verificare**: il dato per distinguerle c'è già ed è `synced_at` — la lista più **fresca** dovrebbe vincere sul massimo, almeno quando è quella del gestionale. È la stessa medicina della **73**, applicata alla lettura. 🔎⭐⭐ **30/08 a tarda sera — LA STRADA MISURATA, e non è quella «probabile» qui sopra.** 📏 ① **Il ponte non vede l'operazione**: `consumer-player-readmodel` legge `.in('record_type', ['booking', 'staff_booking'])` e basta ⇒ il registro della rimozione **esiste e gli è invisibile**. 📏 ② **Il registro c'è ed è un DELTA, non un roster**: `matchpoint-bookings-edit` scrive un record `staff_edit` con `players: { remove?: string[], removeAll?: boolean, add?: [...] }` ⇒ **il gestionale sa già i nomi tolti e l'istante**. Caso vero su PROD: `29/08 21:25:19 · idReserva 9649 · {"remove":["Ospite"]}`. ⇒ **La cura non è aritmetica sulle liste: è far dire al gestionale ciò che già sa.** È *il gestionale SA, il bot DICE* applicato alla lettura, e la strada del `synced_at` sarebbe stata una **deduzione** al posto di un fatto. 🚨⭐⭐ **③ E LA CHIAVE DI AGGANCIO NON È QUELLA CHE SI SAREBBE SCELTA A OCCHIO.** Misurato sulle 158 righe `staff_edit` di PROD: con `da: {data, ora, campo}` ce ne sono **58 (37%)**, con `idReserva` **145 (92%)**. ⇒ Si aggancia per **`idReserva`**, non per `data|ora|campo` — che è la chiave con cui il ponte ragiona ovunque, e che qui avrebbe mancato i **due terzi** dei casi lasciando il difetto vivo proprio dove sembrava curato. ⚙️ **La forma della cura, quindi**: il ponte legge anche gli `staff_edit`, e per ogni slot sottrae i nomi di `players.remove` delle righe **più recenti del `synced_at` dello slot**. Fuori da quella finestra non tocca niente ⇒ passato il sync la cura è inerte da sé, senza scadenze da mantenere. ⚠️ **Due trappole da non perdere quando si scriverà**: ⓐ `remove: ["Ospite"]` toglie **UN** ospite, non tutti — la sottrazione è per **occorrenza**, non per nome, o una partita con tre ospiti ne perde tre; ⓑ se l'aggancio non riesce **non si fa niente**, cioè si torna al comportamento di oggi: sbagliare verso il fastidio vecchio e non verso un roster inventato. ✅⭐ **E il costo è più basso di quanto la scheda lasciasse credere: è UN SOLO REPO.** Sottraendo nel ponte, il bot riceve `compagni` e `giocatori` già corretti ⇒ **nessuna modifica al bot e nessun riavvio**; e con loro si corregge da sé anche il bottone «Togli un giocatore», che smette di offrire una persona già uscita perché quella persona non arriva più. ✅⭐⭐ **SCRITTA il 30/08 a tarda sera, e su TEST dal push.** Modulo puro nuovo `consumer-player-readmodel/rimozioni-recenti.ts`, più il cablaggio nel ponte. ⭐ **La sottrazione sta in UN SOLO PUNTO, prima della composizione**, ed è la decisione che conta: `compagni`, `giocatori` e `in_campo` nascono tutt'e tre da `listeByKey`/`schedeByKey` ⇒ correggendo le **liste** una volta si correggono tutt'e tre insieme, e con loro il bottone «Togli un giocatore», che smette di offrire una persona già uscita **perché quella persona non arriva più**. Curare le tre uscite una per una sarebbero tre regole che divergono al primo che ne tocca una. ⚙️ **Una query SUA per gli `staff_edit`, e non un'aggiunta alla `.in(...)` esistente** — misurato, non stilistico: quella query filtra `.gte('payload->>data', today)` e uno `staff_edit` **non ha `data` di primo livello** (sta in `da`, e solo nel 37% dei casi) ⇒ infilarlo là avrebbe tolto di mezzo proprio le righe che servono, **in silenzio**. ⏱️ **Finestra di 15 minuti** (`RIMOZIONI_FINESTRA_MIN`), e il numero non è inventato: il ritardo del sync ha mediana ~2′ e **massimo misurato 10′04″** (voce 53), quindi la correzione deve stargli sopra con margine o scade prima del dato che deve correggere. È lo stesso quarto d'ora di `roster-di-recente.ts` nel bot, per la stessa ragione. ⛔ **E fallisce CHIUSA in quattro modi**, ognuno con il suo caso: aggancio mancato ⇒ niente; `synced_at` assente sullo `staff_edit` ⇒ niente; `aggiornato_al` dello slot nullo ⇒ niente (*non sapere quando il circolo ha parlato non autorizza a togliere qualcuno dal campo*); un errore sulla query ⇒ si perde la correzione, **non** le prenotazioni. 🧪 **Banco `rimozioni-recenti.test.ts`, 12 casi (70 → 71 file verdi), e SEI sabotaggi visti rossi**: la sottrazione per nome invece che per occorrenza, una grafia sola di `idReserva`, tolta la strada `da`, la finestra che ignora il sync, il togliere senza sapere l'istante, e un'**aggiunta** scambiata per rimozione. ⭐ Il caso ⑤ percorre la finestra del 23/08 dal fatto al roster **e porta la controprova dentro di sé**: col sync atterrato *dopo* la rimozione, la cura non tocca niente. *Non «non è successo niente di male», ma «è passato di lì e non ha corretto ciò che era già giusto».* ✅⭐⭐ **CHIUSA il 30/08 a tarda sera, A PROVA FISICA SU PROD — e la controprova sta dentro la prova.** Alle **23:25** il bot mostrava `⭐ Maurizio Aprea` e tre posti liberi; nello stesso istante la scheda del circolo era **ancora** `-Maurizio Aprea.-Ospite.` (`booking` sincronizzato 23:24:02). ⇒ **L'Ospite è sparito per la cura, non per il sync** — che è l'unica forma in cui questa prova vale. Ed è sparito con lui il bottone «Togli un giocatore»; al suo posto è comparso «Annulla la partita», la conseguenza giusta di essere rimasto solo. 📏 **E la firma nel registro, che è ciò che si guarda invece dell'effetto**: `23:24:35 [readmodel] voce80: tolti 1 da 2026-09-07|14:00|1 (non ancora nel sync)`, due volte. 🚨⭐⭐ **MA LA PRIMA PROVA È FALLITA, E IL DIFETTO CHE HA TROVATO È IL PEZZO CHE VALE PIÙ DELLA CURA.** Alle 23:12 il committente ha tolto l'Ospite e il bot gliel'ha mostrato lo stesso: *«negativo»*. 📏 I dati erano perfetti — `booking` 21:10:04, `staff_edit {remove}` **21:12:12**, quindi la rimozione era più recente del sync — e la cura non ha morso. 🔎 Perché il confronto usava `frescoByKey`, che è il **massimo di TUTTE le righe** dello slot, **copie nostre comprese**: la `staff_booking` è stata scritta a **21:12:14**, cioè **due secondi dopo** la rimozione, e il confronto rispondeva *«il circolo ha già recepito»*. ⚖️ **E non era sfortuna: era strutturale.** Quella copia la scrive **la stessa operazione** che produce la rimozione, sempre un istante dopo ⇒ **la cura non avrebbe morso MAI**. Un banco verde, sei sabotaggi rossi, e una cura inerte al 100%. 📌 **`frescoByKey` si chiama «fresco» e si documenta come *«l'ultima volta che il circolo mi ha raccontato questa partita»* — ma non lo è.** Risponde a *«quando questo dato è stato toccato»*. Due domande, un nome solo: è la **trappola ① della 63ª**, e mi ci sono fidato leggendo il nome invece di guardare cosa misura. 🚨 **E IL BANCO NON POTEVA VEDERLO, il che è la lezione vera**: al modulo puro il `sincronizzatoAl` glielo passavo **io**, quindi il difetto stava nel **cablaggio** e non nella regola — e nessun sabotaggio sul modulo lo avrebbe mai fatto uscire. 📌 *Un modulo puro provato benissimo non dice niente sull'argomento che gli si passa: la prova fisica non è la conferma del banco, è l'unica sonda che guarda la giuntura.* 🔨 **Cura del difetto della cura**: `istanteDelCircolo`, messa **dentro il modulo provato** e non nell'`index` — o il banco resterebbe cieco esattamente dov'ero cieco io — che tiene solo le righe **non `copiaNostra`**. `frescoByKey` resta com'è: esce come `aggiornato_al` e serve al ricordo del bot, fonderle romperebbe quello. ⭐ Il caso nuovo porta dentro di sé il **controllo del metro**: col metro sbagliato lo stesso caso torna a fallire, cioè non proverebbe niente. ⚡ **E un secondo difetto trovato da lui, in un'osservazione di passaggio** (*«ci mette un po' più di tempo»*): 📏 misurato invece di rassicurare — media **400 → 536 ms** sulle chiamate al ponte, cioè **+136 ms** a ogni apertura di `/prenotazioni`. **Non era un'impressione.** ⇒ Le due letture sono **indipendenti** e le metteva in fila solo il codice: partite insieme, il costo è il **massimo** delle due invece della somma. 📌 *Prima di pagare un dato con del tempo, guardare se quel tempo è davvero necessario o solo l'ordine in cui è stato scritto.* 🩹 **E una prova sbagliata l'ha fermata LUI, per la seconda volta in una sera**: gli avevo detto di togliere l'Ospite, ma dal bot l'Ospite **non si toglie** (voce 82) — e prima ancora, a metà serata, aveva letto «Aggiorna non me l'ha fatto vedere» dove il registro mostra che il bottone aveva riletto **quattro volte** (`Ho guardato alle 23:03:38 → 23:03:51 → 23:04:41 → 23:05:51`, l'ora cambia a ogni tocco) e a mancare era il **dato**, arrivato dal sync solo alle 23:06:37. ⛔ Quella non è diventata una voce: sarebbe stato **inventare un lavoro da un'impressione**, e la misura la smentisce. |
| **113** | 🎓⏳ **IL CARTELLINO «DA CERTIFICARE» RESTA FERMO A UN TEST SUPERATO, e la segreteria non ricarica la pagina** — 🗣️ **voce SUA del 30/08**, detta guardando l'anagrafica di PROD durante la prova della 110: *«non è normale che appaia perché una persona di segreteria non aggiorna la pagina»*. 📏 **IL FATTO, visto succedere e non ricostruito**: alle **16:03:58** il committente ha consegnato un test nuovo (dimostrato **4,5 · Avanzato**, coerenza alta) e alle **16:09**, sulla sua riga in Anagrafica soci, il cartellino diceva ancora *«il test dice **Agonista (5)**»* — cioè il verdetto del **29/08**, superato da sei minuti. Dopo un ⌘R è **sparito**, come previsto prima di guardare. ⚖️ **NON è un difetto del criterio**: `assessmentAspettaIlMaestro` prende l'**ultima scheda per data** e sulla nuova ritorna `null` per la regola che ha dato lui il 27/08 (*«stesso livello che già ha in scheda ⇒ niente maestro»*, e 4 → 4,5 è la stessa **parola**). ⇒ Il codice ha ragione; a essere vecchio è il **dato in pagina**. 🔎 **PERCHÉ resta vecchio, misurato sul sorgente**: `refreshAssessmentDataForMembersList` parte **solo all'INGRESSO** nella scheda «Anagrafica soci» (più una strozzatura di 60 s), e **nessun `setInterval` dell'app tocca le schede del test** ⇒ chi **resta** su quella scheda — che è esattamente come ci si lavora — vede il cartellino fermo all'istante in cui ci è entrato, senza limite di tempo. ⚖️⭐ **L'ATTENUANTE, misurata, e stringe il difetto invece di allargarlo**: il filtro **«Da certificare dal maestro»** — la lista che il maestro guarda davvero — **forza** il rinfresco a ogni selezione (`force:true`, riga 13230). ⇒ **La lista è fresca; è il cartellino di passaggio su una riga cercata per nome che può essere vecchio.** Per questo sta in coda e non in urgenti. 🚨 **Il danno, quando capita**: chi apre l'anagrafica per altro legge un verdetto superato e può mandare il maestro a certificare un livello che il socio non ha più — o, nel verso opposto, non vedere chi ha appena cominciato ad aspettarlo. È la stessa famiglia del calendario congelato di TEST: *la prova non fallisce, riesce mostrando il passato*. 🔨 **Nessuna cura proposta qui**, di proposito: le strade sono almeno tre (un rinfresco a tempo mentre la scheda è aperta; il rinfresco agganciato alla **ricerca** invece che al solo ingresso; o dire accanto al cartellino **a che ora** è stato letto, che è la strada che non promette freschezza ma non mente). ⚖️ Scegliere fra le tre vuole sapere quanto costa un giro in più su un'anagrafica da 2817 righe, e non è stato misurato. | 🚫⭐⭐ **SCARTATA il 30/08 a tarda sera, su sua parola** (*«stavo guardando la descrizione della centotredici e secondo me anche questa non è da fare»*, poi *«vai»*) — **e scartata con una MISURA, non con un'impressione.** 📏 **Il difetto vive solo dentro una congiunzione**, e la congiunzione è rara: serve che un verdetto ne **scavalchi un altro** (cioè una **seconda** consegna della stessa persona) *mentre* qualcuno è fermo sull'anagrafica *e* cerca proprio quella riga per nome *e* agisce su ciò che legge. 📏 **Misurato su PROD (`self_assessments`): 86 schede in tutto, 28 persone distinte, e con più di una scheda sono SEI persone** — quasi tutte lui, durante i collaudi. ⇒ La prima condizione della catena, da sola, quasi non si verifica. ⚖️ **E la strada operativa era già fresca**, come la scheda aveva misurato prima di essere scartata: il filtro «Da certificare dal maestro» — la lista che il maestro guarda davvero — **forza** il rinfresco a ogni selezione (`force:true`). Quello che poteva restare vecchio era il **cartellino di passaggio** su una riga cercata per nome. 🔓⭐ **LA CONDIZIONE CHE LA RIAPRE, scritta perché nessuno rifaccia la misura da zero — e NON è teorica: 43 delle 86 schede sono degli ULTIMI SETTE GIORNI.** Il test è appena partito, e la popolazione di oggi (28 persone) non è quella di domani. ⇒ **Il giorno in cui il test si apre ai 2.281 soci fermi a 0,5, i ripassi crescono e con loro la finestra.** Quando succederà, la cura da fare è **la terza delle tre** già elencate qui sopra, e non la prima: dire accanto al cartellino **a che ora è stato letto**. Non promette freschezza, non costa un giro in più su 2817 righe, e soprattutto **non mente** — che è l'unico difetto vero della voce. 📌 *Una voce si scarta scrivendo cosa la farebbe tornare: «non è da fare» senza quella riga è una decisione che scade in silenzio, e la prossima sessione la ricomincia dalla misura.*
| **99** | 🚪 **Il cancello di Principiante da accendere** — la banca è piena (27+9) e le domande sono approvate, ma `regole_fascia` dice ancora `Principiante: { cancello: false }` ⇒ da quella fascia non si pesca niente. 🗣️ **Decisione sua già presa**: chi non passa prende **Principiante + segnalazione allo staff**, non resta a 0,5 ⇒ serve il **terzo esito**, che dalla 94 c'è. ⚙️ E vuole la rimodulazione a **2 normali + 2 trabocchetti** per quella fascia (invece di 3+1): lì la domanda vera è *«hai mai visto una partita?»*, e a scoprirlo è il **trabocchetto**, non la domanda normale | ✅⭐⭐ **CHIUSA il 30/08 a tarda sera, da LUI** (*«va bene chiudi la novantanove»*) — **e METÀ era già fatta da lui il 27/08 sera, senza che la scheda se ne fosse accorta.** 📏 **Misurato invece di crederle**: qui era scritto *«`regole_fascia` dice ancora `Principiante: { cancello: false }`»*, e nel codice **quella chiave non c'è più**. Oggi è `Principiante: { pass_min_correct: 0 }`, e siccome `assessKnowledgeRegole` torna `cancello: propria.cancello !== false`, per quella fascia il cancello è **ACCESO**: le domande **si pescano**, e semplicemente non bocciano nessuno. 🗣️ Fu una sua decisione del **27/08 sera** — *«direi di sbloccare le domande della banca per principiante»* — e la scheda è rimasta indietro tre giorni. 📏 **E la banca dichiarata qui era vecchia pure lei**: `27+9` scritto, **27+16** misurato (per ogni fascia; Avanzato 27+17, Agonista 27+19). ⛔ **LA SECONDA METÀ — il «2 normali + 2 trabocchetti» — è stata SCARTATA, con la sua parola e per due ragioni misurate:** ① **collide con una regola che lui ha dato DOPO.** `pass_min_correct: 4` è la sua *«se ne può sbagliare una su cinque»* del 27/08. Con 2+2 le domande diventano **quattro** ⇒ o si lascia la soglia a 4, e allora sono **zero errori concessi** (il contrario della sua regola), o si scende a 3, e allora è *«una su quattro»*, **più permissivo** di quanto avesse chiesto. ⇒ Non è una rimodulazione: è un cambio di severità travestito da conteggio. ② **la ragione che l'aveva chiesta si è dissolta da sé.** Era la ripetizione dei trabocchetti — il file stessa la chiamava *«peggiorata da noi»*, 62% di rivederne uno alla prova dopo — ma quel conto era su **12** trabocchetto; oggi sono **16**, e dal 27/08 sera c'è l'**ordinamento per freschezza** che pesca prima le mai viste. 📏 Con 2+3 la banca dei trabocchetti gira in **5,3 prove**, non in 4. 📌 *Una richiesta si rilegge contro lo stato di oggi, non contro quello del giorno in cui fu scritta: qui la ragione era caduta e la richiesta, applicata alla lettera, avrebbe rotto una regola più recente dello stesso committente.* 🩹 **E l'unica riga di codice toccata è un COMMENTO che mentiva**, in testa alle costanti della pescata — cioè il primo posto che legge chi tocca quel file: *«⛔ Principiante resta SENZA quiz (regola del 9/08, non toccata)»*, falso dal 27/08. Corretto, non affiancato: la ragione del 9/08 regge intera nel merito (*chi si dichiara al minimo della scala non guadagna niente mentendo*), è cambiato il **come**, non il **perché**. ⚠️ **Nessun comportamento cambiato**: zero righe di logica, `pick_normal`/`pick_trap`/`pass_min_correct` intatti. Il redeploy dell'edge `assessment-quiz` è a **effetto nullo**, ed è stato detto prima di farlo.
| **79** | 🔕 **Un avviso di «aggiunto» o «tolto» arriva SOLO a chi si è mosso, non a chi resta in campo** — 🗣️ segnalata dal committente il 23/08 sera, controllando il proprio telefono: *«a Maurizio sul bot non è arrivato nessun messaggio che si è aggiunto un ospite o si era levato un ospite»*. 📏 **Misurato su `pmo_eventi_staff`**: fra le 21:15 e le 21:35 c'è **un fatto solo** — la creazione della partita (`Maurizio Aprea · aggiunto · 21:20:04 · consegnato 21:22:27`). Per l'ospite tolto (21:25:48) e per quello aggiunto (21:30:29): **zero fatti**. Non è un messaggio perso: è un messaggio mai nato. 🔎 **E la ragione è più larga del caso degli ospiti**: i fatti `aggiunto`/`tolto` sono **intestati a chi si è mosso**, non a chi resta. La riprova sta nella partita vera della stessa sera: alle 18:00 sono stati aggiunti Fabio e Andrea → sono nati **due** fatti, uno per Fabio e uno per Andrea; a Maurizio e a Benso, che erano in campo, **non è arrivato niente**. ⚖️ **Che è ciò che la regola del 23/08 vieta** — *«quando la segreteria fa un qualsiasi tipo di operazione, le persone che sono dentro la partita devono essere avvisate»*: quella regola era stata applicata all'annullo e allo spostamento (voci 74 e 76), **non** all'entrata e all'uscita di un giocatore. ⇒ Con un ospite non c'è nessuno da avvisare e il silenzio è **totale**; con una persona vera l'avviso va **solo a lei**. 🚨 **Perché conta**: è il caso più frequente di tutti — la segreteria che compone una partita — ed è esattamente quello in cui gli altri vorrebbero sapere chi si sono trovati in campo. | 🔄🚨⭐⭐ **RIMISURATA la notte del 23/08, su TRE gesti in un colpo solo, ed è più larga di come era scritta.** Alle 23:07 la segreteria cambia la formazione del 31/08 · 09:00 · Campo 2: **fuori Lidia, fuori Fabiola, dentro Marco**. Il sync li vede tutti e tre alle **23:10:04** e li consegna alle **23:13:49** — e i tre fatti sono intestati **a Lidia, a Fabiola e a Marco**. A **Maurizio** e a **Laura**, che erano e restano in campo: **zero**. 🚨⭐⭐ **E LA SECONDA PORTA, che è la parte nuova e che il committente ha deciso di tenere QUI dentro** (*«trattala dentro la 79»*): a chi resta un messaggio è arrivato lo stesso, alle **23:18** — ma dall'**altra macchina**, quella dei promemoria (`testoTornataIncompleta`), e diceva **«Un giocatore è uscito»**. 📏 Ne erano usciti **due**, ed era **entrato Marco**, che non viene nominato. 🔎 Il perché: quella macchina non guarda i gesti, guarda **un numero** — `giocatori_visti`, quanti erano e quanti sono. Da 4 a 3 il conto fa **−1**, e il **netto** viene raccontato come se fosse un **evento**. ⇒ Due uscite e un ingresso, caduti nella stessa finestra, si annullano fino a diventare «un giocatore è uscito». ⚖️ *È la stessa forma della 79 vista dall'altro lato: là chi resta non riceve niente, qui riceve un messaggio che dice metà* — e la regola del committente («gli avvisi se devono arrivare devono arrivare **corretti fino in fondo**») le vieta tutte e due. 📌 **E un terzo dettaglio, piccolo e vero**: «Ora siete **in tre**: Laura Aprea e Marco Aprea» promette tre nomi e ne elenca **due** — il terzo è chi legge, che si capisce ma non sta nella lista, e i due punti fanno aspettare l'elenco completo. ⇒ **La cura dovrà essere UNA**: i fatti nascono dai gesti (non da un conteggio) e vanno a **tutti quelli in campo**; se poi la macchina dei promemoria dica ancora la sua, o taccia perché l'ha già detto il fatto, è la prima cosa da decidere — due macchine che raccontano lo stesso cambiamento sono il modo di ottenere due messaggi che si contraddicono. 🆕🧊 *(25/08 notte)* **E adesso questa voce ha una CODA FUORI DAL REPO, che chi la cura deve toccare nello stesso giro**: chiudendo la 87 il testo che il bot dice al socio — `avvisi_dal_circolo.come_funziona` nella kb, PROD e TEST — è stato scritto con le parole del committente e dice *«arriva solo a chi il gesto ha toccato, non agli altri in campo»*. ⇒ È **vero oggi** e **falso il giorno in cui questa voce si cura**, e non lo protegge nessuna guardia: la kb sta in un database, e le guardie di questo repo leggono i sorgenti. 📌 L'avviso è stato messo **dentro il dato stesso** (`_scade_con_la_voce_79`), che è l'unico posto dove chi ci mette le mani lo trova per forza. ⚖️ È la regola delle «partite aperte» applicata: *un fatto vero che si sa già essere temporaneo va messo dove costa poco cambiarlo* — la kb è quel posto, a patto che la scadenza sia scritta accanto al fatto. 🔨⭐⭐ **CURATA IL 31/08/2026 (65ª sessione), IN SERVIZIO — e la cura è UNA, come la scheda chiedeva.** **Ⓐ Il quinto gesto `formazione`**: in `eventi-staff.ts`, quando una partita viva cambia roster, nasce un fatto anche per **chi resta**, con dentro **chi è entrato e chi è uscito** — ospiti compresi, perché `puoRicevere` decide chi RICEVE un messaggio, non chi si può NOMINARE dentro a un messaggio, e aver confuso le due è ciò che rendeva invisibile l'ospite aggiunto. Il bot lo dice con `testoStaffFormazioneCambiata` («Entra Marco Aprea, escono Lidia Comes e un ospite»), verbi accordati sul **numero** e non sul genere, ospiti **contati** e non elencati. La riduzione lo fonde **al netto della raffica** (entrato in un giro e uscito in quello dopo ⇒ niente da dire) e lo toglie dal conto dentro/fuori: a chi è stato **tolto** non si racconta come si è composta una partita che non è più sua. **Ⓑ La seconda porta**: `testoTornataIncompleta` raccontava il **netto** come un evento — `usciti` era `vistiPrima - giocatoriOra`, e due uscite più un ingresso lo facevano valere **1**. Il campo è stato **TOLTO**, non corretto: nessun accordo grammaticale poteva renderlo vero. Adesso quel messaggio dichiara uno **STATO** («Non siete più al completo»), che il conteggio conosce davvero, e «cosa è successo» lo dice il gesto nuovo. 📌 *Una macchina che conosce solo un netto deve parlare di uno stato.* Con due difetti minori dello stesso messaggio: «Ora siete in tre» seguito da **due** nomi (adesso «tu, X e Y») e il plurale rivolto a chi è rimasto solo. 🩹 **E la decisione ① del 21/08 in testa a `eventi-staff.ts` è stata CORRETTA, non affiancata**: la forma resta (un fatto porta una persona sola), ma di fatti ne nascono di più. 🚨 **L'ordine di messa in servizio è obbligato**: bot → migrazione del `CHECK` → gestionale, perché `ponte.ts` scarta i gesti che non conosce. ⭐ E l'insert del sync ha un **ripiego**: se la migrazione non fosse applicata, riprova senza i fatti nuovi invece di far cadere il blocco intero — annullamenti compresi. 🧪 Banco: gestionale **71 verdi / 0 rossi**, bot **1673 verdi / 0 rossi** (erano 1662). Visto **rosso con cinque sabotaggi** (il fatto che non nasce, gli elenchi accodati invece che fusi, `formazione` rimesso nel conto dentro/fuori, il ponte tornato a quattro gesti, l'apertura che torna a raccontare il netto). ⏳ **RESTA APERTA, e manca UNA cosa sola: la PROVA FISICA.** Un cambio di formazione fatto dalla segreteria su una partita vera di PROD con **due soci che restano**, e il messaggio guardato su un telefono. ⛔ Su TEST non si può — calendario congelato, e il dispatcher di TEST non sa nemmeno chiedere il sync delle prenotazioni. ⚠️ **Due residui dichiarati, non taciuti**: ① la strada `conferma` (`fatti-da-conferma.ts`) **non** produce ancora `formazione` ⇒ chi resta lo sa alla velocità del **sync** (~2′, massimo misurato 10′04″) invece che all'istante; ② durante uno **spostamento** che cambia anche i giocatori, chi resta riceve `spostata` e **non** l'elenco dei cambi: è il ramo della voce 76, che non è stato toccato. 🧊 **E la coda fuori dal repo NON è ancora fatta, di proposito**: la kb va cambiata **dopo** il deploy del gestionale, o per la finestra fra i due direbbe il falso al contrario. ✅⭐⭐ **CHIUSA IL 31/08/2026 (65ª sessione), A PROVA FISICA SUA — e con un residuo dichiarato.** 🗣️ Il messaggio è arrivato sul suo telefono alle **15:28**: *«È cambiata la formazione della tua partita · Lunedì 7 settembre alle 11:00, campo 3 · Entra un ospite. L'ha cambiata il circolo.»* — cioè **esattamente** il caso da cui la voce era nata due giorni prima, l'ospite aggiunto di cui non sapeva nessuno. ⏱️ **E poi ha detto la cosa che valeva più del verde**: *«però ci ha messo parecchio tempo ad arrivare»*. 📏 Misurato sul fatto vero invece che stimato: `visto_at` 15:26:04 → `consegnato_at` 15:28:16 = **131,6 s**, di cui **120 di quiete** e ~11 di ritiro; più **0-120 s** di attesa del giro di sync, che non si possono sapere meglio perché `visto_at` è l'istante **del giro**, non del gesto. ⇒ percepiti **2:12-4:12**. 🔎 **La causa era una parola sola nel fatto: `origine: 'sync'`.** La strada veloce esiste dalla voce 76 (istante vero, quiete **30 s**), ma `matchpoint-bookings-edit` la usava **solo per lo spostamento puro** e taceva quando il gesto toccava i giocatori — con una ragione scritta e buona: *dove la conferma non sa dire tutto, tace invece di dire metà*. ⇒ Il gesto **più frequente di tutti** non aveva mai avuto la strada veloce, né prima né dopo la cura: era il perimetro della 76, non un buco aperto dalla 79. 🔨 **CURATO LO STESSO GIORNO**, e la forma se l'è dettata una sonda: alla sua domanda *«controlla prima il doppione»* la risposta misurata è stata **il doppione no, ma il dedup mangiava un cambiamento vero**. 📏 Su `aggiunto`/`tolto` la chiave `(slot, persona, gesto)` dice **cosa** è successo, perché `persona` è chi si è **mosso**; su `formazione` `persona` è chi **riceve**, quindi due cambi diversi sullo stesso slot hanno la **stessa chiave**. Caso concreto e non teorico: un ospite aggiunto dal gestionale (⇒ dichiarato) e un altro messo direttamente su Matchpoint (⇒ no) ⇒ il socio avrebbe saputo del primo e non del secondo. ⇒ Cura: il dedup del sync **SOTTRAE** ciò che è già stato detto invece di scartare in blocco, ed è la stessa regola del netto che la riduzione applica già a valle, portata a monte. Più `fattiDaCambioRoster`, che **non riscrive la regola**: chiama `fattiDaConfronto`, la stessa del sync, su due fotografie di un solo slot — e un caso del banco confronta i due risultati per **identità**, così una futura copia a mano si vede subito. 📌 *Una domanda posta prima («controlla il doppione») ha cambiato la forma della cura; posta dopo sarebbe stata un incidente.* 🧪 Banco **71 verdi / 0 rossi** (gestionale) e **1673 / 0** (bot), con **sette** sabotaggi visti rossi in tutto. ✅⭐⭐ **E IL RESIDUO È STATO CHIUSO LA SERA STESSA, con la sua seconda prova fisica — 31/08, 20:34 e 20:36.** Due gesti dal gestionale sulla partita del 7/09 · 11:00 · C3, distanziati di **2′23″** apposta perché non si fondessero in una raffica sola: `+ Lidia Comes`, poi `− Ospite`. 📏 Letti sul fatto, non sull'orologio — che da solo non distingue le due strade e poteva ingannare se il sync fosse passato in quell'istante:
...
⇒ Da **131,6 s** (più 0-120 di attesa del giro) a **33**, e `visto_at` è adesso l'**istante vero del gesto**. ⭐ **E tre cose che il dato ha mostrato senza che nessuno le cercasse**: ① i due gesti NON si sono fusi, cioè la quiete distingue due raffiche vere; ② al secondo gesto **anche Lidia** ha ricevuto `formazione`, perché era entrata due minuti prima — la squadra su cui si calcola è quella del momento, non quella di partenza; ③ 🚨 **i doppioni dal sync sono ZERO**, e questa volta lo zero vale, perché il sync **è passato** nel frattempo (ultimo giro 20:39:12, dopo tutti e due i gesti). ⇒ La **sottrazione ha lavorato sul vivo**, non solo nel banco: è il caso ② della sonda verificato dal vero. ⭐ **E con lui si chiude anche la GIUNTURA**, che era il residuo dentro il residuo: l'edge che chiama la dichiarazione non ha un caso del banco e non poteva averlo — a coprirla poteva essere solo un gesto vero, ed è successo. 📌 *La voce 80 aveva insegnato che la prova fisica guarda un posto che il banco non vede; qui quel posto è stato guardato lo stesso giorno in cui è nato.* |
| **109** | ✅ *(31/08 mattina, 65ª sessione — **chiusa a prova fisica su PROD, e la prova è arrivata da SÉ**: un omaggio vero, fatto dalla segreteria su una partita viva, scritto nel cloud alle **07:53:29** con `cloud_records_upsert {count: 1}` allo stesso microsecondo. Prima della cura sarebbe caduto in silenzio.)* 🚨🚨 **109. La RPC non conosceva i pagamenti: una «quota offerta» sarebbe sparita in silenzio, e lo schermo l'avrebbe data per registrata.** 📏 **Una DERIVA fra due liste, non una scelta**: `payment` stava nel vincolo della tabella (22 tipi) e **non** nella lista dentro `pmo_upsert_records_admin` (15) ⇒ scartato in silenzio, `ok: true` con `count: 0`, e l'app guardava `ok`. La migrazione che aggiunse `payment` alla tabella è del **27/06**: per due mesi nessuno se n'era accorto, perché **un omaggio non l'aveva mai fatto nessuno** — quello zero era un **non uso**, non una perdita. ⚙️ Cura larga quanto il bisogno misurato, per sua decisione: `payment` **e solo quello**. 🔒 `test/i-tipi-che-lapp-scrive.test.mjs` impedisce alla deriva di tornare in silenzio, e non pretende che le due liste siano uguali (non devono esserlo): pretende che **nessun tipo che l'app spinge davvero cada nella fessura fra loro**. 🚨🚨⭐⭐ **E LA SONDA CHE DOVEVA CHIUDERLA È STATA SBAGLIATA TRE VOLTE IN TRE GIORNI, ognuna nel verso di affermare una cosa non vera**: il campo (`data` è il giorno del PAGAMENTO, `booking_data` quello della PARTITA), poi la finestra dell'export, poi il **bersaglio annullato**. 📌 *Rendere conclusiva una sonda la rende anche pericolosa: da quel momento ogni suo silenzio è un'affermazione.* 🎯 **E ALLA FINE L'HA CHIUSA IL CODICE, NON LA SONDA — è il pezzo che vale.** `_pmoGiftSyncFromRoster` riceve **solo** `data.worker.partecipantiFinali`, cioè il roster letto **dal vivo sulla ficha di Matchpoint**, e scrive solo per chi ha `stato === 'riscosso' && importoCents === 0`. ⇒ **Un record `paygift` non può esistere se la ficha non diceva già «riscosso, 0 €»**: la direzione è Matchpoint → gestionale, e *«l'omaggio è arrivato su Matchpoint»* è vero **per costruzione**, non per assenza o presenza di una riga. La scheda conteneva tutt'e due le letture a quindici righe di distanza. 📌 *Una scheda che si contraddice non si risolve scegliendo la riga più convincente: si va a leggere il codice.* ⚠️ **Un residuo DICHIARATO, che non è di questa voce**: l'export dei pagamenti di Matchpoint **non porta le righe a 0 €** — su **3063** pagamenti mai tornati, quelli a zero sono **ZERO**, e il 31/08 l'omaggio delle 09:30 non è tornato benché l'export delle 08:55 avesse il 31/08 nella finestra (che è su `booking_data`, misurato). È un fatto sugli **Incassi**, non un difetto della cura. |
| **71** | 🧩 🙅 **«Questa partita non l'hai organizzata tu» — detto a chi l'ha appena prenotata — CURATA IL 22/08, TUTT'E DUE LE METÀ, in servizio** — 🩹 *(corretta la sera del 22/08)* qui c'era scritto **«manca il bot»**, e non era più vero: il bot legge `ordine` (`ponte.ts`) e la frase c'è (`invito-partita-testi.ts`, *«Sto ancora registrando questa prenotazione col circolo, quindi non so ancora chi l'ha organizzata»*), fusa con la **#55** e già ai soci. ⚖️ La riga vecchia è sopravvissuta **poche ore** alla cura che la smentiva, ed è la 26ª nella forma più banale: *una scheda si aggiorna quando si chiude il lavoro, non quando qualcuno se ne ricorda*. 🚨 E costava più di un'imprecisione: chi avesse provato la 71 stasera avrebbe letto un risultato **buono** come se fosse un difetto aperto. 📌 Trovata **controllando invece di ricordare**, rispondendo alla domanda «è rimasto qualcosa in lista?» — 📏 **misurato al secondo la notte del 21/08**, ed è il PRIMO difetto uscito dal collaudo: il committente prenota dal bot (31/08, 11:00, campo 1), conferma, e il bot gli risponde *«Questa partita non l'hai organizzata tu, quindi non posso invitare altri giocatori. Puoi chiederlo a chi l'ha organizzata.»* 🔎 **La causa è una FINESTRA, non un errore di regola:** la regola *«l'organizzatore è il primo dell'elenco»* si legge **solo** dalla scheda del circolo (`descrizione`), e la scheda la scrive **Matchpoint**, non il bot ⇒ una prenotazione appena nata dal bot non ce l'ha. Sta scritto nel ponte, nero su bianco: *«Uno `staff_booking` non ha descrizione: la sua lista non entra, e da solo non dà ordine»* ⇒ `rosterOrdinatoDelloSlot` torna `[]` ⇒ **nessun organizzatore**. 📏 **La finestra, misurata sulla prenotazione vera**: `staff_booking` scritto alle **21:31:14** con `descrizione` vuota, `booking` tornato dal sync alle **21:32:47** con `-Maurizio Aprea.` ⇒ **1′33″**, e il messaggio è caduto lì dentro. Riprovando quattro minuti dopo l'invito è partito senza storie ⇒ **è una finestra, non un muro**. 🚨 **Perché non è un caso di bordo:** il bot offre «🎾 Invita un giocatore» **attaccato al messaggio «Prenotato»**, cioè esattamente dentro la finestra, e il ritardo del sync è ~2′ in mediana (max misurato **10′04″**). Nessuno aspetta due minuti prima di invitare chi ha appena chiamato per giocare ⇒ **è la strada principale**, e la becca ogni socio che prenota e invita di seguito. ⚖️⭐ **Il difetto NON è il cancello, è la FRASE**: il cancello ha ragione a non far invitare quando non sa chi ha organizzato — sbaglia a dire **«non sei tu»** quando la verità è **«non lo so ancora»**, e a mandare il socio *«da chi l'ha organizzata»*, che è **lui stesso**. 📌 È la stessa famiglia di `testoSeiStatoTolto` (*«parlane con X»* a chi non aveva fatto niente) e la forma giusta il progetto ce l'ha già scritta: **`esito_ignoto`** della voce 53 — *quando non lo so, dico che non lo so*. 🔨 **Cura proposta, NON scritta**: il ponte deve poter distinguere *«elenco vuoto perché non c'è ancora la scheda»* da *«elenco vuoto perché è davvero ignoto»* — oggi `giocatori: []` dice tutti e due — e il bot, davanti al primo, deve rispondere *«sto ancora registrando la prenotazione, riprova fra un minuto»* invece di negare la paternità. ⚠️ **Tocca i DUE repo** (il ponte porta il dato, il bot applica la regola: è la divisione della regola ferrea, e va rispettata), quindi non si chiude in una sessione che ha in mano solo il gestionale. 🔨 **FATTA il 22/08 la metà di QUESTO repo** — `consumer-player-readmodel` non risponde più con un solo silenzio: accanto a `giocatori` esce ora **`ordine`**, che vale `noto` · `non_ancora` · `ignoto` (`compagni-slot.ts`, `ordineDelloSlot`). ⚠️ `giocatori` **non cambia** né forma né significato: `ordine` si aggiunge, quindi un bot più vecchio del ponte continua a leggere quello che leggeva. ⭐ **La distinzione è STRUTTURALE, non a tempo**, ed è una scelta: si guarda **da dove arrivano le righe** dello slot — se ne esiste una venuta dal circolo, il circolo ha già parlato e un ordine mancante è davvero ignoto; se ci sono solo le copie scritte da noi (`staff_booking`), il circolo **non ha ancora parlato**. ⛔ Scartata la strada del tempo («meno di N minuti ⇒ è presto»): sarebbe una soglia inventata, nessuno l'ha misurata, e il ritardo del sync ha una coda lunga (mediana ~2′, massimo **10′04″**). 📌 A chi volesse comunque invecchiare il messaggio il dato c'è già: ogni slot porta `aggiornato_al`. 🚨 **Il verso del dubbio non è simmetrico**: un tipo di riga non riconosciuto vale **«viene dal circolo»**, così un caso inatteso ricade in `ignoto` — il comportamento di prima — invece di far promettere al bot *«riprova fra un minuto»* per una scheda che non arriverà mai. ⇒ *Sbagliando si torna al fastidio vecchio, non a una promessa che non si può mantenere.* 🩹🚨⭐⭐ **QUI C'ERA SCRITTO «COSA MANCA, ed è tutto nel repo del bot», E LA SCHEDA SI CONTRADDICEVA CON SÉ STESSA** — due righe più su una correzione del 22/08 sera diceva che il bot la frase **ce l'aveva già**. 📏 **Misurato il 30/08 sera invece di scegliere quale credere: hanno ragione tutt'e due, e nessuna lo diceva.** Il bot la frase ce l'aveva — **ma solo per l'INVITO** (`invito-partita.ts:110`). 🎯 **Le porte che dicono «non l'hai organizzata tu» sono TRE, non una**: l'invito, il **TOGLI** (`bot.ts`) e l'**ANNULLO** (`uscita.ts`) — e le ultime due `ordine` non lo guardavano affatto. 🚨 **E `uscita.ts` lo dichiarava nel suo stesso commento**, che nessuno aveva letto come un difetto: *«Non è (più) lui l'organizzatore, **o non si sa chi sia**»*, seguito da un `return 'non_sei_organizzatore'` che **afferma**. ⇒ Un fatto e un'ignoranza detti con la stessa parola: la forma esatta della 70 e della 71, su un altro bottone. 📌 *Una scheda che si contraddice non si risolve scegliendo la riga che convince di più: si va a misurare, e quasi sempre le due righe descrivono due pezzi diversi che nessuno aveva separato.* ✅⭐⭐ **CURATA il 30/08 sera** (`assistente-padel-agent#112`, fusa). ⚙️ Un modulo puro nuovo — `src/mastra/lib/ordine-del-roster.ts` — traduce `ordine` in un motivo, e lo leggono le **due** porte scoperte. Sta in **un posto solo** per la ragione già scritta su `puoiTogliere`: due copie divergono, e divergere qui vuol dire che **lo stesso socio, nello stesso minuto, si sente dire due verità diverse a seconda del bottone che tocca**. 🚨 **Il verso del dubbio non è simmetrico, ed è la scelta che regge il modulo**: **solo** la parola `non_ancora` guadagna la frase morbida; `noto`, `ignoto`, l'`undefined` di un ponte più vecchio e qualunque parola futura ricadono sulla frase di oggi. ⇒ Sbagliando si torna al **fastidio vecchio**, non a una **promessa non mantenibile** — *«riprova fra un minuto»* su una scheda che non arriverà mai è peggio del «non sei tu», che almeno una strada ce l'ha. 🗣️ **Le frasi**, sul modello della gemella dell'invito: dicono che la partita **è prenotata** (chi legge «non posso» sospetta che non sia passata), vietano di rifarla, **non promettono nessun tempo**, e mandano a `/prenotazioni` invece che in segreteria — nessun vicolo cieco, e **nessun numero**, che accenderebbe anche il bottone WhatsApp per una cosa che si risolve da sé. 🧪 **Banco**: `test/voce71-non-ancora-registrata.test.ts`, **10 casi nuovi** (1652 → **1662**, 0 rossi, `tsc` pulito), e **cinque sabotaggi visti rossi** — la regola rimessa a com'era, il verso del dubbio rovesciato, l'annullo staccato dal modulo, la frase che promette «fra 2 minuti», il togli che torna a negare la paternità. ⭐ E un caso pretende che **le tre porte diano lo stesso motivo sullo stesso dato**: protegge una **decisione**, non un calcolo — è quello che qualcuno, fra sei mesi, romperebbe curandone una sola. 🩹 **Un rosso del banco stesso va detto**: la prima voce di prova cadeva in un ramo precedente di `perche()` ed era **verde senza esercitare niente**. Solo `azione: 'esci'` + `ancheAnnulla: false` arriva alla riga curata — ed è anche la fotografia esatta della finestra della 71. ✅⭐ **IN SERVIZIO AI SOCI dal 30/08 alle 22:09:34**, su sua parola (*«vai col deploy»*): `deploy-bot-hetzner` bersaglio **soci**, dallo sha `7a414e1` — cioè il merge della cura, che è il deploy stesso a dichiarare, non una deduzione. 📏 **Verificato con una sonda SEPARATA da quella che ha fatto il lavoro** (`stato-bot`, sola lettura), perché il verde di un comando non è il bersaglio: `online`, uptime **43 s**, riavvii **99 → 100**, riga d'avvio `22:09:34`, ritiro dei fatti riacceso alle `22:09:55`. 🔒 **E il `.env` il deploy non lo tocca**: il bot dichiara ancora `ponti edge qqbf… (PROD)` e `✍️ prenotazioni REALI` ⇒ è rimasto puntato dov'era, che è l'unica cosa che quella riga può provare. ✅⭐⭐ **CHIUSA il 30/08 a tarda sera, da LUI** (*«la prova funziona, chiudi la 71»*), **con la schermata in mano**: il messaggio «✅ Prenotato: lunedì 7 settembre, 14:00-15:30, campo 1» col bottone **«🎾 Invita un giocatore»** attaccato sotto, e *«Adesso puoi organizzare la partita»* — cioè, **dentro la finestra**, il bot gli riconosce la partita come sua invece di negargliela. ⚖️ **COSA QUELLA PROVA HA ESERCITATO, E COSA NO — dichiarato, perché non si chiude su un'impressione:** ha esercitato **la porta vera della 71**, l'invito attaccato al «Prenotato», che è esattamente dove il difetto fu visto il 21/08. ⛔ **NON ha esercitato le due porte curate quella sera** (il togli e l'annullo): quelle restano coperte dal solo banco. 🩹🚨⭐⭐ **E LA RIGA «IL TOGLI È LA PORTA LARGA», scritta qui poche ore prima, ERA FALSA — si corregge, non si affianca.** Gliel'avevo data come istruzione per la prova, e lui si è fermato a chiedere *«devo aggiungere un giocatore, giusto?»*. 📏 Misurato allora invece che prima: `puoiTogliere` vuole **tre** cose insieme — partita, organizzatore riconosciuto, e qualcuno da togliere — quindi nella finestra della 71 quel bottone **non viene disegnato**; e `schedaTogli` si raggiunge **solo** da lì (`bot.ts:3913`, è un callback), mai a parole. Stessa condizione per «Invita» sulla schermata della partita (`inviti: v.sonoOrganizzatore === true`). ⇒ Le due porte curate quella sera si raggiungono **solo da un bottone vecchio rimasto in chat**: sono **profondità difensiva**, non una strada che si attraversa a comando. 📌 *La sua domanda ha fermato una prova che sarebbe riuscita senza esercitare niente* — l'obbligo ③ della delega, con i ruoli scambiati: stavolta a fermarla è stato lui. ⛔ **RESIDUO DICHIARATO**: la cura del togli e dell'annullo **non l'ha vista succedere nessuno**, e non si provoca — si aspetta, come la 65 e la 92. Chiusa lo stesso perché la voce chiedeva *«il bot non deve negare la paternità a chi ha appena prenotato»*, e **quello è stato visto**. Curare anche le altre due porte era chiudere la **classe** invece dell'istanza: giusto farlo, e onesto dire che quella metà la coprono il banco e cinque sabotaggi, non un telefono. ⏳ **E dopo il deploy la prova fisica ha una forma precisa**: prenotare dal bot e toccare **«Togli un giocatore»** *dentro* la finestra del sync — mediana ~2′, massimo misurato 10′04″ — leggendo «sto ancora registrando» invece di «non l'hai organizzata tu». ⚠️ **L'annullo è più stretto del togli e va detto**: la riga curata si raggiunge solo su un **bottone vecchio confermato**, perché dentro quella finestra il bottone «Annulla» non compare nemmeno. Il togli è la porta larga. 🔎 **Trovato per strada e DICHIARATO, non fatto**: `organizzatore_ignoto` è **una frase che nessun percorso può raggiungere** — 9 occorrenze, 3 rami `case`, 1 nel tipo, 5 nei test che la chiamano a mano. Non l'ho cablata perché questa scheda decide il contrario per `ignoto` (*«resta la frase generica di oggi»*), e cambiarlo toccherebbe un caso che **nessuno ha misurato** |
| **108** | ✅ *(30/08 sera, 64ª sessione — **chiusa a prova fisica su PROD, e la prova è arrivata da SÉ**: «Nessun avviso giallo»)* 🚨 **108. Un salvataggio di scheda socio poteva sparire in silenzio, e lo schermo diceva «salvato».** 🗣️ Nata da un caso suo del 29/08: aveva cambiato il livello di Maurizio Aprea da **4 a 3,5 e poi di nuovo a 4** — nel cloud non è arrivata **nessuna delle due**, e il gestionale non l'ha detto. Il giorno dopo lo schermo mostrava 3,5, il cloud diceva 4, e nessuno dei due sapeva di essere in disaccordo. 📏 **Le due misure, su PROD**: in tutto il 29/08 l'unica scrittura di un record `member` è stata il sync clienti delle 19:30 ⇒ **zero** soci su 2817 con `payload.updatedAt` di quel giorno, dopo una serie continua dal 16 al 28; e sul registro `pmo_audit_log`, dal 15 al 29 agosto, **67 spinte su 411 hanno scritto ZERO record** — **una su sei** — mentre `pmoSyncCloudRecordsNow` le dava tutte per riuscite, perché guardava `ok` e **non** `count`. 🚨⭐⭐ **E la cosa che ha deciso la forma della cura: il ramo che ha mangiato quei due salvataggi NON SI È POTUTO NOMINARE** — le 67 lasciano almeno la loro riga di audit, quelle due nemmeno quella. I modi di perdere quella scrittura sono almeno **quattro**, e curarli uno per uno avrebbe lasciato scoperto il **quinto**, che è precisamente questo caso. 📌 *Una perdita silenziosa non si cura indovinando il ramo che si rompe: si cura rendendola rumorosa.* ⚙️ **La cura, tre pezzi**: ① una spinta che scrive **zero** record **fallisce** invece di passare per riuscita (il confronto è con lo zero e non con `list.length`, perché un lotto può legittimamente scriverne meno — zero no); ② ogni modifica lascia un segno in `localStorage` scritto **prima** di spingere e cancellato **solo** quando il cloud conferma, e all'**avvio** i segni rimasti si dicono, perché un avviso che vive un secondo è un avviso che si perde; ③ la spinta sta subito dopo `save('giocatori', …)` e non più in fondo a `closeMemberCard()`, né dentro un `catch (e) {}` **nudo**. ⛔ **Non rispinge da sola, dichiarato**: manderebbe la copia di *quel* browser sopra una riga più fresca — il danno della voce 105 con un altro nome. 🧪 Banco `test/il-salvataggio-che-non-sale.test.mjs`, **15 verdi**, e **tutte e quattro le cure viste rosse con un sabotaggio**. 🩹 Due prove testuali erano nate rosse perché cercavano nel sorgente **coi commenti dentro**, e i commenti della cura nominano proprio ciò da cui il codice era stato spostato ⇒ *un banco che legge il sorgente deve leggere il CODICE.* ✅⭐⭐ **Prova su TEST senza NESSUNO STUB**: l'utenza della console remota è `readonly`, quindi la spinta **fallisce per davvero**, rifiutata da `pmoRequireStaffPermission` — la catena esatta che il 29/08 ha perso i due salvataggi. Tracce **0 → 1 → dopo il fallimento 1** (il punto che conta: prima qui non restava niente) → l'avviso dice 1 → tolta, **0** → e con zero tracce l'avviso **tace**. ⭐ **E la seconda metà è arrivata dal suo gesto la sera stessa**: livello 4→5 sul gestionale di TEST, e il bot di prova interrogato prima (*«Avanzato»*) e dopo (*«Agonista»*) ⇒ il fallimento tiene il segno **e** il successo lo toglie. ⏱️ Dei 32 secondi fra il salvataggio e la frase al socio, la scrittura ne ha presi **0,6** (`21:01:17,511` → `21:01:18,095`): fra gestionale e bot non c'è nessun sync e nessun cron. 🚨 **Un disegno sbagliato della prova l'avrebbe fatta riuscire senza mostrare niente**: il bot non dice il numero, dice la **parola** della tabella ufficiale ⇒ 4→4,5 avrebbe dato *«Avanzato»* prima e dopo. Il cambio è stato scelto **perché scavalca una fascia**. 📌 *Una prova su un valore tradotto va disegnata sulla traduzione, non sul valore.* ✅ **Promossa a PROD (v6.257) per RIGHE** (regola 3), conflitto solo su `APP_VERSION`, zero codice gated `PMO_IS_TEST_ENV`, e **verificata sull'app viva** e non solo deployata. 🔎 **60ª sessione: le due piste sulle 67 spinte a vuoto sono cadute tutt'e due misurando** — la whitelist non può spiegarle (dei sette tipi mancanti l'app ne scrive **uno**, e solo dal percorso omaggi, misurato zero volte in tre mesi) e nessuna strada nota sa costruire un record senza chiave. ⇒ Al loro posto una **diagnostica sul registro** (migrazione `20260829223000`, ai due database): quando e **solo quando** `v_count = 0`, l'audit annota `ricevuti`, `senza_tipo`, `senza_chiave` e `tipi` ⇒ la prossima spinta a vuoto **dice da sé** quale regola di scarto è scattata. Provata **eseguendo** i tre scarti dentro la RPC vera su TEST, con 3 guardie nuove viste rosse su tre sabotaggi. 📌 *Un registro che annota il RISULTATO e non l'OGGETTO non può chiudere una diagnosi.* ✅⭐⭐ **CHIUSA il 30/08 sera, e il caso è arrivato da sé come la scheda prometteva.** 📏 Su PROD, dal deploy della v6.257: **12 spinte, 0 a vuoto**, e **UN** salvataggio vero di scheda socio — la riga `d7c6d389…`, la stessa della prova della voce 105, spinta due volte di fila (audit `13:49:34` e `13:50:03`, **`count: 1` tutt'e due**) e atterrata nel cloud **1,7 secondi** dopo il gesto. ⇒ Un gesto vero della segreteria, sull'app vera di PROD, con la cura in servizio, è passato **e ha scritto**. 🗣️ **E l'ultima metà l'ha guardata LUI**, perché dal cloud non si vede: la traccia vive nel `localStorage` di *quel* browser e la console remota parte sempre pulita ⇒ gli è stata chiesta l'unica cosa che chiudeva la voce, e la risposta è **«Nessun avviso giallo»**. ⭐ *La cura non è stata vista funzionare tacendo: è stata vista lasciare passare una scrittura vera e non lasciare nessun segno — che è la sola forma in cui un silenzio vale una prova.* ⛔ **I RESIDUI, dichiarati e NON curati**: ① **non si saprà perché le sue due spinte del 29/08 non siano partite** — non hanno lasciato nemmeno la riga di audit; la cura non lo spiega all'indietro, fa in modo che la prossima volta lo si sappia; ② **i due livelli di quella sera sono persi**: su PROD il socio è a **4** con `lastLevelUpdateAt` fermo al **2 maggio** — se il livello giusto è un altro, va rimesso a mano; ③ 🚨 **il «0 su 12» NON assolve le 67 spinte a vuoto**: col ritmo di prima (una su sei), dodici di fila senza zeri capitano per caso circa **una volta su nove** (`(5/6)¹² ≈ 0,11`) ⇒ campione corto, non assoluzione — e la **diagnostica del registro non ha ancora avuto una spinta a vuoto da raccontare**, quindi è in servizio ma non l'ha ancora vista nessuno parlare. 📌 *Chiudere una voce non è dichiarare risolto tutto ciò che la circonda: è dichiarare fatto ciò che la voce chiedeva, e scritto il resto.* |
| **97** | ✅ *(30/08 sera, 63ª sessione — **due repo, un ordine obbligato, e la prova fisica su tutt'e due gli ambienti vivi**)* 🧩 **97. Il test una domanda alla volta, e poi DENTRO Telegram.** I primi due passi erano in servizio dal 25/08 (motore su PROD alle 23:43, bot alle 23:45, in quest'ordine perché il motore da solo è inerte). Le due cure nate dalla sua prova del 27/08 — il bottone «🔄 Sì, lo rifaccio» e la frase scaduta «ti resta una prova» — sono state **viste sul suo telefono il 30/08**, insieme al difetto peggiore della scheda curato: alla conferma il bot dice *«È già il livello che hai in scheda: resta tutto com'è»* e **così è** (`member_decision` `mi_fermo` alle 16:18:47, `applied_level` null, livello **4** invariato) — il *«Te lo registro sulla scheda a breve»* detto a Laura non esce più. 🚨⭐⭐ **E IL TERZO PASSO NON ERA «spegnere una pagina»**, ed è la cosa che questa scheda insegna: era un lavoro su **due repo**, con un ordine che non si poteva invertire. 📏 La pagina era **morta da sola** — `scheda-pubblica` **17** schede, ultima il **23/06**, contro **38** da `bot-a-passi` dal 26/08 ⇒ **68 giorni**; e i 133 gettoni `status: sent` non erano link ricevuti da nessuno (**132 senza indirizzo email**, **zero aperti**), come il committente diceva a memoria e il dato ha confermato una volta letto bene. 🚨 **Ma il bot scriveva ancora quell'indirizzo** in un ripiego vivo (`frasePerIlTest`, ramo `if (dove)`): chiudere prima avrebbe consegnato a un socio **un link a una porta chiusa**, e non l'avrebbe detto nessun banco — l'avrebbe detto lui. ⇒ **① il bot** (assistente-padel-agent#111, deploy #126, 17:01: la terza strada dice «apri «📊 Test Livello di Gioco»» invece del link; 1652 prove verdi, due sabotaggi rossi), **② poi la pagina** (PROD **6.259**, TEST 6.263). ✋ **PROVA FISICA SU TUTT'E DUE GLI AMBIENTI VIVI**, con la console remota e non sul sorgente: aperta con un gettone, titolo «Test Livello di Gioco», il testo della porta con l'istruzione, e **`moduloPresente: false`** — il modulo non è nascosto, **non esiste più nel DOM**. 🔒 **E una guardia che mancava**: chiudendo la porta il banco è rimasto **verde**, cioè quel ramo non lo sorvegliava nessuno. `test/la-porta-del-quiz-e-chiusa.test.mjs`, 3 casi dichiarati testuali, due sabotaggi visti rossi — e il primo di quei due era **debole** (la carta nomina la porta due volte), quindi la prova è stata stretta a cercare **l'istruzione** e non la parola. 📌 *Una sonda che cerca una parola trova la parola.* ⛔ **Residui dichiarati, due**: il modulo resta in pagina **irraggiungibile e marcato tale** (la cancellazione è un lavoro a parte — mescolarla a un cambio di comportamento renderebbe illeggibile quale delle due ha rotto qualcosa); e la frase nuova del bot nella strada «gettone senza tastiera» **non l'ha ancora vista nessuno su un telefono**, perché quell'angolo non si provoca a comando. 🔄 **E la prova di parità con `passi.js` NON è stata tolta**, contro quanto la scheda prevedeva: il motivo per cui vale sopravvive alla chiusura — nel gestionale l'anteprima resta, e adesso si chiama per quello che è, *«le domande che il bot chiede»*. |
| **110** | ✅ *(30/08 pomeriggio, 63ª sessione — **le due righe aperte cadute nello stesso pomeriggio: la rilettura è SUA, la prova è sul SUO telefono**, e a residuo dichiarato)* 🧪 **110. Il test di autovalutazione ritarato in quattro punti** — la banca dei trabocchetto bilanciata (chi negava sempre passava nel **76-96%** dei casi contro il 50% di chi tira a caso), i pesi da 0,40/0,25/0,35 a **0,20/0,25/0,55** col freno basso tolto, le quattro scale tecniche sullo stesso metro, e la frequenza che smette di essere un dato raccolto e buttato. ⏳ **Restava aperta per DUE cose, e sono cadute a un'ora di distanza.** ① **LE DOMANDE.** Il controllo sul regolamento (30/08 sera) ne aveva chiuse 21 e **corrette tre** — la peggiore **P-T15**, che dava per buono il cambio di mano durante il punto contro l'obbligo del **cordino**, contraddicendo **A-T15 della stessa banca**: chi sapeva la regola sbagliava *proprio perché la sapeva*. Restavano **6** che il regolamento non poteva decidere (P-T12 + le 5 di terminologia). 🗣️ **Le ha rilette lui**: *«sono tutte giuste ma la P-T12 me la devi specificare meglio perché così non si capisce qual è la risposta giusta»*. 📏 **Il difetto isolato, ed è la lezione**: dei tre distrattori **due dicevano «solo» e il quarto no** — «La parte piatta e il manico» si leggeva come **un'altra risposta vera**. ⇒ *La giusta non era ambigua per il testo suo: a non dichiararsi concorrente era il concorrente.* 🔒 Curata **senza toccare la risposta giusta** (*«a me piace come risposta»*) e senza cambiare il verso `afferma` — a Principiante i «nega» sono a 9/16 e uno in più sfonderebbe la guardia del 60%. Banco 9/9, 32 caratteri su 36. ✅ **In servizio su tutt'e due**, verificato sulla **sorgente servita** e non sul log: TEST edge **v28** (14:28:24Z), PROD edge **v22** (14:30:44Z). ② **LA PROVA SUL TELEFONO.** Test vero consegnato alle **16:03:58**: dichiarato 4,5, tecnica 4,75, `raw_score` **4,638**, calcolato **4,5 · Avanzato**. ⭐ Il conto **rifatto a mano** dalla formula in servizio — 0,20×4,5 + 0,25×4,5 + 0,55×4,75 = **4,6375** — coincide alla terza cifra ⇒ i pesi nuovi non sono *deployati*, sono **stati usati**. ⭐⭐ **E il controllo che rende onesto il verde**: la scheda del **29/08 della stessa persona** porta `raw_score` **5,106**, che è il conto coi pesi **vecchi**. Due righe della stessa mano a un giorno di distanza, due formule diverse. ⚠️⚠️ **IL RESIDUO, dichiarato e non nascosto in fondo — sono DUE e nessuno dei due è piccolo:** · **il metro nuovo non ha dimostrato di DISCRIMINARE**. Coi pesi vecchi sarebbe uscito **4,5 lo stesso** (4,5875): il committente ha risposto **coerente**, ed è precisamente il caso su cui la misura prevedeva che il ribilanciamento *non* mordesse. Serve una scheda **incoerente** vera, e non si può fabbricare; · **la bandiera della frequenza non si è mai accesa** — né sulle 44 schede storiche né qui (risposta «Più di 10»). Il campo però è arrivato **compilato**, mentre il 29/08 era vuoto ⇒ *smettere di buttarlo* si vede nel dato, *accendersi* no. 📌 E si chiude lo stesso, perché il residuo non è una prova mancata: è **il caso che non si è presentato**, ed è la stessa forma con cui sono chiuse la 90 e la 102. |
| **105** | ✅ *(30/08 pomeriggio, 63ª sessione — **provata da LUI sul gestionale di PROD, dentro la finestra esatta**)* 🚨 **105. Una modifica dalla segreteria poteva SDOPPIARE un socio: il gestionale CALCOLAVA la chiave di scrittura invece di usare quella della riga viva.** 📏 Nata da un guasto **visto succedere** — Maurizio Aprea sdoppiato il 28/08 alle 22:17, con una riga archiviata dal 19 luglio **resuscitata** (`deleted` da `true` a `false`): una scrittura non deve poter inventare un'identità, e men che meno riportarne in vita una che qualcuno aveva archiviato. ⚖️ **Due false partenze, ed erano la stessa**: la prima cura era **inerte** (metteva `cloudLocalKey` sui soci scaricati, e quel valore al socio che poi viene scritto non arrivava mai) e la sua prova era **verde per la ragione sbagliata** — girava sul **produttore**, in un browser che parte pulito, cioè esattamente il caso in cui il difetto non esiste. Ricurata mettendo la chiave nell'idratazione, **fuori** dal confronto sulla freschezza: *una chiave non è un dato che compete sulla freschezza, è l'indirizzo della riga*. 📏 Promossa a PROD e **rimisurata là** con la stessa sonda a mezz'ora di distanza: 6.254 → **0 corretti su 24**, 6.255 → **24 su 24**, e il 25° esposto (una riga `phone:` a 12 cifre contro un telefono di 10) coperto come previsto. ⏳ **Restava non provato il giro intero dall'app** — la segreteria che salva e la riga che atterra — e la scheda lo diceva invece di darlo per fatto. ✋ **Ed è arrivato il 30/08**: aperta la scheda di `Utente Test`, **uno dei 24 esposti**, e salvato **due volte di fila** (livello 3 → 3,5 → 3), che è la forma identica al guasto del 29/08. ⇒ La riga è rimasta **una**, sotto `local_key = d7c6d389-f896-…` cioè la **riga viva** e non `phone:393482356899`; doppioni **0** e soci vivi **2817**, identici al «prima» misurato dieci minuti prima del gesto. ⭐ *Non «non è successo niente di male»: è passata di lì e non ha sbagliato* — la forma della voce 77. |
| **106** | 🙅 **«Non ci sono riuscito» detto su un esito che il gestionale NON sapeva — i quattro gesti senza «non lo so»** — 📏 **visto succedere il 29/08 alle 15:28:58**, e non cercato: il committente chiede al bot di togliere **due** giocatori in un gesto solo, ne esce `✅ Ho tolto Lidia Comes` e `⚠️ Fabiola Limuti: non ci sono riuscito.` 🔎 **Nel registro**: `[togli] Fabiola Limuti: rifiutato (scrittura_rifiutata)` — cioè il gestionale ha tradotto un **timeout del worker** (`Worker error 500 (nessun retry)`, `locator.click: Timeout 8000ms`) in **«non è passata»**, che è un'affermazione sul passato che da lì non si può fare: un timeout non dice se la scrittura è arrivata. ⚖️ **NON è una regressione, ed è il pezzo che rende questa voce una voce e non un guasto**: il limite è **già dichiarato nel codice** dal 19/08, in `supabase/functions/consumer-booking-write/esito-scrittura.ts` — *«Oggi la chiama solo il ramo `create`. Gli altri quattro (`leave`, `remove`, `add`, `cancel`) continuano a dire “rifiutata” anche quando l'esito è ignoto»*. Il motivo scritto lì è misurato e regge: **il bot non ha nessuna frase «non lo so» per quei quattro gesti** (`testoRifiuto` conosce `esito_ignoto` solo sulla prenotazione), quindi mandargli `esito_ignoto` oggi gli farebbe dire una frase da prenotazione su un'uscita, o cadere nel generico. ⇒ Oggi quel residuo si è **visto succedere per la prima volta**, e su `togli`. 🍀 **Perché stavolta non ha fatto danno, e perché non è una consolazione**: ① l'asimmetria già dichiarata — *prenotare due volte occupa un campo, disdire due volte no*; ② il click non era davvero arrivato (`subtree intercepts pointer events` a **ogni** tentativo), quindi il rifiuto era vero. 🚨 Ma **era vero per fortuna, non perché il gestionale lo sapesse**: la stessa riga, su una rimozione passata, avrebbe detto «non ci sono riuscito» di una cosa fatta. 🔨 **La strada la dice già il codice, e va rispettata**: *«chi lo farà cominci dalle frasi, non da questa funzione»* ⇒ **prima il bot** (le quattro frasi «non lo so» per togli/aggiungi/esci/annulla), **poi** il gestionale (`esitoIgnotoDaRisposta` chiamata anche dagli altri rami). È lo stesso ordine di messa in servizio del `CLAUDE.md`: al contrario, per la finestra fra i due deploy il bot riceverebbe una parola che non sa tradurre. ✅⭐⭐ **FATTI TUTT'E DUE I PASSI il 29/08 sera, NELL'ORDINE.** ① Il **bot** ha imparato le quattro frasi (PR #110, banco 1652 verdi, 8 prove nuove viste rosse con cinque sabotaggi) ed è stato **messo in servizio sulla VM alle 22:58:50** — `deploy-bot-hetzner` bersaglio `soci`, verificato con `stato-bot`: online, e dichiara ancora `✍️ prenotazioni REALI` su `qqbf…` (il `.env` il deploy non lo tocca). ② **Poi** il gestionale: `esitoIgnotoDaRisposta` la chiamano ora **tutti e cinque** i rami, la parola non è più scritta a mano da nessuna parte, e il registro **distingue** un rifiuto da un ignoto su ogni KO (banco nuovo `test/tutti-e-cinque-chiedono-alla-guardia.test.mjs`, 6 verdi, rosso su cinque sabotaggi). 🩹 **E la riga del modulo che diceva «oggi la chiama solo il ramo `create`» è stata CORRETTA, non affiancata**: era vera, e da stasera non lo è più. ⚙️ **Cosa NON si manda sui quattro, dichiarato**: `scritta_alle` e `slot`. Su `create` servono al bot per **tornare a chiedere** (voce 53); per gli altri quattro quel ciclo non esiste, e le frasi nuove infatti non lo promettono — dicono di guardare `/prenotazioni` fra qualche minuto. Mandarli sarebbe dato che nessuno legge, e peggio: suggerirebbe una capacità che non c'è. 🔎 **E il banco del bot ha trovato un SECONDO difetto che rileggendo non si vedeva**: curate le righe dell'elenco del togli multiplo, l'**intestazione** diceva ancora «Non ho tolto nessuno» sopra una riga che dichiarava di non sapere — una testa che afferma sopra una riga che non sa, e la testa è la prima cosa che si legge. Forma della voce 70 con una differenza: là la coppia mentiva, qui la testa da sola. Curata. 📌 *Curare le righe di un elenco e lasciarne l'intestazione è curare metà di una frase.* 🩹🔓 **QUI C'ERA SCRITTO «RESTA APERTA, e non si provoca — si aspetta, come la 65 e la 83», ed è stato SMENTITO nel giro di un'ora.** La riga si corregge, non si affianca. Era vera nella parte che conta — *non si chiude leggendo il registro: un `(ESITO IGNOTO)` nei log dice che il gestionale l'ha detto, non che il socio l'abbia capito* — e **sbagliata** in una parola sola: «non si provoca». 📌 **Si provocava eccome**, e lo strumento esisteva già da due settimane: `cancello-worker.yml`, scritto il 16/08 per il collaudo della voce 53, che ferma Caddy per N secondi dichiarati e riapre da sé. ⇒ Bastava chiedersi *cosa deve succedere perché il gestionale dica «non lo so»* e leggere la risposta nel codice (una `fetch` che cade a livello di rete) invece di dichiarare un limite. ⚖️ È la **26ª un'altra volta**: *un limite dichiarato che nessuno prova resta vero per sempre perché sembra prudente* — e stavolta l'ho scritto io, in una scheda, sei ore prima di smentirlo. ⚖️ **Perché IN CODA e non in urgenti, dichiarato come vuole la regola**: non scavalca niente — nessun danno oggi (asimmetria ①), il difetto è dichiarato da dieci giorni, e le urgenti aperte aspettano tutte prove fisiche. 📌 *Un limite dichiarato resta un limite anche quando lo si vede succedere: cambia che adesso ha una data e un caso.* 🧊 **Coperta a metà dalla 83**, che è la stessa forma sul ramo `create`: là il residuo è *«il prossimo `KO HTTP 504` deve uscire come `esito_ignoto`»*, qui è *«gli altri quattro gesti non chiamano affatto la guardia»*. Si leggono insieme ✅⭐⭐ **CHIUSA il 29/08 a tarda sera, A PROVA FISICA — e la prova è stata VISTA ATTRAVERSARE LA FINESTRA ESATTA in cui prima sbagliava.** Fatti i due passi nell'ordine che la scheda prescriveva: ① il **bot** impara le quattro frasi «non lo so» (PR #110) e va **in servizio sulla VM alle 22:58:50**; ② **poi** il gestionale (PR #1192): `esitoIgnotoDaRisposta` la chiamano ora **tutti e cinque** i rami. 🧪 **Poi la si è provocata, invece di aspettarla**: cancello del worker chiuso col workflow `cancello-worker` (sonda **HTTP 000** verificata dal workflow stesso, che fallisce se la porta non è davvero chiusa), e il committente ha fatto **lo stesso identico gesto** del difetto — togliere un giocatore dal bot. 📏 **Le due righe del registro, a 24 ore e mezza di distanza, stesso gesto, stessa forma:** `15:28:58 [togli] Fabiola Limuti: rifiutato (scrittura_rifiutata)` → `⚠️ non ci sono riuscito.` **contro** `23:48:58 [togli] Lidia Comes: rifiutato (esito_ignoto)` → `🔧 Non so ancora com'è andata · ⚠️ Lidia Comes: il circolo non mi ha risposto in tempo`. ⇒ *Non «non è successo niente di male», ma «è passato di lì e non ha mentito».* ⭐ E si vedono **tutte e due** le cure: la riga E l'**intestazione**, che è il secondo difetto — trovato **dal banco e non rileggendo** — per cui la testa diceva «Non ho tolto nessuno» sopra una riga che dichiarava di non sapere. ✅ **Controprova**: Lidia è rimasta in campo (`-Maurizio Aprea.-Lidia Comes.`), cioè **nessuna scrittura è partita** — che è esattamente ciò che rende il «non lo so» la sola risposta vera. ⛔ **COSA NON È STATO VISTO, e va detto**: le altre **tre** frasi (`esci`, `annulla`, `aggiungi`) non le ha lette nessuno su un telefono — sono coperte dal banco, che è una prova testuale, non un messaggio arrivato a qualcuno. La classe è curata nello stesso punto (la guardia sta in tutti e cinque i rami), ma *un esito visto una volta non è una regola*: se un domani una di quelle tre sbagliasse, questa chiusura non l'ha esclusa. 🩹 **E LA PROVA HA FATTO USCIRE UN RESIDUO, dichiarato e NON curato**: il registro del bot scrive `rifiutato (esito_ignoto)` — cioè chiama **«rifiutato»** proprio ciò che il messaggio al socio (giustamente) non chiama così. È lo stesso difetto della voce, un piano più in basso: il socio legge la verità, chi legge i log no — e fra un mese la diagnosi la fa chi legge i log. Una riga in `bot.ts:2406`. Non toccata stasera perché vorrebbe un altro riavvio del bot dei soci a mezzanotte, e non vale il prezzo. ⚠️ **E il conto della prova, perché non si ripeta a caso**: quattro chiusure del cancello hanno fatto cadere il **sync di PROD** quattro volte (`MATCHPOINT_BROWSER_WORKER_FAILED`), con recuperi da 5-6 minuti l'uno. Il cron non ha mai smesso di girare — il guasto era a valle. 📌 *Il cancello si chiude UNA volta, quando il bersaglio è già verificato nella copia*: due dei quattro giri sono stati sprecati perché il bersaglio non c'era ancora, e uno perché l'**Ospite non è togglibile dal socio** (voce 82) — cosa che si leggeva nel codice e che non ho letto prima di far toccare il telefono a qualcuno. |
| **107** | ✅ *(29/08 pomeriggio, 58ª sessione — **voce SUA, entrata e uscita nello stesso pomeriggio**, e chiusa da lui a menu guardato su tutt'e due i bot)* 🚪 **107. La porta del test si chiama «Test Livello di Gioco».** 🗣️ Sua decisione: *«nel menu del bot al posto de "il mio livello di gioco" devi mettere "Test Livello di Gioco", e vedi di cambiare la frase dove ti sembra corretto»*. ⚖️ **Non è un rinomino, è un cambio di categoria**: il nome vecchio descriveva **il dato** («che livello ho»), quello nuovo descrive **il gesto** («fai il test»). È la stessa scelta del 4/08 su «Le tue partite», dove il nome della porta fu messo sul gesto **frequente** e non sull'oggetto — e qui il gesto frequente è fare o rifare la prova, non leggere un numero che cambia due volte l'anno. ⚙️ **Il nome sta in UN POSTO SOLO** (`scelta-livello.ts`: `EMOJI_LIVELLO`, `TITOLO_LIVELLO`, `ETICHETTA_LIVELLO`, `RIMANDO_LIVELLO`), accanto alle **16 frasi** che lo citano — è la lezione della **voce 87**, pagata: la stessa voce di menu si chiamava in **tre modi** e **due su tre indicavano una porta che non esiste**. *La cura non è correggere la stringa: è togliere le copie.* ⭐ **E cambia anche il VERBO**: dicevano *«chiedimi "il mio livello"»* — giusto finché il nome era una domanda scrivibile; con un titolo si dice **«apri»**, come già fa `ETICHETTA_ELENCO`. Chiedere al bot «Test Livello di Gioco» non è una frase che qualcuno direbbe. 🔒 **I commenti col nome vecchio NON si toccano**, ed è la stessa regola della fotografia della 26ª: raccontano episodi datati (Fabiola il 27/08, Marco il 28/08) in cui la porta si chiamava davvero così. Riscriverli falsificherebbe un fatto. Stessa cosa in `docs/test-livello-regole.md`: la riga **D10**, che descrive la regola **in vigore**, cita il nome nuovo; le **citazioni storiche** tengono il nome di allora, con una nota accanto. 🧪 **I casi, e due sono interessanti più della cura.** ① `comandi.test.ts` difendeva una **sua** regola del 20/08 (*«le voci che nominano roba sua parlano in prima persona»*) e questa decisione la rovescia su una voce: `livello` esce da `DEL_SOCIO` **non perché la regola sia stata allentata**, ma perché quella voce ha cambiato categoria ⇒ le categorie diventano **tre**, e i **titoli** hanno una regola loro (non mescolano le due voci). *Toglierla e basta avrebbe lasciato quella voce senza nessun caso a guardarla, che è come si perde una protezione senza deciderlo.* ② Quattro casi pretendevano `/il mio livello/i` **scritto a mano**: sarebbero diventati loro il posto in cui il nome vecchio sopravviveva — *un caso che pretende un valore non impedisce il drift, lo sposta dentro di sé*. Ora pretendono la **costante**. ③ **Guardia nuova**: nessuna frase visibile al socio può riscrivere il nome a mano, **vista rossa con un sabotaggio** (una frase nuova in `riserva.ts`) e verde una volta tolto. Banco **1641 verdi**, `tsc --noEmit` pulito. 🚀 **In servizio su TUTT'E DUE i bot**, deploy **#122 (soci)** e **#123 (prova)** sullo **stesso sha** `b78954d7` — non due copie che possono divergere. Bot dei soci risalito alle **16:09:06**, `@loziocoach_bot`, `✍️ prenotazioni REALI`, `menu ☰: 7 comandi registrati`. ✅ **LA PROVA FISICA È SUA, ed era l'unica possibile**: il registro conta i comandi ma **non stampa le etichette**, e il token di Telegram dal cloud non si raggiunge ⇒ da qui si poteva sapere che il menu era stato registrato, **non** cosa ci si legge. *«Ti confermo che il menù è stato cambiato sia su soci che su test»* |
| **101** | ✅ *(29/08 pomeriggio, 58ª sessione — **la lista vista popolarsi con un socio vero sull'app viva**, e con 23 righe di controllo accanto)* 🔄 **101. Il riallineo `test-preview` ← `main` della catena `assessment-*`.** Fatto il 27/08 (v6.252): motore a passi, tetto e scala con le tre copie identiche byte per byte, retrocessione tolta, lista del maestro col criterio allargato della voce 100. Restava aperta perché **nessuno l'aveva vista popolarsi con soci veri**. 🚨⭐⭐ **E LA RIGA CHE DICEVA PERCHÉ ERA FALSA, corretta misurando.** Diceva *«l'utenza `readonly` della console non ha `view_members`»*: l'app viva di TEST carica **2815 soci** con quella utenza. Il blocco era **la guardia dell'attrezzo** — `get_assessment_tokens_admin` e `get_self_assessments_by_tokens` sono **letture** che viaggiano in **POST** (tutte le RPC di PostgREST lo fanno) e venivano fermate come scritture. ⚠️ **E il sintomo era muto**: pagina aperta, soci caricati, `assessmentResponses` a **0** ⇒ la lista usciva **vuota senza un errore**. 📌 *Un limite attribuito al bersaglio quando sta nell'attrezzo si autoconferma a ogni prova: la sonda dice «vuoto» e chi legge capisce «non c'è niente».* Curato in `tools/verifica-browser/console.mjs` con le due RPC **nominate** (non allargando la regex a `^get_`, che sarebbe una regola sul nome) e il permesso dato dopo aver letto `prosrc` in `pg_proc` sui **due** progetti. ✅⭐⭐ **LA PROVA FISICA, in due tempi nello stesso pomeriggio.** ① Con l'attrezzo curato, i **quattro cancelli esercitati su 24 soci veri** di PROD (83 schede, tetto 3,5), ognuno scartato per la ragione giusta — comprese **le due regole del 27/08**, che fino a lì erano state provate solo su schede finte: Oriana 5 con 5 e Carmelo 4 con 4 (*non più di quel che ha in scheda*), Maurizio 4,5 con 4 (*stessa parola: Avanzato*). ② Poi **il committente ha rifatto il test dichiarando Agonista**, e la stessa sonda ha risposto **`Maurizio Aprea · dimostrato 5 · in scheda 4 → ENTRA`**: la lista **si popola con un socio vero**, con 23 righe di controllo accanto. ⚖️ *Il verde vale perché il rosso gli sta accanto, riga per riga.* 🔎 **E in mezzo la lista si era anche SVUOTATA per la ragione giusta**, col «prima» e il «dopo» datati: la voce 100 il 28/08 mattina dichiarava *«una riga, quella di Laura»*, e Laura ne è uscita perché ha **due** schede — 27/08 22:14:58 con **4** (contro 3,5 ⇒ entrava) e 28/08 15:55:27 con **3** (⇒ sotto il tetto). Vince l'ultima, come `assessmentUltimaScheda` dichiara. ⇒ **La coda si svuota e si riempie**, viste tutt'e due |
| **78** | ✅ *(29/08 pomeriggio, 58ª sessione — **provata da LUI dentro la finestra**, e il registro del bot l'ha catturata riga per riga)* 🔢 **78. «2 posti liberi» su una partita PIENA — i nomi e il conteggio venivano da DUE LETTURE con due tempi.** 🗣️ Sua segnalazione con la schermata (*«qui mi segnala che mancano due persone, ma invece siamo tutti nella partita»*). 🔎 **La causa**: i **nomi** nascono da `liste` (che include `staff_booking`, scritto subito dal gestionale), il **conteggio** da `playersFromDescrizione`, cioè dalla `descrizione` che scrive **Matchpoint** e arriva col sync ⇒ finché il sync non torna, il numero è calcolato sul roster vecchio. 🔨 **La cura**, in DUE punti perché la stessa partita si mostra in due forme: a letture discordi (`leDueLettureConcordano`) `quantiInCampo` vale `null` e la riga compatta perde il numero; nella scheda non si disegnano i `— posto libero —` né si dice «Siete al completo», e al loro posto va `⏳ Questo elenco sta cambiando proprio adesso` col bottone **🔄 Aggiorna**, che risponde con l'**ora della lettura al secondo** — l'unica cosa che cambia davvero fra due tocchi, e senza la quale Telegram rifiuta la riscrittura e lo schermo sembra morto. ⭐⭐ **LA PROVA FISICA DEL 29/08, sulla partita di martedì 1 settembre · 10:00 · Campo 3**, misurata al millesimo sui due record: **15:19:40** la stessa schermata contava regolarmente (`⭐ Maurizio Aprea · Lidia Comes · — posto libero — · — posto libero —`); **15:21:25.091** la segreteria aggiunge **Fabiola Limuti** (`staff_booking` a tre); **15:21:33 →** i due nomi, **nessun** `— posto libero —`, la riga «sta cambiando» e il bottone; **15:25:04.171** il sync atterra con Fabiola e la riga si raddrizza da sé. ⇒ **Finestra 3′39″**, attraversata. Senza la cura quella schermata avrebbe disegnato **due** posti liberi invece di uno — un posto che non esiste, perché ce l'ha Fabiola, e da lì un socio invita qualcuno che non entra. 🔄 **E il bottone risponde: QUINDICI tocchi** (15:21:33 · :46 · :51 · :57 · 15:22:02 · :06 · :13 · :17 · :19 · :22 · :29 · 15:23:02 · :28 · :31 · :41), quattro dei quali **nello stesso minuto** con secondi diversi — che è esattamente il caso in cui il 23/08 notte lo schermo non si muoveva. Nel registro **zero** righe `↔️ la schermata era già questa: non riscrivo`. ⚖️ **E IL CONTROLLO C'È, senza averlo cercato**: alle **15:22:11**, in mezzo ai tocchi, la partita di lunedì 31 (letture concordi) ha disegnato regolarmente `— posto libero — ×2`. ⇒ La cura non è «sempre muta»: tace dove non sa e conta dove sa. *È il verde reso onesto dal rosso accanto* — la lezione ② del 29/08 mattina, applicata senza doverla costruire. 🩹 **DUE TRAPPOLE PAGATE OGGI, e stanno qui perché costano un giro ciascuna.** ① **La prima partita scelta non aveva il bottone**, e non era un guasto: era **dentro le 48 ore**, quindi il bot le dà `testoSchedaSolaLettura` (voce 62 — *«una voce senza nessun potere aprirebbe una schermata senza bottoni»*) e la schermata di gestione non esiste. ⇒ *Una prova fisica si progetta anche sulle schermate che il bersaglio NON ha.* ② **Solo un'AGGIUNTA apre la finestra**: il passaggio di consegne diceva «un giocatore messo **o tolto**», ed è falso — `compagni` prende il **massimo** fra le liste, quindi una rimozione resta invisibile finché il sync non la porta. Era già scritto nel reperto del 23/08 alle 21:25 e si è dovuto rileggere. 📌 *Un residuo di metodo riscritto in un passaggio di consegne perde le condizioni che lo rendevano vero.* ⏳ **Nessun residuo**: la voce nasceva da un difetto visto, è curata in tutt'e due le forme, il bottone è stato toccato in una finestra vera e il «prima» e il «dopo» stanno nello stesso registro, sulla stessa partita |
| **69** | ✅ *(28/08 pomeriggio, 55ª sessione — **curata la CAUSA**, dopo che l'effetto si era manifestato per la TERZA volta e su un terzo gesto)* 🧬 **69. Una scheda senza telefono genera un socio DOPPIO.** 📏 **L'effetto di oggi**: Laura Aprea tocca il test e legge *«Non riesco ad aprire il test adesso»* (15:24). Prima: *«Non hai prenotazioni»* a Fabiola (23/08) e *«Non sono riuscito a farti entrare»* a Lidia (24/08). **Stessa causa, tre gesti diversi** — e ogni volta il ponte trovava due righe vive con lo stesso `payload.id` e rispondeva `AMBIGUOUS`, cioè si fermava correttamente. 🩹🚨⭐⭐ **LE DUE RIGHE CHE LA SCHEDA PORTAVA ERANO FALSE, ed è la parte che vale**: ① *«l'`anagrafica-mirror` (05:00) scrive `email:`»* — quella funzione **non è deployata su PROD** (non è fra le 39 edge vive) e il suo sorgente sta solo su `test-preview`: è un mirror **PROD → TEST**, su PROD non crea niente; ② *«la cura è far cercare al sync anche per `payload.id`»* — **non avrebbe curato niente**, perché il match c'è già: `collectExistingMemberCandidates` trova benissimo la riga `phone:` cercando per `email:` e per `name:`. 📌 *Una cura si disegna sul difetto raccontato e si convalida sul codice: se il racconto e il codice non combaciano, il difetto è dove sta il codice.* 🔎 **La catena vera, letta nel sorgente in servizio**: `shouldNormalizeMemberLocalKey` è **vera** per ogni riga `source: matchpoint_auto` — quasi tutto il circolo — quindi il ramo che sceglie la chiave usa la **canonica dell'import**, e `memberCloudKey` la calcola col telefono se c'è, **altrimenti con l'email**. ⇒ Un export senza telefono sposta la chiave da `phone:` a `email:`, nessuno cancella la vecchia, e la stessa persona resta viva su **due righe**. Il difetto non è **trovare** la riga: è **riscriverla sotto un'altra chiave**. 🔨 **Cura**: `chiaveDaScrivere` normalizza **verso l'alto o alla pari, mai verso il basso** (rango `phone:` > `email:` > `name:` > legacy). Chiude la porta **alla radice** invece di ripulire dopo; la normalizzazione che funziona resta intera; a parità di rango segue l'import (chi cambia numero cambia chiave). 🔒 **Decide SOTTO CHE chiave si scrive, mai SE si scrive**: non può cancellare nessuno, e il caso peggiore di un suo errore è una chiave meno bella. ✅ **13 casi**, e la **tabella di taratura scritta a tavolino sbagliava in QUATTRO righe su cinque** — seconda volta in questa cartella (la prima è in `chiave-vecchia-guard.test.ts`, 9/08): corretta coi numeri **misurati** sabotando. ⭐ Più la **guardia sul CABLAGGIO**, che è la metà che i 13 casi non provano — lezione della voce 103 di stamattina: una regola giusta a cui nessuno passa il dato lascia il banco tutto verde. Sabotata staccando la chiamata e togliendo l'import: **rossa tutt'e due le volte**. 🩹 E la sua prima stesura agganciava il `localKey` **sbagliato** (in `index.ts` ce ne sono due) fallendo su codice giusto ⇒ ora si ancora a `shouldNormalizeMemberLocalKey`, che identifica il punto. 📌 *Una guardia che cerca un testo deve cercare quello che identifica il punto, non quello che lo descrive.* Banco del repo **62 file, zero rossi**. ⭐ In servizio su PROD dalle **15:46** (`matchpoint-clients-sync` **v67**, letto nel **sorgente servito** e non dedotto dal deploy verde). 🩹 **Tampone applicato prima della cura** (col suo ok, mentre glielo dicevo): marcate `deleted` le righe `email:` di Laura e Marco, tenendo le `phone:` col livello che aveva messo lui ⇒ **zero persone con due righe vive** su tutto il circolo, misurato dopo. 📏 **E la prova che la cura serviva davvero**: Laura, sbloccata, ha fatto il test intero e toccato il gradino — è la voce 69 vista non succedere sul gesto che l'aveva scoperta. ⏳ **RESIDUO DICHIARATO, e non è di questa cura**: **perché il 9 agosto la rete di pulizia** (`eChiaveVecchiaDellaStessaScheda`) **non ha archiviato la riga vecchia** resta non misurato. Pretende lo stesso telefono su candidato e sopravvissuto, e oggi il telefono c'è su tutt'e due le righe — quindi *avrebbe dovuto* scattare. La cura non dipende da quella risposta (chiude la porta prima), ma il buco nella rete resta, e sta scritto invece che dato per curato. |
| **104** | ✅ *(28/08 pomeriggio, 55ª sessione — **voce SUA, aperta a mezzogiorno e chiusa nel pomeriggio**, curata e vista dal vivo sul suo telefono in due metà)* 🎲 **104. Le opzioni escono sempre in ordine crescente, e quell'ordine È la scala.** 🗣️ *«Diverse domande sono in ordine crescente di livello… Dovrebbe essere un ordine random, se no dopo un po' la gente capisce questo sistema.»* ⇒ Difetto del **cancello**, non di stile: chi rifà il test impara che *l'ultima opzione è la più alta* e da lì pilota il livello senza saper giocare. 🗣️⭐ **QUALI, deciso da lui**: *«mescola solo le 4 tecniche»* — scambio, vetro, rete, colpi alti. Le due scale numeriche e le due sui livelli **restano ferme**, perché lì il nome della fascia è scritto sul bottone e la posizione non aggiunge niente. 🔨 **Cura**: `conOpzioniMescolate` mescola **al momento di presentarle**, dentro `domandeDelGiro`; `SCHEDA_DOMANDE` resta la sorgente canonica ordinata — è ciò che tiene verde la parità con i `<select>` di `index.html`. 🔒 Seme `seme(gettone, 'ordine-delle-opzioni', chiave)`: **solo gettone e chiave**, e non è comodità — il bot risponde con la **posizione** del bottone, quindi un ordine che si spostasse fra la tastiera e il tocco registrerebbe **una risposta mai data**, in silenzio. 🩹🚨⭐⭐ **DUE SABOTAGGI SOPRAVVISSUTI ALLA PRIMA STESURA, trovati sabotando e non rileggendo**: ① la prova del punteggio era **tautologica** (confrontava il livello con sé stesso) ⇒ staccando `valore` da `testo` il banco restava tutto verde, mentre il socio leggeva un'etichetta e ne faceva registrare un'altra — rifatta sulla **coppia**; ② il **sale unico** dimezzava la cura: le quattro uscivano con la **stessa** permutazione, e da 120 ordini da capire si tornava a **uno**. ✅ **Otto sabotaggi visti rossi**, 61 file di prove Node verdi. 🗣️⭐⭐ **E UNA DECISIONE SUA NEL MEZZO, presa su una misura**: guardando il vetro sullo schermo ha visto la più alta rimasta ultima e ha chiesto conto. 📏 Misurato su **20.000 gettoni** invece di rispondere a impressione — la più alta finisce in ognuna delle cinque posizioni al **~20%**, tutte e **120** le permutazioni, ordine di partenza allo **0,88%** contro lo 0,83% atteso ⇒ non un pezzo che non parte: **una volta su cinque**. ⛔ **Scartata** la strada che verrebbe in mente per prima — vietare che la più alta sia ultima: sembra più mescolato ed è **più debole**, perché insegna *«l'ultima NON è mai la più alta»*, un candidato eliminato a **ogni** domanda invece che mai (*«teniamo la a»*). 🔒 La decisione è **protetta da una prova** che diventa rossa se qualcuno aggiunge quel vincolo, verificata implementandolo: *non protegge un calcolo, protegge una decisione — che è ciò che il codice dimentica per primo*. ⭐ In servizio su PROD dalle **10:06** (`assessment-quiz` **v19**, letto nel **sorgente servito** e non dedotto dal deploy verde). 📏⭐ **LE DUE METÀ CHE LA CHIUDONO, sul suo telefono**: alle **12:10** la domanda sul vetro con le opzioni **mescolate** (`Evito il vetro` da 1ª a 4ª); alle **14:02** *«Che livello pensi di avere?»* coi sette livelli **in ordine** — Principiante, Base, Intermedio, Avanzato, Agonista, Semi-Pro, Professionista. ⚖️ **La seconda metà è quella che una prova distratta avrebbe saltato**, ed è metà della decisione: una cura che mescola tutto sarebbe passata per «funziona» guardando solo il primo screenshot. 📌 *Quando una decisione dice «questo sì e quello no», provare solo il «sì» prova metà cura e nessuna decisione.* |
| **98** | ✅ *(28/08 mattina, 54ª sessione — **guardata da LUI sul gestionale vero**, ed è precisamente il gesto che la voce aspettava)* 🎓 **98. La lista per il maestro, nel gestionale.** ⏳ Restava aperta per **due** cose, e lo screenshot le chiude tutt'e due: ① *«una persona in lista, vista con gli occhi»* — ce ne sono **due**, Laura e Marco, con la spiegazione accanto (*«Da certificare — il test dice Avanzato (4), in scheda Intermedio (3.5) · nessuna partita nei prossimi 30 giorni»*); ② il **cablaggio dal vivo**, che era dichiarato non provato perché l'utenza `readonly` della console non ha `view_members` e da lì Anagrafica soci non si apre ⇒ *«il gesto vero aspetta un giro dalle sue mani»*. Lo ha fatto: sezione aperta, filtro scelto, lista popolata. 📏 **E che il rinfresco sia partito davvero lo prova il contenuto, non il gesto**: dentro c'è la scheda di Marco delle **10:58 di oggi**, quindi la sincronizzazione è avvenuta dopo quell'ora. ⭐⭐ **E i due casi sono STRUTTURALMENTE DIVERSI, che è più di quanto la voce chiedesse**: Laura ci è arrivata da una scheda vecchia, **Marco dal tetto scritto stamattina** (3 → 3,5, voce 103). Il criterio «dimostrato > in scheda» regge su **due strade**, non su una ripetuta — e una regola vista funzionare due volte per la stessa via è ancora un caso solo. ⚖️ **Cosa lo screenshot NON dice, dichiarato**: quante righe ci siano **in tutto** nel filtro. La ricerca era ristretta a «aprea», quindi il 2 è il conto dei soci con quel cognome, non della lista intera. ⏳ **Residuo dichiarato, e NON è di questa voce**: **Santiago Carabajal** (dimostrato 5, in scheda 0,5) continua a non comparire, perché la sua scheda è agganciata a un `member_local_id` che nell'anagrafica non esiste più. È la famiglia nota delle **schede non collegate**, che ha il suo bottone e il suo banco: si ricollega di là, e allargare questa voce per tenerla dentro sarebbe stato il modo di non chiuderla mai. |
| **103** | ✅ *(28/08 mattina, 54ª sessione — **difetto visto da LUI sullo schermo, cura vista dal vivo 14 minuti dopo**)* 🩹 **103. L'esito nominava la parola DICHIARATA, e il messaggio si contraddiceva.** 🗣️ *«non coincide con le nostre regole la risposta»*, detto guardando il telefono di Marco durante un tentativo di provare la D2. 📏 **Il difetto, alle 10:58**: dichiarato **Intermedio** (3,5), dimostrato **Avanzato** (4), e il bot ha scritto *«Il test da solo arriva fino a **Intermedio**, e te lo sto scrivendo adesso»* seguito da *«Le tue risposte sono da **Intermedio**, ma un livello così alto non lo decide il test»* ⇒ **due affermazioni opposte sulla stessa parola**, e quella sbagliata falsa due volte: le sue risposte non erano da Intermedio, ed è proprio Intermedio ciò che il test **decide**. ⚖️ **La LOGICA era giusta e va detto**: 4 sta sopra il tetto 3,5 ⇒ il maestro ci va davvero e il tetto è stato scritto (Marco da 3 a 3,5). Sbagliata era **solo la parola**. 🔎 **La causa: la E4 del 27/08 sopravvissuta in un altro ramo** — `promemoria.ts` passava `parolaDelTest` alla **domanda** (riga 356, curata il 27/08) e `fascia` all'**esito** (riga 365). La parola giusta il bot ce l'aveva in mano: a quella funzione non gliela dava nessuno, e il commento in `avvisi-testi.ts` lo dichiarava pure — *«la parola resta quella DICHIARATA»*. 📌 *Curare l'istanza invece della classe non è una cura*: allora l'istanza era una `select`, stavolta un **ramo**. 🔨 **Cura**: l'esito riceve `livelloDimostrato`, ed è **la stessa parola che riceve la domanda** — due sorgenti sarebbero il modo in cui le due frasi tornano a divergere. ⛔ **Lo `skip` NON si tocca**, ed è il rovescio della cura: lì la frase dice *«per il livello che hai DICHIARATO»* e la dichiarata è giusta — senza quel limite la correzione avrebbe **rotto una frase sana** (è uno dei sabotaggi). 🩹🚨⭐⭐ **E UN BUCO TROVATO SABOTANDO, NON RILEGGENDO, che vale più della cura**: staccando il **collegamento** in `promemoria.ts` il banco restava **verde** mentre il socio tornava a leggere la parola sbagliata — le prove chiamavano la funzione in diretta. ⚖️ È la **stessa forma** del difetto riparato (*la regola giusta con in pasto una riga monca*), e sarebbe stato beffardo lasciarla scoperta proprio lì. Aggiunta una guardia sul **cablaggio**, tollerante alla forma, verificata risabotando. ✅ Banco **1640/1640**, `tsc` pulito, **quattro sabotaggi visti rossi**, e fra le prove una che **non nomina Marco e coglie la classe**: *la parola che il test scrive e quella che il test non può decidere devono essere diverse, o il messaggio si contraddice*. ⭐ In servizio sui soci dalle **11:08:04** (PR #106, deploy #119, `fb2cfec`, verificato sul bersaglio). 📏⭐ **LA PROVA CHE LA CHIUDE, alle 11:12 sul telefono di Marco**: stesso giro, e il messaggio dice ora *«Le tue risposte sono da **Avanzato**»*. 🎁 **E un secondo fatto, non cercato**: la testa è passata da *«te lo sto scrivendo adesso»* a *«In scheda ti resta Intermedio»*, perché stavolta non c'era niente da scrivere — è la cura **E11** vista funzionare sull'altro suo ramo, in regalo. 📏 Il database concorda: `applied_level` vuoto, livello di Marco fermo a 3,5 dalle 10:58:59. |
| **102** | ✅ *(28/08 mattina, 54ª sessione — **cura vista dal vivo sul suo telefono**, e **A RESIDUO DICHIARATO**: la forma già usata per la 85, la 82 e la 90)* 🩹 **102. L'eco diceva una parola che il bottone non aveva.** 📏 **Il difetto, trovato guardando lo screenshot di una prova fisica e non cercandolo**: alle 10:11 il bottone diceva **«👍 Mi tengo il mio livello»** e l'eco sopra rispondeva **«✅ Hai risposto: Tengo questo livello»**. «**questo** livello» indica il livello che il test ha prodotto, e su una prova che dice **meno** quel livello **non esiste** — è esattamente la cosa che l'etichetta del bottone è scritta per non dire. 🔎 **La causa è strutturale**: allo stesso tocco `sl|mi_fermo` corrispondono **TRE bottoni** («Tengo Avanzato», «Tengo questo livello», «Mi tengo il mio livello») e la tabella dell'eco traduce la **chiave**, che è una sola ⇒ da lì la differenza **non si può vedere**, e l'eco era stata scritta ricalcando il *ripiego* del caso superato. ⛔ **Non curata rifacendo la regola dentro l'eco**: sarebbe stata la **terza copia** di una condizione che vive già altrove — *due regole che rispondono alla stessa domanda o sono una sola, o divergono*. ⭐ Quale bottone fosse in campo lo sa **Telegram**, che rimanda la tastiera del messaggio toccato insieme al tocco — **la stessa memoria che le spunte dell'invito usano da giorni** ⇒ l'eco smette di dedurre e **legge il fatto**. 🔒 **La tabella resta**, e resta la cosa che conta di più: se bastasse l'etichetta, la **navigazione** si prenderebbe un'eco anche lei e la cura si svuoterebbe da sola ⇒ *la tabella fa il cancello, l'etichetta fa la parola*; senza etichetta si torna alla parola di prima. 🩹 **E una GUARDIA RISCRITTA, dichiarata perché toccare un banco per farlo tornare verde è la cosa che qui non si fa**: quella sulla riga della riscrittura congelava la **forma della chiamata** e non la regola — terza volta che andava ritoccata senza che cambiasse niente di ciò che difende. È la trappola ② del 27/08 (*una guardia sull'istanza non protegge la classe*) dove l'istanza è la **formattazione**; riscritta per pretendere ciò che conta, **verificata con tre sabotaggi**. ✅ Banco **1634/1634**, `tsc` pulito, **sei sabotaggi visti rossi**. ⭐ In servizio sul bot dei **soci** dalle **10:29:51** (PR #105, deploy #118, `3bc8a9a`, verificato sul bersaglio: «✍️ prenotazioni REALI»). 📏⭐ **LA PROVA CHE LA CHIUDE, alle 10:36 sul suo telefono**: toccando «✅ Tengo Avanzato» l'eco ha scritto **«Hai risposto: Tengo Avanzato»** — la parola del **bottone**. Prima della cura quella riga avrebbe detto «Tengo questo livello». ⇒ Il meccanismo è **visto**, non dedotto. ⏳🚨 **IL RESIDUO, ed è preciso: la parola «Mi tengo il mio livello» — cioè l'ISTANZA da cui la voce è nata — non l'ha vista nessuno.** La prova è passata dal ramo della prova *superata*, non da quello che dice *meno*. ⚖️ Il codice non biforca sui tre bottoni (una riga sola, `senzaIlSegno(etichetta) || parola`) e il banco copre la tastiera a tre righe, quindi la conseguenza è **quasi certa** — ma resta una **deduzione**, ed è scritta qui come tale invece che spacciata per una cosa vista. 📌 *Provare la classe non è provare l'istanza, esattamente come provare l'istanza non prova la classe: sono due mancanze diverse, e nessuna delle due si copre chiamandola l'altra.* |
| **100** | ✅ *(28/08 mattina, 54ª sessione — **prova fisica misurata sulla PROD viva** con la console remota e l'utenza di sola lettura, non un banco)* 🎓 **100. Chi è sopra il tetto NON entrava nella lista del maestro — e la promessa gli arrivava lo stesso.** 🗣️ Nata il 27/08 da una sua domanda (*«chi è come livello avanzato e facendo il test risulta agonista, come risponde il bot?»*): il socio riceveva *«te lo certifica il maestro»* e poi **non compariva in nessuna lista**, perché `assessmentAspettaIlMaestro` escludeva chi ha **già** in scheda un livello sopra il tetto. ⇒ Una promessa che non arrivava a nessuno. 🔨 **Curata la sera del 27/08 su sua decisione — «si allarga la lista»**: il criterio non è più **dove sta** il socio (`in scheda ≤ tetto`) ma **quanto ha dimostrato in più** (`dimostrato > in scheda`), e il 27/08 mattina si è stretto ancora su sua parola — il «di più» si misura **in PAROLE**, non nei numeri, così Maurizio (4 → 4,5, tutti e due «Avanzato») non va a farsi certificare il livello che ha già. ⭐ E la stessa regola è stata portata **dai due lati**: il ponte mandava dal maestro guardando **solo il tetto** mentre la lista usava il confronto con la scheda ⇒ un socio si sarebbe presentato in segreteria per una cosa che il circolo non gli aveva chiesto. 📌 *Due regole che rispondono alla stessa domanda o sono una sola, o divergono — e chi paga la divergenza è chi ci cammina.* 🧪 **Il banco era verde prima e dopo il cambio di criterio**, il che vuol dire che i suoi 14 casi non lo coprivano: aggiunti quattro casi e un **sabotaggio** che rifà la regola vecchia, verificati rossi rigirandoli col codice di ieri. 📏⭐ **LA PROVA CHE LA CHIUDE, del 28/08**: aperto il gestionale di PROD vivo (v6.253) e letto il filtro **«Da certificare dal maestro»** — dentro c'è **esattamente una riga**, quella di **Laura**, con la spiegazione accanto: *«il test dice Avanzato (4), in scheda Intermedio (3.5) · nessuna partita nei prossimi 30 giorni»*. Non una previsione e non un conteggio in database: **la lista che la segreteria guarda, letta dov'è servita**. ⚖️ **Cosa questa prova NON dice**, dichiarato: è stata fatta **leggendo**, non da un suo gesto sul telefono, e prova la metà del **maestro** — la metà del **socio** (il messaggio che lo manda in segreteria) era già stata provata il 27/08 alle 22:15, sempre su Laura. ⏳ Il candidato **Santiago Carabajal** resta fuori dalla lista e va bene così: ci sarebbe finito solo passando dal bottone «Ricollega le schede», che è una scrittura sul gestionale e si dice prima. |
