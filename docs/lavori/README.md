...
| 📋 **In coda** | **9** — la **68**, la **70**, la **71**, la **72**, la **79** e la **80**, più le 🆕 **81** e **82** della notte del 23/08 e la **60** in sezione D (in attesa che parli con Wansport). 🆕 **Le due nuove non sono idee: sono due misure fatte mentre si provava altro** — la **81** perché una socia vera si è sentita dire che non aveva prenotazioni mentre ne aveva una (il difetto sopravvive alla cura della 69, e vale per qualunque futuro mancato riconoscimento); la **82** perché «Togli un giocatore» **non funziona** su una partita con due ospiti e, quel che è peggio, **non lo dice** — cinque tocchi del committente finiti in `tocca: ignoto` e in silenzio. 🔼 **La 69 è uscita di qui** la notte stessa in cui il suo effetto è stato visto |
