...
| **2️⃣** | ⏱️ **la STRADA VELOCE provata**: un altro cambio di giocatori dal gestionale su una partita vera, e si guarda **due** cose — che il fatto nasca con `origine: 'conferma'` e che il messaggio arrivi in **~40 s** invece di ~180. ⭐ È anche l'unica prova che copre la **giuntura**, che il banco non vede | un gesto suo | il residuo della **79** |

🩹 **La 1️⃣ del 30/08 — «la sonda della 109 dal 31/08» — è stata ESAUDITA e TOLTA**: la voce è chiusa, e per una
