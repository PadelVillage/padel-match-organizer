...
Vuole un giro solo, con le schermate guardate dopo. ⏳ E resta **una domanda per lui**: vale anche
per il **bot dei soci** (repo separato `assistente-padel-agent`), che al socio dice «borsellino»?
Lì è la parola che leggono i soci, non la segreteria. Non scavalca niente.
