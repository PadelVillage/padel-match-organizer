...
### **135** — 📐 L'IMPORTO ERA INCOLLATO A DESTRA, lontano dal suo `€`

🗣️ **Sua segnalazione**, 03/09/2026, nello stesso messaggio in cui dichiarava provata la 134:
*«l'unica cosa è che quando scrivo l'importo è troppo allineato a destra»*, con schermata di
PROD 6.282 (Luca Allera, 10 €).

📏 **MISURATO sulla pagina viva prima di toccare niente** — la casella aveva `text-align:right` su
una larghezza **fissa di 58px**, e il `€` sta **FUORI**, a sinistra:

| valore | testo | vuoto fra `€` e cifre |
|---|---|---|
| `0,00` | 25px | **35px** |
| `10,00` | 33px | ~25px |
| `1000,00` | 47px | ~11px |

⇒ Si leggeva **«€        10,00»**: due cose staccate, e il numero appiccicato al bordo opposto
rispetto al simbolo che lo qualifica.

⚖️ **La cura, e perché non è un gusto**: qui **non c'è nessuna colonna di numeri da incolonnare**
— ogni casella ha il **suo** `€` accanto, a sinistra. ⇒ L'ancora è il simbolo, e le cifre vanno
**a sinistra**, attaccate a lui.
📌 *L'allineamento a destra serve a confrontare numeri incolonnati; dove i numeri non sono in
colonna, allinea alla cosa a cui il numero appartiene.*

🚨 **E la larghezza gliela si DÀ, misurata, non a occhio**: «1000,00» col font vero
(`bold 12.8px`) chiede **47px** ⇒ **50** bastano e non tagliano. Prima erano **58**, scelti a
occhio, e proprio quegli **8px in più erano metà del buco**. Su mobile il font è `1rem` ⇒ le
larghezze scalano di ×1.25 e «1000,00» chiede ~59px: da **80** a **62**.
📌 *Una larghezza scelta a occhio non è neutra: il vuoto che avanza diventa il difetto.*

⛔ **Nessun banco nuovo, ed è una scelta.** Il fatto da difendere («le cifre stanno accanto al
`€`») è **geometria del render**, e in questo repo una guardia sul CSS è già stata smentita due
volte — la stessa ragione per cui il banco della 127 guarda il fatto e non la regola. La misura
sta scritta qui sopra; a dire che si vede giusto è il suo occhio.

🔨 **IN SERVIZIO su TEST 6.296 e PROD 6.283.**
⏳ **RESTA APERTA finché non la guarda**: due righe di CSS misurate non sono un occhio.
...
## 📦 CHIUSE — dal 13/08 al 03/09/2026 — 111 voci
