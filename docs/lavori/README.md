...
| 📋 **In coda** | **6** — la **68** (curata e in servizio: resta finché il primo giorno vero non è stato guardato), la **69**, la **70**, la **71** e la **72**, più la **60** in sezione D (in attesa che parli con Wansport). 🔼 **La 78 è uscita di qui la sera stessa in cui è entrata**, promossa dalla sessione: delle sette voci, cinque erano curate e in attesa di essere viste succedere e una è ferma su terzi ⇒ era l'unica con del lavoro vero davanti. 🔼 **La 74 era uscita di qui il 23/08** — promossa e chiusa lo stesso giorno; 📦 **la 73 è stata chiusa** lo stesso pomeriggio |
