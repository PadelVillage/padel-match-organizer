...
| **2️⃣** | 👥 **la VOCE 79 provata sul telefono**: un cambio di formazione fatto dalla segreteria su una partita vera di PROD, con dentro **due soci che restano** — e si guarda se a chi resta arriva «È cambiata la formazione». ⛔ Su TEST non si può: il calendario è congelato e il suo dispatcher non sa nemmeno chiedere il sync delle prenotazioni | un gesto suo | **79** |
...
## 📦 CHIUSE — dal 13 al 31/08/2026 — 96 voci
