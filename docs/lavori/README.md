...
| | |
|---|---|
| 🔴 **Urgenti** | **2** — la **65**, curata e in servizio, aperta perché la cura non l'ha ancora vista succedere nessuno (**si aspetta, non si provoca**), e la 🆕 **78**, 🔼 **promossa dalla coda la sera del 23/08 dalla sessione stessa** — primo uso della delega estesa da lui quella sera (*«sì, copre anche le promozioni»*), col perché e cosa scavalca dichiarati nella scheda: è **l'unico difetto aperto che un socio vede adesso**, e scavalca solo delle attese. 📦 **Il 23/08 se ne sono chiuse cinque**: la **63**, la **66**, la **74**, la **76** e la **77**. ⭐⭐ **La 77 è quella da rileggere fra tutte**: la cura è stata provata, ha mandato al socio un *«Sei in campo»* **falso**, è stata **ritirata in dodici minuti**, e la causa non era sua — il **sync** leggeva le due metà della fotografia di «prima» in due momenti, con l'**upsert in mezzo**, che riportava in vita la riga che la resurrezione della voce 73 cerca fra i sepolti. La stessa corsa era **già viva** per un annullo della segreteria. Curato quello (dieci righe spostate 320 più su), la cura è tornata in servizio e alle **18:06:50** è stata vista funzionare **nel caso peggiore**: export scattato **48 secondi prima** dell'annullo — la finestra esatta della bugia — e il giro dopo ha scritto `slotPrima:81 slotDopo:81 accodati:0`. ⇒ *Una cura ritirata ha pagato la diagnosi di un difetto che non era suo* |
| 📋 **In coda** | **8** — la **68**, la **69**, la **70**, la **71**, la **72**, la 🆕 **79** e la 🆕 **80** del 23/08 sera, più la **60** in sezione D (in attesa che parli con Wansport). 🆕 **Le due nuove sono uscite dal collaudo della 78, non da un'idea**: la **79** perché il committente ha controllato il proprio telefono e non aveva ricevuto niente (misurato: zero fatti per l'ospite tolto e per quello aggiunto — gli avvisi `aggiunto`/`tolto` vanno **solo a chi si è mosso**); la **80** perché la scheda ha continuato a mostrare per **2′05″** un ospite già tolto — il rovescio della 78, che la sua cura **non copre**. 🔼 **La 78 è uscita di qui la sera stessa in cui è entrata**, promossa dalla sessione |
