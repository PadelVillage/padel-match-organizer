...
| | |
|---|---|
| 🔴 **Urgenti** | **2** — 💸 **entra la 173 il 07/09 alle 00:12, e non è una segnalazione: è un ESPERIMENTO** — due pagamenti stornati davvero, `status: void`; lanciato `matchpoint-payments-sync`, tornano `status: paid` con `voided_at: null`. ⇒ **negli Incassi uno storno dura al massimo 5 minuti** (il sync gira `*/5 6-21`), e la cassa risulta sempre più alta del vero. Il report 11.13 di Matchpoint **non toglie i pagamenti stornati** (`byMethod` identico prima e dopo) e il sync gli lascia sovrascrivere un fatto che il gestionale sapeva. 🚨 **La cassa di oggi 07/09 va letta 16,00 € più bassa**: due righe di Fabiola sono prove stornate. — 💶 **la 171 è ENTRATA e PROMOSSA il 06/09 notte** (l'incasso dalla scheda partita non funzionava **per nessun metodo**): curata la sera stessa — erano **tre stanze**, non una — e provata su PROD con un incasso vero e il suo storno. **Resta aperta** perché carta e borsellino non li ha visti nessuno riuscire. 🩹 *Questo numero diceva `0` con una urgente dentro, e ha tenuto `guard-docs-truth` ROSSA su tutt'e due i rami dalle 20:28 alle 23:5x del 06/09: una promozione si dichiara anche QUI, non solo nella sezione.* — 🏁 **la 92 e la 83 CHIUSE il 05/09 notte, a prove PROVOCATE sul gestionale di TEST**: quattro chiamate concorrenti con una sola consegna e tre `gia_presi = 100`; un 504 vero del cancello a 151 s uscito come `esito_ignoto` con la ricevuta accanto. ⇒ **lista vuota**, e la 164 nata dalla 92 sta in coda, curata. — 🔒 **la 65 CHIUSA il 05/09 notte, a prova fisica letta nel registro del bot**: l'esito ignoto datato che aspettava c'era dal 23/08 00:14:52, col dettaglio muto al posto del nome del worker. Le due rimaste (92, 83) hanno la finestra guardata la stessa notte — la 92 si era aperta davvero nell'avaria della 160, senza esercitare la cura; la 83 vuota. — 📦 **la 138 CHIUSA il 05/09 sera, a prova fisica su TEST 6.365 e PROD 6.365 (telefono 390×844), ed è la prima delle quattro che si poteva *lavorare* invece che aspettare: le tre rimaste vogliono tutte un evento che nessuno provoca.** — 📦 **la 137 CHIUSA il 05/09 mattina, a prova fisica sulla pagina viva di TEST 6.360 e PROD 6.360, computer **e** telefono**: la cella si accende dove il calendario si **disegna**. 🚨 Il difetto teneva la voce aperta da due giorni e nessuna delle due spiegazioni scritte nella scheda lo nominava — le coordinate stavano in una funzione **che nessuno chiama**, e le due spiegazioni vecchie davano al vuoto una causa **innocente e definitiva**, cioè la forma esatta di una cosa che nessuno riprova. Da 5 a **4**. — 📦 **la 158 CHIUSA il 05/09 a notte, a prova fisica su TUTT'E DUE le metà**: «ciao» che riceve la presentazione, e il tocco su «⬅️ Altri giorni» che fa **riscrivere** al bot lo stesso messaggio con la griglia dei giorni. ⭐ Adesso una conversazione col bot si prova **dal cloud**, con la trascrizione vera e il gestionale che risponde davvero. Da 6 a **5**. — 📦 **la 153 CHIUSA il 05/09 a notte, completa e provata su PROD**: C · A · B, tre lavori separabili fatti in quest'ordine, e ognuno apriva il successivo. Il calendario che **non entrava mai** (serviva una finestra alta 1.966 px) ora entra; la scheda scala col monitor invece di misurare 860 px su qualunque schermo; le colonne si dividono lo spazio invece di stringere solo la più alta. ⭐ E l'ordine C → A → B l'ha deciso chi lavora, su sua richiesta — *«decidi tu dove è meglio per il progetto»* — perché **C scioglieva l'incastro** di una riga CSS che governava scheda e calendario insieme. Da 7 a **6**. — 📦 **la 149 CHIUSA il 04/09 a notte, da lui**: «ok» — le caselle non lette si aprono col trattino, non a zero. 📌 Resta nella scheda il perché: `0,00 €` è un numero VERO, e usarlo per «non lo so» rende le due cose indistinguibili davanti a chi sta per incassare. Da 8 a **7**. — 📦 **la 150 CHIUSA il 04/09 a notte, DA LUI CON UN SALVA VERO**: «funziona». ⭐ È la voce che **non potevo chiudere io** — voleva una scrittura vera sul Matchpoint del circolo — e il confine è stato detto prima, non dopo: avevo provato che la regola è cablata e che il banco cade sui sabotaggi, non che sullo schermo si veda una riga sola. Da 9 a **8**. — 📦 **la 151 CHIUSA il 04/09 a notte, da lui**: «ok» — gli importi ci sono alla seconda apertura senza aspettare Matchpoint. 📌 Il pezzo che vale resta scritto nella scheda: la guardia «è cambiato?» che confrontava solo i nomi non proteggeva, **congelava**. Da 10 a **9**. — 📦 **la 152 CHIUSA il 04/09 a notte, da lui**: «ok» sulle due colonne e sul conto della partita. ⭐ E il ramo **«conto parziale»** — l'unico motivo per cui restava aperta, mai passato sul vivo da quando esiste — è stato esercitato la notte stessa su PROD: l'avviso giallo esce. Da 11 a **10**. — 📦 **la 154 CHIUSA il 04/09 a notte, da lui**: «ok» sui tre versi — la scheda socio che viene sopra al click sul nome, e la partita che si riprende la cima quando la si riapre, che è il caso dell'esito del salvataggio anagrafica. Da 12 a **11**. — 📦 **la 156 e la 155 sono state CHIUSE il 04/09 a notte, DA LUI**, guardandole una alla volta: «ok» («Impostazioni» al posto di «Amministrazione», pagina di accesso compresa · la barra dei capitoli che resta ferma). ⭐ Chiuse **e spostate subito** fra le 📦, che è la regola sua di stanotte: *«man mano la lista si va pulendo coi lavori che chiudi»* — una voce curata e provata che resta qui non è vecchia, **occupa**. Da 14 a **12**. — 🆕 **entra la 158 il 04/09 a notte, SUA** (*«riusciresti a fare anche gli stessi test sul chatbot?»* → *«mettila in lista e falla perché ci servirà appena abbiamo finito di fixare il gestionale»*, e poi *«funziona sia a gesti che a parole»*): 📏 misurato il buco invece di supporlo — dal cloud arrivo al banco, al deploy, al registro e al ponte, ma **non posso mandare un messaggio al bot** (per scrivere a un bot serve un account Telegram, e il nostro è in long polling: non c'è nemmeno una porta dove posare un update finto). ⭐⭐ La strada l'ha aperta una misura del codice: il ciclo del polling fa **una cosa sola** con quello che riceve — `gestisciMessaggio` oppure `gestisciTocco`, **due porte e nessun'altra** — e *tutte* le chiamate a Telegram passano da **una sola** funzione ⇒ una conversazione si dà in pasto al bot senza Telegram, e intercettando quel filo si raccoglie la trascrizione intera **mentre le chiamate al gestionale passano vere**. 🔒 Entra come **terzo modo di `avvio-prova.ts`**, dopo le sue cinque serrature: ricopiarle sarebbe la trappola dichiarata del progetto. Non scavalca niente: entra in testa perché è di stanotte ed è chiesta da lui. Da 13 a **14**. — 📦 **la 157 è stata CHIUSA il 04/09 a tarda notte, da lui**: *«controllato ed è ok»* sulla scheda con la nota di due righe e il titolo nella testata, in servizio su PROD 6.349 e provata da me a tre larghezze prima di consegnargliela. Da 14 a **13**. — 🆕 **entra la 157 il 04/09 a notte, SUA** (*«il campo nota è troppo alto… la parte sinistra la puoi alzare all'altezza del titolo, fammi un mockup»* → **«fai la A»**): 🎨 mockup con **tre letture** e una tabella che il browser calcola da sé — ed è il mockup ad aver scoperto che l'altezza la detta **la più alta delle due colonne**, quindi la nota da sola non basta. 🔨 Nota 3 righe → 2 (85→64 px, resta trascinabile) e titolo **fuori dal flusso** nella testata, che conteneva solo la ✕: le colonne partono in cima. **Solo CSS**, il DOM non si tocca. 🩹 Un difetto visto solo sul vivo: `grid-row:2` dei giocatori descriveva la riga del titolo, che non c'è più. ✅ **In servizio su PROD 6.349 e provata lì a tre larghezze**. Non scavalca niente: entra in testa perché è di stanotte. Da 13 a **14**. — 🆕 **entra la 156 il 04/09 a notte, SUA** (*«nel menù in alto c'è una parola che si chiama amministrazione che può essere confusa con l'amministrazione economica»* → **«va bene impostazioni»**): 📏 guardato **cosa c'è dentro** prima di proporre il nome — Utenti Staff · Notifiche staff · Dati · Bot Telegram, non una riga di soldi ⇒ la confusione non era un'impressione. 🔨 Cambiate **tutte le 24** occorrenze che si leggono, compresi i **quattro testi del login**, e la **chiave interna `administration` NON toccata** (ci sta appesa la visibilità per ruolo). ✅ **In servizio su PROD 6.346 e provata lì**, pagina di accesso compresa. Non scavalca niente: entra in testa perché è di stanotte. Da 12 a **13**. — 🆕 **entra la 155 il 04/09 a notte, SUA** (*«questa barra su desktop deve rimanere sempre fissa e il sotto scollare»*, con la schermata): 📏 misurata la pagina viva **prima** di scrivere, perché `sticky` non funziona «in generale» — a scorrere **non è il documento** (`html` e `body` sono `overflow:hidden`, e `scrollHeight − clientHeight` valeva **zero**), lo scroller è `main.main-content`, e fra la barra e lui c'è un solo antenato a `overflow:visible`. 🔨 `sticky; top:0; z-index:1200` sopra i 900 px, col livello **sotto** il velo delle schede. ✅ **Provata su TEST a due larghezze, col prima e col dopo**: se ne andava a −193, adesso resta a 0. **Promossa a PROD 6.344.** Non scavalca niente: entra in testa perché è di stanotte. Da 11 a **12**. — 🆕 **entra la 154 il 04/09 a notte, SUA e vista sulla pagina viva** (*«Ti trovato un errore con la scheda aperta della partita se clicco sul nome la scheda di anagrafica va sotto invece che sopra»*, con la schermata): 📏 la causa è che `.member-card-overlay` e `.svc-chat-panel` hanno **lo stesso** z-index (2600) — a parità decide l'**ordine nel DOM**, quindi la scheda partita vince **sempre**. 📌 *Non è un numero sbagliato: è un numero che non decide niente.* ⛔ E alzare la scheda socio e basta sarebbe stato sbagliato: l'esito del **salvataggio anagrafica** passa dall'aprire il pannello della chat, e sarebbe finito sotto — il difetto mostrato curato creandone il **gemello** dove si scrive su Matchpoint. 🔨 Cura: `pmoPortaInCima`, una classe che **passa di mano** fra le due schede. ✅ **Promossa a PROD 6.342 e provata lì nei due versi** con `elementFromPoint`; resta aperta per il **suo** gesto sulla partita vera. Non scavalca niente: entra in testa perché è di stanotte, ed è un difetto **visto da lui**. Da 10 a **11**. — 🆕 **entra la 153 il 04/09 a notte, DA UNA SUA DOMANDA** (*«hai fatto anche un pensiero sul fatto di rendere scalabile/adattabile la scheda e il calendario a seconda del tipo di monitor? cioè se è un 15 pollici o un 13 o un 9?»*): 🚨 **e non è una rifinitura — è la causa del difetto che la 152 non ha chiuso.** 📏 Misurato su PROD: il pannello è **fisso a 860 px** e non scala mai ⇒ su **1280×800 la scheda sfora di 94 px**, a 1440 di 0÷10, a 1920 entra. La cura della 152 è **tarata su un monitor solo**. E nel foglio di stile ci sono **tredici** soglie diverse, nate una per volta: l'app non scala, fa **gradini** non allineati. ⏳ **Da decidere con lui**: è una modifica visibile e larga, vuole un mockup e misure su tre larghezze vere. ⚠️ Il **calendario** non è stato misurato (selettore sbagliato) ed è nominato nella sua domanda. Non scavalca niente: entra in testa perché è di stanotte. Da 9 a **10**. — 🆕 **entra la 152 il 04/09 sera, SUA** (*«a livello grafico puoi migliorarla così da far entrare tutte le informazioni dentro la scheda aperta»*, poi *«fai la A»* sul mockup): 📏 misurato su PROD prima di disegnare — la finestra è 860 px, la scheda ne usava 612 (231 vuoti a destra) e 453 px finivano sotto il bordo. Ora **due colonne** da 900 px in su, e nello spazio libero il **conto della partita** (a carico · già incassato · manca). 🚨 Fatto **solo in CSS**: incartare le sezioni avrebbe ucciso in silenzio la guardia della **150**, che cerca la riga dell'esito fra i **figli diretti** del box. ✅ Provata su TEST: **453 px di scorrimento → 0**. **Resta aperta**: il caso «conto parziale» sul vivo non è ancora passato, e manca il suo occhio. Non scavalca niente: entra in testa perché è di stasera. Da 8 a **9**. — 🆕 **entra la 151 il 04/09 sera, DA UNA SUA OSSERVAZIONE E CON LA SUA APPROVAZIONE** (*«sull'importo c'è un trattino, dopo circa otto secondi appare l'importo… dovrebbe apparire già l'importo»* → *«sì, procedi col salvare l'importo quando si legge»*): 🚨 **la premessa della sua frase era FALSA, ed è la misura che ha deciso la strada** — il sync ogni due minuti **non legge gli importi** (solo nomi, dalla descrizione dell'export), e aprire tutte le ficha vorrebbe dire ~206 prenotazioni × un giro ogni 2 minuti sul worker condiviso ≈ **150.000 visite al giorno**. ⇒ L'unica lettura che li vede è quella che parte aprendo la scheda, e **si buttava via**. Ora si tiene, col **quando** (`lettoAt`) che rende il ricordo onesto: la casella guadagna un **terzo esito** e il «da» del cambio importo lo dichiara. ⛔ **Non** si ricordano borsellino e **stato del pagamento** — un «✓ pagato» ricordato su uno storno fa saltare un incasso vero. 📏 Provata sulla pagina viva di TEST: l'importo c'è a **1,2 secondi** invece di otto, coi tre esiti distinti nella stessa schermata. **Resta aperta** per il suo occhio su una scheda vera. Non scavalca niente: entra in testa perché è di stasera. Da 7 a **8**. — 🆕 **entra la 150 il 04/09 sera, DA UNA SUA SEGNALAZIONE su PROD 6.334** (*«continuano ad esserci due messaggi uno dopo l'altro in basso alla scheda, che ora si chiude dopo che ho salvato»*): 🚨 **è il QUARTO giro sullo stesso difetto** — 136, 137 ⑤, 145 e 147 governavano tutte l'**attesa**, nessuna l'**esito**, che è l'istante in cui la riga torna (voce 134, voluta) e la striscia dice lo stesso fatto dieci pixel più giù. 📏 Misurato sulla pagina viva a 390×844 **prima** di curare: due riquadri, 573→650 e 771→844, tutti e due dentro `#svcChatPanel`. Curata con una **funzione pura** (`svcBarraDoppiaDellaRiga`), tre freni dichiarati e il ridisegno nei due versi; provata sulla pagina viva di TEST **2 riquadri → 1**. **Resta aperta** per il suo occhio: un Salva vero non lo può fare la console, che è `readonly`. Non scavalca niente: entra in testa perché è di stasera. Da 6 a **7**. — 📦 **la 148 CHIUSA il 04/09 sera, a PROVA FISICA SUA su PROD** (*«la scheda… ora si chiude dopo che ho salvato, e questo te lo confermo»*): era l'unica metà che non potevo provare io. Da 7 a **6**. — 🆕 **entra la 149 il 04/09, DA UNA SUA SEGNALAZIONE dal cellulare** (*«ho aperto la scheda della partita ma gli importi sono a zero»*, con Matchpoint che ne portava 8,00 e 10,00): 🚨 **è la TERZA volta che questo progetto scrive «zero non è non lo so»** — dopo la 114 e la 139, e nessuna delle due aveva guardato questa casella. Curata con una **funzione pura**, così il quarto punto la eredita. Provata sulla pagina viva di TEST nei due versi; **resta aperta** per il suo occhio. Da 6 a **7**. — 🆕 **entra la 148 il 04/09, DA UNA SUA SEGNALAZIONE dal cellulare** (*«la scheda è rimasta aperta e non si è più chiusa sul cellulare»*, dopo il primo cambio importo vero su PROD 6.330): 🚨 **non era un guasto, era una riga della 132 scritta apposta** — giusta su desktop, dove la scheda è un pannello, sbagliata su telefono, dove è un foglio a tutto schermo. Curata, **resta aperta** per il suo dito: la prova vuole un cambio importo vero, che la console in sola lettura non può fare. Non scavalca niente: entra in testa perché è di stasera. Da 5 a **6**. — 🆕 **entra anche la 139, SUA** (*«non c'è accanto all'importo, dentro la scheda della partita o della lezione, se un giocatore ha dei soldi nel borsellino»*): è l'**altra metà** del residuo della 129, ed è **decisa in tutto** — si scrive e basta, poche righe dove `saldoCents` è già in mano. Da 5 a 6 — 🆕 **entra la 138 il 03/09 sera, SUA** (*«l'unica cosa che rimane fuori è che il nome del giocatore dalla scheda della partita non è cliccabile»*): è il **residuo dichiarato** della 129 archiviata, e sta in una voce sua perché **un residuo lasciato dentro una voce chiusa è un residuo perso**. Aspetta una sua scelta fra tre strade. Da 4 a 5 — 📦 **la 125, la 136 e la 129 chiuse il 03/09 sera** (le prime due a prova fisica sua, la terza archiviata senza essere costruita): da 7 a **4**. ⇒ Restano **92 · 83 · 65** (aspettano un caso) e la **137**, che è l'unica su cui si lavora. 🆕 **entra anche la 137, VOCE SUA** (*«come poter avere sul gestionale la visione di quello che sta succedendo sul Matchpoint non legato alla scheda… tipo in sovrapposizione sul calendario»*): 🚨 misurato che **il motore c'è già ed è spento da tre mesi** — edge ACTIVE su PROD, funzioni scritte nell'app, la riga che le accende **commentata** il 3/06 per una ragione di **ingombro**, non di dato. Quattro disposizioni disegnate a due larghezze; **aspetta la sua scelta**. Da 6 a 7 — 🆕 **entra la 136 il 03/09, DA UNA SUA SEGNALAZIONE dal telefono** (*«ci sono due avvisi, è troppo pieno»*): è un **difetto della 134**, la cui scheda dichiarava che le due cose «si affiancano, non sono due copie» — vero con l'esito fuori dal bordo, **falso** con l'esito dentro. Da 5 a 6 — 📦 **la 135 è CHIUSA il 03/09 a prova fisica** (*«puoi chiuderla»*), e con lei si svuota la fila delle voci nate oggi: da 6 a **5**. ⇒ Restano **92 · 83 · 65 · 125 · 129**, e delle cinque solo la **125** aspetta un suo gesto (il primo incasso vero) — 📦 **la 134 è CHIUSA il 03/09 a prova fisica** (da 6 a 5) e 🆕 **entra la 135, DA UNA SUA SEGNALAZIONE** nello stesso messaggio (*«quando scrivo l'importo è troppo allineato a destra»*): 📏 misurati **35px di vuoto** fra il `€` e le cifre, perché la casella era `text-align:right` su 58px scelti a occhio. Da 5 a 6, il conto resta 6 — 📦 **la 132 è CHIUSA il 03/09 a prova fisica** (da 6 a 5) e 🆕 **entra la 134, DA UNA SUA DOMANDA** (*«dove è giusto che io veda la conferma?»*, poi *«un risultato che non deve essere nascosto, sia se scrivi sia se clicchi i bottoni»*): 📏 misurato che la conferma nasce **568px sotto il bordo** e che la vista **torna in cima**. Da 5 a 6, il conto resta 6 — 📦 **la 133 è CHIUSA il 03/09 su sua istruzione** (*«chiudi la centotrentatré»*), il giorno stesso in cui è nata da una sua domanda. Da 7 a 6 — 🆕 **entra la 133 il 03/09, DA UNA SUA DOMANDA** (*«è possibile negli incassi avere lo storno?»*): in servizio su TEST 6.293 e PROD 6.280. Da 6 a 7 — 📦 **la 128 è CHIUSA il 03/09, a PROVA FISICA su PROD 6.279**: la colonna «come» della scheda socio **guardata con 50 movimenti veri dentro**, e scrive **Card** e **Cash** dove prima scriveva `carta` e `contanti` in minuscolo. Da 7 a 6 — 🆕 **entra la 132 il 03/09 mattina, MESSA QUI DA LUI** (*«quando su una scheda cambio l'importo e poi clicco salva me lo deve riportare su Matchpoint e sul gestionale»*), e 📦 **esce la 131, CHIUSA da lui lo stesso giorno** (*«chiudi la centotrentuno»*) ⇒ il conto resta 7. — 🆕 **era entrata la 131 il 03/09 mattina, MESSA QUI DA LUI** (*«prima aggiusta la scheda quando apro una nuova prenotazione che è tagliata in alto… ottimizza i campi mettendoli tutti su una riga e la data la metti dopo il testo campo»*): due cose sulla stessa scheda, in servizio su TEST 6.291 e PROD 6.278. Da 6 a 7 — 📦 **la 127 e la 130 sono CHIUSE il 02/09 notte, a PROVA FISICA su PROD e in un colpo solo**: *«l'ho aperta e la scheda si vede tutta. E il calendario non si sposta più»*. Entrate e chiuse **nella stessa sessione**, il che è possibile solo perché la causa è stata **misurata** invece che ipotizzata. Da 8 a 6 — 🆕 **era entrata la 130 il 02/09 notte, da una SUA OSSERVAZIONE** (*«ogni tanto sembra che il calendario si sposta, sale e scende velocemente, ma è molto piccolo lo spostamento in verticale»*): **misurata e curata la sera stessa** — non era il calendario a muoversi, era l'etichetta «aggiorno…» a crescere sopra di lui. Resta **aperta** finché non la si vede ferma con i propri occhi. Non scavalca niente: entra in fondo. Da 7 a 8 — 🆕 **entra la 129 il 02/09 a notte fonda, IDEA SUA**: il saldo wallet a colpo d'occhio nella riga del giocatore. 📏 Il dato c'è già (il worker lo manda su ogni riga e l'app lo butta via) ⇒ non costa una chiamata in più. Da 6 a 7 — 🆕 **entrano la 127 e la 128 il 02/09 a notte fonda, MESSE QUI DA LUI**: la scheda della partita che si apre **tagliata in alto** (vista con schermata, e presente anche sulla 6.273 ⇒ non l'hanno portata i lavori di stasera) e il **«borsellino» che diventa «wallet» ovunque** (~45 stringhe, con dentro chiavi di permesso e di dato che NON si toccano). Nessuna delle due scavalca niente: entrano in fondo. Da 4 a 6 — 🆕 **entra la 125 il 02/09, per sua richiesta** (*«procedi con l'accensione dei soldi nella scheda partita»*): l'incasso è in servizio su TEST 6.287 e aspetta **un incasso vero da 1 €** su PROD, che è un gesto suo. Non scavalca niente: entra in fondo. Da 3 a 4 — 📦 **la 84 è CHIUSA il 02/09 pomeriggio, a prova fisica su PROD**: la riga del motivo **vista da lui** nella scheda socio. Si chiude sulla ⓑ; la ⓐ e il residuo della ⓒ **proseguono nella 124**, per sua scelta — una voce che si chiude portandosi via del lavoro non curato non è chiusa, è persa. Da 4 a 3 — 📦 **la 123 è CHIUSA il 02/09 mattina, a prova fisica su PROD**, il giorno dopo essere entrata: *è passata di lì e non è successo niente* — stesso giro di consegna, stessa partita, e le due righe divergono dove devono (`suo_gesto` a chi ha chiesto, `passato_al_bot` a chi resta), confermato sui due telefoni. Da 5 a 4 — 🆕 **era entrata il 02/09, MESSA LÌ DA LUI** (*«apri l'altra in coda, tra gli urgenti»*): il circolo avvisa il socio di un gesto che ha fatto lui e lo manda a parlare con sé stesso — **vista succedere** sul suo telefono 🆕 **entra la 123 il 02/09, MESSA QUI DA LUI** (*«apri l'altra in coda, tra gli urgenti»*): il circolo avvisa il socio di un gesto che ha fatto lui e lo manda a parlare con sé stesso — **vista succedere** sul suo telefono alle 00:03:26. È la voce 70 rientrata da una porta che quella cura non copriva: la ricevuta del `remove` copre chi viene tolto, non chi ha chiesto. Non scavalca niente: entra in fondo. Da 4 a 5 — 📦 **la 109 è CHIUSA il 31/08 mattina, a prova fisica arrivata da sé**: un omaggio vero della segreteria su una partita viva, scritto alle 07:53:29 con `count: 1`. ⭐ E a chiuderla è stato il **codice**, non la sonda — il record `paygift` nasce solo leggendo la ficha di Matchpoint, quindi «l'omaggio è passato di là» è vero per costruzione. La sonda era stata sbagliata **tre volte in tre giorni**, ogni volta nel verso di affermare una cosa non vera. Da 5 a 4 — 📦 **la 108 è CHIUSA il 30/08 sera, a prova fisica su PROD**: il caso è arrivato da sé — un salvataggio vero di scheda socio passato dalla cura (`count: 1`, atterrato in 1,7 s) — e l'unica metà che dal cloud non si vede l'ha guardata **lui**: *«Nessun avviso giallo»*. ⇒ Le urgenti che restano aspettano **tutte** un caso, tranne la sonda della 109. — 📦 **la 97 è CHIUSA il 30/08 sera**, e il suo terzo passo si è rivelato un lavoro su **due repo con un ordine obbligato**: prima il bot smette di offrire l'indirizzo della pagina (17:01, deploy #126), poi la pagina si chiude (PROD **6.259**). Prova fisica su tutt'e due gli ambienti vivi: la porta c'è e il modulo **non esiste più nel DOM**. Da 7 a 6 — 📦 **la 110 è CHIUSA il 30/08 pomeriggio**, e le due righe che la tenevano aperta sono cadute nello stesso pomeriggio: le **6 domande** che volevano l'orecchio di chi gioca le ha rilette **lui** (cinque confermate, la P-T12 corretta e rideployata), e le cure le ha viste succedere **sul suo telefono**, col conto del livello rifatto a mano dalla formula in servizio. A residuo dichiarato. Da 8 a 7 — 📦 **la 105 è CHIUSA il 30/08 pomeriggio**, provata da lui sul gestionale di PROD nella finestra esatta: due salvataggi di fila sulla scheda di un socio **esposto** (riga viva `d7c6d389-…`, telefono che ne calcolerebbe un'altra) e la riga è rimasta **una**, doppioni **0**, soci vivi **2817** prima e dopo. Da 9 a 8 — 🆕 **entra la 110 il 30/08**, il test di autovalutazione ritarato in quattro punti su sua parola (*«VAi procedi e fai il lavoro»*): la banca dei trabocchetto bilanciata perché «nego sempre» passava nel 76-96% dei casi contro il 50% del caso, i pesi portati da 0,40/0,25/0,35 a 0,20/0,25/0,55 col freno basso tolto, le quattro scale tecniche ritarate sullo stesso metro, e la frequenza che smette di essere un dato raccolto e buttato. Curata, con tre guardie sabotate, e **aperta per due cose**: le 27 domande nuove non le ha rilette nessuno che giochi a padel, e nessuna delle quattro cure è stata vista succedere su un telefono. **Non scavalca niente**: entra in fondo. Da 8 a 9 — 🆕 **entra la 109 la sera del 29/08**, la RPC che non conosceva i pagamenti: **trovata tirando il filo della 108** (🩹 e NON è la sua causa: quella riga è stata corretta un'ora dopo — le 67 restano senza spiegazione). Una deriva fra due liste (la tabella ne ammette 22, la RPC 15) che scartava `payment` **in silenzio** dal 27/06 ⇒ **3032** record `payment` nel cloud e **zero** scritti dall'app — 🩹 e anche questo era letto male: su 3014 pagamenti non c'è **nessuna** riga a 0 €, quindi un omaggio non l'ha mai fatto nessuno. Il danno è **potenziale**, non avvenuto: la porta si chiude prima che qualcuno ci passi. Curata (solo `payment`, larghezza decisa da lui) e applicata sui due progetti; manca la prova fisica. Non scavalca niente: entra sopra perché **stava già perdendo dati**. Da 7 a 8 — 🆕 **entra la 108 la sera del 29/08**, un salvataggio di scheda socio che sparisce in silenzio mentre lo schermo dice «salvato»: **guasto suo**, visto succedere su un livello cambiato **due volte** e mai arrivato al cloud, e **misurato** — zero soci su 2817 con `payload.updatedAt` del 29/08, e **67 spinte su 411 in quindici giorni hanno scritto ZERO record** con l'app che le dava per riuscite. 🆕 **Il 29/08 notte le due piste su quelle 67 sono cadute tutte e due** (la whitelist non può spiegarle, e nessuna strada nota costruisce un record senza chiave): al loro posto c'è una **diagnostica nel registro**, applicata ai due database e provata eseguendo la RPC su TEST — la causa resta **ignota**, ma la prossima spinta a vuoto si spiega da sé. Sta in cima perché tocca l'anagrafica a ogni modifica normale della segreteria e **rende inerte il punto D**, promosso in PROD lo stesso giorno. Non scavalca nessuna: entra sopra perché le altre sei aspettano una prova, questa perde dati adesso. Da 6 a 7 — 📦 **la 101 è CHIUSA il 29/08 pomeriggio**: la lista del maestro vista popolarsi con un socio vero sull'app viva (lui rifa' il test dichiarando Agonista ⇒ dimostrato 5 con 4 in scheda ⇒ **ENTRA**), e prima ancora i quattro cancelli esercitati su 24 soci veri con il rosso accanto a ogni riga. 🚨 Nel farlo e' caduta una riga falsa della sua stessa scheda — il blocco non era un permesso mancante, era la guardia della console che fermava due **letture** in POST. Da 7 a 6 — 📦 **la 78 è CHIUSA il 29/08 pomeriggio**, provata da lui dentro la finestra esatta (aggiunta 15:21:25 → sync 15:25:04, **3′39″**) e col bottone «🔄 Aggiorna» toccato **quindici volte**, quattro nello stesso minuto: il registro del bot porta il «prima» e il «dopo» sulla stessa partita, più il **controllo** non cercato di una partita concorde che nello stesso minuto contava i posti. Da 8 a 7 — 🆕🔼 **entra la 105 la sera del 28/08**, il gestionale che sdoppia un socio scrivendo sotto una chiave calcolata invece che sotto quella della riga viva: **guasto visto succedere** (Maurizio, 22:17), non un'idea, e **non scavalca nessuna** — sta in cima perché si riattiva a ogni modifica normale della segreteria e intanto lascia il socio fuori dal test. Da 7 a 8 — 📦 **la 69 è CHIUSA il 28/08 pomeriggio**, curata alla **causa** dopo che l'effetto si era visto per la terza volta e su un terzo gesto (*«Non riesco ad aprire il test»* a Laura). ⚖️ E le due righe che la scheda portava come causa e come cura erano **tutt'e due false**: si sono corrette misurando. Da 8 a 7 — 📦 **la 104 è entrata e USCITA nella stessa giornata**, aperta a mezzogiorno su sua parola e chiusa nel pomeriggio con **due** prove fisiche sul suo telefono: le tecniche mescolate e le altre quattro ferme. Nel mezzo una sua decisione presa su una misura da 20.000 gettoni (*«teniamo la a»*), e due sabotaggi sopravvissuti alla prima stesura del banco. Da 9 a 8 — 🆕🔼 **era entrata la 104 il 28/08 a mezzogiorno, voce SUA**, e ci entra **promossa da lui**: l'avevo messa in coda dichiarando che non bloccava niente, e lui l'ha spostata di sopra (*«mettila nella lista dei task che stiamo facendo adesso»*). Non scavalca niente. Da 8 a 9 — 📦 **la 98 è CHIUSA il 28/08**, guardata da lui sul gestionale vero: due soci nel filtro del maestro, e il cablaggio dal vivo che era dichiarato non provato. Da 9 a 8 — 📦 **la 103 è entrata e USCITA in due ore**, difetto visto da lui sullo schermo e cura vista dal vivo 14 minuti dopo il deploy. 🆕 era entrata il 28/08 mattina, l'esito che nominava la parola dichiarata: il difetto l'ha visto **lui sullo schermo** durante una prova fisica (*«non coincide con le nostre regole la risposta»*), quindi la voce nasce da una misura e non da un'idea. Curata e in servizio, aperta per la prova fisica. Da 9 a 10 — 📦 **la 102 è entrata e USCITA nella stessa mattina**, curata, messa in servizio e vista dal vivo (a residuo dichiarato: la parola esatta da cui era nata non l'ha vista nessuno). 🆕 era entrata il 28/08 mattina, l'eco che diceva una parola che il bottone non aveva: voluta dalla **sessione** su una misura (delega del 23/08), e **non scavalca niente** — è curata e in servizio, ma non l'ha ancora vista nessuno su un telefono, che è la forma esatta che questa lista tiene aperta. Da 9 a 10 — 📦 **la 100 è CHIUSA il 28/08 mattina**, a prova fisica: la sua riga sta fra le chiuse. Da 10 a 9 — 🆕 **entra la 101 la tarda sera del 27/08**, il riallineo `test-preview` ← `main` della catena `assessment-*`: voluta dalla **sessione** su sua parola (*«quella voce la devi volere tu. FALLO SUBITO»*), e **non scavalca niente** — è entrata sotto alle nove, perché cresceva da sola invece di aspettare il suo turno. 🩹 **E questo numero era SBAGLIATO: diceva 8 con 9 voci sotto.** 📏 Non è una svista trovata rileggendo — `guard-docs-truth` lo dichiarava **rosso** dal #1117 di ieri sera, a ogni giro, e nessuno leggeva quel rosso. ⚖️ *Una guardia che nessuno guarda è una guardia che non c'è.* — 📦🔼 **il 26/08 il numero resta 8 ma le voci sono altre**: la **94** è stata chiusa a prova fisica sua e al suo posto è salita la **98**, la lista per il maestro — la prova stessa ha mostrato che quella segnalazione non la legge nessuno — 🔼 **e la 97 era salita qui dalla coda la sera stessa in cui ci era entrata**, per sua parola: il test di livello lo prova **dentro Telegram** ⇒ quella voce non è più il lavoro dopo la 94, è **la strada che la chiude**. Scavalca solo delle attese (98 e 99) — 🆕 **entra la 94 la sera del 25/08** (il **test di livello rifatto**: banca 27+9, tetto a Intermedio, i due valori, il terzo esito, l'attesa a zero), e con lei erano entrate la **95** e la **96** — 📦 **chiuse tutt'e due la sera stessa, provate da lui**: l'«Esci» con lo screenshot delle 22:04, l'«Annulla» e il menu `/gruppo` a parole (*«annulla e il menu /gruppo sono ok»*). 🚨 Erano già tutte in produzione mentre questa riga diceva ancora **6**: la giornata del 25/08 è stata lavorata **fuori dalla lista** — 📦 **e la 90 è stata chiusa da LUI a mezzogiorno del 25/08, a residuo dichiarato**: la bolla non l'ha mai vista nessuno su un telefono, perché un esito ignoto **non si provoca** — e la strada per provocarlo è stata scartata con la misura, non con un'impressione — 🔽 **la 88 è tornata IN CODA il 25/08, per sua parola** (*«per la 88 non fare sviluppo, metti solo in documentazione le regole»*): le quattro regole sono decise e scritte, il codice no, ed è voluto — 📦 **e la 89 è stata chiusa a mezzogiorno del 25/08**, cronometrata due volte da lui: **76 secondi** dal gesto al telefono, di cui **36 fuori dal nostro controllo** (worker 23, Telegram 13) ⇒ il bersaglio «entro 1 minuto» l'ha **ritirato lui sulla misura**, mentre la cura è risultata **dentro il suo budget** (40 su 50) — 📦 **anche la 86 è stata chiusa la mattina del 25/08**, curata e provata da lui nello stesso giro: il link d'invito non arriva più nudo, è un **messaggio pronto da inoltrare** col nome di chi invita e la parola «accettare» — 📦 **la 93 è stata chiusa la mattina del 25/08**, provata da lui sul telefono di Laura: il conto **visto scendere** a «fra 29 giorni» con le date invariate — il terzo dei suoi tre pezzi (**due richieste sue sulla stessa schermata**: le due date nel «mio livello» al posto del solo «fra 30 giorni» — e la misura ha mostrato che il **30 non era una costante**, il conto era già vero e le date il ponte le mandava già; e la **manina** del bottone «Togli i giocatori», che era lo stesso segno delle righe dei nomi — e non solo a occhio: la lettura della selezione ci finiva dentro. Curate, resta la prova fisica sul telefono) — 🆕 la **92** del 24/08 in tarda serata (**due messaggi identici allo stesso socio**, misurati nel registro a un secondo di distanza: la coda dei fatti del circolo si **legge** al passo 1 e si **chiude** al passo 5, e due giri sovrapposti la prendono tutt'e due. Mancava la presa atomica che tutti gli altri avvisi hanno. Curata; la prova fisica vuole un gesto della segreteria che attraversi un riavvio del bot) — 📦 **la 91 è entrata e uscita nella stessa sera**, curata e **provata da lui dentro la finestra esatta** (nome visibile 41 secondi dopo la prenotazione, senza stella e senza conteggi) — 🆕 la **90** del 24/08 sera (**una bolla sola che si aggiorna** invece di due messaggi che si smentiscono: idea sua, aperta e **curata la sera stessa**. Il difetto era di **forma e non di verità** — nessuno dei due messaggi mentiva, la **coppia** sì. Resta aperta per la prova fisica, che vuole un esito ignoto e non si provoca a comando) — 🆕 la **89** del 24/08 sera (la kb dice **«entro 1 minuto»**: non un errore ma un **bersaglio**, scelto da lui a conseguenza dichiarata. 🩹 La scheda è stata **riscritta un'ora dopo perché era sbagliata** — il gestionale **dichiara già** l'istante vero (voce 76) e la quiete è **già** 30 secondi: avevo creduto a una nota del 22/08 superata il giorno dopo. La catena vera era **30s-2′30″** e la cura **una costante sola**, il ritiro del bot da 2 min a **20 secondi** — fatta, resta la prova col cronometro) — 🆕 la **88** del 24/08 (**«Partite Aperte»**, una voce di menu nuova: partecipare a partite che un organizzatore apre di sua volontà — messa qui **da lui**, ed è l'unica di questa lista che **aggiunge** invece di curare, quindi ha priorità sulle attese e non sui guasti) — 📦 **la 87 è stata chiusa da LUI la notte del 25/08**, dopo la prova fisica sul telefono: cinque domande scritte a mano, quattro corrette e la quinta — «perché mi è arrivato questo messaggio?» — **corretta con le sue parole nello stesso giro**. E la caduta non era ignoranza: il testo giusto nella kb c'era già, ma il campo che si dichiarava «la risposta» conteneva tre righe che il modello ha l'ordine di NON dire  — 📦 **la 85 è stata chiusa da LUI la notte del 24/08** («85 provata ed è ok la puoi chiudere»), **a residuo dichiarato**: la frase è curata e provata, ma la causa nel worker — la griglia dei livelli che non si legge — resta scritta nella riga delle chiuse e **non è diventata una voce**: quella decisione è sua — la **84** del 24/08 (il test di livello: l'esito dopo **11 minuti** e il livello che **non si scrive mai**, con una socia vera ferma a 0,5 — aperta su sua parola, scavalca solo delle attese) — la **83** della notte del 23/08 (un «no» falso su un annullo **passato**: la voce 72 al rovescio) — — la **65** (curata e in servizio, aperta perché la cura non l'ha ancora vista succedere nessuno: **si aspetta, non si provoca**), la **78** e la 🔼 **69**, promossa la notte del 23/08 dalla sessione stessa. ⚖️ **Il perché della promozione, dichiarato come vuole la regola**: la 69 descriveva una *causa* archiviata come «1 caso su 2810, nessuna urgenza»; quella notte se n'è visto l'**effetto** — il bot che dice **«Non hai prenotazioni»** a una socia che in campo c'era, un minuto prima di dirle «Sei in campo». Un «no» falso, che è la specie di errore più grave qui dentro. Scavalca **solo delle attese**. ⭐⭐ **La 78 è stata VISTA FUNZIONARE la notte del 23/08**, nella finestra esatta e larga **33 secondi** (staff 22:19:31 → sync 22:20:04): tre nomi, nessun `— posto libero —`, nessun «Siete al completo», la riga «sta cambiando» — e il banco l'aveva **predetto eseguendo** i moduli veri sui payload veri un minuto prima. Resta aperta per il **bottone «🔄 Aggiorna»**, chiesto da lui guardando quella schermata e in servizio dalle 22:36, ma non ancora toccato |
...
### 173 — 💸🚨🚨 IL SYNC DEGLI INCASSI **CANCELLA LO STORNO**: la cassa risulta più alta del vero

🆕 **Entra il 07/09/2026 alle 00:12, ed è un guasto MISURATO su PROD** — non una supposizione,
non un difetto raccontato: è un esperimento con un prima e un dopo, sulle stesse due righe.

📏 **L'esperimento, e chiunque può rifarlo in due minuti.** Due pagamenti di Fabiola Limuti sulla
9844, stornati davvero (il worker conferma `pendentePostCents: 800`, cioè su Matchpoint il
pagamento non c'è più). Poi si lancia `matchpoint-payments-sync` e si rileggono le stesse righe:

| | `pay\|301\|291\|2026-09-06\|800\|cash\|1` | `pay\|301\|291\|2026-09-07\|800\|wallet\|1` |
|---|---|---|
| **prima** del sync | `status: void` · `voided_at 2026-09-06T22:09:58Z` | `status: void` · `voided_at 2026-09-06T22:09:58Z` |
| **dopo** il sync | `status: **paid**` · `voided_at **null**` | `status: **paid**` · `voided_at **null**` |

⇒ **Lo storno viene cancellato dal sync.** E il sync degli incassi di oggi gira `*/5 6-21 * * *`:
⇒ **negli Incassi uno storno dura al massimo CINQUE MINUTI**, poi il pagamento torna «riscosso».

🔎 **E il perché sta a monte, misurato nello stesso giro**: il `byMethod` del report è **identico
prima e dopo** lo storno (`cash 25600 · card 15000 · wallet 1600`). ⇒ **Il report 11.13 di
Matchpoint non toglie i pagamenti stornati**, e non ha una colonna che lo dica. Il sync fa il suo
mestiere — rispecchia il report — e nel farlo **sovrascrive un fatto che il gestionale sapeva**.
📌 *Non è il sync a mentire: è uno specchio che rispecchia. Il difetto è avergli lasciato
sovrascrivere una cosa che lui non può sapere e noi sì.*

🎯 **⇒ È esattamente «il gestionale SA, il bot DICE» applicato alla cassa.** Lo storno l'ha fatto
il **gestionale**: è un fatto **nostro**, non di Matchpoint. Un dato che nasce da noi non può
essere cancellato da uno specchio di qualcun altro.
🔨 **La forma della cura, dichiarata ma NON ancora scritta**: `matchpoint-payments-sync` deve
**preservare** `status: 'void'` e `voided_at` quando la riga esistente li porta, invece di
riscrivere il payload intero. ⛔ E prima di scriverla vanno guardate due cose che non ho misurato:
① cosa succede a un pagamento **rifatto** sullo stesso slot dopo uno storno (la chiave
`pay|…|metodo|seq` la distingue davvero, o si sovrappone?); ② se un pagamento **stornato dentro
Matchpoint** — dalla segreteria, non dal gestionale — abbia un modo di essere riconosciuto, o se
per quelli il buco resti.

⚖️ **QUANTO PESA, senza gonfiarlo e senza sminuirlo.** Non muove denaro e non tocca Matchpoint,
che resta la verità: il pendente del socio è giusto, e chi guarda la **scheda partita** vede il
vero. A essere sbagliata è la **sezione Incassi**, cioè il posto da cui si guarda la cassa di
giornata — e sbaglia sempre **per eccesso**, mostrando incassato del denaro che è stato reso.
🚨 E colpisce proprio il gesto che la **voce 133** ha appena costruito: il `↩︎ Storna` per riga di
movimento, messo lì perché lo storno si facesse *«sempre nello stesso posto»*. Chi lo preme vede
la riga cambiare e, cinque minuti dopo, tornare com'era.

📌 **PROMOSSA A URGENTE da chi lavora, il 07/09 notte** (delega del 23/08, che chiede di
dichiarare promozione, perché e cosa scavalca). **Non scavalca niente**: era urgente la sola
**171**, e questa le sta accanto. Il perché è che riguarda **la cassa** — il numero su cui si
chiude la giornata — e perché il difetto è **silenzioso**: nessun errore, nessun rosso, solo una
riga che torna al suo posto quando nessuno guarda.
⚠️ **E una cosa che va detta stanotte, non domani**: negli Incassi di **oggi 07/09** ci sono
**due righe da 8,00 € intestate a Fabiola Limuti** che **non sono incassi veri** — sono le prove
autorizzate del 06/09 notte e del 07/09, stornate su Matchpoint ma che il report continua a
elencare. La cassa di oggi va letta **16,00 € più bassa** finché questa voce non è curata.
...
| | |
|---|---|
| **172** | 🔐 **SPUNTANDO IL CAPITOLO, LE SOTTOSEZIONI NON SI ATTIVANO** (permessi staff) — 🗣️ **difetto SUO, trovato il 06/09/2026** mentre apriva i permessi dell'utenza della console: spuntando la voce di capitolo le sottosezioni sotto restavano spente, e ha dovuto metterle **una per una a mano**. ⚖️ **Entra come voce e non come nota** perché è la forma peggiore di difetto in un pannello di permessi: chi spunta il capitolo **crede** di aver aperto tutto, e la casella lo lascia credere ⇒ l'errore va nel verso opposto a quello che spaventa (uno chiude e resta aperto) solo se il difetto è simmetrico, e **nessuno l'ha misurato in quel verso**. 📏 **Cosa NON è stato misurato, e va fatto prima di curare**: se il difetto sia solo nel **disegno** della casella (il click non propaga) o anche nel **salvataggio**; se togliendo la spunta al capitolo le sottosezioni restino **accese**; e se il capitolo spuntato **da solo**, senza sottosezioni, apra qualcosa o niente. ⇒ Tre domande, una sonda sola: la pagina *Impostazioni → Utenti Staff* aperta con la console remota, in lettura. ⛔ **Non si tocca il codice prima**: un pannello di permessi curato sull'ipotesi sbagliata apre porte, non le chiude. 📌 *Il conto di questa voce lo ha già pagato lui: quindici spunte a mano su un'utenza sola.* |
| **142** | 🪟 **La scheda completa al click: giocatori, id e Osservazioni dentro il gestionale** — 🗣️ **sua**, disegnata in cinque messaggi il 04/09/2026 dal cellulare: *«perché ogni volta dobbiamo andare a leggere Matchpoint?»*. ✅⭐ **Primo passo IN SERVIZIO** (TEST e PROD **6.323**), con prova fisica **su tutt'e due** dalla console remota: i nomi che il gestionale ha già si vedono **a 15 ms**, la rotellina «Leggo i giocatori da Matchpoint» non compare, e i pagamenti non ancora letti portano il **terzo segno** («non lo so ancora») invece della ✗ rossa che manderebbe la cassa a chiedere soldi già pagati. 🚨 La misura aveva **spaccato il difetto in due** — 173 roster a oggetti e **67 a stringhe**, questi ultimi vuoti sotto il velo — e curare solo il velo avrebbe lasciato un terzo dei casi con una **sezione vuota**, che sembra una risposta. ⏳ **RESTA APERTA la metà che conta**: l'**id interno** e le **Osservazioni** dentro il gestionale al primo incontro del sync ⇒ oggi i soldi arrivano ancora dal worker, la **138** aspetta quell'id, e la seconda metà della **143** pure. 📄 Scheda per intero qui sopra. |
...
## 📦 CHIUSE — dal 13/08 al 06/09/2026 — 151 voci
