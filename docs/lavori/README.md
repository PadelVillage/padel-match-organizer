...
| | |
|---|---|
| 🔴 **Urgenti** | **2** — restano la **65** e la **66**. La **65** è curata e in servizio, aperta perché la **cura** non l'ha ancora vista succedere nessuno: si aspetta, non si provoca. La **66** era l'unica non curata, di sua scelta (*«solo la diagnostica»*): il fallimento è arrivato nella notte fra il 22 e il 23/08, la traccia è stata recuperata con `stato-worker.yml`, e il **23/08 mattina la cura è stata scritta e messa in servizio** — `PLAYER_ID_NOT_LOCKED` è entrato fra i fallimenti CERTI, così il socio legge «non è passata, rifalla» invece di restare fermo fino a un quarto d'ora. Resta aperta per la stessa ragione della 65: capita di rado e non si provoca. 📦 **Chiusa il 23/08 mattina: la 63**, a cura vista sul bersaglio su un invito vero e una partita vera spostata dal gestionale — previsto 12:27:19, successo 12:27:20. 📦 **Chiuse da lui la notte prima**: la **75**, la **64** e la **67**, tutte e tre a cura **vista**. Dal fallimento della 66 sono nati **due reperti più grandi di lui** — vedi le 🆕 nate misurando, dove il ③ è stato curato nella metà del gestionale e in quella del bot |
