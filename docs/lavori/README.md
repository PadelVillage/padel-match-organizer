...
🆕 **2️⃣ LA SCHEDA DELLA PARTITA TAGLIATA IN ALTO — serve il suo schermo** *(voce 127)*. Da qui non
si riproduce: la console remota blocca `/functions/v1/`, che è la strada del calendario staff ⇒ zero
riquadri da cliccare. Due domande da fare lì: il pannello è **scrollato** o **tagliato**? E succede
**sempre** o solo mentre la lista giocatori sta ancora caricando?
