...
- 🔴 **`pmo_parser_errors`: l'app di PROD scrive e legge colonne che su PROD NON esistono.** Dalla
  ...
  **solo su TEST**. Provato sul bersaglio: **`42703`** su tutte e tre le strade. ⇒ Su PROD nessuna
  ...
  🩹 La riparazione è **piccola e a due strade**: o si aggiungono le 5 colonne a PROD, o si toglie
  quel che l'app chiede in più. La prima allinea, la seconda mutila: propendo per la prima, ma è una
  decisione, non un'ovvietà. **Non l'ho messa in coda da me.**
