...
entrata.
⚖️ **Il perché e cosa scavalca, dichiarati come vuole la regola**: lui ha detto che il test di
livello lo prova **quando sarà dentro Telegram** (*«rimane il test di livello che appena mi dici che
è dentro telegram lo provo»*) ⇒ questa non è più «la prossima cosa da fare sul test», è **l'unica
...
🚨 **L'ordine conta, o il lavoro si fa due volte.** Oggi il test è «tutto in una consegna»: la pagina
raccoglie le 12 risposte e le manda in blocco. La pagina una-alla-volta **e** Telegram hanno bisogno
della **stessa cosa nuova** — che l'edge sappia dire *«questa è la prossima domanda»* e *«questa
risposta è arrivata»*, un passo per volta. ⇒ **motore a passi → Telegram → la pagina si spegne**: se
il test si fa nel bot, il link non serve più.

⭐ **E dentro Telegram è più sicuro della pagina, non solo più comodo**: le opzioni sono bottoni, la
risposta torna come `callback_data`, **la risposta giusta non lascia mai il server**. Oggi la pagina
si scarica le 4 domande del cancello **tutte insieme** e si possono leggere prima di rispondere: è
il buco vero, e non lo chiude nessun cronometro — è la ragione per cui la **fase 2** del cronometro
è stata cancellata e la **fase 1** è qui dentro.
...
### **110** — 🧪 IL TEST DI AUTOVALUTAZIONE RITARATO: la scorciatoia che rendeva più del sapere, i pesi, le scale, la frequenza

🗣️ **Voce SUA, del 30/08/2026**, e nasce da una sua domanda su tre cose che la sessione aveva
**misurato scrivendo la scheda delle regole** per farla esaminare da fuori: *«HAI proposte per
questo?»*, poi *«VAi procedi e fai il lavoro»* sull'ordine proposto.
⚖️ **Non è una voce inventata a fine giornata**: le quattro cure escono tutte da una misura, e le
misure sono state fatte **prima** di proporle — è la forma che la delega del 23/08 chiede.

**① 🚨 La banca dei trabocchetto era sbilanciata, e la scorciatoia batteva il sapere.** Dei 57
trabocchetto, **44 si passavano negando** (le tre forme «Non esiste», «Mai: …», «No: …» sono la
stessa cosa per chi risponde). ⇒ Chi negava tutti e tre i trabocchetto del giro e sapeva le due
domande normali passava il quiz nel **76%** dei casi su Base e Intermedio, **87%** su Avanzato,
**96%** su Agonista — contro il **50%** di chi tira a caso.
🔨 Curata bilanciando la **banca** (27 trabocchetto nuovi che affermano, ogni fascia a metà) e
**non** la pescata: imporre una composizione fissa al giro creerebbe la scorciatoia specchio,
perché con soglia 4/5 e le due normali sapute bastano 2 trabocchetto su 3. 📌 *Contro una
scorciatoia non si mette una regola fissa: una regola fissa è la prossima scorciatoia.*
⇒ Adesso «nego sempre» paga il 50-60% e «confermo sempre» il 40-50%: nessuna risposta automatica
batte il caso.

**② I pesi: il 65% del punteggio veniva da due domande in cui il socio dice di sé** (dichiarato
0,40 + alla pari 0,25). Ora **0,20 · 0,25 · 0,55**, e il freno verso il basso è **tolto**.
📏 E la misura ha spostato l'argomento, perché la prima ipotesi era sbagliata: sui soci che
rispondono **coerenti** il peso non cambia quasi niente (3 schede su 44); cambia dove il socio
**non concorda con sé stesso** (10 su 19 schede con scarto > 0,5, sempre verso il basso).
⇒ Ribilanciare non tocca chi risponde onesto: morde chi si sopravvaluta.
🩹 **E i freni non erano quello che sembravano**: su 44 schede non avevano morso **mai**. Non era
l'ancoraggio a incollare il risultato alla dichiarazione, erano i pesi — la riga che diceva il
contrario nella scheda delle regole è stata corretta.

**③ Le quattro scale tecniche avevano corse diverse** (1-5 lo scambio, 1,5-4,5 la rete e i colpi
alti) ed erano mediate come se fossero commensurabili ⇒ lo scambio pesava un terzo in più, per un
peso che nessuno aveva deciso, e la media tecnica viveva solo fra 1,25 e 4,625. Ora ogni risposta
vale **il minimo della fascia che descrive** (1 · 2 · 3 · 4 · 5).

**④ La domanda sulla frequenza era raccolta e buttata**: non pesava — quello era noto — ma la
colonna era **vuota su 44 schede su 44** (la scrittura cercava una chiave che nessuno manda) e
nel gestionale non la mostrava nessuno. Ora la colonna si riempie, la segreteria la **vede** nella
scheda del socio, e c'è la bandiera gemella di quella dell'esperienza: dichiara Intermedio o più
e gioca 0-1 volte al mese ⇒ scheda in segreteria.

📏 **EFFETTO COMPLESSIVO, misurato sulle 44 schede vere col quiz**: il numero cambia in **15**
casi (4 salgono, 11 scendono), la **parola** in 6 — 3 Base→Intermedio e 1 Intermedio→Avanzato (chi
risponde al centro e prima veniva tenuto giù), più due discese che sono il caso per cui il test
esiste (un Agonista→Avanzato e un Base→Principiante). Le schede fermate per coerenza bassa
scendono da 7 a 5. 🔒 La simulazione è stata **validata prima di crederle**: col calcolo vecchio
riproduce `calculated_level` su **44 schede su 44**. Nessun livello già scritto cambia da sé.

🔒 **Tre guardie nuove, tutte SABOTATE e non solo viste verdi**: il verso dei trabocchetto contro
la forma della risposta giusta (che ha **sostituito** un conteggio con quindici eccezioni
indistinguibili dagli errori), l'equilibrio della banca con la probabilità delle due scorciatoie
speculari, e la taratura — che **non era protetta da niente**: delle 65 prove del repo nessuna
...
(chi risponde «0-1» dichiara sempre meno di Intermedio) ⇒ nasce **non provata su un caso vivo**.
...
## 📦 CHIUSE — dal 13 al 30/08/2026 — 88 voci
