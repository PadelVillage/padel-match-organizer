...
| | |
|---|---|
| **114** | 🟩 **Oltre i 30 giorni il calendario staff dice «Libero», non «non lo so»** — 🗣️ nata da una sua domanda del 01/09/2026: *«non vedo quattro campi prenotati il quattro di ottobre alle ore dieci e trenta»*. 🔎 **La causa NON è un guasto**: `matchpoint-bookings-sync` chiede a Matchpoint `DEFAULT_FUTURE_DAYS = 30` giorni da oggi (`index.ts:59`), quindi la copia arriva a **oggi+30** e basta. Il 4 ottobre era a **33 giorni** ⇒ quelle prenotazioni sul gestionale non ci potevano essere, e il 4 settembre entreranno da sé. **Quello non è il difetto.** 🚨⭐⭐ **IL DIFETTO È COSA SI VEDE AL POSTO LORO: quattro campi VERDI con scritto «Libero», tutto il giorno.** ⇒ Un'assenza di dato mostrata come una **risposta affermativa** — e nel verso peggiore, perché «libero» è esattamente la condizione per prenotarci sopra. Chi in segreteria guarda una data oltre l'orizzonte legge *campo libero* dove su Matchpoint il campo **è preso**. 📏 **Misurato dentro l'app viva su PROD** (console remota, dopo aver atteso il caricamento), con il **controllo accanto** che isola il difetto: 4 settembre → **5 slot occupati**, griglia di 348 caratteri; 4 ottobre → **0 slot**, griglia di 66 caratteri e **4 blocchi «Libero»**. E la copertura vista da dentro l'app (01/09 → 30/09, 28 giorni) combacia col database. ⚠️ **Due letture PRIME di questa erano false e vanno sapute**, perché è la trappola che questa voce insegna: cercare le prenotazioni in `window.bookings` (che non esiste) e leggere la griglia **prima** che il caricamento finisse — con la schermata che lo diceva («aggiorno…») senza che nessuno lo leggesse. Tutt'e due davano «tutto Libero» anche sul 4 settembre, cioè **avrebbero fatto chiamare difetto una cosa sana**. 📌 *Una sonda che risponde «zero» va sempre puntata prima su un caso che DEVE dire «non zero».* ⏳ **La cura non è scritta e sono due strade diverse**: ① far dire alla griglia *«oltre i 30 giorni non lo sappiamo»* invece di «Libero» — piccola, e toglie il danno; ② **allungare l'orizzonte** del sync — costa scraping su giorni quasi vuoti, e va deciso da lui. La ① non esclude la ②. ⛔ Nessuna cura proposta prima di una sua parola su quale delle due |
...
## 📦 CHIUSE — dal 13/08 al 01/09/2026 — 98 voci
