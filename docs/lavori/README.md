...
### **123** — 🚨🚨 Il circolo avvisa il socio di un gesto che ha fatto LUI, e lo manda a parlare con sé stesso

🆕 **APERTA E MESSA IN URGENTI il 02/09/2026, per sua decisione** (*«apri l'altra in coda, tra
gli urgenti»*), dopo averla vista sul proprio telefono.

📏 **VISTA SUCCEDERE, non dedotta.** Alle **00:02:47** Maurizio toglie Marco dalla partita del 7
settembre — gesto suo, dal bot, riuscito. Alle **00:03:26** il registro del bot scrive:

```
🔔 detto a Maurizio Aprea: il circolo ha formazione — 2026-09-07|11:00|3
🔔 detto a Lidia Comes:   il circolo ha formazione — 2026-09-07|11:00|3
🔔 detto a Laura Aprea:   il circolo ha formazione — 2026-09-07|11:00|3
```

⇒ A **Maurizio** è arrivato: *«🔄 È cambiata la formazione della tua partita … Esce Marco Aprea.
**L'ha chiesto Maurizio Aprea.** … Se non te lo aspettavi, **parlane con Maurizio Aprea**.»*

🚨 **Cioè: il circolo gli annuncia una cosa che ha appena fatto lui, e lo manda a chiedere
spiegazioni a sé stesso.** È la **voce 70** — *«il circolo annuncia al socio una cosa che ha
appena fatto lui»* — rientrata da una porta che quella cura non copriva.

⚖️ **PERCHÉ LA RICEVUTA NON L'HA COPERTO, e non è una dimenticanza: è una scelta scritta.** In
`consumer-booking-write/index.ts`, sul `remove` riuscito:
...
await lasciaRicevuta('remove', …, [{ persona: bersaglio.nome, gesto: 'tolto' }]);
```

⇒ La ricevuta copre **chi viene tolto** (Marco), e **solo lui**. Chi ha **chiesto** la scrittura
(Maurizio) resta scoperto, e il fatto lo raggiunge dal sync come se fosse del circolo.

🩹 **E QUI STA LA RIGA DA CORREGGERE, NON DA AFFIANCARE.** La voce 70 aveva stabilito che la
regola giusta è *«una ricevuta dice: questo non l'ha fatto la segreteria»* — larga, non *«non
dirlo a chi l'ha fatto»*. Ma sul `remove` la ricevuta è stata scritta con la lista dei **toccati**
invece che con quella dei **coperti**, e le due divergono esattamente qui: nell'`add` chi chiede è
...
## 📦 CHIUSE — dal 13/08 al 01/09/2026 — 101 voci
