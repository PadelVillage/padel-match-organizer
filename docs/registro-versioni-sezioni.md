...
| Autovalutazioni / dashboard | `padel_match_organizer_v5_236.html`; mockup `mockup/padel-dashboard-mockup.html`; viewer `mockup/padel-players-assessment-viewer.html` | **In lavorazione su v5.236, da validare manualmente** | v5.236 mantiene il calcolo Dashboard introdotto in v5.233: `Slot Liberi` usa la griglia comune degli slot potenziali salvata in DATI (in/out) e sottrae le occupazioni Matchpoint importate. Formula: slot potenziali configurati - prenotazioni/occupazioni Matchpoint = slot liberi reali. |
...
| Matchpoint / DATI (in/out) | `padel_match_organizer_v5_236.html`; `docs/matchpoint.md`; `docs/slot-potenziali.md` | **In prova locale su v5.236, da validare manualmente** | Sezione operativa minimale con prima riga Clienti, Prenotazioni future, Storico e Backup. Il riquadro `Slot potenziali Matchpoint` resta sotto, a tutta larghezza, aperto di default senza barra di apertura, con contenuto orizzontale immagine/griglia. La logica resta sui dati `potentialSlotSchedule`, senza OCR runtime. |
