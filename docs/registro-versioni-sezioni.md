...
- `padel_match_organizer_v5_224.html`: seconda fase performance Apri Partite: nessun loading visibile nella sezione, contesto candidati riusato in memoria e pre-riscaldato dopo il calendario; non ancora pubblicata; richiede validazione manuale.
